...
do
    if [ "$file" != "catalina.out" -a "$file" != "serverlog.$today"  -a "$file" != "accesslog.$today" -a "$file" != "serverlog" -a "$file" != "resultset" -a "$file" != "l4jaccesslog"  -a "$file" != "useraccesslog"  -a "$file" != "clientlog"  -a "$file" != "userlogin"  -a "$file" != "sqlitelog" ]; then
