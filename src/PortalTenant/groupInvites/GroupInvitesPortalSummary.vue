<template>
  <div class="d-flex flex-col flex-auto visitor-summary" style="overflow: hidden;">
    ...
    <template v-else>
      <div class="visitor-container">
        <div class="fc-dark-grey-txt18">
          <div class="row p5 pointer summary-name">
      ...
      <div class="flex-auto" v-if="!$validation.isEmpty(summaryData)">
        <div class="fc__asset__main__scroll">
          ...
          <div class="fc__white__bg__p0">
            <el-table
              height="400"
              class="m0 p15 width100 inventory-inner-table clearboth visitor-table"
