...
<%
    ...
    try {
        FacilioIndexJsp.setOrgAttribute(request);
        if (!FacilioIndexJsp.redirectToNewVersion(request)) {
        ...
        */
        ...
        /* else {
            ...
            Object pathInfo = request.getAttribute("javax.servlet.forward.request_uri");
            UriBuilder redirectLocation = UriBuilder.newInstance()
                    .scheme(scheme)
                    .host(host);
            if (pathInfo != null) {
                redirectLocation.path(pathInfo.toString());
            }
            if (StringUtils.isNotEmpty(request.getQueryString())) {
                redirectLocation.replaceQuery(request.getQueryString());
            }
            redirectLocation.queryParam(FacilioIndexJsp.NEW_SERVER_QUERY_PARAM_KEY, FacilioIndexJsp.NEW_SERVER_QUERY_PARAM_VAL);
