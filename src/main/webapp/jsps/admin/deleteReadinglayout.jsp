        ...
        <select class="admin-data-select"
            ...
            <%
                for (Organization domain : orgs) {
                    if (domain.getOrgId() == 321 || domain.getOrgId() == 1 || domain.getOrgId() == 75 || domain.getOrgId() == 155 || domain.getOrgId() == 210 || domain.getOrgId() == 349 || domain.getOrgId() == 78 || domain.getOrgId() == 343 || domain.getOrgId() == 473 ||  domain.getOrgId() == 393) {
