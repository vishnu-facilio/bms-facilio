...
<head>
    <script type="text/javascript">
        function changeOrgPage() {
            var selectedOption = "moveReadings?orgid=" + $("#orgid").val();
    ...
    <script type="text/javascript">
        ...
        function changeendTTimePage() {
            var selectedOption = "moveReadings?orgid=" + $("#orgid").val() + "&" + "email=" + $("#email").val()
...
<form action="moveReadingAction">
    ...
    <div class=" col-lg-8 col-md-8">
        ...
        <div>
            ...
            <option value="" disabled selected>Select</option>
            <option value="<%=1%>"<%=(request.getParameter("shiftType") != null && request.getParameter("shiftType").equals("1" + "")) ? "shiftType" : " "%>>
                Before
            </option>
            <option value="<%=2%>"<%=(request.getParameter("shiftType") != null && request.getParameter("shiftType").equals("2" + "")) ? "shiftType" : " "%>>
                After
            </option>
        </select>
        ...
        <input type="number" id="durations"
               value="<%=request.getParameter("durations")==null?"": request.getParameter("durations")%>" name="durations">
        (in minutes)
        <br>
        <br>
        <br>
        <br>
        <input type="submit" style="margin-left: 200px" name="moveReadings" value="Submit"/>
        <br>
        <br>
        <br>
