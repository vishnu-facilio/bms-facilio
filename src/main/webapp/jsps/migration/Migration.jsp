...
<%
	...
	public boolean executeCommand(Context context) throws Exception {
		...
		for(Organization org : organizations) {
			...
			FacilioModule serviceRequest = modBean.getModule("serviceRequest");
			if(serviceRequest != null) {
				NumberField srRequestType = new NumberField(serviceRequest, "requestType", "Request Type", FieldDisplayType.NUMBER, "REQUEST_TYPE", FieldType.NUMBER, true, false, true, false);
				modBean.addField(srRequestType);
				
				NumberField srRatingValNF = new NumberField(serviceRequest, "ratingVal", "Rating Val", FieldDisplayType.NUMBER, "RATING_VAL", FieldType.NUMBER, true, false, true, false);
				modBean.addField(srRatingValNF);
			} else {
				LOGGER.log(Level.INFO, "Migration didn't happen for: " + orgId);
			}
			LOGGER.log(Level.INFO, "Migration done for: " + orgId);
		}
