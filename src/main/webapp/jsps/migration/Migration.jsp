	...
	final class MigrationCommand extends FacilioCommand {
		...
		public boolean executeCommand(Context context) throws Exception {
			...
			for (Organization org : organizations) {
				...
				if (applicationModule != null && webtabGroupModule != null) {
					ApplicationContext applicationContext = new ApplicationContext();
					applicationContext.setName("Facilio");
					applicationContext.setIsDefault(true);
					long appId = ApplicationApi.addApplicationApi(applicationContext);
					...
					if(webTabGroups!=null && !webTabGroups.isEmpty()) {
						for(WebTabGroupContext webTabGroupContext: webTabGroups) {
							webTabGroupContext.setAppId(appId);
							ApplicationApi.updateWebTabGroups(webTabGroupContext);
						}
					}
