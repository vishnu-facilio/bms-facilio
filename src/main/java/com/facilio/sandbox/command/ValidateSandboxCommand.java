...
public class ValidateSandboxCommand extends FacilioCommand {
    ...
    public boolean executeCommand(Context context) throws Exception {
        ...
        if(sandboxConfig.getId() > 0) {
            ...
            V3Util.throwRestException(!existingSandbox.getSubDomain().equalsIgnoreCase(sandboxConfig.getSubDomain()), ErrorCode.VALIDATION_ERROR, "Cannot change sandbox domain");
        }
        return false;
    }
}
