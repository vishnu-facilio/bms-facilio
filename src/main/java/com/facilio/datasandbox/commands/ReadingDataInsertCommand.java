...
public class ReadingDataInsertCommand extends FacilioCommand {
    ...
    public boolean executeCommand(Context context) throws Exception {
        ...
        if (dataMigrationObj.getStatusEnum().getIndex() > DataMigrationStatusContext.DataMigrationStatus.READING_MODULE_IN_PROGRESS.getIndex()) {
            return false;
        }
        ...
        for (String moduleName : readingModulesList) {
            ...
            try {
                do {
                    ...
                    migrationBean.updateDataMigrationStatusWithModuleName(dataMigrationObj.getId(), DataMigrationStatusContext.DataMigrationStatus.READING_MODULE_IN_PROGRESS, module.getName(), offset);
