...
public class GetOneLevelModuleFieldsCommand extends FacilioCommand {
    ...
    public boolean executeCommand(Context context) throws Exception {
        ...
        if (fetchSupplementModuleFields) {
            boolean checkFieldsPermission = (boolean) context.getOrDefault(FacilioConstants.FieldsConfig.CHECK_FIELDS_PERMISSION, true);
            ...
            for (String lookupModuleName : lookupModuleNames) {
                FacilioContext supplementsContext = FieldsConfigChainUtil.fetchFieldList(lookupModuleName, fieldListType, defaultFieldIds, checkFieldsPermission, true);
