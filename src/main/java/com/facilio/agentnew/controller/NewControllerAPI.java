...
public class NewControllerAPI {
    private static final Logger LOGGER = LogManager.getLogger(NewControllerAPI.class.getName());
    ...
    public static long addController(Controller controller) {
        try {
            ...
            String assetCategoryName = NewControllerAPI.getControllerModuleName(FacilioControllerType.valueOf(controller.getControllerType()));
