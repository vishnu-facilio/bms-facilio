...
public class AssetDepartmentPackageBeanImpl implements PackageBean<V3AssetDepartmentContext> {
    ...
    public Map<String, Long> createComponentFromXML(Map<String, XMLBuilder> uniqueIdVsXMLData) throws Exception {
        ...
        if(CollectionUtils.isNotEmpty(updateAssetDepartmentDatas)) {
            ...
            FacilioContext context = V3Util.updateBulkRecords(module, v3Config, oldRecords, updateAssetDepartmentDatas, keyList, null, null, null, null, null, null, null, null, false, false, null,null);
            Map<String, List> recordMap = (Map<String, List>) context.get(Constants.RECORD_MAP);
    ...
    public void updateComponentFromXML(Map<Long, XMLBuilder> idVsXMLComponents) throws Exception {
        ...
        if(CollectionUtils.isNotEmpty(keyList)) {
            ...
            V3Config v3Config = ChainUtil.getV3Config(module);
            V3Util.updateBulkRecords(module, v3Config, oldRecords, newAssetDepartmentDatas, keyList, null, null, null, null, null, null, null, null, false, false, null,null);
        }
    }
