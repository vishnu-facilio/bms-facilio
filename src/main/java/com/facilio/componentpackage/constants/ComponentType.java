...
public enum ComponentType implements FacilioIntEnum {
    ...
    TICKET_CATEGORY(TicketCategoryPackageBeanImpl.class, MODULE, true),
    TICKET_TYPE(TicketTypePackageBeanImpl.class, MODULE, true),
    TICKET_PRIORITY(TicketPriorityPackageBeanImpl.class, MODULE, true),
    SPACE_CATEGORY(SpaceCategoryPackageBeanImpl.class, MODULE, true),
    ...
    VALUE_GENERATOR(null,null,false),
    ...
    USER_SCOPING_CONFIG(null,null, false),
    PEOPLE_USER_SCOPING_CONFIG(null,null, false),
    PERMISSION_SET(PermissionSetPackageBeanImpl.class,MODULE,false),
    PERMISSION_SET_CONFIG(null,null,false),
    PEOPLE_PERMISSION_SET_CONFIG(null,null,false),
