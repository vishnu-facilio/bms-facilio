...
//    }
                ...
                case REMOVE_MANDATORY:   //   12
                    ...
                    for (FormRuleActionFieldsContext actionFieldContext : formRuleActionContext.getFormRuleActionFieldsContext()) {
                        ...
                        if (actionFieldContext.getFormFieldId() > 0) {
                            FormField formField = FormsAPI.getFormFieldFromId(actionFieldContext.getFormFieldId());
                            ...
                            if (formField != null && formField.getField() != null) {
                                ...
                                FacilioForm form = FormsAPI.getFormFromDB(formField.getFormId());
                    ...
                    for (FormRuleActionFieldsContext actionFieldContext : formRuleActionContext.getFormRuleActionFieldsContext()) {
                        ...
                        if (actionFieldContext.getFormFieldId() > 0) {
                            ...
                            if (formField != null && formField.getField() != null) {
                                ...
                                if (actionFieldContext.getCriteria() != null) {
                                    filterAndValueActionFieldElement.addElement(PackageBeanUtil.constructBuilderFromCriteria(actionFieldContext.getCriteria(), filterAndValueActionFieldElement.element(PackageConstants.FormRuleConstants.FILTER_CRITERIA), moduleName));
                                }
                            }
                        }
                    }
    ...
    public static List<FormRuleActionContext> constructActionFieldsFromBuilder(XMLBuilder formRuleActionsList) throws Exception {
        ...
        for (XMLBuilder actionElement : actionsListElementList) {
            ...
            switch (actionType) {
                ...
                case EXECUTE_SCRIPT:     //8
                    FormRuleActionContext formRuleActionContext = new FormRuleActionContext();
                    WorkflowContext workflowContext = new WorkflowContext();
                    ...
                    workflowContext.setIsV2Script(isV2Script);
                    workflowContext.setWorkflowV2String(workflowV2String);
                    formRuleActionContext.setWorkflow(workflowContext);
                    formRuleActionContext.setActionType(FormActionType.EXECUTE_SCRIPT.getVal());
                    actionContextList.add(formRuleActionContext);
    ...
    public static List<FormRuleContext> getFormRules(List<FacilioField> selectableFields, Criteria formRuleCriteria) throws Exception{
    ...
    public static Map<Long, Long> getFormRuleIdVsFormId(boolean fetchSystem,boolean fetchSubForm) throws Exception {
