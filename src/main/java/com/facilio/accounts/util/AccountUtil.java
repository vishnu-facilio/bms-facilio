...
public class AccountUtil {
    ...
    public enum FeatureLicense {
		...
		APPROVAL(11,1024,LicenseMapping.GROUP1LICENSE), // --- not in use
		...
		SMS(59, 288230376151711744L, LicenseMapping.GROUP1LICENSE), // 2 ^ 58 --- not in use
		...
		FSM(157,getExponentValue(30),new String[]{FacilioConstants.ContextNames.FieldServiceManagement.SERVICE_ORDER,FacilioConstants.Territory.TERRITORY,FacilioConstants.ServiceAppointment.SERVICE_APPOINTMENT,FacilioConstants.TimeSheet.TIME_SHEET,FacilioConstants.Trip.TRIP},LicenseMapping.GROUP3LICENSE),//2^30
