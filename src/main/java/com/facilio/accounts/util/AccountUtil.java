...
public class AccountUtil {
    ...
    public enum FeatureLicense {
		...
		PM_PLANNER(81, 131072, new String[]{ContextNames.PLANNEDMAINTENANCE,FacilioConstants.ContextNames.JOB_PLAN} , LicenseMapping.GROUP2LICENSE),
		...
		DISABLE_GROUP_INVITE(105,8796093022208L,LicenseMapping.GROUP2LICENSE);//2^43
