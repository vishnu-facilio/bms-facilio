...
public interface WorkflowV2Visitor<T> extends ParseTreeVisitor<T> {
	 ...
	 * @return the visitor result
	 */
	T visitReadingInitialization(WorkflowV2Parser.ReadingInitializationContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link WorkflowV2Parser#db_param_group}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitDb_param_group(WorkflowV2Parser.Db_param_groupContext ctx);
	/**
