...
data_type
 : op=(VOID | DATA_TYPE_STRING | DATA_TYPE_NUMBER | DATA_TYPE_BOOLEAN | DATA_TYPE_MAP | DATA_TYPE_LIST | DATA_TYPE_CRITERIA | DATA_TYPE_CHAT_BOT_ACTION)
 ;
...
DATA_TYPE_CHAT_BOT_ACTION : 'ChatBotAction';
RETURN : 'return';
