...
@Log4j
public class ClearAlarmJob extends FacilioJob {
    @Override
    public void execute(JobContext jc) throws Exception {
        ...
        if(rawAlarm != null) {
            ...
            if(filterRuleCriteria != null) {
                AlarmCriteriaHandler handler = filterRuleCriteria.getFilterCriteria().getHandler(rawAlarm);
                if(handler != null) {
                    handler.clearAlarm(rawAlarm);
                }
            }
        }
    }
