...
public class LastAggregationHandler implements AggregationHandler {
    @Override
    public Double aggregate(NameSpaceField nameSpaceField) throws Exception {
        ...
        SelectRecordsBuilder<ReadingContext> selectBuilder = new SelectRecordsBuilder<ReadingContext>()
                ...
                .orderBy("TTIME desc")
                .limit(1);
        selectBuilder.aggregate(BmsAggregateOperators.SpecialAggregateOperator.LAST_VALUE, field);
