...
public class TelemetryAggregationUtil {
    public static Double getAggregatedValue(NameSpaceField nameSpaceField,AggregateOperator operator) throws Exception {
        ...
        SelectRecordsBuilder<ReadingContext> selectBuilder = new SelectRecordsBuilder<ReadingContext>()
                ...
                .orderBy("TTIME");
        selectBuilder.aggregate(operator, field);
