...
public class FacilioIAMFunction {
    public Object allowAppAccess(Map<String, Object> map, Object... objects) throws Exception {
        if (objects.length < 4) {
    ...
    public Object changeAppRole(Map<String, Object> map, Object... objects) throws Exception {
        if (objects.length < 3) {
    ...
    public Object revokeAppAccess(Map<String, Object> map, Object... objects) throws Exception {
        if (objects.length < 2) {
