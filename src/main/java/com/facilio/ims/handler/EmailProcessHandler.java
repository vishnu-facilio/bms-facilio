...
@Log4j
public class EmailProcessHandler extends ImsHandler {
	public static final String KEY = "email-process";
	public static final String TUTEN_LABS_KEY = "email-process-tutenlabs";
