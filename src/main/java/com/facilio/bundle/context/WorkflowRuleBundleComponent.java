...
public class WorkflowRuleBundleComponent implements BundleComponentInterface {
	...
	public JSONArray getAllFormatedObject(FacilioContext context) throws Exception {
        ...
        newContext.put(FacilioConstants.ContextNames.RULE_TYPE, WorkflowRuleContext.RuleType.MODULE_RULE.getIntVal());
        chain.execute();
