...
public class FacilioCorsFilter implements Filter {
    ...
    public void init(FilterConfig filterConfig) throws ServletException {
        ...
        if(originValues == null) {
            originValues = "https://facilio.com,https://facilioportal.com,https://faciliovendors.com,https://faciliotenants.com";
        }
    ...
    public void doFilter(ServletRequest servletRequest, ServletResponse servletResponse, FilterChain filterChain) throws IOException, ServletException {
        ...
        if( ! (FacilioProperties.isOnpremise() || FacilioProperties.isDevelopment())) {
            if (FacilioProperties.isProduction()) {
                response.setHeader(CONTENT_SECURITY_POLICY , "default-src 'self' data: 'unsafe-inline' 'unsafe-eval' https:; script-src 'self' 'unsafe-inline' 'unsafe-eval' https://*.facilio.com https://apis.google.com https://maps.googleapis.com https://ssl.gstatic.com https://www.google-analytics.com https://accounts.google.com; child-src 'self' blob:  https:; worker-src 'self' blob:; style-src 'self' data: 'unsafe-inline' https://*.facilio.com https://*.googleapis.com; connect-src wss: https: data:; object-src 'none'; form-action https:; upgrade-insecure-requests; img-src 'self' blob: data: https:;");
           } else {
                response.setHeader(CONTENT_SECURITY_POLICY , "default-src 'self' data: 'unsafe-inline' 'unsafe-eval' https:; script-src 'self' 'unsafe-inline' 'unsafe-eval' https://*.facilio.in  https://apis.google.com https://maps.googleapis.com https://ssl.gstatic.com https://www.google-analytics.com https://accounts.google.com; child-src 'self' blob:  https:; worker-src 'self' blob:; style-src 'self' data: 'unsafe-inline' https://*.facilio.in https://*.googleapis.com; connect-src wss: https: data:; object-src 'none'; form-action https:; upgrade-insecure-requests; img-src 'self' blob: data: https:;");
            }
        }
