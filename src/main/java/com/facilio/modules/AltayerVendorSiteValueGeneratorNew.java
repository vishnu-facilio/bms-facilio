...
public class AltayerVendorSiteValueGeneratorNew extends ValueGenerator {
    @Override
    ...
    public String getValueGeneratorName() {
        return "Altayer Vendors Sites New";
    }

    @Override
    public String getLinkName() {
        return "com.facilio.modules.AltayerVendorSiteValueGeneratorNew";
    }
