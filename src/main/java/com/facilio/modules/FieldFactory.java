...
//                "fieldId",
    ...
    public static List<FacilioField> getFormFieldsFields() {
        ...
        fields.add(getField("relationMappingId", "Relation Mapping Id", "RELATION_MAPPING_ID", module, FieldType.NUMBER));
...
//		fields.add(getField("lowerAnomaly","lowerAnomalyLog","DECIMAL_CF5",module,FieldType.NUMBER));
    ...
    public static List<FacilioField> getCustomButtonAppRelFields(){
        FacilioModule module = ModuleFactory.getCustomButtonAppRelModule();
        List<FacilioField> fields = new ArrayList<>();
        
        fields.add(getIdField(module));
        fields.add(getNumberField("customButtonId","CUSTOM_BUTTON_ID",module));
...
//        fields.add(getNumberField("appId", "APP_ID", module));
    ...
    public static List<FacilioField>  getDashboardReadingWidgetFieldMappingFields()
    {
        FacilioModule module = ModuleFactory.getDashboardReadingWidgetFieldMappingModule();
        List<FacilioField> fields = new ArrayList<>();
        fields.add(getIdField(module));
        fields.add(getField("userFilterId", "USER_FILTER_ID", module, FieldType.NUMBER));
        fields.add(getField("widgetId", "WIDGET_ID", module, FieldType.NUMBER));
...
//    }
    ...
    public static List<FacilioField> getPageTabsFields(){
        ...
        fields.add(getField("sequenceNumber", "SEQUENCE_NUMBER", module, FieldType.DECIMAL));
        fields.add(getBooleanField("status","STATUS",module));
        fields.add(getStringField("tabType","TAB_TYPE",module));
...
//        fields.add(getNumberField("maxWidth","MAX_WIDTH",module));
    ...
    public static List<FacilioField> getPageSummaryWidgetFields() {
        ...
        fields.add(getNumberField("pageWidgetId", "PAGE_WIDGET_ID", module));//TODO remove this once PAGE_WIDGET_ID once column is migrated
        fields.add(getNumberField("widgetId", "WIDGETID", module));
    ...
    public static FacilioField getWidgetIdField(FacilioModule module, WidgetWrapperType type) {
        switch (type) {
            case DEFAULT:
                return getNumberField("widgetId","WIDGETID",module);
            case WIDGET_GROUP:
                return getNumberField("widgetGroupWidgetId", "WIDGETGROUP_WIDGET_ID", module);
            default:
                return new FacilioField();
        }
    }
