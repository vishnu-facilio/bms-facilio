...
public class FacilioConstants {
	...
	public static class ContextNames {
		...
		public static final String EXTENDED_MODULE_NAME = "extendedModuleName";
		...
		public static final String COMMENT_MENTIONS = "commentMentions";
		public static final String COMMENT_SHARING = "commentsSharing";
		...
		public static final String INCLUDE_PARENT_ID = "includeParentId";
		...
		private static Map<String, Class> initClassMap() {
			...
			classMap.put(BureauCloseIssueReasonOptionListModule.MODULE_NAME, BureauCloseIssueReasonOptionContext.class);
	...
	public static class HTTPParameter {
		public static final List<String> KEYS = Arrays.asList("permission","moduleName","tabType","setupTab",FacilioConstants.ContextNames.WebTab.PARENT_MODULE_NAME,"isAttachmentApi","skipPermission","permissionModuleName");
	}
