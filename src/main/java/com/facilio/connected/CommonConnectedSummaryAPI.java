...
public class CommonConnectedSummaryAPI {
    ...
    public static List<PagesContext> getNewReadingRuleSystemPage(ApplicationContext app, boolean isTemplate, boolean isDefault) throws Exception {
        ...
        PagesContext ruleTemplatePage = new PagesContext(pageName, pageDisplayName, "", null, isTemplate, isDefault, false)
                ...
                .addWidget("ruleDetails", "Rule Details", PageWidget.WidgetType.SUMMARY_FIELDS_WIDGET, "flexiblewebsummaryfieldswidget_11", 0, 0, null, getReadingRuleSummaryWidgetDetails(FacilioConstants.ReadingRules.NEW_READING_RULE, app))
                .widgetDone()
                .sectionDone()
                .addSection("faultDetails", null, null)
                .addWidget("assetsAndAlarm", null, PageWidget.WidgetType.RULE_ASSETS_AND_ALARM, "webRuleAssetsAndAlarm_30_4", 0, 0, null, null)
                .widgetDone()
                .addWidget("rootCauseAndImpact", null, PageWidget.WidgetType.ROOT_CAUSE_AND_IMPACT, "webRootCauseAndImpact_30_3", 4, 0, null, null)
                .widgetDone()
                .addWidget("ruleAlarmInsights", null, PageWidget.WidgetType.RULE_ALARM_INSIGHT, "webRuleAlarmInsights_30_5", 7, 0, null, null)
                .widgetDone()
                .sectionDone()
                .addSection("workOrderDetails", null, null)
                .addWidget("associatedWorkOrders", "Associated Work Orders", PageWidget.WidgetType.RULE_ASSOCIATED_WORK_ORDERS, "webRuleAssociatedWorkOrders_15_6", 0, 0, null, null)
                .widgetDone()
                .addWidget("ruleWorkOrderDuration", "Associated Work Orders", PageWidget.WidgetType.RULE_WORK_ORDER_DURATION, "webRuleWorkOrderDuration_15_6", 6, 0, null, null)
                .widgetDone()
                .sectionDone()
                .columnDone()
                .tabDone()
                ...
                .addWidget("ruleInsight", "Rule Insight", PageWidget.WidgetType.RULE_INSIGHT, "webRuleInsight_32_12", 0, 0, null, null)
                .widgetDone()
                .sectionDone()
                .columnDone()
                .tabDone()
                ...
                .addWidget("rootCauses", "Root Causes", PageWidget.WidgetType.ROOT_CAUSES, "webRootCauses_32_12", 0, 0, null, null)
                .widgetDone()
                .sectionDone()
                .columnDone()
                .tabDone()
                ...
                .addWidget("ruleLogs", "Activity Log", PageWidget.WidgetType.RULE_LOGS, "webRuleLogs_32_12", 0, 0, null, null)
                .widgetDone()
                .sectionDone()
                .columnDone()
                .tabDone()
    ...
    public static List<PagesContext> getReadingAlarmSystemPage(ApplicationContext app, boolean isTemplate, boolean isDefault) throws Exception {
        ...
        PagesContext readingAlarmTemplatePage = new PagesContext(pageName, pageDisplayName, "", null, isTemplate, isDefault, false)
                ...
                .addWidget("readingAlarmDetails", "Faults Details", PageWidget.WidgetType.SUMMARY_FIELDS_WIDGET, "websummaryfieldswidget_28_9", 0, 0, null, getReadingAlarmSummaryWidgetDetails(FacilioConstants.ContextNames.NEW_READING_ALARM, app))
                .widgetDone()
    ...
    public static List<PagesContext> getBMSAlarmSystemPage(ApplicationContext app, boolean isTemplate, boolean isDefault) throws Exception {
        ...
        PagesContext sensorAlarmTemplatePage = new PagesContext(pageName, pageDisplayName, "", null, isTemplate, isDefault, false)
                ...
                .addColumn(PageColumnContext.ColumnWidth.FULL_WIDTH)
                .addSection("alarmDetails", null, null)
                .addWidget("bmsAlarmDetails", "BMS Alarm Details", PageWidget.WidgetType.SUMMARY_FIELDS_WIDGET, "websummaryfieldswidget_28_9", 0, 0, null, getBMSAlarmSummaryWidgetDetails(FacilioConstants.ContextNames.BMS_ALARM, app))
                .widgetDone()
    ...
    public static List<PagesContext> getSensorAlarmSystemPage(ApplicationContext app, boolean isTemplate, boolean isDefault) throws Exception {
        ...
        PagesContext sensorAlarmTemplatePage = new PagesContext(pageName, pageDisplayName, "", null, isTemplate, isDefault, false)
                ...
                .addColumn(PageColumnContext.ColumnWidth.FULL_WIDTH)
                .addSection("alarmDetails", null, null)
                .addWidget("sensorAlarmDetails", "Details", PageWidget.WidgetType.SUMMARY_FIELDS_WIDGET, "websummaryfieldswidget_28_9", 0, 0, null, getSensorAlarmSummaryWidgetDetails(FacilioConstants.ContextNames.SENSOR_ROLLUP_ALARM, app))
                .widgetDone()
