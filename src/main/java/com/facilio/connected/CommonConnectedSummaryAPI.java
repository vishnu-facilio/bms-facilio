...
public class CommonConnectedSummaryAPI {
    ...
    public static List<PagesContext> getNewReadingRuleSystemPage(ApplicationContext app, boolean isTemplate, boolean isDefault) throws Exception {
        ...
        PagesContext ruleTemplatePage = new PagesContext(pageName, pageDisplayName, "", null, isTemplate, isDefault, false)
                ...
                .addWidget("ruleInsight", "Rule Insight", PageWidget.WidgetType.RULE_INSIGHT, "ruleInsight_32_12", 0, 0, null, null)
                .widgetDone()
                .sectionDone()
                .columnDone()
                .tabDone()
                ...
                .addWidget("rootCauses", "Root Causes", PageWidget.WidgetType.ROOT_CAUSES, "rootCauses_32_12", 0, 0, null, null)
                .widgetDone()
                .sectionDone()
                .columnDone()
                .tabDone()
                ...
                .addWidget("ruleLogs", "Activity Log", PageWidget.WidgetType.RULE_LOGS, "ruleLogs_32_12", 0, 0, null, null)
                .widgetDone()
                .sectionDone()
                .columnDone()
                .tabDone()
