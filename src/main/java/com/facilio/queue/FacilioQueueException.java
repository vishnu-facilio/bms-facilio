...
public class FacilioQueueException {
	private static final String TABLE_OLD = "FacilioExceptionQueue";
	private static final String NEW_TABLE_DATA ="FacilioExceptionQueue_Data" ;
	private static final FacilioQueueService INSTANCE = new FacilioDbQueue(TABLE_OLD,NEW_TABLE_DATA,true);
