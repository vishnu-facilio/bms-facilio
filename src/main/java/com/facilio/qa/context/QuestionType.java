...
public enum QuestionType implements FacilioStringEnum {
    ...
    SHORT_ANSWER (FacilioConstants.QAndA.Questions.SHORT_STRING_QUESTION, ShortStringQuestionContext.class, new StringAnswerHandler(StringAnswerContext.class, false)),
    ...
    BOOLEAN (FacilioConstants.QAndA.Questions.BOOLEAN_QUESTION, BooleanQuestionContext.class, new BooleanAnswerHandler(BooleanAnswerContext.class)),
    ;
