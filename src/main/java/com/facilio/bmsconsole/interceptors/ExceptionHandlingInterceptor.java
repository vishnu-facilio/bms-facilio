...
public class ExceptionHandlingInterceptor extends AbstractInterceptor  {
    ...
    public String intercept(ActionInvocation invocation) throws Exception {
        ...
        try{
            ...
            errorMap.put("message", errorType ? values.getMessage() : ex.getMessage());
            errorMap.put("responseCode",errorType ? values.getErrorCode().getCode() : ErrorCode.ERROR.getCode());
            errorMap.put("code",errorType ? values.getErrorCode().getCode() : ErrorCode.ERROR.getCode());
            ...
            write(errorMap, errorType ? values.getErrorCode().getHttpStatus() : ErrorCode.ERROR.getHttpStatus(), response);
