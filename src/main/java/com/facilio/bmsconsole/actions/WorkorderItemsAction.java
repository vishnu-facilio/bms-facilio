...
public class WorkorderItemsAction extends FacilioAction{
	...
	public String addOrUpdateWorkorderItems() throws Exception {
		...
		setWorkorderItems((List<WorkorderItemContext>) context.get(FacilioConstants.ContextNames.WO_ITEMS_LIST));
	...
	public String deleteWorkorderItems() throws Exception {
		...
		FacilioChain deleteInventoryChain = TransactionChainFactory.getDeleteWorkorderItemChain();
