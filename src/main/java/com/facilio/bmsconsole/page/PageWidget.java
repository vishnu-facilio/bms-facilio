...
public class PageWidget {
	...
	public enum WidgetType {
		...
		STOREROOM_ITEMS("storeroomitems"),
		STOREROOM_TOOLS("storeroomtools"),
		STOREROOM_ITEM_TRANSACTIONS("storeroomitemtransactions"),
		STOREROOM_TOOL_TRANSACTIONS("storeroomtooltransactions"),
		...
		TENANT_SERVICE_REQUEST("tenantservicerequest"),
		...
		ONGOING_WORK_WIDGET("ongoingTimeSheetWidget"),
		...
		UPCOMING_SERVICE_APPOINTMENTS_WIDGET("openServiceAppointmentsWidget"),
		...
		TOOL_DETAILS_CARD("toolDetailsCard"),
		...
		RESOURCE_WIDGET("resourceWidget"),
		LOCATION_WIDGET("locationWidget"),
		USER_WIDGET("userWidget"),
		SERVICE_TASK_LIST_WIDGET("serviceTaskListWidget"),
		PLANS_COST_WIDGET("plansCostWidget"),
		PLANNED_ITEMS_LIST("plansItemsList"),
		PLANNED_TOOLS_LIST("plansToolsList"),
		PLANNED_SERVICES_LIST("plannedServiceList"),
		ACTUAL_ITEMS_LIST("actualItemsList"),
		ACTUAL_TOOLS_LIST("actualToolsList"),
		ACTUAL_SERVICES_LIST("actualServicesList"),
		TIME_SHEET_OVERVIEW("timeSheetOverview"),
		TIME_SHEET_LIST("timeSheetList"),
		TRIP_OVERVIEW("tripList"),
		TRIP_LIST("tripList"),
