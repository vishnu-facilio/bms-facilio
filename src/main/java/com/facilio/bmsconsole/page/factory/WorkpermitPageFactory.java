...
//		addRecurringInfoWidget(tab1Sec1);
	...
	private static void addRecurringInfoWidget(Section section) {
		PageWidget recurringInfoWidget = new PageWidget(WidgetType.CARD, "recurringInfo");
		recurringInfoWidget.addToLayoutParams(section, 24, 10);
