...
public class TermsAndConditionsPageFactory extends PageFactory{
    private static final Logger LOGGER = LogManager.getLogger(TermsAndConditionsPageFactory.class.getName());
    public static Page getTermsAndConditionsPage(V3TermsAndConditionContext termsandconditions, FacilioModule module) throws Exception {
        Page page = new Page();
