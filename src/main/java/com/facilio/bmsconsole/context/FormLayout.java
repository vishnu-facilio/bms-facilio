...
public class FormLayout {
	...
	public static List<Panel> getNewTicketLayout(List<FacilioField> fields)
	{
		...
		for(FacilioField field : fields) {
			...
			if(field.getName().equals("subject") || field.getName().equals("description") || field.getName().equals("assignedTo") || field.getName().equals("location") || field.getName().equals("assetId") || field.getName().equals("spaceId") || field.getName().equals("createdDate")) {
				first.add(field);
			}
			else {
				second.add(field);
