...
public class RentalLeaseContractLineItemsContext  extends ModuleBaseWithCustomFields{
	...
	private long rentalLeaseContractId = -1;
	
	public long getRentalLeaseContractId() {
		return rentalLeaseContractId;
	}
	public void setRentalLeaseContractId(long rentalLeaseContractId) {
		this.rentalLeaseContractId = rentalLeaseContractId;
	}
