...
public class VendorTemplatePage implements TemplatePageFactory {
    ...
    public PagesContext getTemplatePage(ApplicationContext app, FacilioModule module) throws Exception {
        ...
        return new PagesContext(null, null, "", null, true, false, false)
                ...
                .addWidget("vendorcontactrelatedlistWidget", "Vendor Contact", PageWidget.WidgetType.RELATED_LIST, "flexiblewebrelatedlist_29", 0, 0, null,fetchSingleRelatedListForModule(module,vendorContactModule,"vendor",false))
                .widgetDone()
                .sectionDone()
                .columnDone()
                .tabDone()
