...
public class ControlActionPage implements TemplatePageFactory{
    ...
    public PagesContext getTemplatePage(ApplicationContext app, FacilioModule module) throws Exception {
        ...
        return new PagesContext(null, null, "", null, true, false, false)
                ...
                .addWidget("controlactionassetcriteriafieldswidget", "Asset Field Criteria", PageWidget.WidgetType.CRITERIA_LIST_VIEW, "webCriteriaListView_6_6", 0, 0, getSummaryCriteriaListWidgetDetails(FacilioConstants.ContextNames.ASSET, "assetCriteriaId"),null)
                .widgetDone()
    ...
    public static JSONObject getWidgetGroup(boolean isMobile) throws Exception {
        ...
        attachmentsWidgetParam.put("attachmentsModuleName", FacilioConstants.Control_Action.CONTROL_ACTION_ATTACHMENT_MODULE_NAME);
