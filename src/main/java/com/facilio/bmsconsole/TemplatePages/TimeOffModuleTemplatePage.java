...
public class TimeOffModuleTemplatePage implements TemplatePageFactory {
    ...
    public PagesContext getTemplatePage(ApplicationContext app, FacilioModule module) throws Exception {
        ...
        historyWidgetParam.put("activityModuleName", FacilioConstants.TimeOff.TIME_OFF);
        ...
        return new PagesContext(null, null, "", null, true, false, false)
                ...
                .addWidget("timeoffbulkrelatedlist", "Related List", PageWidget.WidgetType.BULK_RELATED_LIST, "flexiblewebbulkrelatedlist_29", 0, 4, null, null)
                .widgetDone()
                .sectionDone()
                .columnDone()
                .tabDone()
