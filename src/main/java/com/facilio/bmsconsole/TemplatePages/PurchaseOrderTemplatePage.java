...
public class PurchaseOrderTemplatePage implements TemplatePageFactory{
    @Override
    public String getModuleName() {
        return FacilioConstants.ContextNames.PURCHASE_ORDER;
    }
    ...
    public PagesContext getTemplatePage(ApplicationContext app, FacilioModule module) throws Exception {
        ...
        return  new PagesContext(null, null,"", null, true, false, false)
                ...
                .addWidget("purchaseOrderSummaryFieldsWidget", "Purchase Order Details", PageWidget.WidgetType.SUMMARY_FIELDS_WIDGET, "flexiblewebsummaryfieldswidget_5", 0, 0, null, getSummaryWidgetDetails(module.getName(), app))
                .widgetDone()
                .sectionDone()
                .addSection("purchaseorderwidgetGroup", null,  null)
                .addWidget("purchaseordercommentandattachmentwidgetgroupwidget", null, PageWidget.WidgetType.WIDGET_GROUP, "flexiblewebwidgetgroup_4", 0, 0,  null, getWidgetGroup(false))
                .widgetDone()
                .sectionDone()
                .columnDone()
                .tabDone()
    ...
    public static JSONObject getSummaryWidgetDetails(String moduleName, ApplicationContext app) throws Exception {
        ...
        FacilioField orderedTime = moduleBean.getField("orderedTime", moduleName);
        ...
        addSummaryFieldInWidgetGroup(widgetGroup, orderedTime, 2, 4, 1);
    ...
    public static JSONObject getWidgetGroup(boolean isMobile) throws Exception {
        ...
        notesWidgetParam.put("notesModuleName", FacilioConstants.ContextNames.PURCHASE_ORDER_NOTES);

        JSONObject attachmentsWidgetParam = new JSONObject();
        attachmentsWidgetParam.put("attachmentsModuleName", FacilioConstants.ContextNames.PURCHASE_ORDER_ATTACHMENTS);
