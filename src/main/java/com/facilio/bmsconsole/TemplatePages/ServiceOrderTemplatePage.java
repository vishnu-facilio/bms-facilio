    ...
    public PagesContext getTemplatePage(ApplicationContext app, FacilioModule module) throws Exception {
        ...
        if(app.getDomainType() == AppDomain.AppDomainType.FACILIO.getIndex()) {
            ...
            return  new PagesContext(null, null,"", null, true, false, false)
                    ...
                    .addWebTab("task", "TASK", true, null)
                    .addColumn( PageColumnContext.ColumnWidth.FULL_WIDTH)
                    .addSection("task", "Tasks", "List of Tasks")
                    .addWidget("serviceTaskWidget", "Service Tasks", PageWidget.WidgetType.SERVICE_TASK_WIDGET, "flexiblewebservicetaskwidget_29", 0, 0,  null, null)
                    .widgetDone()
                    .sectionDone()
                    .columnDone()
                    .tabDone();
