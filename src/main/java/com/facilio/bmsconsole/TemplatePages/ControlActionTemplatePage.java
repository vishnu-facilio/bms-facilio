...
public class ControlActionTemplatePage implements TemplatePageFactory {
    ...
    public PagesContext getTemplatePage(ApplicationContext app, FacilioModule module) throws Exception {
        ...
        return new PagesContext(null, null, "", null, true, false, false)
                ...
                .addWidget("controlactiontemplateControlfieldswidget", "Controls", PageWidget.WidgetType.BULK_RELATED_LIST, "fixedrelatedListwidgetViewWidget-28*12", 0, 0, null,fetchRelatedListForModule(module,FacilioConstants.Control_Action.ACTION_MODULE_NAME))
                .widgetDone()
                .sectionDone()
                .addSection("controlactiontemplateCriteriafields", null, null)
                .addWidget("controlactiontemplateassetcriteriafieldswidget", "Asset attribute criteria", PageWidget.WidgetType.CONRTOL_ACTION_CRITERIA, "webControlActionCriteriaViewWidget-28*6", 0, 0, getSummaryCriteriaListWidgetDetails(FacilioConstants.ContextNames.ASSET,"assetCriteriaId"),null)
                .widgetDone()
                .addWidget("controlactiontemplatesitecriteriafieldswidget", "Site attribute criteria", PageWidget.WidgetType.CONRTOL_ACTION_CRITERIA, "webControlActionCriteriaViewWidget-28*6", 6, 0, getSummaryCriteriaListWidgetDetails(FacilioConstants.ContextNames.SITE,"siteCriteriaId"),null)
                .widgetDone()
                .addWidget("controlactiontemplatecontrollercriteriafieldswidget", "Controller attribute criteria", PageWidget.WidgetType.CONRTOL_ACTION_CRITERIA, "webControlActionCriteriaViewWidget-28*6", 0, 28, getSummaryCriteriaListWidgetDetails("controllers","controllerCriteriaId"),null)
                .widgetDone()
