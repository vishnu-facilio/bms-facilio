...
public class UtilityIntegrationCustomerTemplatePage implements TemplatePageFactory {
    ...
    public PagesContext getTemplatePage(ApplicationContext app, FacilioModule module) throws Exception {
        ...
        return new PagesContext(pageName, pageDisplayName, "", null, true, false, false)
                ...
                .addWidget("utilityintegrationcustomersummaryfieldswidget", "Account  Details", PageWidget.WidgetType.SUMMARY_FIELDS_WIDGET, "flexiblewebsummaryfieldswidget_24", 0, 0, null, getSummaryWidgetDetails(FacilioConstants.UTILITY_INTEGRATION_CUSTOMER,app))
                .widgetDone()
                .sectionDone()
                .addSection("meterConnections", null, null)
                .addWidget("meterWidget", "Meter Connections", PageWidget.WidgetType.METER_WIDGET, "webMeterWidget_24_12", 0, 0, moduleData, getSummaryWidgetDetails(FacilioConstants.UTILITY_INTEGRATION_METER,app))
                .widgetDone()
                .sectionDone()
                ...
                .addWidget("utilitycustomerrelatedList", "", PageWidget.WidgetType.BULK_RELATED_LIST, "flexiblewebbulkrelatedlist_29", 0, 0, null, RelatedListWidgetUtil.fetchAllRelatedListForModule(customerModule))
                .widgetDone()
                .sectionDone()
                .columnDone()
                .tabDone()
