...
public class EmployeeModuleTemplatePage implements TemplatePageFactory {
    ...
    public PagesContext getTemplatePage(ApplicationContext app, FacilioModule module) throws Exception {
        ...
        return new PagesContext(null, null, "", null, true, false, false)
                ...
                .addWidget("employeeLastKnownLocationWidget", "Last Known Location", PageWidget.WidgetType.LAST_KNOWN_LOCATION, "webLastKnownLocation_22_6", 0, 0, null, null)
                .widgetDone()
                ...
                .addWidget("employeeWorkScheduleWidget", "Work Schedule", PageWidget.WidgetType.WORK_SCHEDULE, "flexibleWorkSchedule_50", 0, 0, null, null)
                .widgetDone()
                .sectionDone()
                .columnDone()
                .tabDone()
                ...
                .addWidget("employeeBulkRelatedList", "Related List", PageWidget.WidgetType.BULK_RELATED_LIST, "flexiblewebbulkrelatedlist_29", 0, 0, null, RelatedListWidgetUtil.fetchAllRelatedListForModule(bean.getModule(getModuleName())))
                .widgetDone()
                .sectionDone()
                .columnDone()
                .tabDone()
    ...
    private static JSONObject getHistoryWidgetGroup(boolean isMobile) throws Exception {
        ...
        WidgetGroupContext widgetGroup = new WidgetGroupContext()
                ...
                .addWidget("locationWidget", "Location", PageWidget.WidgetType.EMPLOYEE_LOCATION, isMobile ? "flexiblemobileattachment_8" : "flexibleEmployeeLocation_50", 0, 0, null, null)
                .widgetGroupWidgetDone()
                .widgetGroupSectionDone();
