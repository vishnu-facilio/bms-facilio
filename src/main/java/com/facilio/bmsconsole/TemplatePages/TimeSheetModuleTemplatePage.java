...
public class TimeSheetModuleTemplatePage implements TemplatePageFactory {
    ...
    public PagesContext getTemplatePage(ApplicationContext app, FacilioModule module) throws Exception {
        ...
        return new PagesContext(null, null, "", null, true, false, false)
                ...
                .addWidget("timesheetbulkrelatedlist", "Related List", PageWidget.WidgetType.BULK_RELATED_LIST, "flexiblewebbulkrelatedlist_29", 0, 4, null, RelatedListWidgetUtil.addAllRelatedModuleToWidget(getModuleName()))
                .widgetDone()
                .sectionDone()
                .columnDone()
                .tabDone()
