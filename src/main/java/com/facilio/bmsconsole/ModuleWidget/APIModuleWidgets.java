 ...
 */
    ...
    public static Supplier<ModuleWidgets> getReadingAlarmWidgets() {
        return () -> new ModuleWidgets()
                ...
                .addFixedWidgetConfig("webMtba_14_6", "Mtba - 14 - 6", 14, 6, PagesContext.PageLayoutType.WEB)
                .done()
    ...
    public static Supplier<ModuleWidgets> getNewReadingRuleWidgets() {
        return () -> new ModuleWidgets()
                ...
                .addFixedWidgetConfig("webRuleAssetsAndAlarm-30_4", "Rule Assets And Alarm - 30_4", 30, 4, PagesContext.PageLayoutType.WEB)
                .done()
                ...
                .addFixedWidgetConfig("webRuleAssociatedWorkOrders-15_6", "Rule Associated Work Orders - 15_6", 15, 6, PagesContext.PageLayoutType.WEB)
                .done()
                .addModuleWidget("ruleWorkOrderDuration", "Rule Work Order Duration", PageWidget.WidgetType.RULE_WORK_ORDER_DURATION)
                .addFixedWidgetConfig("webRuleWorkOrderDuration-15_6", "Rule Work Order Duration - 15_6", 15, 6, PagesContext.PageLayoutType.WEB)
                .done()
