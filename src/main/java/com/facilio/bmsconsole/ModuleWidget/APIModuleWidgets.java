 ...
 */
    ...
    public static Supplier<ModuleWidgets> getTenantWidgets(){
        return () -> new ModuleWidgets()
                ...
                .addWidgetConfig("webtenantspecialwidget_6_12","Tenant Special Widget - 6 - 12",WidgetConfigContext.ConfigType.FIXED,6,12,PagesContext.PageLayoutType.WEB)
                .done()
                .addModuleWidget("webtenantservicerequestswidget","Service Requests",PageWidget.WidgetType.TENANT_SERVICE_REQUEST)
                .addWidgetConfig("webtenantservicerequestswidget_3_4","Service Requests -3 -4",WidgetConfigContext.ConfigType.FIXED,3,4,PagesContext.PageLayoutType.WEB)
                .done()
                .addModuleWidget("webtenantworkorderswidget","Tenant WorkOrders",PageWidget.WidgetType.TENANT_WORKORDERS)
                .addWidgetConfig("webtenantworkorders_3_4","Tenant WorkOrders -3 -4",WidgetConfigContext.ConfigType.FIXED,3,4,PagesContext.PageLayoutType.WEB)
                .done()
                .addModuleWidget("webtenantfacilitybookingwidget","Facility Bookings",PageWidget.WidgetType.TENANT_BOOKINGS)
                .addWidgetConfig("webtenantfacilitybookingwidget_3_4","Facility Bookings -3 -4",WidgetConfigContext.ConfigType.FIXED,3,4,PagesContext.PageLayoutType.WEB)
                .done()
                ...
                .addWidgetConfig("webtenantrecentlyclosedworkorder_6_4","Recently Closed Work order -6 -4",WidgetConfigContext.ConfigType.FIXED,6,4,PagesContext.PageLayoutType.WEB)
                .done()
                ...
                .addWidgetConfig("webtenantupcomingfacilitybookingwidget_3_4","Upcoming Facility Booking -3 -4",WidgetConfigContext.ConfigType.FIXED,3,4,PagesContext.PageLayoutType.WEB)
                .done()
    ...
    public static Supplier<ModuleWidgets> getTenantUnitWidgets() {
        return () -> new ModuleWidgets()
                ...
                .addFlexibleWidgetConfig("webtenantunitinsightswidget_6","Insights - 6",6,PagesContext.PageLayoutType.WEB)
                .done()
                ...
                .addFlexibleWidgetConfig("webtenantunitrecentlyclosedworkorderwidget_4","Recently Closed Workorder - 4",4,PagesContext.PageLayoutType.WEB)
                .done()
    ...
    public static Supplier<ModuleWidgets> getServiceOrderWidgets() {
        return () -> new ModuleWidgets()
                ...
                .done()
                .addModuleWidget("appointments","Appointment",PageWidget.WidgetType.SERVICE_ORDER_APPOINTMENTS)
                .addWidgetConfig("webAppointments_10_12","Appointment - 10 - 12", WidgetConfigContext.ConfigType.FIXED,10,12, PagesContext.PageLayoutType.WEB)
                .done()
                .addModuleWidget("serviceOrderResourceWidget",null, PageWidget.WidgetType.RESOURCE_WIDGET)
                .done()
                .addModuleWidget("serviceOrderLocationWidget",null, PageWidget.WidgetType.LOCATION_WIDGET)
                .done()
                .addModuleWidget("serviceOrderUserWidget",null, PageWidget.WidgetType.USER_WIDGET)
                .done()
                .addModuleWidget("serviceOrderServiceTaskListWidget","Tasks",PageWidget.WidgetType.SERVICE_TASK_LIST_WIDGET)
                .done()
                .addModuleWidget("serviceOrderServiceAppointmentListWidget","Appointments",PageWidget.WidgetType.SERVICE_APPOINTMENT_LIST)
                .addWidgetConfig("mobileServiceAppointmentListWidget_16","Service Appointments Flexible - 16", WidgetConfigContext.ConfigType.FLEXIBLE,16,-1, PagesContext.PageLayoutType.MOBILE)
                .done()
                .addModuleWidget("serviceOrderPlansCostWidget","Plans Cost",PageWidget.WidgetType.PLANS_COST_WIDGET)
                .done()
                .addModuleWidget("serviceOrderPlannedItemsListWidget","Planned Items",PageWidget.WidgetType.PLANNED_ITEMS_LIST)
                .done()
                .addModuleWidget("serviceOrderPlannedToolsListWidget","Planned Tools",PageWidget.WidgetType.PLANNED_TOOLS_LIST)
                .done()
                .addModuleWidget("serviceOrderPlannedServicesListWidget","Planned Services",PageWidget.WidgetType.PLANNED_SERVICES_LIST)
                .done()
                .addModuleWidget("serviceOrderActualsCostWidget","Actuals Cost",PageWidget.WidgetType.ACTUALS_COST)
                .done()
                .addModuleWidget("serviceOrderActualItemsListWidget","Actual Items",PageWidget.WidgetType.PLANNED_ITEMS_LIST)
                .done()
                .addModuleWidget("serviceOrderActualToolsListWidget","Actual Tools",PageWidget.WidgetType.PLANNED_TOOLS_LIST)
                .done()
                .addModuleWidget("serviceOrderActualServicesListWidget","Actual Services",PageWidget.WidgetType.PLANNED_SERVICES_LIST)
                .done()
                ;
    ...
    public static Supplier<ModuleWidgets> getServiceAppointmentWidgets() {
        return () -> new ModuleWidgets()
                ...
                .done()
                .addModuleWidget("serviceAppointmentResourceWidget",null, PageWidget.WidgetType.RESOURCE_WIDGET)
                .addWidgetConfig("mobileFlexibleResourceWidget_6","Resource Widget Flexible - 6",WidgetConfigContext.ConfigType.FLEXIBLE,6,-1,PagesContext.PageLayoutType.MOBILE)
                .done()
                .addModuleWidget("serviceAppointmentLocationWidget",null, PageWidget.WidgetType.LOCATION_WIDGET)
                .addWidgetConfig("mobileFlexibleLocationWidget_9","Location Widget Flexible - 9",WidgetConfigContext.ConfigType.FLEXIBLE,9,-1,PagesContext.PageLayoutType.MOBILE)
                .done()
                .addModuleWidget("serviceAppointmentUserWidget",null, PageWidget.WidgetType.USER_WIDGET)
                .addWidgetConfig("mobileFlexibleUserWidget_7","User Widget Flexible - 7",WidgetConfigContext.ConfigType.FLEXIBLE,7,-1,PagesContext.PageLayoutType.MOBILE)
                .done()
                .addModuleWidget("serviceAppointmentServiceTaskListWidget","Tasks",PageWidget.WidgetType.SERVICE_TASK_LIST_WIDGET)
                .addWidgetConfig("mobileServiceTaskListWidget_16","Service Tasks Flexible - 16", WidgetConfigContext.ConfigType.FLEXIBLE,16,-1, PagesContext.PageLayoutType.MOBILE)
                .done()
                .addModuleWidget("serviceAppointmentPlansCostWidget","Plans Cost",PageWidget.WidgetType.PLANS_COST_WIDGET)
                .addWidgetConfig("mobilePlansCostWidget_2","Plans Cost Flexible - 2", WidgetConfigContext.ConfigType.FLEXIBLE,2,-1, PagesContext.PageLayoutType.MOBILE)
                .done()
                .addModuleWidget("serviceAppointmentPlannedItemsListWidget","Planned Items",PageWidget.WidgetType.PLANNED_ITEMS_LIST)
                .addWidgetConfig("flexiblemobileplanneditems_16","Planned Items Flexible - 16", WidgetConfigContext.ConfigType.FLEXIBLE,16,-1, PagesContext.PageLayoutType.MOBILE)
                .done()
                .addModuleWidget("serviceAppointmentPlannedToolsListWidget","Planned Tools",PageWidget.WidgetType.PLANNED_TOOLS_LIST)
                .addWidgetConfig("flexiblemobileplannedtools_16","Planned Tools Flexible - 16", WidgetConfigContext.ConfigType.FLEXIBLE,16,-1, PagesContext.PageLayoutType.MOBILE)
                .done()
                .addModuleWidget("serviceAppointmentPlannedServicesListWidget","Planned Services",PageWidget.WidgetType.PLANNED_SERVICES_LIST)
                .addWidgetConfig("flexiblemobileplannedservices_16","Planned Services Flexible - 16", WidgetConfigContext.ConfigType.FLEXIBLE,16,-1, PagesContext.PageLayoutType.MOBILE)
                .done()
                .addModuleWidget("serviceAppointmentActualsCostWidget","Actuals Cost",PageWidget.WidgetType.ACTUALS_COST)
                .addWidgetConfig("mobileActualsCostWidget_2","Actuals Cost Flexible - 2", WidgetConfigContext.ConfigType.FLEXIBLE,2,-1, PagesContext.PageLayoutType.MOBILE)
                .done()
                .addModuleWidget("serviceAppointmentActualItemsListWidget","Actual Items",PageWidget.WidgetType.ACTUAL_ITEMS_LIST)
                .addWidgetConfig("flexiblemobileactualitems_16","Actual Items Flexible - 16", WidgetConfigContext.ConfigType.FLEXIBLE,16,-1, PagesContext.PageLayoutType.MOBILE)
                .done()
                .addModuleWidget("serviceAppointmentActualToolsListWidget","Actual Tools",PageWidget.WidgetType.ACTUAL_TOOLS_LIST)
                .addWidgetConfig("flexiblemobileactualtools_16","Actual Tools Flexible - 16", WidgetConfigContext.ConfigType.FLEXIBLE,16,-1, PagesContext.PageLayoutType.MOBILE)
                .done()
                .addModuleWidget("serviceAppointmentActualServicesListWidget","Actual Services",PageWidget.WidgetType.ACTUAL_SERVICES_LIST)
                .addWidgetConfig("flexiblemobileactualservices_16","Actual Services Flexible - 16", WidgetConfigContext.ConfigType.FLEXIBLE,16,-1, PagesContext.PageLayoutType.MOBILE)
                .done()
                .addModuleWidget("serviceAppointmentTimeSheetOverviewWidget","Time Sheet Overview",PageWidget.WidgetType.TIME_SHEET_OVERVIEW)
                .addWidgetConfig("mobileTimeSheetOverviewWidget_2","Time Sheet Overview - 2", WidgetConfigContext.ConfigType.FLEXIBLE,2,-1, PagesContext.PageLayoutType.MOBILE)
                .done()
                .addModuleWidget("serviceAppointmentTimeSheetListWidget","Time Sheet List",PageWidget.WidgetType.TIME_SHEET_LIST)
                .addWidgetConfig("mobileTimeSheetListWidget_16","Time Sheet List Flexible - 16", WidgetConfigContext.ConfigType.FLEXIBLE,16,-1, PagesContext.PageLayoutType.MOBILE)
                .done()
                .addModuleWidget("serviceAppointmentTripOverviewWidget","Trip Overview",PageWidget.WidgetType.TRIP_OVERVIEW)
                .addWidgetConfig("mobileTripOverviewWidget_2","Trip Overview - 2", WidgetConfigContext.ConfigType.FLEXIBLE,2,-1, PagesContext.PageLayoutType.MOBILE)
                .done()
                .addModuleWidget("serviceAppointmentTripListWidget","Trip List",PageWidget.WidgetType.TRIP_LIST)
                .addWidgetConfig("mobileTripListWidget_16","Trip List Flexible - 16", WidgetConfigContext.ConfigType.FLEXIBLE,16,-1, PagesContext.PageLayoutType.MOBILE)
                .done()
                ;
    ...
    public static Supplier<ModuleWidgets> getTimeSheetWidgets(){
        return () -> new ModuleWidgets()
                ...
                .done()
                .addModuleWidget("timeSheetServiceAppointmentCard","Service Appointment",PageWidget.WidgetType.SERVICE_APPOINTMENT_CARD)
                .addWidgetConfig("mobileFlexibleTimeSheetServiceAppointmentCard_2","Service Appointment Flexible - 2",WidgetConfigContext.ConfigType.FLEXIBLE,2,-1,PagesContext.PageLayoutType.MOBILE)
                .done()
                .addModuleWidget("timeSheetTasks","Tasks",PageWidget.WidgetType.SERVICE_TASK_LIST_WIDGET)
                .addWidgetConfig("mobileFlexibleTimeSheetServiceTaskList_16","Service Tasks Flexible - 16",WidgetConfigContext.ConfigType.FLEXIBLE,16,-1,PagesContext.PageLayoutType.MOBILE)
                .done()
                ;
    }
    ...
    public static Supplier<ModuleWidgets> getTripWidgets(){
        return () -> new ModuleWidgets()
                ...
                .done()
                .addModuleWidget("tripLocationWidget","Location",PageWidget.WidgetType.TRIP_MAP_WIDGET)
                .done()
                .addModuleWidget("tripMapWidget","Journey",PageWidget.WidgetType.TRIP_MAP_WIDGET)
                .addWidgetConfig("mobileFlexibleTripMapWidget_9","Journey Widget Flexible - 9",WidgetConfigContext.ConfigType.FLEXIBLE,9,-1,PagesContext.PageLayoutType.MOBILE)
                .done()
                ;
    }
    ...
    public static Supplier<ModuleWidgets> getFlaggedEventWidgets(){
        return () -> new ModuleWidgets()
                ...
                .addWidgetConfig("evaluationTimeRemaining_2_3","Evaluation Time Remaining - 2 - 3",WidgetConfigContext.ConfigType.FIXED,2,3,PagesContext.PageLayoutType.WEB)
                .done()
