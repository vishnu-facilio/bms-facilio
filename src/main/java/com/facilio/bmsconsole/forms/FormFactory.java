...
public class FormFactory {
	...
	private static List<FormField> getMobileApprovalFormFields() {
		...
		fields.add(new FormField("urgency", FieldDisplayType.URGENCY, "Urgency", Required.OPTIONAL, "urgency" ,6, 1));
	...
	private static List<FormField> getWebPMFormFields() {
		...
		fields.add(new FormField("groups",FieldDisplayType.LOOKUP_SIMPLE,"Team", Required.OPTIONAL, "groups", 6, 1));
		fields.add(new FormField("attachedFiles", FieldDisplayType.ATTACHMENT, "Attachments", Required.OPTIONAL, "attachment", 7, 1));
		return fields;
	}
