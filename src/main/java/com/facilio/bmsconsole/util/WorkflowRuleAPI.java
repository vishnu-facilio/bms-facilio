...
//		}
		...
		if (shouldExecute) {
			if(result) {
				...
				try {
					if (AccountUtil.isFeatureEnabled(AccountUtil.FeatureLicense.WORKFLOW_RULE_LOG) && workflowRule.getRuleTypeEnum().isLoggable() && record instanceof ModuleBaseWithCustomFields) {
