...
public class DemoRoleUtil {
	...
	private static Map<String,List<String>> dateFieldModified()  {
		...
		tablesContainsDateField.put("Scheduled_Workflow", Arrays.asList("START_TIME"));
		...
		tablesContainsDateField.put("Psychrometric_Reading" , Arrays.asList("ACTUAL_TTIME","TTIME"));
		...
		tablesContainsDateField.put("Agent_Data" , Arrays.asList("LAST_MODIFIED_TIME","CREATED_TIME","LAST_DATA_RECEIVED_TIME"));
		...
		tablesContainsDateField.put("Agent_Message" , Arrays.asList("START_TIME"));
		tablesContainsDateField.put("Controller" , Arrays.asList("CREATED_TIME","LAST_MODIFIED_TIME","LAST_DATA_RECEIVED_TIME"));
		...
		tablesContainsDateField.put("Contracts" , Arrays.asList("SYS_CREATED_TIME","SYS_MODIFIED_TIME","SYS_DELETED_TIME","SCHEDULE_TIME"));
		...
		tablesContainsDateField.put("Asset_Breakdown" , Arrays.asList("FROM_TIME","TO_TIME","TIME_BETWEEN_FAILURE"));
		tablesContainsDateField.put("Asset_BD_SourceDetails" , Arrays.asList("FROM_TIME","TO_TIME"));
		...
		tablesContainsDateField.put("WorkOrderRequest_EMail" , Arrays.asList("CREATED_TIME"));
		...
		tablesContainsDateField.put("ImportProcess" , Arrays.asList("IMPORT_TIME"));
		tablesContainsDateField.put("Formula_Field" , Arrays.asList("START_TIME","END_TIME"));
		...
		tablesContainsDateField.put("BaseAlarm" , Arrays.asList("ACKNOWLEDGED_TIME","LAST_OCCURRED_TIME","LAST_CLEARED_TIME"));
		tablesContainsDateField.put("AlarmOccurrence" , Arrays.asList("ACKNOWLEDGED_TIME","CREATED_TIME","CLEARED_TIME"));
		...
		tablesContainsDateField.put("Shift" , Arrays.asList("START_TIME","END_TIME"));
		tablesContainsDateField.put("Shift_User_Rel" , Arrays.asList("START_TIME","END_TIME"));
		tablesContainsDateField.put("Break" , Arrays.asList("BREAK_TIME"));
		tablesContainsDateField.put("Cost_Assets" , Arrays.asList("FIRST_BILL_TIME"));
		tablesContainsDateField.put("Cost_Readings" , Arrays.asList("ACTUAL_TTIME","TTIME"));
		...
		tablesContainsDateField.put("Gate_Pass_Notes" , Arrays.asList("CREATED_TIME","MODIFIED_TIME"));
		tablesContainsDateField.put("Gate_Pass_Attachments" , Arrays.asList("CREATED_TIME","MODIFIED_TIME"));
		...
		tablesContainsDateField.put("Inventory_Requests" , Arrays.asList("SYS_CREATED_TIME","SYS_MODIFIED_TIME","SYS_DELETED_TIME"));
		tablesContainsDateField.put("Inventory_Request_Attachments" , Arrays.asList("CREATED_TIME"));
		tablesContainsDateField.put("Inventory_Request_Notes" , Arrays.asList("CREATED_TIME"));
		tablesContainsDateField.put("Shipment" , Arrays.asList("SYS_CREATED_TIME","SYS_MODIFIED_TIME","SYS_DELETED_TIME"));
		tablesContainsDateField.put("Shipment_line_item" , Arrays.asList("SYS_CREATED_TIME","SYS_MODIFIED_TIME"));
		tablesContainsDateField.put("Shipment_Notes" , Arrays.asList("CREATED_TIME"));
		tablesContainsDateField.put("Shipment_Attachments" , Arrays.asList("CREATED_TIME"));
		...
		tablesContainsDateField.put("Item_vendors" , Arrays.asList("CREATED_TIME","MODIFIED_TIME"));
		tablesContainsDateField.put("Tool_vendors" , Arrays.asList("CREATED_TIME","MODIFIED_TIME"));
		...
		tablesContainsDateField.put("Service" , Arrays.asList("SYS_CREATED_TIME","SYS_MODIFIED_TIME","SYS_DELETED_TIME"));
		...
		tablesContainsDateField.put("Attendance" , Arrays.asList("SYS_CREATED_TIME","SYS_MODIFIED_TIME"));
		tablesContainsDateField.put("Attendance_Transactions" , Arrays.asList("SYS_CREATED_TIME","SYS_MODIFIED_TIME"));
		tablesContainsDateField.put("MV_Project" , Arrays.asList("START_TIME","END_TIME"));
		...
		tablesContainsDateField.put("Shift_Rotation" , Arrays.asList("SYS_CREATED_TIME","SYS_MODIFIED_TIME"));
		tablesContainsDateField.put("Break_Transaction" , Arrays.asList("SYS_CREATED_TIME","SYS_MODIFIED_TIME","START_TIME","TIME_TAKEN","STOP_TIME"));
		tablesContainsDateField.put("Service_vendors" , Arrays.asList("CREATED_TIME","MODIFIED_TIME"));
		tablesContainsDateField.put("Terms_And_Conditions" , Arrays.asList("SYS_CREATED_TIME","SYS_MODIFIED_TIME","SYS_DELETED_TIME"));
		tablesContainsDateField.put("Terms_And_Conditions_Attachments" , Arrays.asList("CREATED_TIME"));
		tablesContainsDateField.put("Terms_And_Conditions_Notes" , Arrays.asList("CREATED_TIME"));
