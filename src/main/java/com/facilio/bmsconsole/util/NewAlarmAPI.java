...
//		}
	...
	public static List<PagesContext> getReadingAlarmSystemPage(ApplicationContext app, boolean isTemplate, boolean isDefault) throws Exception {
		ModuleBean modBean = (ModuleBean) BeanFactory.lookup("ModuleBean");
		FacilioModule ruleModule = modBean.getModule(FacilioConstants.ContextNames.NEW_READING_ALARM);
		...
		PagesContext readingAlarmTemplatePage = new PagesContext(pageName, pageDisplayName, "", null, isTemplate, isDefault, false)
				...
				.addWidget("readingAlarmDetails", "Faults Details", PageWidget.WidgetType.SUMMARY_FIELDS_WIDGET, "flexiblewebsummaryfieldswidget_24", 0, 0, null, getReadingAlarmSummaryWidgetDetails(FacilioConstants.ContextNames.NEW_READING_ALARM, app))
				.widgetDone()
				.sectionDone()
				...
				.addWidget("widgetGroup", "Widget Group", PageWidget.WidgetType.WIDGET_GROUP, "flexiblewebwidgetgroup_20", 0, 0, null, getReadingAlarmSummaryWidgetGroup(false))
				.widgetDone()
				.sectionDone()
				.columnDone()
				.tabDone()
	...
	private static JSONObject getReadingAlarmSummaryWidgetDetails(String moduleName, ApplicationContext app) throws Exception {
		...
		addReadingAlarmSummaryFieldInWidgetGroup(primaryDetailsWidgetGroup, lastOccurredTime, 1, 1, 1, false);
		addReadingAlarmSummaryFieldInWidgetGroup(primaryDetailsWidgetGroup, lastCreatedTime, 1, 2, 1, false);
		addReadingAlarmSummaryFieldInWidgetGroup(primaryDetailsWidgetGroup, rule, 1, 3, 1, false);
		addReadingAlarmSummaryFieldInWidgetGroup(primaryDetailsWidgetGroup, resource, 1, 4, 1, false);
		addReadingAlarmSummaryFieldInWidgetGroup(primaryDetailsWidgetGroup, resource, 2, 1, 1, true);
		...
		for (FacilioField field : fields) {
			addReadingAlarmSummaryFieldInWidgetGroup(allFieldsWidgetGroup, field, rowNo, columnNo, 1, false);
			columnNo++;
			if(columnNo > 4) {
				columnNo = 1;
				rowNo ++;
	...
	private static void addReadingAlarmSummaryFieldInWidgetGroup(SummaryWidgetGroup widgetGroup, FacilioField field, int rowIndex, int colIndex, int colSpan, Boolean isOneLevelField) throws Exception {
		if (field != null) {
	...
	private static JSONObject getReadingAlarmSummaryWidgetGroup(boolean isMobile) throws Exception {
	...
	public static List<PagesContext> getSensorAlarmSystemPage(ApplicationContext app, boolean isTemplate, boolean isDefault) throws Exception {
		...
		List<PagesContext> bmsAlarmPages = new ArrayList<>();

		PagesContext bmsAlarmTemplatePage = new PagesContext(pageName, pageDisplayName, "", null, isTemplate, isDefault, false)
				.addLayout(PagesContext.PageLayoutType.WEB)
				.addTab("summary", "Summary", PageTabContext.TabType.SIMPLE, true, null)
				.addColumn(PageColumnContext.ColumnWidth.FULL_WIDTH)
				.addSection("alarmDetails", null, null)
				.addWidget("bmsAlarmDetails", "BMS Alarm Details", PageWidget.WidgetType.SUMMARY_FIELDS_WIDGET, "flexiblewebsummaryfieldswidget_24", 0, 0, null, getBMSAlarmSummaryWidgetDetails(FacilioConstants.ContextNames.BMS_ALARM, app))
				.widgetDone()
				.sectionDone()
				.addSection("secondaryDetails",null,null)
				...
				.sectionDone()
				.addSection("widgetGroup", null, null)
				.addWidget("widgetGroup", "Widget Group", PageWidget.WidgetType.WIDGET_GROUP, "flexiblewebwidgetgroup_20", 0, 0, null, getBMSAlarmSummaryWidgetGroup(false))
				.widgetDone()
				.sectionDone()
				.columnDone()
				.tabDone()
		...
		bmsAlarmPages.add(bmsAlarmTemplatePage);
		return bmsAlarmPages;
	}
	...
	private static JSONObject getBMSAlarmSummaryWidgetDetails(String moduleName, ApplicationContext app) throws Exception {
		...
		addBMSAlarmSummaryFieldInWidgetGroup(primaryDetailsWidgetGroup, lastOccurredTime, 1, 1, 1, false);
		addBMSAlarmSummaryFieldInWidgetGroup(primaryDetailsWidgetGroup, lastCreatedTime, 1, 2, 1, false);
		addBMSAlarmSummaryFieldInWidgetGroup(primaryDetailsWidgetGroup, condition, 1, 3, 1, false);
		addBMSAlarmSummaryFieldInWidgetGroup(primaryDetailsWidgetGroup, source, 1, 4, 1, false);
		addBMSAlarmSummaryFieldInWidgetGroup(primaryDetailsWidgetGroup, controller, 2, 1, 1, false);
		addBMSAlarmSummaryFieldInWidgetGroup(primaryDetailsWidgetGroup, resource, 2, 2, 1, false);
		addBMSAlarmSummaryFieldInWidgetGroup(primaryDetailsWidgetGroup, resource, 2, 3, 1, true);
		...
		int columnNo = 1, rowNo = 1;
		for (FacilioField field : fields) {
			addBMSAlarmSummaryFieldInWidgetGroup(allFieldsWidgetGroup, field, rowNo, columnNo, 1, false);
			columnNo++;
			if(columnNo > 4) {
				columnNo = 1;
				rowNo ++;
	...
	private static void addBMSAlarmSummaryFieldInWidgetGroup(SummaryWidgetGroup widgetGroup, FacilioField field, int rowIndex, int colIndex, int colSpan, Boolean isOneLevelField) throws Exception {
		if (field != null) {
			SummaryWidgetGroupFields summaryField = new SummaryWidgetGroupFields();
			summaryField.setName(field.getName());
			summaryField.setDisplayName(field.getDisplayName());
	...
	private static JSONObject getBMSAlarmSummaryWidgetGroup(boolean isMobile) throws Exception {
		WidgetGroupContext widgetGroup = new WidgetGroupContext()
				.addConfig(WidgetGroupConfigContext.ConfigType.TAB)
				.addSection("notes", "Notes", "")
				.addWidget("commentwidget", "Comment", PageWidget.WidgetType.COMMENT, isMobile ? "flexiblemobilecomment_8" : "flexiblewebcomment_27", 0, 0, null, null)
	...
	public static List<PagesContext> getBMSAlarmSystemPage(ApplicationContext app, boolean isTemplate, boolean isDefault) throws Exception {
		...
		PagesContext sensorAlarmTemplatePage = new PagesContext(pageName, pageDisplayName, "", null, isTemplate, isDefault, false)
				...
				.addColumn(PageColumnContext.ColumnWidth.FULL_WIDTH)
				.addSection("alarmDetails", null, null)
				.addWidget("sensorAlarmDetails", "Details", PageWidget.WidgetType.SUMMARY_FIELDS_WIDGET, "flexiblewebsummaryfieldswidget_24", 0, 0, null, getSensorAlarmSummaryWidgetDetails(FacilioConstants.ContextNames.SENSOR_ROLLUP_ALARM, app))
				.widgetDone()
				.sectionDone()
				.addSection("secondaryDetails",null,null)
				...
				.sectionDone()
				.addSection("widgetGroup", null, null)
				.addWidget("widgetGroup", "Widget Group", PageWidget.WidgetType.WIDGET_GROUP, "flexiblewebwidgetgroup_20", 0, 0, null, getSensorAlarmSummaryWidgetGroup(false))
				.widgetDone()
				.sectionDone()
				.columnDone()
				.tabDone()
	...
	private static JSONObject getSensorAlarmSummaryWidgetDetails(String moduleName, ApplicationContext app) throws Exception {
		...
		addSensorAlarmSummaryFieldInWidgetGroup(primaryDetailsWidgetGroup, lastCreatedTime, 1, 1, 1, false);
		addSensorAlarmSummaryFieldInWidgetGroup(primaryDetailsWidgetGroup, lastOccurredTime, 1, 2, 1, false);
		addSensorAlarmSummaryFieldInWidgetGroup(primaryDetailsWidgetGroup, readingField, 1, 3, 1, false);
		addSensorAlarmSummaryFieldInWidgetGroup(primaryDetailsWidgetGroup, resource, 1, 4, 1, false);
		addSensorAlarmSummaryFieldInWidgetGroup(primaryDetailsWidgetGroup, resource, 2, 1, 1, true);
		...
		int columnNo = 1, rowNo = 1;
		for (FacilioField field : fields) {
			addSensorAlarmSummaryFieldInWidgetGroup(allFieldsWidgetGroup, field, rowNo, columnNo, 1, false);
			columnNo++;
			if(columnNo > 4) {
				columnNo = 1;
				rowNo ++;
	...
	private static void addSensorAlarmSummaryFieldInWidgetGroup(SummaryWidgetGroup widgetGroup, FacilioField field, int rowIndex, int colIndex, int colSpan, Boolean isOneLevelField) throws Exception {
		if (field != null) {
			SummaryWidgetGroupFields summaryField = new SummaryWidgetGroupFields();
			summaryField.setName(field.getName());
			summaryField.setDisplayName(field.getDisplayName());
	...
	private static JSONObject getSensorAlarmSummaryWidgetGroup(boolean isMobile) throws Exception {
		WidgetGroupContext widgetGroup = new WidgetGroupContext()
				.addConfig(WidgetGroupConfigContext.ConfigType.TAB)
				.addSection("notes", "Notes", "")
				.addWidget("commentwidget", "Comment", PageWidget.WidgetType.COMMENT, isMobile ? "flexiblemobilecomment_8" : "flexiblewebcomment_27", 0, 0, null, null)
