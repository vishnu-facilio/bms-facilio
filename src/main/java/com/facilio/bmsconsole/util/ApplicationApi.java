...
public class ApplicationApi {
    ...
    public static void addDefaultApps(long orgId) throws Exception {
        ...
        AppDomain servicePortalApp, tenantPortalApp, vendorPortalApp, clientPortalApp, employeePortalApp;
        if(org.getOrgType() == Organization.OrgType.SANDBOX.getIndex()){
            ...
            servicePortalApp = IAMAppUtil
                    .getAppDomain(productionOrg.getDomain() + "." + FacilioProperties.getSandboxOccupantAppDomain(), productionOrg.getOrgId());
            tenantPortalApp = IAMAppUtil
                    .getAppDomain(productionOrg.getDomain() + "." + FacilioProperties.getSandboxTenantAppDomain(), productionOrg.getOrgId());
            vendorPortalApp = IAMAppUtil
                    .getAppDomain(productionOrg.getDomain() + "." + FacilioProperties.getSandboxVendorAppDomain(), productionOrg.getOrgId());
            clientPortalApp = IAMAppUtil
                    .getAppDomain(productionOrg.getDomain() + "." + FacilioProperties.getSandboxClientAppDomain(), productionOrg.getOrgId());
            employeePortalApp = IAMAppUtil.
                    getAppDomain(productionOrg.getDomain() + "." + FacilioProperties.getSandboxEmployeeAppDomain(), productionOrg.getOrgId());
        }else{
            servicePortalApp = IAMAppUtil
            ...
            employeePortalApp = IAMAppUtil.
                    getAppDomain(org.getDomain() + "." + FacilioProperties.getEmployeeAppDomain());
        }
        ...
        ApplicationContext employeePortalApplication = new ApplicationContext(orgId, "Employee Portal", true,
                employeePortalApp.getAppDomainType(), FacilioConstants.ApplicationLinkNames.EMPLOYEE_PORTAL_APP,
                ApplicationContext.AppLayoutType.SINGLE.getIndex(), "Employee Portal App",
                ApplicationContext.AppCategory.PORTALS.getIndex());
        ...
        applicationsDefault.add(fsmApplication);
...
//        }
    ...
    public static void addFsmSetupLayout(ApplicationLayoutContext fsmLayoutSetup) throws Exception {
        ...
        addFSMSetupLayoutWebGroups(fsmLayoutSetup);
    }
...
//                }
    ...
    public static void addDefaultAppDomains(long orgId) throws Exception {
        ...
        if(org.getOrgType()==Organization.OrgType.SANDBOX.getIndex()){
            ...
            if (SandboxUtil.getOrgSwitchBean(org.getProductionOrgId()).getSandboxCount(null) > 1) {
                return;
            }
            Organization productionOrg = AccountUtil.getOrgBean().getOrg(org.getProductionOrgId());
            servicePortalAppDomain = getSandboxAppDomain(productionOrg.getDomain() + "." + FacilioProperties.getSandboxOccupantAppDomain(),
                    AppDomainType.SERVICE_PORTAL.getIndex(), GroupType.TENANT_OCCUPANT_PORTAL.getIndex(), productionOrg.getOrgId(),
            ...
            vendorPortalAppDomain = getSandboxAppDomain(productionOrg.getDomain() + "." + FacilioProperties.getSandboxVendorAppDomain(),
                    AppDomainType.VENDOR_PORTAL.getIndex(), GroupType.VENDOR_PORTAL.getIndex(), productionOrg.getOrgId(),
                    AppDomain.DomainType.DEFAULT.getIndex());
            tenantPortalAppDomain = getSandboxAppDomain(productionOrg.getDomain() + "." + FacilioProperties.getSandboxTenantAppDomain(),
                    AppDomainType.TENANT_PORTAL.getIndex(), GroupType.TENANT_OCCUPANT_PORTAL.getIndex(), productionOrg.getOrgId(),
                    AppDomain.DomainType.DEFAULT.getIndex());
            clientPortalAppDomain = getSandboxAppDomain(productionOrg.getDomain() + "." + FacilioProperties.getSandboxClientAppDomain(),
                    AppDomainType.CLIENT_PORTAL.getIndex(), GroupType.CLIENT_PORTAL.getIndex(), productionOrg.getOrgId(),
                    AppDomain.DomainType.DEFAULT.getIndex());
            employeePortalAppDomain = getSandboxAppDomain(productionOrg.getDomain() + "." + FacilioProperties.getSandboxEmployeeAppDomain(),
                    AppDomainType.EMPLOYEE_PORTAL.getIndex(), GroupType.EMPLOYEE_PORTAL.getIndex(), productionOrg.getOrgId(),
                    AppDomain.DomainType.DEFAULT.getIndex());
        } else{
            servicePortalAppDomain = new AppDomain(org.getDomain() + "." + FacilioProperties.getOccupantAppDomain(),
                    AppDomainType.SERVICE_PORTAL.getIndex(), GroupType.TENANT_OCCUPANT_PORTAL.getIndex(), orgId,
                    AppDomain.DomainType.DEFAULT.getIndex());
            vendorPortalAppDomain = new AppDomain(org.getDomain() + "." + FacilioProperties.getVendorAppDomain(),
                    AppDomainType.VENDOR_PORTAL.getIndex(), GroupType.VENDOR_PORTAL.getIndex(), orgId,
                    AppDomain.DomainType.DEFAULT.getIndex());
            tenantPortalAppDomain = new AppDomain(org.getDomain() + "." + FacilioProperties.getTenantAppDomain(),
                    AppDomainType.TENANT_PORTAL.getIndex(), GroupType.TENANT_OCCUPANT_PORTAL.getIndex(), orgId,
                    AppDomain.DomainType.DEFAULT.getIndex());
            clientPortalAppDomain = new AppDomain(org.getDomain() + "." + FacilioProperties.getClientAppDomain(),
                    AppDomainType.CLIENT_PORTAL.getIndex(), GroupType.CLIENT_PORTAL.getIndex(), orgId,
                    AppDomain.DomainType.DEFAULT.getIndex());
            employeePortalAppDomain = new AppDomain(org.getDomain() + "." + FacilioProperties.getEmployeeAppDomain(),
    ...
    public static void addSetupLayoutWebGroups(ApplicationLayoutContext layout) {
        try {
            ...
            webTabs.add(new WebTabContext("Vendor Kiosk", "vendorkiosksettings", WebTabContext.Type.VENDOR_KIOSK, null, appId, null,AccountUtil.FeatureLicense.VENDOR_KIOSK.getFeatureId()));
            ...
            webTabs.add(new WebTabContext("SFG 20", "sfg", WebTabContext.Type.SFG_20, null, appId, null,AccountUtil.FeatureLicense.SFG_20.getFeatureId()));
...
//            groupNameVsWebTabsMap.put("developerspace", webTabs);
      ...
      public static void addFSMSetupLayoutWebGroups(ApplicationLayoutContext layout) {
        try {
            ModuleBean modBean = (ModuleBean) BeanFactory.lookup("ModuleBean");
            int groupOrder = 1;
    ...
    public static void addEnergyAppWebTabs(ApplicationLayoutContext layout) {
        ...
        try {
            ...
            webTabs = new ArrayList<>();
            webTabs.add(new WebTabContext("Reading Kpis", "readingKpi", WebTabContext.Type.KPI, Arrays.asList(), layout.getApplicationId(), null, AccountUtil.FeatureLicense.KPI.getFeatureId()));
            ...
            groupNameVsWebTabsMap.put("client", webTabs);
    ...
    public static void addEnergySetupLayoutWebGroups(ApplicationLayoutContext layout) {
        try {
            ModuleBean modBean = (ModuleBean) BeanFactory.lookup("ModuleBean");
            int groupOrder = 1;
            ...
            webTabGroups.add(new WebTabGroupContext( "Energy Analytics","energyanalytics", layout.getId(),2, groupOrder++));
            webTabs = new ArrayList<>();
            webTabs.add(new WebTabContext("Reading KPIs","kpi", WebTabContext.Type.NEW_KPI_TEMPLATES,null,appId,null,AccountUtil.FeatureLicense.NEW_KPI.getFeatureId()));
            webTabs.add(new WebTabContext("Fault Impact","faultimpact", WebTabContext.Type.FAULT_IMPACT_TEMPLATE,null,appId,null));
            groupNameVsWebTabsMap.put("energyanalytics", webTabs);
