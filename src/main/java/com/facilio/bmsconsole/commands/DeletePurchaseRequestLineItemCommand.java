...
public class DeletePurchaseRequestLineItemCommand implements Command {
	...
	public boolean execute(Context context) throws Exception {
		...
		if (StringUtils.isNotEmpty(moduleName) && CollectionUtils.isNotEmpty(recordIds)) {
			...
			DeleteRecordBuilder<PurchaseRequestLineItemContext> deleteRecordBuilder = new DeleteRecordBuilder<PurchaseRequestLineItemContext>()
					.module(module)
