...
//        PagesUtil.addTemplatePage(moduleName, getCustomModuleTemplatePageForApps(module, appNames));
    ...
    public static List<PagesContext> createCustomPage(ApplicationContext app, FacilioModule module, boolean isTemplate, boolean isDefault) throws Exception {
        ...
        if (app.getDomainType() == AppDomain.AppDomainType.FACILIO.getIndex()) {
            return new ModulePages()
                    ...
                    .addWidget("bulkrelatedlist", "Related List", PageWidget.WidgetType.BULK_RELATED_LIST, "flexiblewebbulkrelatedlist_6", 0, 0, null, null)
                    .widgetDone()
                    .sectionDone()
                    .columnDone()
                    .tabDone()
            ...
            return new ModulePages()
                    ...
                    .addColumn(PageColumnContext.ColumnWidth.FULL_WIDTH)
                    .addSection("classification", null, null)
                    .addWidget("classificationwidget", "Classfication", PageWidget.WidgetType.CLASSIFICATION, "flexiblewebclassification_6", 0, 0, classificationWidgetParam, null)
                    .widgetDone()
                    .sectionDone()
                    .columnDone()
                    .tabDone()
                    ...
                    .addColumn(PageColumnContext.ColumnWidth.FULL_WIDTH)
                    .addSection("relationships", "Relationships", "List of relationships and types between records across modules")
                    .addWidget("bulkrelationshipwidget", "Realtionships", PageWidget.WidgetType.BULK_RELATION_SHIP_WIDGET, "flexiblewebbulkrelationshipwidget_6", 0, 0, null, null)
                    .widgetDone()
                    .sectionDone()
                    .addSection("relatedlist", "Related List", "List of related records across modules")
                    .addWidget("bulkrelatedlist", "Related List", PageWidget.WidgetType.BULK_RELATED_LIST, "flexiblewebbulkrelatedlist_6", 0, 0, null, null)
    ...
    private static JSONObject getMobileRelatedWidgetGroup() throws Exception {
        ...
        WidgetGroupContext widgetGroup = new WidgetGroupContext()
                ...
                .addWidget("relationships", null, PageWidget.WidgetType.BULK_RELATION_SHIP_WIDGET, "flexiblemobilebulkrelationshipwidget_14", 0,0, null, null)
                .widgetGroupWidgetDone()
                .widgetGroupSectionDone()
                .addSection("relatedlistsection", "Related List", "List of related records across modules")
                .addWidget("relatedlist", null, PageWidget.WidgetType.BULK_RELATED_LIST, "flexiblemobilebulkrelatedlist_14", 0, 0, null, null)
                .widgetGroupWidgetDone()
                .widgetGroupSectionDone();
