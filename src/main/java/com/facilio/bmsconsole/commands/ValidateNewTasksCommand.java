...
public class ValidateNewTasksCommand implements Command {
	...
	public boolean execute(Context context) throws Exception {
		...
		Object obj = context.get(FacilioConstants.ContextNames.IS_PM_EXECUTION);
		boolean isPmExec = false;
		if (obj != null) {
			isPmExec = (Boolean) obj;
		}
		if(context.get(FacilioConstants.ContextNames.TASK_SECTION_TEMPLATES) != null && !isPmExec) {
		...
		if (tasks != null && !tasks.isEmpty()) {
			...
			else if (context.containsKey(FacilioConstants.ContextNames.PREVENTIVE_MAINTENANCE_LIST) && !pmExecution){
