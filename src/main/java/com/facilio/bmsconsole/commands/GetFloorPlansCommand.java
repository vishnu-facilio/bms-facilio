...
public class GetFloorPlansCommand extends FacilioCommand {
	@Override
		...
		FloorPlanContext floorPlan = (FloorPlanContext) context.get(FacilioConstants.ContextNames.FLOOR_PLAN);
	      ...
	      GenericSelectRecordBuilder selectRecordBuilder = new GenericSelectRecordBuilder()
                  ...
                  .select(FieldFactory.getFloorPlanFields())
  					.andCondition(CriteriaAPI.getCondition("Floor_Plan.FLOOR_ID", "floorId", String.valueOf(floorPlan.getFloorId()), NumberOperators.EQUALS));
