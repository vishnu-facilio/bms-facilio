...
public class FetchScheduledRuleMatchingSpecificRecordCommand implements Command{

private static final Logger LOGGER = LogManager.getLogger(FetchScheduledRuleMatchingSpecificRecordCommand.class.getName());
	

@Override
public boolean execute(Context context) throws Exception {
	// TODO Auto-generated method stub
	RecordSpecificRuleContext rule = (RecordSpecificRuleContext) context.get(FacilioConstants.ContextNames.WORKFLOW_RULE);
...
private List<? extends ModuleBaseWithCustomFields> getRecords(RecordSpecificRuleContext rule, JobContext jc) throws Exception {
