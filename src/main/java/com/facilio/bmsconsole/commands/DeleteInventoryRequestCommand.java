...
public class DeleteInventoryRequestCommand extends FacilioCommand {
	...
	public boolean executeCommand(Context context) throws Exception {
		...
		if (CollectionUtils.isNotEmpty(recordIds)) {
			...
			DeleteRecordBuilder<InventoryRequestContext> deleteRecordBuilder = new DeleteRecordBuilder<InventoryRequestContext>()
