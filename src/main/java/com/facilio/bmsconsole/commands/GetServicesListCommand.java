...
public class GetServicesListCommand extends FacilioCommand {
	...
	public boolean executeCommand(Context context) throws Exception {
		...
		SelectRecordsBuilder<ServiceContext> builder = new SelectRecordsBuilder<ServiceContext>()
				.module(module)
		...
		List<ServiceContext> records = builder.get();
