...
//			context.put(FacilioConstants.ContextNames.PARENT_ID, getAssetId());
		...
		} else if (Arrays.asList(ContextNames.PURCHASE_ORDER, ContextNames.PURCHASE_REQUEST, ContextNames.SAFETY_PLAN, ContextNames.HAZARD, ContextNames.PRECAUTION).contains(mod.getName())) {
			fields.addAll(FieldFactory.getSystemPointFields(mod));
		}
