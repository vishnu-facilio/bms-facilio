 ...
 *
 */
public class ReadingToolCommand extends FacilioCommand {
	...
	public boolean executeCommand(Context context) throws Exception {
		...
		try {
			...
			if(props!=null) {
				...
				FacilioTimer.deleteJob(readingToolsjobId, FacilioConstants.ContextNames.ADMIN_DELTA_CALCULATION);
			...
			LOGGER.info("#####ReadingTools Exception Occurred"+e);
		}
		return false;
	}
