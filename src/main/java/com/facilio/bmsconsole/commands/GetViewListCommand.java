...
public class GetViewListCommand extends FacilioCommand {
	...
	public boolean executeCommand(Context context) throws Exception {
		...
		Map<Long, SharingContext<SingleSharingContext>> sharingMap = null;
		if (dbViews != null) {
			sharingMap = SharingAPI.getSharingMap(ModuleFactory.getViewSharingModule(), SingleSharingContext.class);
		...
		if (fetchByGroup != null && fetchByGroup) {
			...
			Optional<FacilioView> myupcomingView = allViews.stream()
				...
				sortGroupViews(groupViews, viewMap);
	...
	private void sortGroupViews(List<Map<String, Object>> groupViews, Map<String, FacilioView> viewMap) {
