...
import com.facilio.fsm.commands.fetchDispatcherBoardListCommand;
import com.facilio.fsm.commands.fetchDispatcherBoardSharingCommand;
import com.facilio.fsm.commands.fetchDispatcherConfigCommand;
...
public class ReadOnlyChainFactory {
	...
	public static FacilioChain getRuleCriteria(){
		FacilioChain c = getDefaultChain();
		c.addCommand(new GetConditionsListFromCriteria());
		c.addCommand(new ConstructObjectFromConditions());
		return c;
	}
	public static FacilioChain getValueForRecordIds(){
		FacilioChain c = getDefaultChain();
		c.addCommand(new GetValueForRecordIds());
		return c;
	}
...
//		chain.addCommand(new AddVisitorLogStatesCommand());
	...
	public static FacilioChain getAllApplicationBasedOnDashboardChain() {
		FacilioChain chain = getDefaultChain();
		chain.addCommand(new GetAllApplicationBasedOnDashboardCommand());
		return chain;
	}
