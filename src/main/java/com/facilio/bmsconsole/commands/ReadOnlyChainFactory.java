...
//		c.addCommand(new FetchExtraMetaForAlarmRuleCommand());
	...
	public static Chain executeWorkflowsForReadingChain() {
		Chain c = getDefaultChain();
		c.addCommand(new ExecuteAllWorkflowsCommand(false, RuleType.READING_RULE, RuleType.PM_READING_RULE, RuleType.VALIDATION_RULE,RuleType.ALARM_TRIGGER_RULE,RuleType.ALARM_CLEAR_RULE,RuleType.ALARM_RCA_RULES));
		return c;
	}
