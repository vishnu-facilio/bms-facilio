...
public class LoadWorkorderHazardLookUpCommand extends FacilioCommand {
	...
	public boolean executeCommand(Context context) throws Exception {
		...
		LookupField workorderField = (LookupField) fieldsAsMap.get("workorder");
		LookupField hazardField = (LookupField) fieldsAsMap.get("hazard");
		additionaLookups.add(workorderField);
