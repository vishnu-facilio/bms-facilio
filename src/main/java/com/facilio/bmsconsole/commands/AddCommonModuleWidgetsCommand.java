    ...
    public List<WidgetContext> getCommonModuleWidgets() {
         ...
         return new ModuleWidgets()
                    .addModuleWidget("summaryfieldswidget", "Summary Fields Widget", PageWidget.WidgetType.SUMMARY_FIELDS_WIDGET)
                        ...
                        .addWidgetConfig("flexiblewebsummaryfiledswidget_22","Summary Fields Widget - 22", WidgetConfigContext.ConfigType.FLEXIBLE,22,-1 ,PagesContext.PageLayoutType.WEB)
                    ...
                    .addModuleWidget("widgetgroup", "Widget Group", PageWidget.WidgetType.WIDGET_GROUP)
                        ...
                        .addFlexibleWidgetConfig("flexiblewebwidgetgroup_50","Widget Group - 50", 50, PagesContext.PageLayoutType.WEB)
                    .done()
