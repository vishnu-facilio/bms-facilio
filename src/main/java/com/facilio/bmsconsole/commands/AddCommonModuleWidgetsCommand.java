    ...
    public List<WidgetContext> getCommonModuleWidgets() {
         ...
         return new ModuleWidgets()
                    .addModuleWidget("summaryfieldswidget", "Summary Fields Widget", PageWidget.WidgetType.SUMMARY_FIELDS_WIDGET)
                        ...
                        .addFlexibleWidgetConfig("flexiblemobilesummaryfieldswidget_14","Summary Fields Widget - 14", 14, PagesContext.PageLayoutType.MOBILE)
                        ...
                        .addWidgetConfig("flexiblewebsummaryfieldswidget_3","Summary Fields Widget - 3",WidgetConfigContext.ConfigType.FLEXIBLE,3,-1,PagesContext.PageLayoutType.WEB)
                        .addWidgetConfig("flexiblewebsummaryfieldswidget_6","Summary Fields Widget - 6",WidgetConfigContext.ConfigType.FLEXIBLE,6,-1,PagesContext.PageLayoutType.WEB)
                    .done()
                    .addModuleWidget("fixedsummaryfieldswidget", "Fixed Summary Fields Widget", PageWidget.WidgetType.FIXED_SUMMARY_FIELDS_WIDGET)
                        .addFixedWidgetConfig("webfixedsummaryfieldswidget_6_9","Fixed Summary Fields Widget - 6 - 9", 6, 9, PagesContext.PageLayoutType.WEB)
                    .done()
                    .addModuleWidget("widgetgroup", "Widget Group", PageWidget.WidgetType.WIDGET_GROUP)
                        ...
                        .addFlexibleWidgetConfig("flexiblemobilewidgetgroup_16","Widget Group - 16",16,PagesContext.PageLayoutType.MOBILE)
                    ...
                    .done()
                    .addModuleWidget("classification", "Classification", PageWidget.WidgetType.CLASSIFICATION)
                        .addFlexibleWidgetConfig("flexiblewebclassification_6","Classification - 6", 6, PagesContext.PageLayoutType.WEB)
                        .addFlexibleWidgetConfig("flexiblemobileclassification_14","Classification - 14", 14, PagesContext.PageLayoutType.MOBILE)
                    .done()
                    .addModuleWidget("activity", "Activity", PageWidget.WidgetType.ACTIVITY)
                        ...
                        .addFlexibleWidgetConfig("flexiblemobileactivity_16","Activity - 16", 16, PagesContext.PageLayoutType.MOBILE)
                 .done()
                    ...
                    .addModuleWidget("bulkrelatedlist", "Bulk Related List", PageWidget.WidgetType.BULK_RELATED_LIST)
                        ...
                        .addFlexibleWidgetConfig("flexiblemobilebulkrelatedlist_14","Bulk Related List - 14",14, PagesContext.PageLayoutType.MOBILE)
                    .done()
                    .addModuleWidget("bulkrelationshipwidget", "Bulk Relationship Widget", PageWidget.WidgetType.BULK_RELATION_SHIP_WIDGET)
                        ...
                        .addFlexibleWidgetConfig("flexiblemobilebulkrelationshipwidget_14","Bulk Relationship Widget - 14",14, PagesContext.PageLayoutType.MOBILE)
                    .done()
                    ...
                    .done()
                     .addModuleWidget("relatedlistwidget", "Related List", PageWidget.WidgetType.RELATED_LIST)
                        ...
                        .addFlexibleWidgetConfig("flexiblemobilerelatedlist_14","Related List - 14",14, PagesContext.PageLayoutType.MOBILE)
                    .done()
