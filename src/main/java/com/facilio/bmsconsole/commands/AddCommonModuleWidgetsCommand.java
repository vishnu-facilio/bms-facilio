...
public class AddCommonModuleWidgetsCommand extends FacilioCommand {
    ...
    public List<WidgetContext> getCommonModuleWidgets() {
        ...
        WidgetConfigContext w1Con1 = new WidgetConfigContext(WidgetConfigContext.ConfigType.FLEXIBLE, 7,12);
        ...
        WidgetConfigContext wid2Con1 = new WidgetConfigContext(WidgetConfigContext.ConfigType.FLEXIBLE, 8,12);
        ...
        WidgetConfigContext wid3Con1 = new WidgetConfigContext(WidgetConfigContext.ConfigType.FLEXIBLE, 8,12);
        ...
        WidgetConfigContext wid4Con1 = new WidgetConfigContext(WidgetConfigContext.ConfigType.FLEXIBLE, 8,12);
        ...
        WidgetConfigContext wid5Con1 = new WidgetConfigContext(WidgetConfigContext.ConfigType.FLEXIBLE, 8,12);
        ...
        WidgetConfigContext wid6Con1 = new WidgetConfigContext(WidgetConfigContext.ConfigType.FLEXIBLE, 3,12);
        ...
        WidgetConfigContext wid7Con1 = new WidgetConfigContext(WidgetConfigContext.ConfigType.FLEXIBLE, 8,12);
        ...
        WidgetConfigContext wid8Con1 = new WidgetConfigContext(WidgetConfigContext.ConfigType.FLEXIBLE, 8,12);
        WidgetContext wid8 = new WidgetContext("bukrelatedlist", "Bulk Related List", PageWidget.WidgetType.BULK_RELATED_LIST, Arrays.asList(wid8Con1));
