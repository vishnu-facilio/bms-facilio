    ...
    public List<WidgetContext> getCommonModuleWidgets() {
         ...
         return new ModuleWidgets()
                    .addModuleWidget("summaryfieldswidget", "Summary Fields Widget", PageWidget.WidgetType.SUMMARY_FIELDS_WIDGET)
                        ...
                        .addWidgetConfig("flexiblewebsummaryfieldswidget_11","Summary Fields Widget - 11",WidgetConfigContext.ConfigType.FLEXIBLE,11,-1,PagesContext.PageLayoutType.WEB)
                        .addFixedWidgetConfig("websummaryfieldswidget_28_9", "Summary Fields Widget - 28 - 9", 28, 9, PagesContext.PageLayoutType.WEB)
                    .done()
                    .addModuleWidget("widgetgroup", "Widget Group", PageWidget.WidgetType.WIDGET_GROUP)
                        ...
                        .addFixedWidgetConfig("webwidgetgroup_28_6","Widget Group - 28 - 6", 28,6, PagesContext.PageLayoutType.WEB)
                    ...
                    .addModuleWidget("comment", "Comment", PageWidget.WidgetType.COMMENT)
                        ...
                        .addFlexibleWidgetConfig("flexiblewebcomment_28","Comment - 28", 28, PagesContext.PageLayoutType.WEB)
                    ...
                    .addModuleWidget("attachment", "Attachment", PageWidget.WidgetType.ATTACHMENT)
                        ...
                        .addFlexibleWidgetConfig("flexiblewebattachment_28","Attachment - 28",28, PagesContext.PageLayoutType.WEB)
                    ...
                    .addModuleWidget("connectedApp", "Connected App", PageWidget.WidgetType.CONNNECTED_APP)
                        .addWidgetConfig("flexiblewebconnectedapp_30","Connected App - 30", WidgetConfigContext.ConfigType.FLEXIBLE, 30, -1, PagesContext.PageLayoutType.WEB)
                    .done()
                .getWidgets();
    }
}
