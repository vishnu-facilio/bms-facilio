...
public class AddCommonModuleWidgetsCommand extends FacilioCommand {
    ...
    public List<WidgetContext> getCommonModuleWidgets() {
         ...
         return new ModuleWidgets()
                 ...
                 .addWidgetConfig("flexiblewebsummaryfieldswidget_30_9","Summary Fields Widget - 30 -9",WidgetConfigContext.ConfigType.FIXED,30,9,PagesContext.PageLayoutType.WEB)
                    .done()
