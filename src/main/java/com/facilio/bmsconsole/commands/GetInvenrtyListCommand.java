...
public class GetInvenrtyListCommand implements Command{
	@Override
	public boolean execute(Context context) throws Exception {
		...
		SelectRecordsBuilder<InventryContext> builder = new SelectRecordsBuilder<InventryContext>().module(module)
		...
		List<InventryContext> records = builder.get();
		...
		if (records != null && !records.isEmpty()) {
			if (getCount != null && getCount) {
				...
				for (InventryContext inventry : records) {
