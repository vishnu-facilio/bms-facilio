...
public class GetDeleteShipmentCommand extends FacilioCommand {
	...
	public boolean executeCommand(Context context) throws Exception {
		...
		if (CollectionUtils.isNotEmpty(recordIds)) {
			...
			DeleteRecordBuilder<ShipmentContext> deleteRecordBuilder = new DeleteRecordBuilder<ShipmentContext>()
