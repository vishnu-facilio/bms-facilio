...
public class GetPurchaseContractListCommand implements Command {
	...
	public boolean execute(Context context) throws Exception {
		...
		SelectRecordsBuilder<PurchaseContractContext> builder = new SelectRecordsBuilder<PurchaseContractContext>()
				.module(module)
		...
		List<PurchaseContractContext> records = builder.get();
