...
public class NewsAndInformationScopingConfig extends ModuleScopingConfiguration {
    @Override
    public void addScopingConfiguration() {
        try {
            ModuleBean modBean = (ModuleBean) BeanFactory.lookup("ModuleBean");
            FacilioModule module = modBean.getModule(FacilioConstants.ContextNames.Tenant.NEWS_AND_INFORMATION);
            ...
            scoping.setFieldName("newsandinformationsharing.newsAndInformation");
