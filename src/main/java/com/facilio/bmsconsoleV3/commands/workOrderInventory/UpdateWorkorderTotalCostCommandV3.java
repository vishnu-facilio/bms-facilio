    ...
    public boolean executeCommand(Context context) throws Exception {
        ...
        if (parentIds != null && !parentIds.isEmpty()) {
            if(parentIds.size()==1){
                ...
                V3Util.processAndUpdateSingleRecord(FacilioConstants.ContextNames.WORK_ORDER, parentId, FieldUtil.getAsJSON(workorder), null, null, null, null, null,null, null);
