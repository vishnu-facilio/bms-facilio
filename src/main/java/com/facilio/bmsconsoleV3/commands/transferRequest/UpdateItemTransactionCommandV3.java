...
public class UpdateItemTransactionCommandV3 extends FacilioCommand {
    ...
    public boolean executeCommand(Context context) throws Exception {
       ...
       String moduleName = Constants.getModuleName(context);
        ...
        if(!Objects.isNull(context.get(FacilioConstants.ContextNames.ITEM_TYPES)) && transferRequests.get(0).getIsStaged().equals(true)&&transferRequests.get(0).getIsCompleted().equals(false) && transferRequests.get(0).getIsShipped().equals(false)){
