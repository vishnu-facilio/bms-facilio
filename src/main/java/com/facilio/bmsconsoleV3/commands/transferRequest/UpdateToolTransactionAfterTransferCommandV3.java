...
public class UpdateToolTransactionAfterTransferCommandV3 extends FacilioCommand {
    ...
    public boolean executeCommand(Context context) throws Exception {
        ...
        if (!Objects.isNull(context.get(FacilioConstants.ContextNames.TOOL_TYPES)) && transferRequests.get(0).getIsStaged().equals(true) && transferRequests.get(0).getIsCompleted().equals(true)) {
