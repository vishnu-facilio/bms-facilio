...
public class FetchSupplementsForCalendarEventCommand extends FacilioCommand {
    @Override
    public boolean executeCommand(Context context) throws Exception {
        ModuleBean modBean = (ModuleBean) BeanFactory.lookup("ModuleBean");
        List<FacilioField> eventModule = modBean.getAllFields(FacilioConstants.Calendar.EVENT_MODULE_NAME);
        Map<String, FacilioField> fieldsAsMap = FieldFactory.getAsMap(eventModule);
