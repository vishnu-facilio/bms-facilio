...
public class AddTicketActivityCommandV3 extends FacilioCommand {
    ...
    @SuppressWarnings("unchecked")
    private Map<Long, ? extends V3TicketContext> getNewTickets(List<Long> ids, FacilioModule module) throws Exception {
        ...
        SelectRecordsBuilder<? extends V3TicketContext> builder = new SelectRecordsBuilder<V3TicketContext>()
                .module(module)
                .select(fields)
    ...
    private void computeAndAddActivity(Context context) throws Exception {
        ...
        Map<Long, ? extends V3TicketContext> newTickets = getNewTickets(ids, module);
        List<? extends V3TicketContext> oldTickets = (List<? extends V3TicketContext>) context.get(FacilioConstants.TicketActivity.OLD_TICKETS);
        ...
        Map<Long, V3TicketContext> oldTicketMap = new HashMap<>();

        if(oldTickets != null && !oldTickets.isEmpty()) {
            isUpdate = true;
            for(V3TicketContext oldTicket : oldTickets) {
