...
public class FetchSupplementsForActionCommand extends FacilioCommand {
    @Override
    public boolean executeCommand(Context context) throws Exception {
        ModuleBean modBean = (ModuleBean) BeanFactory.lookup("ModuleBean");
        List<FacilioField> actionModuleFields = modBean.getAllFields(FacilioConstants.Control_Action.ACTION_MODULE_NAME);
        Map<String, FacilioField> fieldsAsMap = FieldFactory.getAsMap(actionModuleFields);
