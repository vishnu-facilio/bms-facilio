...
public class AddParkingStallSpaceCommand extends FacilioCommand {
	...
	public static void updateSiteAndBuildingId(V3ParkingStallContext space) throws Exception {
