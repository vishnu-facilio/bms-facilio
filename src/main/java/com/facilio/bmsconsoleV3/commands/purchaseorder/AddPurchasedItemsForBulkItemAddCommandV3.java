        ...
        if (purchasedItem != null && !purchasedItem.isEmpty()) {
            ...
            if (purchasedItem != null && !purchasedItem.isEmpty()) {
                ...
                for (V3PurchasedItemContext pi : purchasedItem) {
                    ...
                    if (pi.getId() <= 0) {
                        // Insert
                        pi = (V3PurchasedItemContext) CurrencyUtil.addMultiCurrencyData(purchasedItemModule.getName(), multiCurrencyFields,
                                Collections.singletonList(pi), V3PurchasedItemContext.class, baseCurrency, currencyCodeVsCurrency).get(0);
