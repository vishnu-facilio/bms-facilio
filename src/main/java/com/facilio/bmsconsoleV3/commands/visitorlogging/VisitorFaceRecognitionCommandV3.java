...
public class VisitorFaceRecognitionCommandV3 extends FacilioCommand implements Serializable {
            ...
            if (records != null && !records.isEmpty()) {
                for (ModuleBaseWithCustomFields record : records) {
                    ...
                    if (FacilioConstants.ContextNames.VISITOR.equals(moduleName)) {
                        ...
                        faceModule = ModuleFactory.getVisitorFacesModule();
                        V3VisitorLoggingContext visitorLog = (V3VisitorLoggingContext) record;
