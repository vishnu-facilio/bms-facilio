...
public class SetVendorQuotesLineItemsCommandV3 extends FacilioCommand {
    ...
    public boolean executeCommand(Context context) throws Exception {
        ...
        if(!FacilioUtil.isEmptyOrNull(vendorQuote)) {
            ...
            if(!FacilioUtil.isEmptyOrNull(vendorQuote) && V3InventoryUtil.hasVendorPortalAccess(vendorQuote.getVendor().getId()) && !AccountUtil.getCurrentApp().getLinkName().equals(FacilioConstants.ApplicationLinkNames.VENDOR_PORTAL_APP) && !vendorQuote.getIsFinalized()){
