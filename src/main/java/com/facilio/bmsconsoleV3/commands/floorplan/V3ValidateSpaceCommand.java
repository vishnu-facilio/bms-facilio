...
public class V3ValidateSpaceCommand extends FacilioCommand {

	@Override
	public boolean executeCommand(Context context) throws Exception {
		HashMap record = (HashMap)context.get("recordMap");
		
		List<V3DeskContext> spaces = (List<V3DeskContext>)record.get("desks");
		
		if (spaces != null && !spaces.isEmpty()) {
			for (V3DeskContext space : spaces) {
	...
	public static void updateSiteAndBuildingId(V3DeskContext space) throws Exception {
