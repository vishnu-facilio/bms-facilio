...
public class LoadRequestForQuotationLookupCommandV3 extends FacilioCommand {
    @Override
    public boolean executeCommand(Context context) throws Exception {
        ...
        MultiLookupMeta vendor = new MultiLookupMeta((MultiLookupField) fieldsAsMap.get("vendor"));
