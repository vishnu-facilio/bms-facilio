    ...
    public boolean executeCommand(Context context) throws Exception {
        ...
        if(CollectionUtils.isNotEmpty(requestForQuotationLineItems) && requestForQuotation!=null) {
            ...
            if(CollectionUtils.isNotEmpty(clonedVendorQuotesList)){
                ...
                V3Util.processAndUpdateBulkRecords(vendorQuoteModule, vendorQuotesMap.get(FacilioConstants.ContextNames.VENDOR_QUOTES),  FieldUtil.getAsMapList(updatedVendorQuotesList,V3VendorQuotesContext.class)  ,null,null,null,null,null,null,null,null,false,false,null);
            }
        }
        return false;
    }
