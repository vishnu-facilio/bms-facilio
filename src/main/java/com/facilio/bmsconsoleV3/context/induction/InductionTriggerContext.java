...
@Getter @Setter
public class InductionTriggerContext extends V3Context {
	...
	String name;
	InductionTemplateContext parent;
	TriggerType type;
	BaseScheduleContext schedule;
	Long scheduleId;
	List<InductionTriggerIncludeExcludeResourceContext> resInclExclList;
