...
public class ModulePermission  implements Serializable {
    ...
    private List<ModulePermisssionChild> modulePermisssionChildList;

    public List<ModulePermisssionChild> getModulePermisssionChildList() {
        return modulePermisssionChildList;
    }

    public void setModulePermisssionChildList(List<ModulePermisssionChild> modulePermisssionChildList) {
        this.modulePermisssionChildList = modulePermisssionChildList;
    }
    ...
    public ModulePermission(String moduleName, String specialLinkName, List<Permission> permissionList) throws Exception {
        this.moduleName = moduleName;
