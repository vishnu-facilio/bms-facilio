...
public class V3ModuleAPI {
    ...
    private enum MODULES {
        ...
        VISITOR(FacilioConstants.ContextNames.VISITOR,Arrays.asList(FacilioConstants.ApplicationLinkNames.MAINTENANCE_APP,FacilioConstants.ApplicationLinkNames.EMPLOYEE_PORTAL_APP)),
        VISITOR_LOG(FacilioConstants.ContextNames.VISITOR_LOG,Arrays.asList(FacilioConstants.ApplicationLinkNames.MAINTENANCE_APP,FacilioConstants.ApplicationLinkNames.EMPLOYEE_PORTAL_APP)),
        INVITE_VISITOR(FacilioConstants.ContextNames.INVITE_VISITOR,Arrays.asList(FacilioConstants.ApplicationLinkNames.MAINTENANCE_APP,FacilioConstants.ApplicationLinkNames.EMPLOYEE_PORTAL_APP)),
        ...
        INDOOR_FLOORPLAN(FacilioConstants.ContextNames.Floorplan.INDOOR_FLOORPLAN,Arrays.asList(FacilioConstants.ApplicationLinkNames.EMPLOYEE_PORTAL_APP)),
