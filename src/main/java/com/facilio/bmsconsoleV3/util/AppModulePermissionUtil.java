...
public class AppModulePermissionUtil {
    ...
    private static List < Permission > permissions = Arrays.asList(
            ...
            new Permission(getExponentValue(7), "FEEDBACK_COMPLAINTS", "Feedback Complaints", PermissionMapping.GROUP2PERMISSION),
            new Permission(getExponentValue(8), "TAX", "Tax", PermissionMapping.GROUP2PERMISSION),
            new Permission(getExponentValue(9), "CRAFTS", "Crafts", PermissionMapping.GROUP2PERMISSION),
            new Permission(getExponentValue(10), "PEOPLE", "People", PermissionMapping.GROUP2PERMISSION),
            new Permission(getExponentValue(11), "SINGLE_SIGN_ON", "Single Sign On", PermissionMapping.GROUP2PERMISSION),
            new Permission(getExponentValue(12), "SECURITY_POLICY", "Security Policy", PermissionMapping.GROUP2PERMISSION),
            new Permission(getExponentValue(13), "PRIORITY", "Priority", PermissionMapping.GROUP2PERMISSION),
            new Permission(getExponentValue(14), "TYPES", "Types", PermissionMapping.GROUP2PERMISSION),
            new Permission(getExponentValue(15), "AUDIT_LOG", "Audit Logs", PermissionMapping.GROUP2PERMISSION),
            new Permission(getExponentValue(16), "SURVEY", "Survey", PermissionMapping.GROUP2PERMISSION),
            new Permission(getExponentValue(17), "ASSET_DEPRECIATION", "Asset Depreciation", PermissionMapping.GROUP2PERMISSION),
            new Permission(getExponentValue(18), "TRIGGERS", "Triggers", PermissionMapping.GROUP2PERMISSION),
            new Permission(getExponentValue(19), "CONDITION_MANAGER", "Condition Manager", PermissionMapping.GROUP2PERMISSION),
            new Permission(getExponentValue(20), "VARIABLES", "Variables", PermissionMapping.GROUP2PERMISSION),
            new Permission(getExponentValue(21), "BMS_EVENT_FILTERING", "BMS Event Filtering", PermissionMapping.GROUP2PERMISSION),
            new Permission(getExponentValue(22), "SCORING_RULES", "Scoring Rules", PermissionMapping.GROUP2PERMISSION),
            new Permission(getExponentValue(23), "TRANSACTION_RULES", "Transaction Rules", PermissionMapping.GROUP2PERMISSION),
            new Permission(getExponentValue(24), "APPROVALS", "Approvals", PermissionMapping.GROUP2PERMISSION),
            new Permission(getExponentValue(25), "TABS_AND_LAYOUTS", "Tabs and Layouts", PermissionMapping.GROUP2PERMISSION),
            new Permission(getExponentValue(26), "EMAIL_TEMPLATES", "Email Templates", PermissionMapping.GROUP2PERMISSION),
            new Permission(getExponentValue(27), "LOCALIZATION", "Localization", PermissionMapping.GROUP2PERMISSION),
            new Permission(getExponentValue(28), "USER_SCOPES", "User Scopes", PermissionMapping.GROUP2PERMISSION),
            new Permission(getExponentValue(29), "FAULT_IMPACT_TEMPLATE", "Fault Impact Template", PermissionMapping.GROUP2PERMISSION),
            new Permission(getExponentValue(30), "ENPI", "ENPI", PermissionMapping.GROUP2PERMISSION),
            new Permission(getExponentValue(31), "API_SETUP", "API Setup", PermissionMapping.GROUP2PERMISSION),
            new Permission(getExponentValue(32), "BUNDLE", "Bundle", PermissionMapping.GROUP2PERMISSION),
            new Permission(getExponentValue(33), "INSTALL_BUNDLE", "Install Bundle", PermissionMapping.GROUP2PERMISSION));
