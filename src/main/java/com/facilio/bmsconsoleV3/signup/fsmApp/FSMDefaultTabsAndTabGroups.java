...
public class FSMDefaultTabsAndTabGroups {
    ...
    private Map<String, WebTabContext> getWebTabs(long appId) throws Exception {
        ...
        List<WebTabContext> tabs = Arrays.asList(
                ...
                new WebTabContext("Shift","shift",WebTabContext.Type.MODULE,getModuleIdsListFromModuleNames(Arrays.asList(FacilioConstants.ContextNames.SHIFT)), null, null,null,appId),
                new WebTabContext("Shift Planner","shiftplanner",WebTabContext.Type.SHIFT_PLANNER,null, null, null,null,appId),
                new WebTabContext("Attendance","attendance",WebTabContext.Type.ATTENDANCE,null, null, null,null,appId),
