...
public class AddModbusRtuPointModule extends BaseModuleConfig {

    public AddModbusRtuPointModule() {
        setModuleName(AgentConstants.MODBUS_RTU_POINT_MODULE);
    }
    @Override
    public void addData() throws Exception {
        FacilioModule module = getModbusRtuPointModule();
    ...
    //5-modbusRtu
    private FacilioModule getModbusRtuPointModule() throws Exception{
        ModuleBean moduleBean = (ModuleBean) BeanFactory.lookup("ModuleBean");
        FacilioModule pointModule = moduleBean.getModule(AgentConstants.POINT);

        FacilioModule module = new FacilioModule(AgentConstants.MODBUS_RTU_POINT_MODULE,
                "ModbusRtuPoint",
                "Modbus_Rtu_Point",
        ...
        modbusDataType.setAccessType(FacilioField.AccessType.READ.getVal()+FacilioField.AccessType.CREATE.getVal());
    ...
    public List<Map<String, Object>> getViewsAndGroups() {
        ...
        views.add(getUnconfiguredModbusRTUPointView().setOrder(order++));
        views.add(getConfiguredModbusRTUPointView().setOrder(order++));
        views.add(getCommissionedModbusRTUPointView().setOrder(order++));
        views.add(getSubscribedModbusRTUPointView().setOrder(order));

        groupDetails = new HashMap<>();
        groupDetails.put(AgentConstants.NAME, AgentConstants.MODBUS_RTU_POINT_MODULE+"View");
        groupDetails.put(AgentConstants.DISPLAY_NAME, "ModbusRTU Point Views");
        groupDetails.put(FacilioConstants.ContextNames.MODULE_NAME, AgentConstants.MODBUS_RTU_POINT_MODULE);
    ...
    private FacilioView getUnconfiguredModbusRTUPointView(){
        ...
        viewFields.addAll(getModbusRtuViewFields());
        ...
        criteria.addAndCondition(CriteriaAPI.getCondition("POINT_TYPE",AgentConstants.POINT_TYPE,String.valueOf(5), NumberOperators.EQUALS));
        ...
        view.setName("unconfigured"+AgentConstants.MODBUS_RTU_POINT_MODULE);
        view.setDisplayName("Unconfigured ModbusRTU Points");
        view.setModuleName(AgentConstants.MODBUS_RTU_POINT_MODULE);
    ...
    private FacilioView getConfiguredModbusRTUPointView(){
        List<ViewField>viewFields = new ArrayList<>();
        viewFields.add(new ViewField(AgentConstants.DISPLAY_NAME,"Display Name"));
        viewFields.add(new ViewField(AgentConstants.DEVICE_NAME, "Controller"));
        viewFields.add(new ViewField(AgentConstants.DESCRIPTION, "Description"));
        ...
        FacilioView view = new FacilioView();
        view.setName("configured"+AgentConstants.MODBUS_RTU_POINT_MODULE);
        view.setDisplayName("Configured ModbusRTU Points");
        view.setModuleName(AgentConstants.MODBUS_RTU_POINT_MODULE);
        view.setFields(viewFields);
        view.setCriteria(criteria);
    ...
    private FacilioView getCommissionedModbusRTUPointView(){
        List<ViewField>viewFields = new ArrayList<>();
        viewFields.add(new ViewField(AgentConstants.DISPLAY_NAME,"Display Name"));
        viewFields.add(new ViewField(AgentConstants.DEVICE_NAME, "Controller"));
        viewFields.addAll(getModbusRtuViewFields());
        ...
        FacilioView view = new FacilioView();
        view.setName("commissioned"+AgentConstants.MODBUS_RTU_POINT_MODULE);
        view.setDisplayName("Commissioned ModbusRTU Points");
        view.setModuleName(AgentConstants.MODBUS_RTU_POINT_MODULE);
        view.setFields(viewFields);
        view.setCriteria(criteria);
    ...
    private FacilioView getSubscribedModbusRTUPointView(){
        List<ViewField>viewFields = new ArrayList<>();
        viewFields.add(new ViewField(AgentConstants.DISPLAY_NAME,"Display Name"));
        viewFields.add(new ViewField(AgentConstants.DEVICE_NAME, "Controller"));
        viewFields.add(new ViewField(AgentConstants.DESCRIPTION, "Description"));
        ...
        FacilioView view = new FacilioView();
        view.setName("subscribed"+AgentConstants.MODBUS_RTU_POINT_MODULE);
        view.setDisplayName("Subscribed ModbusRTU Points");
        view.setModuleName(AgentConstants.MODBUS_RTU_POINT_MODULE);
        view.setFields(viewFields);
        view.setCriteria(criteria);
    ...
    private List<ViewField>getModbusRtuViewFields(){
        List<ViewField>viewFields = new ArrayList<>();
