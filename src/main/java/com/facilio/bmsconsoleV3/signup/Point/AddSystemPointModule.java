...
public class AddSystemPointModule extends BaseModuleConfig {
    public AddSystemPointModule() {
        setModuleName(AgentConstants.SYSTEM_POINT_MODULE_NAME);
    }
    @Override
    public void addData() throws Exception {
        FacilioModule module = getSystemPointModule();
    ...
    //12 System
    private FacilioModule getSystemPointModule() throws Exception{
        ModuleBean moduleBean = (ModuleBean) BeanFactory.lookup("ModuleBean");
        FacilioModule pointModule = moduleBean.getModule(AgentConstants.POINT);

        FacilioModule module = new FacilioModule(AgentConstants.SYSTEM_POINT_MODULE_NAME,
                "System Point",
                "System_Point",
        ...
        FacilioField name =  FieldFactory.getNameField(module);
        name.setAccessType(FacilioField.AccessType.READ.getVal());
        fields.add(name);
    ...
    public List<Map<String, Object>> getViewsAndGroups() {
        ...
        views.add(getUnconfiguredSystemPointView().setOrder(order++));
        views.add(getConfiguredSystemPointView().setOrder(order++));
        views.add(getCommissionedSystemPointView().setOrder(order++));
        views.add(getSubscribedSystemPointView().setOrder(order));

        groupDetails = new HashMap<>();
        groupDetails.put(AgentConstants.NAME, AgentConstants.SYSTEM_POINT_MODULE_NAME+"View");
        groupDetails.put(AgentConstants.DISPLAY_NAME, "System Point Views");
        groupDetails.put(FacilioConstants.ContextNames.MODULE_NAME, AgentConstants.SYSTEM_POINT_MODULE_NAME);
    ...
    private FacilioView getUnconfiguredSystemPointView(){
        ...
        criteria.addAndCondition(CriteriaAPI.getCondition("POINT_TYPE",AgentConstants.POINT_TYPE,String.valueOf(12), NumberOperators.EQUALS));
        ...
        view.setName("unconfigured"+AgentConstants.SYSTEM_POINT_MODULE_NAME);
        view.setDisplayName("Unconfigured System Points");
        view.setModuleName(AgentConstants.SYSTEM_POINT_MODULE_NAME);
    ...
    private FacilioView getConfiguredSystemPointView(){
        ...
        FacilioView view = new FacilioView();
        view.setName("configured"+AgentConstants.SYSTEM_POINT_MODULE_NAME);
        view.setDisplayName("Configured System Points");
        view.setModuleName(AgentConstants.SYSTEM_POINT_MODULE_NAME);
        view.setFields(viewFields);
        view.setCriteria(criteria);
    ...
    private FacilioView getCommissionedSystemPointView(){
        List<ViewField>viewFields = new ArrayList<>();
        viewFields.add(new ViewField(AgentConstants.DISPLAY_NAME,"Display Name"));
        viewFields.add(new ViewField(AgentConstants.DEVICE_NAME, "Controller"));
        viewFields.add(new ViewField(AgentConstants.DATA_INTERVAL, "Interval"));
        ...
        FacilioView view = new FacilioView();
        view.setName("commissioned"+AgentConstants.SYSTEM_POINT_MODULE_NAME);
        view.setDisplayName("Commissioned System Points");
        view.setModuleName(AgentConstants.SYSTEM_POINT_MODULE_NAME);
        view.setFields(viewFields);
        view.setCriteria(criteria);
    ...
    private FacilioView getSubscribedSystemPointView(){
        List<ViewField>viewFields = new ArrayList<>();
        viewFields.add(new ViewField(AgentConstants.DISPLAY_NAME,"Display Name"));
        viewFields.add(new ViewField(AgentConstants.DEVICE_NAME, "Controller"));
        viewFields.add(new ViewField(AgentConstants.DESCRIPTION, "Description"));
        ...
        FacilioView view = new FacilioView();
        view.setName("subscribed"+AgentConstants.SYSTEM_POINT_MODULE_NAME);
        view.setDisplayName("Subscribed System Points");
        view.setModuleName(AgentConstants.SYSTEM_POINT_MODULE_NAME);
        view.setFields(viewFields);
        view.setCriteria(criteria);
