...
public class AddNiagaraPointModule extends BaseModuleConfig {
    public AddNiagaraPointModule() {
        setModuleName(AgentConstants.NIAGARA_POINT_MODULE);
    }
    @Override
    public void addData() throws Exception {
        FacilioModule module = getNiagaraPointModule();
    ...
    //3-niagara
    private FacilioModule getNiagaraPointModule() throws Exception {

        ModuleBean moduleBean = (ModuleBean) BeanFactory.lookup("ModuleBean");
        FacilioModule pointModule = moduleBean.getModule(AgentConstants.POINT);

        FacilioModule module = new FacilioModule(AgentConstants.NIAGARA_POINT_MODULE,
                "Niagara Point",
                "Niagara_Point",
    ...
    public List<Map<String, Object>> getViewsAndGroups() {
        ...
        views.add(getUnconfiguredNiagaraPointView().setOrder(order++));
        views.add(getConfiguredNiagaraPointView().setOrder(order++));
        views.add(getCommissionedNiagaraPointView().setOrder(order++));
        views.add(getSubscribedNiagaraPointView().setOrder(order));

        groupDetails = new HashMap<>();
        groupDetails.put(AgentConstants.NAME, AgentConstants.NIAGARA_POINT_MODULE+"View");
        groupDetails.put(AgentConstants.DISPLAY_NAME, "Niagara Point Views");
        groupDetails.put(FacilioConstants.ContextNames.MODULE_NAME, AgentConstants.NIAGARA_POINT_MODULE);
    ...
    private FacilioView getUnconfiguredNiagaraPointView(){
        ...
        criteria.addAndCondition(CriteriaAPI.getCondition("POINT_TYPE",AgentConstants.POINT_TYPE,String.valueOf(3), NumberOperators.EQUALS));
        ...
        view.setName("unconfigured"+AgentConstants.NIAGARA_POINT_MODULE);
        view.setDisplayName("Unconfigured Niagara Points");
        view.setModuleName(AgentConstants.NIAGARA_POINT_MODULE);
    ...
    private FacilioView getConfiguredNiagaraPointView(){
        ...
        FacilioView view = new FacilioView();
        view.setName("configured"+AgentConstants.NIAGARA_POINT_MODULE);
        view.setDisplayName("Configured Niagara Points");
        view.setModuleName(AgentConstants.NIAGARA_POINT_MODULE);
        view.setFields(viewFields);
        view.setCriteria(criteria);
    ...
    private FacilioView getCommissionedNiagaraPointView(){
        List<ViewField>viewFields = new ArrayList<>();
        viewFields.add(new ViewField(AgentConstants.DISPLAY_NAME,"Display Name"));
        viewFields.add(new ViewField(AgentConstants.DEVICE_NAME, "Controller"));
        viewFields.add(new ViewField(AgentConstants.DATA_INTERVAL, "Interval"));
        ...
        FacilioView view = new FacilioView();
        view.setName("commissioned"+AgentConstants.NIAGARA_POINT_MODULE);
        view.setDisplayName("Commissioned Niagara Points");
        view.setModuleName(AgentConstants.NIAGARA_POINT_MODULE);
        view.setFields(viewFields);
        view.setCriteria(criteria);
    ...
    private FacilioView getSubscribedNiagaraPointView(){
        List<ViewField>viewFields = new ArrayList<>();
        viewFields.add(new ViewField(AgentConstants.DISPLAY_NAME,"Display Name"));
        viewFields.add(new ViewField(AgentConstants.DEVICE_NAME, "Controller"));
        viewFields.add(new ViewField(AgentConstants.DESCRIPTION, "Description"));
        ...
        FacilioView view = new FacilioView();
        view.setName("subscribed"+AgentConstants.NIAGARA_POINT_MODULE);
        view.setDisplayName("Subscribed Niagara Points");
        view.setModuleName(AgentConstants.NIAGARA_POINT_MODULE);
        view.setFields(viewFields);
        view.setCriteria(criteria);
