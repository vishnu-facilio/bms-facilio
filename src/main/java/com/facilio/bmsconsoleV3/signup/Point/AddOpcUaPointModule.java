...
public class AddOpcUaPointModule extends BaseModuleConfig {
    public AddOpcUaPointModule() {
        setModuleName(AgentConstants.OPC_UA_POINT_MODULE);
    }
    @Override
    public void addData() throws Exception {
        FacilioModule module = getOpcUaPointModule();
    ...
    //7-opcUa
    private FacilioModule getOpcUaPointModule() throws Exception{

        ModuleBean moduleBean = (ModuleBean) BeanFactory.lookup("ModuleBean");
        FacilioModule pointModule = moduleBean.getModule(AgentConstants.POINT);

        FacilioModule module = new FacilioModule(AgentConstants.OPC_UA_POINT_MODULE,
                "OPC UA Point",
                "OPC_UA_Point",
        ...
        NumberField nameSpace = FieldFactory.getField(AgentConstants.NAMESPACE,"Name Space", "NAME_SPACE", module, FieldType.NUMBER);
        nameSpace.setAccessType(FacilioField.AccessType.READ.getVal()+FacilioField.AccessType.CRITERIA.getVal());
        fields.add(nameSpace);

        StringField identifier = FieldFactory.getField(AgentConstants.UA_POINT_IDENTIFIER, "Identifier","IDENTIFIER", module, FieldType.STRING);
        identifier.setAccessType(FacilioField.AccessType.READ.getVal()+FacilioField.AccessType.CRITERIA.getVal());
    ...
    public List<Map<String, Object>> getViewsAndGroups() {
        ...
        views.add(getUnconfiguredOpcUaPointView().setOrder(order++));
        views.add(getConfiguredOpcUaPointView().setOrder(order++));
        views.add(getCommissionedOpcUaPointView().setOrder(order++));
        views.add(getSubscribedOpcUaPointView().setOrder(order));

        groupDetails = new HashMap<>();
        groupDetails.put(AgentConstants.NAME, AgentConstants.OPC_UA_POINT_MODULE+"View");
        groupDetails.put(AgentConstants.DISPLAY_NAME, "OpcUa Point Views");
        groupDetails.put(FacilioConstants.ContextNames.MODULE_NAME, AgentConstants.OPC_UA_POINT_MODULE);
    ...
    private FacilioView getUnconfiguredOpcUaPointView(){
        ...
        viewFields.addAll(getOpcUaViewFields());
        ...
        criteria.addAndCondition(CriteriaAPI.getCondition("POINT_TYPE",AgentConstants.POINT_TYPE,String.valueOf(7), NumberOperators.EQUALS));
        ...
        view.setName("unconfigured"+AgentConstants.OPC_UA_POINT_MODULE);
        view.setDisplayName("Unconfigured OpcUa Points");
        view.setModuleName(AgentConstants.OPC_UA_POINT_MODULE);
    ...
    private FacilioView getConfiguredOpcUaPointView(){
        ...
        FacilioView view = new FacilioView();
        view.setName("configured"+AgentConstants.OPC_UA_POINT_MODULE);
        view.setDisplayName("Configured OpcUa Points");
        view.setModuleName(AgentConstants.OPC_UA_POINT_MODULE);
        view.setFields(viewFields);
        view.setCriteria(criteria);
    ...
    private FacilioView getCommissionedOpcUaPointView(){
        List<ViewField>viewFields = new ArrayList<>();
        viewFields.add(new ViewField(AgentConstants.DISPLAY_NAME,"Display Name"));
        viewFields.add(new ViewField(AgentConstants.DEVICE_NAME, "Controller"));
        viewFields.addAll(getOpcUaViewFields());
        ...
        FacilioView view = new FacilioView();
        view.setName("commissioned"+AgentConstants.OPC_UA_POINT_MODULE);
        view.setDisplayName("Commissioned OpcUa Points");
        view.setModuleName(AgentConstants.OPC_UA_POINT_MODULE);
        view.setFields(viewFields);
        view.setCriteria(criteria);
    ...
    private FacilioView getSubscribedOpcUaPointView(){
        List<ViewField>viewFields = new ArrayList<>();
        viewFields.add(new ViewField(AgentConstants.DISPLAY_NAME,"Display Name"));
        viewFields.add(new ViewField(AgentConstants.DEVICE_NAME, "Controller"));
        viewFields.add(new ViewField(AgentConstants.DESCRIPTION, "Description"));
        ...
        FacilioView view = new FacilioView();
        view.setName("subscribed"+AgentConstants.OPC_UA_POINT_MODULE);
        view.setDisplayName("Subscribed OpcUa Points");
        view.setModuleName(AgentConstants.OPC_UA_POINT_MODULE);
        view.setFields(viewFields);
        view.setCriteria(criteria);
    ...
    private List<ViewField> getOpcUaViewFields(){
        List<ViewField>viewFields = new ArrayList<>();
        viewFields.add(new ViewField(AgentConstants.NAMESPACE,"Name Space"));
        viewFields.add(new ViewField(AgentConstants.UA_POINT_IDENTIFIER, "Identifier"));
        return viewFields;
    }
