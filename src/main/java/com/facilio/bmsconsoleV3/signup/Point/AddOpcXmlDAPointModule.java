...
public class AddOpcXmlDAPointModule extends BaseModuleConfig {
    public AddOpcXmlDAPointModule() {
        setModuleName(AgentConstants.OPC_XML_DA_POINT_MODULE);
    }
    @Override
    public void addData() throws Exception {
        FacilioModule module = getOPCXmlDAPointModule();
    ...
    //6-opcxmlda
    private FacilioModule getOPCXmlDAPointModule() throws Exception{
        ModuleBean moduleBean = (ModuleBean) BeanFactory.lookup("ModuleBean");
        FacilioModule pointModule = moduleBean.getModule(AgentConstants.POINT);

        FacilioModule module = new FacilioModule(AgentConstants.OPC_XML_DA_POINT_MODULE,
                "OPCXMLDAPoint",
                "OPC_XML_DA_Point",
    ...
    public List<Map<String, Object>> getViewsAndGroups() {
        ...
        views.add(getUnconfiguredOpcXmlDaPointView().setOrder(order++));
        views.add(getConfiguredOpcXmlDaPointView().setOrder(order++));
        views.add(getCommissionedOpcXmlDaPointView().setOrder(order++));
        views.add(getSubscribedOpcXmlDaPointView().setOrder(order));

        groupDetails = new HashMap<>();
        groupDetails.put(AgentConstants.NAME, AgentConstants.OPC_XML_DA_POINT_MODULE+"View");
        groupDetails.put(AgentConstants.DISPLAY_NAME, "OpcXmlDa Point Views");
        groupDetails.put(FacilioConstants.ContextNames.MODULE_NAME, AgentConstants.OPC_XML_DA_POINT_MODULE);
    ...
    private FacilioView getUnconfiguredOpcXmlDaPointView(){
        ...
        criteria.addAndCondition(CriteriaAPI.getCondition("POINT_TYPE",AgentConstants.POINT_TYPE,String.valueOf(6), NumberOperators.EQUALS));
        ...
        view.setName("unconfigured"+AgentConstants.OPC_XML_DA_POINT_MODULE);
        view.setDisplayName("Unconfigured OpcXmlDa Points");
        view.setModuleName(AgentConstants.OPC_XML_DA_POINT_MODULE);
    ...
    private FacilioView getConfiguredOpcXmlDaPointView(){
        List<ViewField>viewFields = new ArrayList<>();
        viewFields.add(new ViewField(AgentConstants.DISPLAY_NAME,"Display Name"));
        viewFields.add(new ViewField(AgentConstants.DEVICE_NAME, "Controller"));
        viewFields.add(new ViewField(AgentConstants.DESCRIPTION, "Description"));
        ...
        FacilioView view = new FacilioView();
        view.setName("configured"+AgentConstants.OPC_XML_DA_POINT_MODULE);
        view.setDisplayName("Configured OpcXmlDa Points");
        view.setModuleName(AgentConstants.OPC_XML_DA_POINT_MODULE);
        view.setFields(viewFields);
        view.setCriteria(criteria);
    ...
    private FacilioView getCommissionedOpcXmlDaPointView(){
        List<ViewField>viewFields = new ArrayList<>();
        viewFields.add(new ViewField(AgentConstants.DISPLAY_NAME,"Display Name"));
        viewFields.add(new ViewField(AgentConstants.DEVICE_NAME, "Controller"));
        viewFields.add(new ViewField(AgentConstants.DATA_INTERVAL, "Interval"));
        ...
        FacilioView view = new FacilioView();
        view.setName("commissioned"+AgentConstants.OPC_XML_DA_POINT_MODULE);
        view.setDisplayName("Commissioned OpcXmlDa Points");
        view.setModuleName(AgentConstants.OPC_XML_DA_POINT_MODULE);
        view.setFields(viewFields);
        view.setCriteria(criteria);
    ...
    private FacilioView getSubscribedOpcXmlDaPointView(){
        List<ViewField>viewFields = new ArrayList<>();
        viewFields.add(new ViewField(AgentConstants.DISPLAY_NAME,"Display Name"));
        viewFields.add(new ViewField(AgentConstants.DEVICE_NAME, "Controller"));
        viewFields.add(new ViewField(AgentConstants.DESCRIPTION, "Description"));
        ...
        FacilioView view = new FacilioView();
        view.setName("subscribed"+AgentConstants.OPC_XML_DA_POINT_MODULE);
        view.setDisplayName("Subscribed OpcXmlDa Points");
        view.setModuleName(AgentConstants.OPC_XML_DA_POINT_MODULE);
        view.setFields(viewFields);
        view.setCriteria(criteria);
