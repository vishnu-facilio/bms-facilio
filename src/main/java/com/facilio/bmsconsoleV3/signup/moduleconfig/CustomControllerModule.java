...
public class CustomControllerModule extends BaseModuleConfig {
    public CustomControllerModule() throws Exception{
        setModuleName("customController");
    }
    ...
    public List<Map<String, Object>> getViewsAndGroups() {
        ...
        int order = 1;
        ArrayList<FacilioView> customController = new ArrayList<FacilioView>();
        customController.add(getCustomController().setOrder(order++));

        groupDetails = new HashMap<>();
        groupDetails.put("name", "systemviews");
        groupDetails.put("displayName", "System Views");
        groupDetails.put("moduleName", getModuleName());
        groupDetails.put("views", customController);
