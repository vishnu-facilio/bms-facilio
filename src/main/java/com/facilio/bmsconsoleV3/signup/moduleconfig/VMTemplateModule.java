...
public class VMTemplateModule extends BaseModuleConfig{
    ...
    private static List<PagesContext> getSystemPage() throws Exception {
        ...
        PagesContext vmTemplateUnPublishedPage = new PagesContext("virtualmetertemplateunpublishedpage", "Virtual Meter Template UnPublished Page", "VirtualMeterTemplate page in UnPublished state", getVMTemplateUnPublishedCriteria(), false, true, true)
                ...
                .addWidget("vmTemplateWidget", "VM Templates", PageWidget.WidgetType.SUMMARY_FIELDS_WIDGET, "flexiblewebsummaryfieldswidget_20", 0, 0, null, getSummaryWidgetDetails(vmTemplateModule.getName()))
                .widgetDone()
                .sectionDone()
                .addSection("vmTemplateReadingsSection", null, null)
                .addWidget("vmTemplateReadingsWidget", "List Of Readings", PageWidget.WidgetType.VIRTUAL_METER_TEMPLATE_READINGS, "flexiblewebvmtemplatereadings_30", 0, 0, null, null)
                .widgetDone()
                .sectionDone()
                .columnDone()
                .tabDone()
        ...
        PagesContext vmTemplatePublishedPage = new PagesContext("virtualmetertemplatepublishedpage", "Virtual Meter Template Published Page", "VirtualMeterTemplate page in Published state", getVMTemplatePublishedCriteria(), false, false, true)
                ...
                .addWidget("relatedVMWidget", "List Of Related VirtualMeters", PageWidget.WidgetType.RELATED_VIRTUAL_METERS_LIST, "flexiblewebrelatedvmlist_30", 0, 0, null, getSummaryWidgetDetails(vmTemplateModule.getName()))
                .widgetDone()
                .sectionDone()
                .columnDone()
                .tabDone()
