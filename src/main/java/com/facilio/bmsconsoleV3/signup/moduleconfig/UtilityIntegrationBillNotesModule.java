...
public class UtilityIntegrationBillNotesModule extends BaseModuleConfig{
    public UtilityIntegrationBillNotesModule() throws Exception {
        setModuleName(FacilioConstants.UTILITY_INTEGRATION_BILL_NOTES);
    }
    ...
    public void addData() throws Exception {
        ...
        FacilioModule UtilityIntegrationBillNotesModule = addNotesModule();
        modules.add(UtilityIntegrationBillNotesModule);
    ...
    public FacilioModule addNotesModule() throws Exception{
        ...
        FacilioModule module = new FacilioModule("utilityIntegrationBillNotes", "Utility Integration Bill Notes", "Utility_Integration_Bill_Notes", FacilioModule.ModuleType.NOTES);
    ...
    public List<FacilioForm> getModuleForms() throws Exception {
        ...
        FacilioModule notesModule = modBean.getModule(FacilioConstants.UTILITY_INTEGRATION_BILL_NOTES);

        FacilioForm notesForm = new FacilioForm();
        notesForm.setName("default_utilityBillNotes_web");
    ...
    public void addParentField() throws Exception {
        ...
        LookupField parentNote = new LookupField(moduleBean.getModule(FacilioConstants.UTILITY_INTEGRATION_BILL_NOTES), "parentNote", "Parent Note", FacilioField.FieldDisplayType.LOOKUP_SIMPLE, "PARENT_NOTE", FieldType.LOOKUP, false, false, true, null, "Parent Note", moduleBean.getModule(FacilioConstants.UTILITY_INTEGRATION_BILL_NOTES));
