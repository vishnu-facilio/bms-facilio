...
//        inventoryRequestModuleFormDefaultFields.add(new FormField("transactionType", FacilioField.FieldDisplayType.SELECTBOX, "Transaction Type", FormField.Required.REQUIRED, ++seqNum, 2));
    ...
    private static void addSystemButton() throws Exception{
        ...
        createButton.setName("New Inventory Request");
        ...
        SystemButtonApi.addSystemButton(FacilioConstants.ContextNames.INVENTORY_REQUEST,createButton);
        ...
        SystemButtonApi.addSystemButton(FacilioConstants.ContextNames.INVENTORY_REQUEST,listEditButton);
        ...
        SystemButtonApi.addSystemButton(FacilioConstants.ContextNames.INVENTORY_REQUEST,listDeleteButton);
        ...
        SystemButtonApi.addSystemButton(FacilioConstants.ContextNames.INVENTORY_REQUEST,exportAsCSVButton);
        ...
        SystemButtonApi.addSystemButton(FacilioConstants.ContextNames.INVENTORY_REQUEST,exportAsExcelButton);
