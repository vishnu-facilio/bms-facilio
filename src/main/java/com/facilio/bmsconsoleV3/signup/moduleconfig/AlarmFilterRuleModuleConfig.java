...
public class AlarmFilterRuleModuleConfig extends BaseModuleConfig {
    ...
    public static Map<String, List<PagesContext>> getSystemPagesMap(String moduleName) throws Exception {
        ...
        pageMap.put(app.getLinkName(), Arrays.asList(new PagesContext(null, null, "", null, true, false, false)
                ...
                .addWidget("alarmDefinition", "Alarm Definitions", PageWidget.WidgetType.RELATED_LIST, "relatedlistwidgetViewWidget-28*12", 0, 4, null, getSingleRelatedListForModule(modBean.getModule(AlarmFilterRuleModule.MODULE_NAME), "alarmFilterRuleCriteriaModule","alarmFilterRule"))
                .widgetDone()
                .sectionDone()
                .addSection("widgetGroup", null, null)
                .addWidget("widgetGroup", "Widget Group", PageWidget.WidgetType.WIDGET_GROUP, "flexiblewebwidgetgroup_20", 0, 8, null, getWidgetGroup())
                .widgetDone()
                .sectionDone()
                .columnDone()
                .tabDone()
