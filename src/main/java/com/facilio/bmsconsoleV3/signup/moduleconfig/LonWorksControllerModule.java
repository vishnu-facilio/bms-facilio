...
public class LonWorksControllerModule extends BaseModuleConfig {
    public LonWorksControllerModule() throws Exception{
        setModuleName("lonworkscontroller");
    }
    ...
    public List<Map<String, Object>> getViewsAndGroups() {
        ...
        int order = 1;
        ArrayList<FacilioView> lonworkscontroller = new ArrayList<FacilioView>();
        lonworkscontroller.add(getLonWorksController().setOrder(order++));

        groupDetails = new HashMap<>();
        groupDetails.put("name", "systemviews");
        groupDetails.put("displayName", "System Views");
        groupDetails.put("moduleName", getModuleName());
        groupDetails.put("views", lonworkscontroller);
