...
import com.facilio.bmsconsole.TemplatePages.ReadingRuleTemplatePage;
import com.facilio.bmsconsole.TemplatePages.SensorAlarmTemplatePage;
...
public class SensorRollUpAlarmModuleConfig extends BaseModuleConfig {
    @Override
    public Map<String, List<PagesContext>> fetchSystemPageConfigs() throws Exception {
        ...
        for (String appName : appNameList) {
            ...
            appNameVsPage.put(appName, Collections.singletonList(new SensorAlarmTemplatePage().getTemplatePage(app, module)));
        }
