...
public class ToolTypesModule extends BaseModuleConfig{
    ...
    private static void addSystemButtons() throws Exception {
        ...
        SystemButtonApi.addSystemButton(FacilioConstants.ContextNames.TOOL_TYPES,createButton);
        ...
        SystemButtonApi.addSystemButton(FacilioConstants.ContextNames.TOOL_TYPES,listEditButton);
        ...
        SystemButtonApi.addSystemButton(FacilioConstants.ContextNames.TOOL_TYPES,exportAsCSVButton);
        ...
        SystemButtonApi.addSystemButton(FacilioConstants.ContextNames.TOOL_TYPES,exportAsExcelButton);
    }
