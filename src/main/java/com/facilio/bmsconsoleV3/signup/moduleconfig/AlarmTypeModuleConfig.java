...
public class AlarmTypeModuleConfig extends BaseModuleConfig {
    public AlarmTypeModuleConfig(){
        setModuleName(AlarmTypeModule.MODULE_NAME);
    }
    ...
    public List<Map<String, Object>> getViewsAndGroups() throws Exception {
        ...
        groupDetails.put("moduleName", AlarmTypeModule.MODULE_NAME);
    ...
    private static FacilioView getAllView() throws Exception {
        ...
        sysCreatedTime.setModule(modBean.getModule(AlarmTypeModule.MODULE_NAME));

        FacilioView allView = new FacilioView();
        allView.setName("all");
        allView.setDisplayName("All Alarm Types");
        allView.setSortFields(Arrays.asList(new SortField(sysCreatedTime, false)));
        allView.setModuleName(AlarmTypeModule.MODULE_NAME);
    ...
    public List<FacilioForm> getModuleForms() throws Exception {
        ModuleBean modBean = (ModuleBean) BeanFactory.lookup("ModuleBean");
        FacilioModule module = modBean.getModule(AlarmTypeModule.MODULE_NAME);

        FacilioForm form = new FacilioForm();
        form.setDisplayName("Alarm Type");
        ...
        formFields.add(new FormField("description", FacilioField.FieldDisplayType.TEXTAREA, "Description", FormField.Required.OPTIONAL,3, 1));
    ...
    public static Map<String, List<PagesContext>> getSystemPagesMap(String moduleName) throws Exception {
        ...
        historyWidgetParam.put("activityModuleName", AddSubModuleRelations.ALARM_TYPE_ACTIVITY);
