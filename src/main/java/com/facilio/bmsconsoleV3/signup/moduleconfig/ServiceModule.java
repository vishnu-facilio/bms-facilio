...
public class ServiceModule extends BaseModuleConfig{
    ...
    private static void addSystemButtons() throws Exception {
        ...
        createButton.setName("New Service");
        ...
        SystemButtonApi.addSystemButton(FacilioConstants.ContextNames.SERVICE,createButton);
        ...
        SystemButtonApi.addSystemButton(FacilioConstants.ContextNames.SERVICE,listEditButton);
        ...
        SystemButtonApi.addSystemButton(FacilioConstants.ContextNames.SERVICE,exportAsCSVButton);
        ...
        SystemButtonApi.addSystemButton(FacilioConstants.ContextNames.SERVICE,exportAsExcelButton);
        ...
        SystemButtonApi.addSystemButton(FacilioConstants.ContextNames.SERVICE,listDeleteButton);
    }
