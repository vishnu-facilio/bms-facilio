...
//        employeeContactForm.setFields(employeeContactFormFields);
    ...
    private static List<PagesContext> createEmployeePage(ApplicationContext app, FacilioModule module, boolean isTemplate, boolean isDefault) throws Exception {
        ...
        return new ModulePages()
                ...
                .addWidget("employeeskillwidget", "Skill", PageWidget.WidgetType.SKILL, "flexiblewebskill_60", 0, 0, null, getSummaryWidgetDetails(FacilioConstants.ContextNames.EMPLOYEE))
                .widgetDone()
                .sectionDone()
                .columnDone()
                .tabDone()
                ...
                .addWidget("employeeworkschedulewidget", "Work Schedule", PageWidget.WidgetType.WORK_SCHEDULE, "flexiblewebworkschedule_60", 0, 0, null, getSummaryWidgetDetails(FacilioConstants.ContextNames.EMPLOYEE))
                .widgetDone()
                .sectionDone()
                .columnDone()
                .tabDone()
    ...
    private static JSONObject getHistoryWidgetGroup(boolean isMobile) throws Exception {
        ...
        WidgetGroupContext widgetGroup = new WidgetGroupContext()
                ...
                .addWidget("locationwidget", "Location", PageWidget.WidgetType.EMPLOYEE_LOCATION, isMobile ? "flexiblemobileattachment_8" : "flexiblewebactivity_60", 0, 0, null, null)
                .widgetGroupWidgetDone()
                .widgetGroupSectionDone();
