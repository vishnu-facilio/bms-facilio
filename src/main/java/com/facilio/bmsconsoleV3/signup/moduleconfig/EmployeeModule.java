...
//        employeeContactForm.setFields(employeeContactFormFields);
    ...
    private static List<PagesContext> createEmployeePage(ApplicationContext app, FacilioModule module, boolean isTemplate, boolean isDefault) throws Exception {
        ...
        return new ModulePages()
                ...
                .addWidget("employeeskillwidget", "Skill", PageWidget.WidgetType.SKILL, "flexiblewebskill_50", 0, 0, null, getSummaryWidgetDetails(FacilioConstants.ContextNames.EMPLOYEE))
                .widgetDone()
                .sectionDone()
                .columnDone()
                .tabDone()
                ...
                .addWidget("employeeworkschedulewidget", "Work Schedule", PageWidget.WidgetType.WORK_SCHEDULE, "flexiblewebworkschedule_50", 0, 0, null, getSummaryWidgetDetails(FacilioConstants.ContextNames.EMPLOYEE))
                .widgetDone()
                .sectionDone()
                .columnDone()
                .tabDone()
