...
public class AlarmDefinitionMappingModuleConfig extends BaseModuleConfig {
    public AlarmDefinitionMappingModuleConfig(){
        setModuleName(AlarmDefinitionMappingModule.MODULE_NAME);
    }
    ...
    private static FacilioView getAllView() throws Exception {
        ...
        sysCreatedTime.setModule(modBean.getModule(AlarmDefinitionMappingModule.MODULE_NAME));
        ...
        viewFields.add(new ViewField("regularExpression","Regular Expression"));
    ...
    public List<FacilioForm> getModuleForms() throws Exception {
        ...
        formFields.add(new FormField("regularExpression", FacilioField.FieldDisplayType.TEXTAREA, "Regular Expression", FormField.Required.REQUIRED,3, 1));
        formFields.add(new FormField("priority", FacilioField.FieldDisplayType.NUMBER, "Priority", FormField.Required.REQUIRED,4, 1));
        formFields.add(new FormField("client", FacilioField.FieldDisplayType.LOOKUP_SIMPLE, "Client", FormField.Required.REQUIRED,5, 1));
    ...
    public static Map<String, List<PagesContext>> getSystemPagesMap(String moduleName) throws Exception {
        ...
        historyWidgetParam.put("activityModuleName", AddSubModuleRelations.ALARM_DEFINITION_MAPPING_ACTIVITY);
    ...
    private static JSONObject getSummaryWidgetDetails(String moduleName, ApplicationContext app) throws Exception {
        ...
        FacilioField regularExpressionField = moduleBean.getField("regularExpression",moduleName);
        ...
        addSummaryFieldInWidgetGroup(widgetGroup, regularExpressionField, 2, 1, 4);
