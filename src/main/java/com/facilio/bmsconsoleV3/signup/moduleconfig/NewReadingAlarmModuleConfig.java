...
import com.facilio.bmsconsole.TemplatePages.ReadingAlarmTemplatePage;
...
public class NewReadingAlarmModuleConfig extends BaseModuleConfig {
    @Override
    public Map<String, List<PagesContext>> fetchSystemPageConfigs() throws Exception {
        ...
        for (String appName : appNameList) {
            ...
            appNameVsPage.put(appName, Collections.singletonList(new ReadingAlarmTemplatePage().getTemplatePage(app, module)));
        }
