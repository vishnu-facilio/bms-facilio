...
//        facilityCreationForm.setFields(facilityCreationFormFields);
    ...
    public static List<PagesContext> facilityModuleTemplatePage(ApplicationContext app, FacilioModule module, boolean isTemplate, boolean isDefault) throws Exception {
        ...
        return new ModulePages()
                ...
                .addWidget("summaryfieldswidget", "Facility Details", PageWidget.WidgetType.SUMMARY_FIELDS_WIDGET, "flexiblewebsummaryfieldswidget_5", 0, 0, null, getSummaryWidgetDetails(module.getName(), app))
                .widgetDone()
                .sectionDone()
                ...
                .addWidget("featureavailability", "Features available", PageWidget.WidgetType.FACILITY_FEATURES, "flexiblewebfacilityfeatures_3", 0, 0, null, null)
                .widgetDone()
                .sectionDone()
                .addSection("slotinformation", null, null)
                .addWidget("slotinformation", "Slot Information", PageWidget.WidgetType.FACILITY_SLOT_INFORMATION, "flexiblewebfacilityslotinformation_10", 0, 0, null, null)
                .widgetDone()
                .sectionDone()
                .addSection("specialavailability", null, null)
                .addWidget("specialavailability", "Special Availabilities", PageWidget.WidgetType.FACILITY_SPECIAL_AVAILABILITY, "flexiblewebfacilityspecialavalability_6", 0, 0, null, null)
                .widgetDone()
                .sectionDone()
                .columnDone()
                .tabDone()
    ...
    private static void addSystemButtons() throws Exception {
        ...
        createButton.setName("New Facility");
