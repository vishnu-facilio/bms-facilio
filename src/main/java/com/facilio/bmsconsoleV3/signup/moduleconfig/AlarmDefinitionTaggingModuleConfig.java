...
public class AlarmDefinitionTaggingModuleConfig extends BaseModuleConfig {
    public AlarmDefinitionTaggingModuleConfig(){
        setModuleName(AlarmDefinitionTaggingModule.MODULE_NAME);
    }
    ...
    public List<Map<String, Object>> getViewsAndGroups() throws Exception {
        ...
        groupDetails.put("moduleName", AlarmDefinitionTaggingModule.MODULE_NAME);
    ...
    private static FacilioView getAllView() throws Exception {
        ...
        sysCreatedTime.setModule(modBean.getModule(AlarmDefinitionTaggingModule.MODULE_NAME));
    ...
    public List<FacilioForm> getModuleForms() throws Exception {
        ...
        formFields.add(new FormField("alarmDefinition", FacilioField.FieldDisplayType.LOOKUP_SIMPLE, "Alarm Definition", FormField.Required.REQUIRED,3, 1));
        formFields.add(new FormField("alarmType", FacilioField.FieldDisplayType.LOOKUP_SIMPLE, "Alarm Type", FormField.Required.REQUIRED,4, 1));
        FormField controllerType = new FormField("controllerType", FacilioField.FieldDisplayType.SELECTBOX, "Controller Type", FormField.Required.REQUIRED,6, 1);
...
//        controllerType.setFilters(operator);
        formFields.add(controllerType);
        formFields.add(new FormField("alarmCategory", FacilioField.FieldDisplayType.LOOKUP_SIMPLE, "Alarm Category", FormField.Required.OPTIONAL,5, 1));
    ...
    public static Map<String, List<PagesContext>> getSystemPagesMap(String moduleName) throws Exception {
        ...
        historyWidgetParam.put("activityModuleName", AddSubModuleRelations.ALARM_DEFINITION_TAGGING_ACTIVITY);
    ...
    private static JSONObject getSummaryWidgetDetails(String moduleName, ApplicationContext app) throws Exception {
        ...
        FacilioField alarmTypeField = moduleBean.getField("alarmType",moduleName);
        FacilioField alarmCategoryField = moduleBean.getField("alarmCategory",moduleName);
        FacilioField controllerTypeField = moduleBean.getField("controllerType",moduleName);
        ...
        addSummaryFieldInWidgetGroup(widgetGroup, alarmDefinitionField, 1, 3, 1);
        addSummaryFieldInWidgetGroup(widgetGroup, alarmTypeField, 1, 4, 1);
        addSummaryFieldInWidgetGroup(widgetGroup, controllerTypeField, 2, 2, 1);
        addSummaryFieldInWidgetGroup(widgetGroup, alarmCategoryField, 2, 1, 1);
