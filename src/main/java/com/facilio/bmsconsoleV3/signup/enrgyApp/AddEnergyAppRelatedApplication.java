...
public class AddEnergyAppRelatedApplication extends FacilioCommand {
    ...
    public boolean executeCommand(Context context) throws Exception {
        List<String> energyAppRelatedApplications = Arrays.asList(FacilioConstants.ApplicationLinkNames.CLIENT_PORTAL_APP,FacilioConstants.ApplicationLinkNames.FACILIO_AGENT_APP,FacilioConstants.ApplicationLinkNames.DATA_LOADER_APP);
