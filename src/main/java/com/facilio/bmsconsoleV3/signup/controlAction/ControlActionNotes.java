...
public class ControlActionNotes extends BaseModuleConfig {
    public ControlActionNotes(){
        setModuleName(FacilioConstants.Control_Action.CONTROL_ACTION_NOTES_MODULE_NAME);
    }
    ...
    public FacilioModule addNotesModule() throws Exception{
        ...
        FacilioModule module = new FacilioModule(FacilioConstants.Control_Action.CONTROL_ACTION_NOTES_MODULE_NAME,
                "Control Action Notes", "Control_Action_Comment",
    ...
    public List<FacilioForm> getModuleForms() throws Exception {
        ...
        FacilioModule notesModule = modBean.getModule(FacilioConstants.Control_Action.CONTROL_ACTION_NOTES_MODULE_NAME);

        FacilioForm meterNotesForm = new FacilioForm();
        meterNotesForm.setName("default_controlActionNotes_web");
    ...
    public void addParentField() throws Exception {
        ...
        LookupField parentNote = new LookupField(moduleBean.getModule(FacilioConstants.Control_Action.CONTROL_ACTION_NOTES_MODULE_NAME), "parentNote", "Parent Note", FacilioField.FieldDisplayType.LOOKUP_SIMPLE, "PARENT_NOTE", FieldType.LOOKUP, false, false, true, null, "Parent Note", moduleBean.getModule(FacilioConstants.Control_Action.CONTROL_ACTION_NOTES_MODULE_NAME));
