...
public class ControlActionModule extends BaseModuleConfig {
    ...
    private List<PagesContext> getControlActionViewPage(ApplicationContext app, FacilioModule module) throws Exception {
        ...
        return new ModulePages()
                ...
                .addWidget("controlactionsummaryfieldswidget", "Control Action", PageWidget.WidgetType.SUMMARY_FIELDS_WIDGET, "flexiblewebsummaryfieldswidget_5", 0, 0, null, ControlActionPage.getSummaryWidgetDetails(FacilioConstants.Control_Action.CONTROL_ACTION_MODULE_NAME , app))
                .widgetDone()
                .sectionDone()
                .addSection("controlactionControlfields", null, null)
