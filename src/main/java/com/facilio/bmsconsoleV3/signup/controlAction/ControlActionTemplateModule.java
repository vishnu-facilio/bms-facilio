...
public class ControlActionTemplateModule extends BaseModuleConfig {
    ...
    private List<PagesContext> getControlActionViewPage(ApplicationContext app, FacilioModule module) throws Exception {
        ...
        return new ModulePages()
                ...
                .addWidget("controlactiontemplateControlfieldswidget", "Controls", PageWidget.WidgetType.BULK_RELATED_LIST, "fixedrelatedListwidgetViewWidget-28*12", 0, 0, null,ControlActionTemplatePage.fetchRelatedListForModule(module,FacilioConstants.Control_Action.ACTION_MODULE_NAME))
                .widgetDone()
                .sectionDone()
                .addSection("controlactiontemplateCriteriafields", null, null)
                .addWidget("controlactiontemplateassetcriteriafieldswidget", "Asset attribute criteria", PageWidget.WidgetType.CONRTOL_ACTION_CRITERIA, "webControlActionCriteriaViewWidget-28*6", 0, 0, ControlActionTemplatePage.getSummaryCriteriaListWidgetDetails(FacilioConstants.ContextNames.ASSET,"assetCriteriaId"),null)
                .widgetDone()
                .addWidget("controlactiontemplatesitecriteriafieldswidget", "Site attribute criteria", PageWidget.WidgetType.CONRTOL_ACTION_CRITERIA, "webControlActionCriteriaViewWidget-28*6", 6, 0, ControlActionTemplatePage.getSummaryCriteriaListWidgetDetails(FacilioConstants.ContextNames.SITE,"siteCriteriaId"),null)
                .widgetDone()
                .addWidget("controlactiontemplatecontrollercriteriafieldswidget", "Controller attribute criteria", PageWidget.WidgetType.CONRTOL_ACTION_CRITERIA, "webControlActionCriteriaViewWidget-28*6", 0, 28, ControlActionTemplatePage.getSummaryCriteriaListWidgetDetails("controllers","controllerCriteriaId"),null)
                .widgetDone()
                .addWidget("controlactiontemplatecommentsfieldswidget", "Comments", PageWidget.WidgetType.COMMENT, "fixedwebwidget_28*6", 6, 28, null,null)
                .widgetDone()
                .sectionDone()
                .columnDone()
                .tabDone()
