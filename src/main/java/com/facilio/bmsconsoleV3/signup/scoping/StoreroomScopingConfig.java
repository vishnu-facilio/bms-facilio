...
public class StoreroomScopingConfig  extends SignUpData {
    @Override
    public void addData() {
        try {
            ...
            Condition maintenance_condition = CriteriaAPI.getCondition("owner", "com.facilio.modules.UserValueGenerator", ScopeOperator.SCOPING_IS);
