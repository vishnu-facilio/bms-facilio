...
public class FacilityScopingConfig extends SignUpData {
    @Override
    public void addData() throws Exception {
        try {
            ...
            condition.setModuleName(facilityModule.getName());
            criteria.addAndCondition(condition);
            scoping.setScopingId(applicationScopingId);
            scoping.setModuleId(facilityModule.getModuleId());
            ...
            maintenance_condition.setModuleName(facilityModule.getName());
            maintenance_criteria.addAndCondition(maintenance_condition);
            maintenance_scoping.setScopingId(maintenanceScopingId);
            maintenance_scoping.setModuleId(facilityModule.getModuleId());
