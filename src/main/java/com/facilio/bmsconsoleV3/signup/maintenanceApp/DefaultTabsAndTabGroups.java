...
public class DefaultTabsAndTabGroups {
    ...
    public List<WebTabGroupContext> getWebTabGroups(long appId,long layoutId) throws Exception {
        ...
        List<WebTabGroupContext> webTabGroups = Arrays.asList(
            ...
            new WebTabGroupContext(Arrays.asList(tabsMap.get("workorder"),tabsMap.get("preventive-maintenance"),tabsMap.get("calendar"),tabsMap.get("workorderreport")), "Maintenance", "maintenance", 0, 4, 1l,layoutId,IconType.maintenance),
