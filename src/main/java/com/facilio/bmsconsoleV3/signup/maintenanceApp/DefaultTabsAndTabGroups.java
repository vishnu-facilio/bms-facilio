...
public class DefaultTabsAndTabGroups {
    ...
    private Map<String, WebTabContext> getWebTabs(long appId) throws Exception {
        ...
        List<WebTabContext> tabs = Arrays.asList(
            ...
            new WebTabContext("Reports", "purchasereports", WebTabContext.Type.REPORT, getModuleIdsListFromModuleNames(Arrays.asList(FacilioConstants.ContextNames.PURCHASE_REQUEST,FacilioConstants.ContextNames.PURCHASE_ORDER,FacilioConstants.ContextNames.RECEIVABLE,FacilioConstants.ContextNames.TERMS_AND_CONDITIONS)), "{\"type\": \"module_reports\"}", 56,null,appId),
            ...
            new WebTabContext("Service Catalog","servicecatalog",WebTabContext.Type.CUSTOM,getModuleIdsListFromModuleNames(Arrays.asList(FacilioConstants.ContextNames.SERVICE_REQUEST)), "{\"type\": \"serviceCatalog\"}", 31,null,appId),
    ...
    public List<WebTabGroupContext> getWebTabGroups(long appId,long layoutId) throws Exception {
        ...
        List<WebTabGroupContext> webTabGroups = Arrays.asList(
            new WebTabGroupContext(Arrays.asList(tabsMap.get("dashboard"),tabsMap.get("portfolio"),tabsMap.get("approval"),tabsMap.get("kpi")), "Home", "home", 1, 1, null,layoutId),
            new WebTabGroupContext(Arrays.asList(tabsMap.get("assets"),tabsMap.get("assetreport")), "Asset", "asset", 6, 2, 4l,layoutId),
            new WebTabGroupContext(Arrays.asList(tabsMap.get("storeroom"),tabsMap.get("itemtypes"),tabsMap.get("items"),tabsMap.get("tooltypes"),tabsMap.get("tools"),tabsMap.get("inventoryrequests"),tabsMap.get("transferrequests"),tabsMap.get("shipments"),tabsMap.get("service"),tabsMap.get("labour"),tabsMap.get("inventoryreports")), "Inventory", "inventory", 27, 3, 14l,layoutId),
            new WebTabGroupContext(Arrays.asList(tabsMap.get("workorder"),tabsMap.get("preventivemaintenance"),tabsMap.get("calender"),tabsMap.get("workorderreport")), "Maintenance", "maintenance", 0, 3, 1l,layoutId),
            new WebTabGroupContext(Arrays.asList(tabsMap.get("inspection"),tabsMap.get("inspectiontemplates"),tabsMap.get("inspectionreport")), "Inspection", "inspection", 34, 3, 54l,layoutId),
            new WebTabGroupContext(Arrays.asList(tabsMap.get("purchaserequest"),tabsMap.get("purchaseorder"),tabsMap.get("receivables"),tabsMap.get("termsandconditions"),tabsMap.get("purchasereports")), "Purchase", "purchase", 25, 4, 56l,layoutId),
            ...
            new WebTabGroupContext(Arrays.asList(tabsMap.get("tenants"),tabsMap.get("tenantcontact"),tabsMap.get("tenantunit"),tabsMap.get("quote"),tabsMap.get("tenantreports")), "Tenant", "tenant", 12, 6, 16l,layoutId),
            new WebTabGroupContext(Arrays.asList(tabsMap.get("vendors"),tabsMap.get("vendorcontact"),tabsMap.get("certificateofinsurance"),tabsMap.get("vendorreports")), "Vendor", "vendor", 26, 7, 57l,layoutId),
            ...
            new WebTabGroupContext(Arrays.asList(tabsMap.get("servicerequest"),tabsMap.get("servicecatalog"),tabsMap.get("contactdirectory"),tabsMap.get("documents"),tabsMap.get("servicereport")), "Service", "service", 8, 10, 31l,layoutId),
