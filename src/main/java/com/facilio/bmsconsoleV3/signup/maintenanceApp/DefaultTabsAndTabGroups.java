...
//            new WebTabContext("Reports", "clientreports", WebTabContext.Type.REPORT, getModuleIdsListFromModuleNames(Arrays.asList(FacilioConstants.ContextNames.CLIENT,FacilioConstants.ContextNames.CLIENT_CONTACT)), "{\"type\": \"module_reports\"}", 33,null,appId),
    ...
    public List<WebTabGroupContext> getWebTabGroups(long appId,long layoutId) throws Exception {
        ...
        List<WebTabGroupContext> webTabGroups = Arrays.asList(
            ...
            new WebTabGroupContext(Arrays.asList(tabsMap.get("assets")), "Asset", "asset", 6, 2, 4l,layoutId,IconType.asset),
            new WebTabGroupContext(Arrays.asList(tabsMap.get("storeroom"),tabsMap.get("itemtypes"),tabsMap.get("items"),tabsMap.get("tooltypes"),tabsMap.get("tools"),tabsMap.get("inventoryrequests")), "Inventory", "inventory", 27, 3, 14l,layoutId,IconType.inventory),
            ...
            new WebTabGroupContext(Arrays.asList(tabsMap.get("workorder"),tabsMap.get("planned-maintenance")), "Maintenance", "maintenance", 0, 4, 1l,layoutId,IconType.maintenance),
            ...
            new WebTabGroupContext(Arrays.asList(tabsMap.get("servicerequest"),tabsMap.get("servicecatalog"),tabsMap.get("contactdirectory"),tabsMap.get("documents")), "Help Center", "helpcenter", 8, 6, 31l,layoutId,IconType.service_request),
