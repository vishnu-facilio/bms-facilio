...
public class DefaultJobsOnSignUp extends SignUpData {
    ...
    public void addData() throws Exception {
        ...
        // INSERT INTO ${publicDb}.Jobs (JOBID, ORGID, JOBNAME, IS_ACTIVE, IS_PERIODIC, PERIOD, NEXT_EXECUTION_TIME, EXECUTOR_NAME, STATUS, JOB_SERVER_ID, TRANSACTION_TIMEOUT, CURRENT_EXECUTION_TIME) VALUES (@ASSET_SCHEDULE_EXPIRY_RULEID, ${orgId}, 'ScheduledRuleExecution', true, true, 1800, UNIX_TIMESTAMP()+300,'facilio', 3, 0, 900000, UNIX_TIMESTAMP()*1000);
        // Shaan
        ...
        FacilioTimer.schedulePeriodicJob(orgId, "ScheduledFormulaCalculator", 900, 900, "facilio");
        ...
        // INSERT INTO ${publicDb}.Jobs (JOBID, ORGID, JOBNAME, IS_ACTIVE, IS_PERIODIC, PERIOD, NEXT_EXECUTION_TIME, EXECUTOR_NAME, STATUS, JOB_SERVER_ID, TRANSACTION_TIMEOUT, CURRENT_EXECUTION_TIME)
        // VALUES (${orgId}, ${orgId}, 'ScheduleInspectionStatusChange', true, true, 1800, UNIX_TIMESTAMP()+1800,'facilio', 3, 0, 300000, UNIX_TIMESTAMP()*1000);
        FacilioTimer.schedulePeriodicJob(orgId, "ScheduleInspectionStatusChange", 1800, 1800, "facilio");

        // INSERT INTO ${publicDb}.Jobs (JOBID, ORGID, JOBNAME, IS_ACTIVE, IS_PERIODIC, SCHEDULE_INFO, NEXT_EXECUTION_TIME, EXECUTOR_NAME, STATUS, JOB_SERVER_ID, TRANSACTION_TIMEOUT, CURRENT_EXECUTION_TIME)
        // VALUES (4, ${orgId}, 'BaseSchedulerJob', true, true, '{"times":["00:00"],"frequencyType":1,"frequencyTypeEnum":"DAILY"}', UNIX_TIMESTAMP()+30,'facilio', 3, 0, 600000, UNIX_TIMESTAMP()*1000);
        FacilioTimer.scheduleCalendarJob(orgId, "BaseSchedulerJob", System.currentTimeMillis(), constructDailyScheduleInfoWithOneTime("00:00"), "facilio");
        ...
        // INSERT INTO ${publicDb}.Jobs (JOBID, ORGID, JOBNAME, IS_ACTIVE, IS_PERIODIC, PERIOD, NEXT_EXECUTION_TIME, EXECUTOR_NAME, STATUS, JOB_SERVER_ID, TRANSACTION_TIMEOUT, CURRENT_EXECUTION_TIME)
        // VALUES (${orgId}, ${orgId}, 'getVerifiedEmailAddressFromAWS', true, true, 300, UNIX_TIMESTAMP()+300,'facilio', 3, 0, 900000, UNIX_TIMESTAMP()*1000);
        FacilioTimer.schedulePeriodicJob(orgId, "getVerifiedEmailAddressFromAWS", 300, 300, "facilio");
    }
}
