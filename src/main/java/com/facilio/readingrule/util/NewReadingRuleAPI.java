...
//                updateFaultImpact(readingRule);
    ...
    public static List<PagesContext> getNewReadingRuleSystemPage(ApplicationContext app,  boolean isTemplate, boolean isDefault) throws Exception {
        ...
        PagesContext ruleTemplatePage = new PagesContext(pageName, pageDisplayName, "", null, isTemplate, isDefault, false)
                ...
                .addWidget("ruleDetails", "Rule Details", PageWidget.WidgetType.SUMMARY_FIELDS_WIDGET, "flexiblewebsummaryfieldswidget_11", 0, 0, null, getSummaryWidgetDetails(FacilioConstants.ReadingRules.NEW_READING_RULE, app))
                .widgetDone()
                .sectionDone()
