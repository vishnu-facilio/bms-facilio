...
public class FetchServiceAppointmentListCommand extends FacilioCommand {
    ...
    public boolean executeCommand(Context context) throws Exception {
        ...
        List<String> defaultFieldNames = new ArrayList<>(Arrays.asList("name","location","site","priority","responseDueStatus","resolutionDueStatus","scheduledStartTime","scheduledEndTime"));
        ...
        if(boardId != null && boardId > 0) {
            ...
            if (CollectionUtils.isEmpty(selectFields)) {
                selectFields = moduleBean.getAllFields(FacilioConstants.ServiceAppointment.SERVICE_APPOINTMENT);
            }
