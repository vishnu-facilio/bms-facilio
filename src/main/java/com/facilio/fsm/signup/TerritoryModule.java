...
public class TerritoryModule extends BaseModuleConfig {
    ...
    private static List<PagesContext> createTerritoryPage(ApplicationContext app, FacilioModule module, boolean isTemplate, boolean isDefault) throws Exception {
        ...
        return new ModulePages()
                ...
                .addWidget("territorySummaryFieldsWidget", "Territory Details", PageWidget.WidgetType.SUMMARY_FIELDS_WIDGET, "flexiblewebsummaryfieldswidget_5", 0, 0, null, getSummaryWidgetDetails(app,FacilioConstants.Territory.TERRITORY))
                .widgetDone()
                .sectionDone()
                .addSection("territoryGeography", null, null)
                .addWidget("territoryGeographyWidget", "Geography", PageWidget.WidgetType.GEOGRAPHY, "webGeography_5_6", 0, 0, null, null)
                .widgetDone()
                .sectionDone()
                .columnDone()
                .tabDone()
                ...
                .addWidget("sites", "Sites", PageWidget.WidgetType.TERRITORY_SITES, "flexibleSites_10", 0, 0, null, null)
                .widgetDone()
                .sectionDone()
                .columnDone()
                .tabDone()
                ...
                .addWidget("fieldAgents", "Field Agents", PageWidget.WidgetType.FIELD_AGENTS, "flexibleFieldAgents_10", 0, 0, null, null)
                .widgetDone()
                .sectionDone()
                .columnDone()
                .tabDone()
