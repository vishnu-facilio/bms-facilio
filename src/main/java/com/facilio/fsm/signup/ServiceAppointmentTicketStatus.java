...
public class ServiceAppointmentTicketStatus extends BaseModuleConfig {
    ...
    private void addServiceAppointmentTicketStatus() throws Exception {
        ...
        FacilioModule serviceAppointmentTicketStatus = new FacilioModule(FacilioConstants.ServiceAppointment.SERVICE_APPOINTMENT_TICKET_STATUS,"Service Appointment Ticket Status","ServiceAppointment_TicketStatus", FacilioModule.ModuleType.PICK_LIST,true);
