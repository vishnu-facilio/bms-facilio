...
INSERT INTO Event_Property (ORGID,HASEVENTRULE,HASMAPPINGRULE) values (${orgId}, true, false);

INSERT INTO Criteria (ORGID, PATTERN) VALUES (${orgId}, '1');
SET @CRITERIA_ID := (SELECT LAST_INSERT_ID());

INSERT INTO Conditions (PARENT_CRITERIA_ID, SEQUENCE, FIELD_NAME, COLUMN_NAME, OPERATOR, VAL) VALUES (@CRITERIA_ID, 1, 'severity', 'Event.SEVERITY', 3, 'Clear');

INSERT INTO Event_Rule (ORGID,HASEVENTFILTER,FILTER_CRITERIAID) values (${orgId}, true, @CRITERIA_ID);