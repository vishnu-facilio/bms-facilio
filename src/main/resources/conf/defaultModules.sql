...
INSERT INTO Fields (ORGID, MODULEID, NAME, DISPLAY_NAME, DISPLAY_TYPE, COLUMN_NAME, DATA_TYPE, REQUIRED, DISABLED, IS_DEFAULT) VALUES (${orgId}, @TICKET_MODULE_ID, 'sourceType', 'Type', 9, 'SOURCE_TYPE', 2, false, false, true);
INSERT INTO Fields (ORGID, MODULEID, NAME, DISPLAY_NAME, DISPLAY_TYPE, COLUMN_NAME, DATA_TYPE, REQUIRED, DISABLED, IS_DEFAULT) VALUES (${orgId}, @TICKET_MODULE_ID, 'assignmentGroup', 'Assignment Group', 11, 'ASSIGNMENT_GROUP_ID', 7, true, false, true);
