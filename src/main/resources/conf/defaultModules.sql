...
INSERT INTO Fields (ORGID, MODULEID, NAME, DISPLAY_NAME, DISPLAY_TYPE, COLUMN_NAME, DATA_TYPE, REQUIRED, DISABLED, IS_DEFAULT) VALUES (${orgId}, @TICKET_MODULE_ID, 'sourceType', 'Source Type', 9, 'SOURCE_TYPE', 3, false, false, true);
...
INSERT INTO Modules (ORGID, NAME, DISPLAY_NAME, TABLE_NAME) VALUES (${orgId}, 'workorderrequest', 'Work Order Requests', 'WorkOrderRequests');
...
INSERT INTO LookupFields (FIELDID, SPECIAL_TYPE) VALUES ((SELECT LAST_INSERT_ID()), 'requester');
INSERT INTO Fields (ORGID, MODULEID, NAME, DISPLAY_NAME, DISPLAY_TYPE, COLUMN_NAME, DATA_TYPE, REQUIRED, DISABLED, IS_DEFAULT) VALUES (${orgId}, @WORK_ORDER_REQUEST_MODULE_ID, 'urgency', 'Urgency', 9, 'URGENCY', 3, false, false, true);
...
INSERT INTO Modules (ORGID, NAME, DISPLAY_NAME, TABLE_NAME) VALUES (${orgId}, 'alarm', 'Alarms', 'Alarms');
...
INSERT INTO Fields (ORGID, MODULEID, NAME, DISPLAY_NAME, DISPLAY_TYPE, COLUMN_NAME, DATA_TYPE, REQUIRED, DISABLED, IS_DEFAULT) VALUES (${orgId}, @ALARM_MODULE_ID, 'status', 'Status', 9, 'STATUS', 3, false, false, true);
INSERT INTO Fields (ORGID, MODULEID, NAME, DISPLAY_NAME, DISPLAY_TYPE, COLUMN_NAME, DATA_TYPE, REQUIRED, DISABLED, IS_DEFAULT) VALUES (${orgId}, @ALARM_MODULE_ID, 'type', 'Type', 9, 'ALARM_TYPE', 3, false, false, true);
