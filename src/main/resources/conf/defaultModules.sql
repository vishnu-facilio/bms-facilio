...
INSERT INTO Event (ORGID, MODULEID, EVENT_TYPE) VALUES (${orgId}, @TICKET_MODULE_ID, 32);
...
INSERT INTO Action (ORGID, ACTION_TYPE, TEMPLATE_TYPE) VALUES (${orgId}, 1, 4);
SET @SEND_EMAIL_ACTION_ID := (SELECT LAST_INSERT_ID());
INSERT INTO Workflow_Rule_Action (WORKFLOW_RULE_ID, ACTION_ID) VALUES (@TICKET_COMMENT_WORKFLOW_RULE_ID, @SEND_EMAIL_ACTION_ID);

INSERT INTO Event (ORGID, MODULEID, EVENT_TYPE) VALUES (${orgId}, @ALARM_MODULE_ID, 1);
...
INSERT INTO Action (ORGID, ACTION_TYPE, TEMPLATE_TYPE) VALUES (${orgId}, 3, 5);
...
SET @ADD_ALARM_WORKFLOW_RULE_ID := (SELECT LAST_INSERT_ID());
INSERT INTO Action (ORGID, ACTION_TYPE, TEMPLATE_TYPE) VALUES (${orgId}, 4, 6);
