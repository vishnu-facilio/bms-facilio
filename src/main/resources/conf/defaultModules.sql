...
INSERT INTO Conditions (PARENT_CRITERIA_ID, SEQUENCE, FIELDID, OPERATOR, CRITERIA_VAL_ID) VALUES (@MY_WORKORDER_CRITERIA_ID, 1, 'lookup', @WORK_ORDER_TICKET_FIELD_ID, @MY_TICKET_CRITERIA_ID);
