...
INSERT INTO TicketStatus (ORGID, MODULEID, STATUS, STATUS_TYPE) VALUES (${orgId}, @TICKET_STATUS_MODULE_ID, 'Ready', 1);
...
INSERT INTO TicketStatus (ORGID, MODULEID, STATUS, STATUS_TYPE) VALUES (${orgId}, @TICKET_STATUS_MODULE_ID, 'Complete', 4);
...
INSERT INTO Fields (ORGID, MODULEID, NAME, DISPLAY_NAME, DISPLAY_TYPE, COLUMN_NAME, DATA_TYPE, REQUIRED, DISABLED, IS_DEFAULT) VALUES (${orgId}, @WORK_ORDER_MODULE_ID, 'requesterId', 'Requester', 10, 'REQUESTER_ID', 7, false, false, true);
...
INSERT INTO Workflow_Rule (ORGID, NAME, DESCRIPTION, EVENT_ID, EXECUTION_ORDER, STATUS, RULE_TYPE) VALUES (${orgId}, 'Assign Workorder', 'Assign Workorder', @EVENT_ID, 1, true, 1);
SET @WORKFLOW_RULE_ID := (SELECT LAST_INSERT_ID());

INSERT INTO Action (ORGID, ACTION_TYPE, TEMPLATE_TYPE) VALUES (${orgId}, 1, 1);
SET @ACTION_ID := (SELECT LAST_INSERT_ID());

INSERT INTO Workflow_Rule_Action (WORKFLOW_RULE_ID, ACTION_ID) VALUES (@WORKFLOW_RULE_ID, @ACTION_ID);
...
-- INSERT INTO LookupFields (FIELDID, LOOKUP_MODULE_ID) VALUES ((SELECT LAST_INSERT_ID()), @TASK_STATUS_MODULE_ID);
-- INSERT INTO Fields (ORGID, MODULEID, NAME, DISPLAY_NAME, DISPLAY_TYPE, COLUMN_NAME, DATA_TYPE, REQUIRED, DISABLED, IS_DEFAULT) VALUES (${orgId}, @TASK_MODULE_ID, 'assignmentGroup', 'Assignment Group', 11, 'ASSIGNMENT_GROUP_ID', 7, true, false, true);
-- INSERT INTO LookupFields (FIELDID, SPECIAL_TYPE) VALUES ((SELECT LAST_INSERT_ID()), 'groups');
