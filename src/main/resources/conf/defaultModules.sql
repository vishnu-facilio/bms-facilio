...
INSERT INTO Fields (ORGID, MODULEID, NAME, DISPLAY_NAME, DISPLAY_TYPE, COLUMN_NAME, DATA_TYPE, REQUIRED, DISABLED, IS_DEFAULT) VALUES (${orgId}, @SPACE_MODULE_ID, 'spaceCategory', 'Space Category', 10, 'SPACE_CATEGORY_ID', 7, false, false, true);
