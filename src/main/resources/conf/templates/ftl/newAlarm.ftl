                                                                                    ...
                                                                                    <tr>
                                                                                          <td>
                                                                                                ...
                                                                                                <div style="font-size: 13px; font-weight: normal; font-style: normal; font-stretch: normal; line-height: 1.53; letter-spacing: 0.4px; color: #78787f;font-family:Ubuntu, Helvetica,Arial, sans-serif,Times New Roman, Times, serif;padding-top: 15px;">
                                                                                                      A new <span style="font-size: 13px; font-weight: normal; font-style: normal; font-stretch: normal; line-height: 1.53; letter-spacing: 0.4px; color: #f66969;font-family:Ubuntu, Helvetica,Arial, sans-serif,Times New Roman, Times, serif;">${(alarm.severityString)!}</span>
                                                                                                      alarm has been
                                                                                                      generated.
                                                                                                </div>
                                                                                          </td>
                                                                  ...
                                                                  <td style="word-wrap:break-word;font-size:0px;padding: 0 40px;"
                                                                        ...
                                                                        <div>
                                                                              <table role="presentation" cellpadding="0"
                                                                                    ...
                                                                                    <tbody>
                                                                                          <tr>
                                                                                                <td style="width: 3%;"><div style="width: 10px; height: 10px; background-color: #f66969;border-radius: 100%;display: inline-block;margin-right: 10px;"></div></td>
