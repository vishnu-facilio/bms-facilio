...
<body style="background: #fafafa;">
      ...
      <div style="max-width:700px;margin: 0 auto;padding-top: 50px;padding-bottom: 50px;">
            <div style="margin:20px auto 0;max-width:700px;padding-left: 0;padding-right: 0;background-color:#FFFFFF;padding-bottom: 50px;box-shadow: 0 1px 15px 0 rgba(0, 0, 0, 0.05); border: solid 1px rgba(0, 0, 0, 0.08);">
                                                                                    ...
                                                                                    <tr>
                                                                                          <td>
                                                                                                ...
                                                                                                <div style="font-size: 13px; font-weight: normal; font-style: normal; font-stretch: normal; line-height: 1.53; letter-spacing: 0.4px; color: #78787f;font-family:Ubuntu, Helvetica,Arial, sans-serif,Times New Roman, Times, serif;padding-top: 15px;">
                                                                                                      Alarm generated hasn't been acknowledged yet.
                                                                                                </div>
                                                                                          </td>
                                                                                    </tr>
                                                                              </tbody>
                  ...
                  <table cellpadding="0" cellspacing="0" style="font-size:0px;width:100%;min-width:100%;max-width:100%;margin-left: 50px;margin-right: 50px;margin-top: 25px;margin-bottom: 30px;"
                        border="0">
                        <tbody>
                              ...
                              <tr>
                                    ...
                                    <td>
                                          ...
                                          <div style="font-size: 13px; font-weight: 600; font-style: normal; font-stretch: normal; line-height: normal; letter-spacing: 0.4px; color: #372668;font-family:Ubuntu, Helvetica,Arial, sans-serif,Times New Roman, Times, serif;padding-top: 5px;">
                                                <span style="font-weight: 600;">${alarm.readingVal!}
                  ...
                  <table cellpadding="0" cellspacing="0" style="font-size:0px;width:100%;min-width:100%;max-width:100%;margin-left: 50px;margin-right: 50px;"
                        border="0">
                        <tbody>
                              <#if alarm.possibleCauses??>
                              <tr>
                                    <td style="padding-top: 0;">
                                          <div style="font-size: 14px; font-weight: bold; font-style: normal; font-stretch: normal; line-height: normal; letter-spacing: 0.5px; color: #252528;font-family:Ubuntu, Helvetica,Arial, sans-serif,Times New Roman, Times, serif;padding-bottom: 10px;">Possible
                                                Cause:</div>
                                          <div style="font-size: 13px; font-weight: normal; font-style: normal; font-stretch: normal; line-height: 1.53; letter-spacing: 0.4px; color: #78787f;font-family:Ubuntu, Helvetica,Arial, sans-serif,Times New Roman, Times, serif;max-width: 530px;width: 530px;padding-top: 10px; padding-bottom: 10px;">
                                                ${alarm.possibleCauses}
                                          </div>
                                    </td>
                              </tr>
                              </#if>
                              <#if alarm.recommendation??>
                              <tr>
                                    <td style="padding-top: 20px;">
                                          <div style="font-size: 14px; font-weight: bold; font-style: normal; font-stretch: normal; line-height: normal; letter-spacing: 0.5px; color: #252528;font-family:Ubuntu, Helvetica,Arial, sans-serif,Times New Roman, Times, serif;padding-bottom: 10px;">Suggestion:</div>
                                          <div style="font-size: 14px; font-weight: normal; font-style: normal; font-stretch: normal; line-height: 1.53; letter-spacing: 0.4px; color: #78787f;font-family:Ubuntu, Helvetica,Arial, sans-serif,Times New Roman, Times, serif;max-width: 530px;width: 530px;padding-top: 10px; padding-bottom: 10px;">
