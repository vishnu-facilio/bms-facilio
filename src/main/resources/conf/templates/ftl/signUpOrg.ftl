...
<body style="background: #fafafa;">
      <div style="max-width:700px;margin: 0 auto;display: block;padding-top: 20px;padding-bottom: 30px;padding-left: 20px;padding-right: 20px;">
                              ...
                              <td>
                                    <div class="td-width-mobile" style="padding-right: 30px;">
                                        ...
                                        <div style="padding-top: 16px;font-size: 14px; font-weight: 400; font-style: normal; font-stretch: normal; line-height: 20px; letter-spacing: 0.4px; color: #324056;font-family:'Open Sans',Ubuntu, Helvetica,Arial, sans-serif,Times New Roman, Times, serif;max-width: 550px;">
                                          ...
                                          We're glad you're a part of it. You can check us out <a href="${brand.url}" style="text-decoration: none;padding-left: 5px;font-size: 14px; font-weight: 500; font-style: normal; font-stretch: normal; line-height: 20px; letter-spacing: 0.4px; color: #396dc2;font-family:'Open Sans',Ubuntu, Helvetica,Arial, sans-serif,Times New Roman, Times, serif;">here.</a>
                                          </div>
                                          ...
                                          <div style="padding-top: 10px;font-size: 14px; font-weight: 400; font-style: normal; font-stretch: normal; line-height: 1.53; letter-spacing: 0.4px; color: #324056;font-family:'Open Sans',Ubuntu, Helvetica,Arial, sans-serif,Times New Roman, Times, serif;max-width: 550px;">
                                           If the button does not work, copy and paste the link below into a new 
                                           browser window.
                                          </div>
                                          ...
                                          <div style="font-size: 14px; font-weight: 400; font-style: normal; font-stretch: normal; line-height: 1.53; letter-spacing: 0.4px; color: #324056;font-family:'Open Sans',Ubuntu, Helvetica,Arial, sans-serif,Times New Roman, Times, serif;max-width: 550px;">
            ...
            <div style="font-size: 11px; font-weight: normal; font-style: normal; font-stretch: normal; line-height: normal; letter-spacing: 0.28px; text-align: center; color: #8e8c97;font-family:'Open Sans',Ubuntu, Helvetica,Arial, sans-serif,Times New Roman, Times, serif;">&copy; 2019 <a href="${brand.url}" style="padding-left: 5px;font-size: 11px; font-weight: 500; font-style: normal; font-stretch: normal; line-height: 20px; letter-spacing: 0.5px; color: #396dc2;font-family:'Open Sans',Ubuntu, Helvetica,Arial, sans-serif,Times New Roman, Times, serif;text-decoration: none;">${brand.url}</a> | ALL RIGHTS RESERVED</div>
            </div>
      </div>
</body>
