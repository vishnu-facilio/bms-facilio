...
CREATE TABLE IF NOT EXISTS  FacilioAuditAction_1(
	...
	CONSTRAINT FK_AuditAction_1 FOREIGN KEY (MODULE_ID) REFERENCES FacilioAuditModule(ID)
);
...
CREATE TABLE IF NOT EXISTS  FacilioAuditMethod_1(
	...
	CONSTRAINT FK_AuditMethod_1 FOREIGN KEY (ACTION_ID) REFERENCES FacilioAuditAction(MODULE_ID)
);
