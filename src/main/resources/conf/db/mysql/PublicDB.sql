...
CREATE INDEX INSTANTJOBQUEUE_DELETED_TIME ON InstantJobQueue (DELETED_TIME);
...
CREATE INDEX RULEINSTANTJOBQUEUE_DELETED_TIME ON RuleInstantJobQueue (DELETED_TIME);
...
CREATE INDEX READINGDATAMIGINSTANTJOBQUEUE_DELETED_TIME ON ReadingDataMigrationInstantJobQueue (DELETED_TIME);
