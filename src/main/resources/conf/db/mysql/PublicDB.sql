...
CREATE TABLE IF NOT EXISTS Secret_File (
 ...
 CREATE TABLE IF NOT EXISTS Account_User_Apps (
  ...
  CREATE TABLE IF NOT EXISTS Account_User_Apps_Orgs (
    ID BIGINT,
    ORGID BIGINT NOT NULL,
    CONSTRAINT FK_Account_User_Apps_Orgs_Id FOREIGN KEY (ID) REFERENCES Account_User_Apps(ID),
    CONSTRAINT FK_Account_User_Apps_Orgs_orgid FOREIGN KEY (ORGID) REFERENCES Organizations(ID)
   );
