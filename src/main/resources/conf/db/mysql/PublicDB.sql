...
CREATE TABLE IF NOT EXISTS ProxySessions (
	...
	CONSTRAINT ProxySessions_FK_USERID FOREIGN KEY (USERID) REFERENCES Account_Users(USERID) ON DELETE CASCADE,
	CONSTRAINT ProxySessions_FK_SESSIONID FOREIGN KEY (SESSIONID) REFERENCES UserSessions(SESSIONID) ON DELETE CASCADE,
