...
CREATE TABLE IF NOT EXISTS  FacilioDBAudit_1(
    ID BIGINT AUTO_INCREMENT PRIMARY KEY,
...
CREATE TABLE IF NOT EXISTS  FacilioAuditModule_1(
	ID BIGINT AUTO_INCREMENT PRIMARY KEY,
	MODULE VARCHAR(200) NOT NULL,
	UNIQUE(MODULE)
);

CREATE TABLE IF NOT EXISTS FacilioAuditReferer_1(
	REFERER_ID BIGINT AUTO_INCREMENT PRIMARY KEY,
	REFERER VARCHAR(300) NOT NULL
);

CREATE TABLE IF NOT EXISTS  FacilioAuditAction_1(
	MODULE_ID BIGINT NOT NULL,
	ACTION VARCHAR(200) NOT NULL,
	UNIQUE(MODULE_ID,ACTION),
	CONSTRAINT FK_AuditAction_1 FOREIGN KEY (MODULE_ID) REFERENCES FacilioAuditModule_1(ID)
);

CREATE TABLE IF NOT EXISTS  FacilioAuditMethod_1(
	ACTION_ID BIGINT NOT NULL,
	METHOD VARCHAR(200) NOT NULL,
	UNIQUE(ACTION_ID,METHOD),
	CONSTRAINT FK_AuditMethod_1 FOREIGN KEY (ACTION_ID) REFERENCES FacilioAuditAction_1(MODULE_ID)
);
