...
CREATE TABLE IF NOT EXISTS FacilioExceptionQueue (
...
CREATE TABLE IF NOT EXISTS FacilioInstantJobQueue (
  ID BIGINT PRIMARY KEY AUTO_INCREMENT,
  ORGID BIGINT(20),
  ADDED_TIME BIGINT ,
  VISIBILITY_TIMEOUT BIGINT NOT NULL,
...
CREATE TABLE IF NOT EXISTS FacilioRuleInstantJobQueue (
  ID BIGINT PRIMARY KEY AUTO_INCREMENT,
  ORGID BIGINT(20),
  ADDED_TIME BIGINT ,
  VISIBILITY_TIMEOUT BIGINT NOT NULL,
...
CREATE TABLE IF NOT EXISTS  FacilioDBAudit(
    ID BIGINT AUTO_INCREMENT PRIMARY KEY,
    ORG_ID BIGINT NOT NULL ,
    STATUS INT DEFAULT NULL ,
    USER_ID BIGINT NOT NULL ,
...
CREATE TABLE IF NOT EXISTS  FacilioAuditModule(
	ID BIGINT AUTO_INCREMENT PRIMARY KEY,
	MODULE VARCHAR(200) NOT NULL,
	UNIQUE(MODULE)
);

CREATE TABLE IF NOT EXISTS FacilioAuditReferer(
	REFERER_ID BIGINT AUTO_INCREMENT PRIMARY KEY,
	REFERER VARCHAR(300) NOT NULL
);

CREATE TABLE IF NOT EXISTS  FacilioAuditAction(
	MODULE_ID BIGINT NOT NULL,
	ACTION VARCHAR(200) NOT NULL,
	CONSTRAINT FK_AuditAction FOREIGN KEY (MODULE_ID) REFERENCES FacilioAuditModule(ID)
);

CREATE TABLE IF NOT EXISTS  FacilioAuditMethod(
	ACTION_ID BIGINT NOT NULL,
	METHOD VARCHAR(200) NOT NULL,
	CONSTRAINT FK_AuditMethod FOREIGN KEY (ACTION_ID) REFERENCES FacilioAuditAction(MODULE_ID)
);
