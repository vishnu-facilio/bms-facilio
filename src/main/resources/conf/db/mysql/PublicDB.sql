...
CREATE INDEX INSTANTJOBQUEUE_DELETED_TIME_ADDED_TIME ON InstantJobQueue (DELETED_TIME, ADDED_TIME);
...
CREATE INDEX RULEINSTANTJOBQUEUE_DELETED_TIME_ADDED_TIME ON RuleInstantJobQueue (DELETED_TIME, ADDED_TIME);
...
CREATE INDEX FORMULAINSTANTJOBQUEUE_DELETED_TIME_ADDED_TIME ON FormulaInstantJobQueue (DELETED_TIME, ADDED_TIME);
...
CREATE INDEX READINGDATAMIGINSTANTJOBQUEUE_DELETED_TIME_ADDED_TIME ON ReadingDataMigrationInstantJobQueue (DELETED_TIME, ADDED_TIME);
...
CREATE TABLE IF NOT EXISTS Agent_Files_Update_Log(
      ...
      AUTH_KEY VARCHAR(40) NOT NULL,
      FILE_ID BIGINT NOT NULL,
      CONSTRAINT FK_Agent_Agent_Files_Update_Log_AGENT_ID FOREIGN KEY (AGENT_ID) REFERENCES Agent(ID),
      CONSTRAINT FK_Agent_Agent_Files_Update_Log_FILE_ID FOREIGN KEY (FILE_ID) REFERENCES FacilioFile(FILE_ID),
      CONSTRAINT FK_Agent_Agent_Files_Update_Log_ORG_ID FOREIGN KEY (ORGID) REFERENCES Organizations(ORGID)
  );
