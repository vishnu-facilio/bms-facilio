...
CREATE TABLE IF NOT EXISTS Preventive_Maintenance (
	...
	CONSTRAINT PREVENTIVE_MAINTENANCE_FK_CUSTOM_MODULEID FOREIGN KEY (CUSTOM_MODULEID) REFERENCES Modules(MODULEID),
	CONSTRAINT PREVENTIVE_MAINTENANCE_FK_DATE_FIELDID FOREIGN KEY (DATE_FIELDID) REFERENCES Fields(FIELDID)
);
...
CREATE TABLE IF NOT EXISTS WorkPermit (
      ...
      CONSTRAINT WorkPermit_FK_TICKET_ID FOREIGN KEY (TICKET_ID) REFERENCES Tickets(ID),
...
CREATE TABLE IF NOT EXISTS Agent_Alarm_Event (
	ID BIGINT PRIMARY KEY AUTO_INCREMENT,
	ORGID BIGINT NOT NULL,
	MODULEID BIGINT NOT NULL,
	SITE_ID BIGINT,
...
CREATE TABLE IF NOT EXISTS Agent_Alarm_Occurrence(
	ID BIGINT PRIMARY KEY AUTO_INCREMENT,
	MODULEID BIGINT NOT NULL,
	ORGID BIGINT NOT NULL,
	SITE_ID BIGINT,
