...
CREATE TABLE IF NOT EXISTS Form_Fields (
	...
	SEQUENCE_NUMBER TINYINT NOT NULL,
	SHOW_FIELD BOOLEAN DEFAULT TRUE NOT NULL,
...
CREATE TABLE IF NOT EXISTS MV_Readings (
	...
	CONSTRAINT MV_READINGS_FK_PARENT_ID FOREIGN KEY (PARENT_ID) REFERENCES MV_Project(ID)
);
...
CREATE TABLE IF NOT EXISTS MV_Adjustment_Readings (
	...
	CONSTRAINT MV_Adjustment_READINGS_FK_PARENT_ID FOREIGN KEY (PARENT_ID) REFERENCES MV_Project(ID)
);