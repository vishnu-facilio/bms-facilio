...
CREATE TABLE ReadingViolationEvent (
  ID BIGINT NOT NULL PRIMARY KEY,
  ORGID BIGINT NOT NULL,
  MODULEID BIGINT NOT NULL,
  FORMULA_FIELD_ID BIGINT NOT NULL,
  CONSTRAINT ReadingViolationEvent_FK_ID FOREIGN KEY (ID) REFERENCES BaseEvent (ID) ON DELETE CASCADE,
  CONSTRAINT ReadingViolationEvent_FK_MODULEID FOREIGN KEY (MODULEID) REFERENCES Modules(MODULEID),
  CONSTRAINT ReadingViolationEvent_FK_FORMULA_FIELD_ID FOREIGN KEY (FORMULA_FIELD_ID) REFERENCES Formula_Field(ID) ON DELETE CASCADE
);

CREATE TABLE ReadingViolationAlarm (
  ID BIGINT NOT NULL PRIMARY KEY,
  ORGID BIGINT NOT NULL,
  MODULEID BIGINT NOT NULL,
  FORMULA_FIELD_ID BIGINT NOT NULL,
  CONSTRAINT ReadingViolationAlarm_FK_ID FOREIGN KEY (ID) REFERENCES BaseAlarm (ID) ON DELETE CASCADE,
  CONSTRAINT ReadingViolationAlarm_FK_MODULEID FOREIGN KEY (MODULEID) REFERENCES Modules(MODULEID),
  CONSTRAINT ReadingViolationAlarm_FK_FORMULA_FIELD_ID FOREIGN KEY (FORMULA_FIELD_ID) REFERENCES Formula_Field(ID) ON DELETE CASCADE
);
...
CREATE TABLE IF NOT EXISTS ReadingViolationOccurrence (
	...
	MODULEID BIGINT NOT NULL,
	FORMULA_FIELD_ID BIGINT NOT NULL,
	CONSTRAINT ReadingViolationOccurrence_FK_MODULEID FOREIGN KEY (MODULEID) REFERENCES Modules(MODULEID),
	CONSTRAINT ReadingViolationOccurrence_FK_SITE_ID FOREIGN KEY (SITE_ID) REFERENCES Site(ID),
	CONSTRAINT ReadingViolationOccurrence_FK_FORMULA_FIELD_ID FOREIGN KEY (FORMULA_FIELD_ID) REFERENCES Formula_Field(ID) ON DELETE CASCADE
);
