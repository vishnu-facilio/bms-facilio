...
(
	...
	DATE_OPERATOR INT DEFAULT NULL,
  	DATE_VALUE VARCHAR(50) DEFAULT NULL,
	CONSTRAINT DASHBOARD_FILTER_FK_DASHBOARD_ID FOREIGN KEY (DASHBOARD_ID) REFERENCES Dashboard(ID),
	CONSTRAINT  DASHBOARD_FILTER_FK_DASHBOARD_TAB_ID FOREIGN KEY (DASHBOARD_TAB_ID) REFERENCES Dashboard_Tab(ID) 
);
...
(
	...
	CONSTRAINT  DASHBOARD_USER_FILTER_FK_DASHBOARD_FILTER_ID FOREIGN KEY (DASHBOARD_FILTER_ID) REFERENCES Dashboard_Filter(ID)
);
