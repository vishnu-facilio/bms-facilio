...
CREATE TABLE IF NOT EXISTS Energy_Star_Property_Metrics (
  ID BIGINT NOT NULL AUTO_INCREMENT,
  ORGID BIGINT NOT NULL,
  PROPERTY_ID BIGINT NOT NULL,
  METRIC_ID int(11) NOT NULL,
  TARGET varchar(45) DEFAULT NULL,
  NATIONAL_MEDIAN varchar(45) DEFAULT NULL,
  PRIMARY KEY (ID),
  CONSTRAINT Energy_Star_Property_Metrics_property_id FOREIGN KEY (PROPERTY_ID) REFERENCES Energy_Star_Property (ID) ON DELETE CASCADE ON UPDATE NO ACTION
);
...
(
    ...
    SHIPPING_CHARGES      BIGINT,
    ADJUSTMENTS_COST      BIGINT,
    ADJUSTMENTS_COST_NAME VARCHAR(50),
    MISCELLANEOUS_CHARGES BIGINT,
    TOTAL_COST            BIGINT,
    ...
    CONSTRAINT QUOTATION_FK_WORKORDER_ID FOREIGN KEY (WORKORDER_ID) REFERENCES WorkOrders (ID)
);
...
(
    ...
    CONSTRAINT QUOTATION_ATTACHMENTS_FK_PARENT_PRECAUTION FOREIGN KEY (PARENT_ID) REFERENCES Quotation (ID),
...
(
    ...
    CONSTRAINT QUOTATION_NOTES_FK_PARENT_ID FOREIGN KEY (PARENT_ID) REFERENCES Quotation (ID)
);
...
(
    ...
    CONSTRAINT QUOTATION_ACTIVITY_FK_PARENT_ID FOREIGN KEY (PARENT_ID) REFERENCES Quotation (ID),
