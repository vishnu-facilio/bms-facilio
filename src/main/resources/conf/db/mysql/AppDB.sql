...
CREATE TABLE IF NOT EXISTS Form_Fields (
	...
	SEQUENCE_NUMBER TINYINT NOT NULL,
	SHOW_FIELD BOOLEAN DEFAULT FALSE,
...
CREATE TABLE IF NOT EXISTS  Agent_VersionLog(
    ...
    CONSTRAINT AGENT_VERSION_LOG_FK_AGENT_ID FOREIGN KEY (AGENT_ID) REFERENCES Agent_Data(ID)
);
...
CREATE TABLE IF NOT EXISTS Device (
	...
	CREATED_TIME BIGINT NOT NULL,
	CONSTRAINT DEVICE_FK_SITE_ID FOREIGN KEY (SITE_ID) REFERENCES Site(ID),
	CONSTRAINT DEVICE_FK_AGENT_ID FOREIGN KEY (AGENT_ID) REFERENCES Agent_Data(ID),
	CONSTRAINT DEVICE_UNIQUE_ORGID_AGENTID_NAME UNIQUE(ORGID, AGENT_ID,NAME)
);
...
CREATE TABLE IF NOT EXISTS Modbus_Tcp_Controller (
	...
	CONSTRAINT Modbus_Tcp_Controller_FK_AGENT_ID FOREIGN KEY (AGENT_ID) REFERENCES Agent_Data(ID),
...
CREATE TABLE IF NOT EXISTS Visitor_Events (
      ...
      FORM_ID 			BIGINT,
      LOCAL_ID 			BIGINT(20)
      CONSTRAINT Visitor_Events_FK_MODULE_ID FOREIGN KEY (MODULEID) REFERENCES Modules (MODULEID),
      CONSTRAINT Visitor_Events_FK_FORM_ID FOREIGN KEY (FORM_ID) REFERENCES Forms(ID) ON DELETE SET NULL,
      CONSTRAINT Visitor_Events_FK_TICKET_STATUS_ID FOREIGN KEY (MODULE_STATE) REFERENCES TicketStatus (ID),
      CONSTRAINT Visitor_Events_FK_SITE_ID FOREIGN KEY (SITE_ID) REFERENCES Site (ID),
      CONSTRAINT Visitor_Events_FK_SYS_CREATED_BY FOREIGN KEY (SYS_CREATED_BY) REFERENCES ORG_Users(ORG_USERID),
      CONSTRAINT Visitor_Events_FK_SYS_MODIFIED_BY FOREIGN KEY (SYS_MODIFIED_BY) REFERENCES ORG_Users(ORG_USERID),
      CONSTRAINT Visitor_Events_FK_EVENT_HOST FOREIGN KEY (EVENT_HOST) REFERENCES ORG_USERS(ORG_USERID)
);

CREATE TABLE IF NOT EXISTS Event_Visitor_Rel (
      ID                BIGINT PRIMARY KEY AUTO_INCREMENT,
      ORGID             BIGINT NOT NULL,
      EVENT_ID			BIGINT,
      VISITOR_ID        BIGINT,
      ...
      MODULE_STATE		BIGINT,
      STATE_FLOW_ID 	BIGINT,
      CONSTRAINT Event_Visitor_Rel_FK_EVENT FOREIGN KEY (EVENT_ID) REFERENCES VISITOR_EVENTS(ID) ON DELETE CASCADE,
      CONSTRAINT Event_Visitor_Rel_FK_VISITOR_ID FOREIGN KEY (VISITOR_ID) REFERENCES Visitor(ID) ON DELETE CASCADE
...
CREATE TABLE IF NOT EXISTS Visitor_Logging (
      ...
      CONSTRAINT Visitor_Logging_FK_EVENT_HOST FOREIGN KEY (EVENT_HOST) REFERENCES ORG_USERS(ORG_USERID),
      CONSTRAINT Visitor_Logging_FK_VISITOR_EVENT FOREIGN KEY (VISITOR_EVENT) REFERENCES Visitor_Events(ID),
