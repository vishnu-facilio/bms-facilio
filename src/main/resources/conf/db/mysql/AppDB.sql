...
CREATE TABLE IF NOT EXISTS ORG_Users (
	...
	ORGID BIGINT NOT NULL,
	IAM_ORG_USERID BIGINT NOT NULL,
	INVITEDTIME BIGINT,
	LICENSE INT,
...
(
	...
	SECURITY_MODE   INT,
	SECURITY_POLICY INT,
	UNIQUE (URL,SECURITY_MODE,SECURITY_POLICY,AGENT_ID),
...
CREATE TABLE IF NOT EXISTS Service_Requests (
	...
	CONSTRAINT SERVICE_REQUESTS_FK_ASSIGNMENT_GROUP FOREIGN KEY (ASSIGNMENT_GROUP_ID) REFERENCES `Groups`(GROUPID),
...
ALTER TABLE Formula_Field ADD CONSTRAINT FORMULA_FIELD_FK_VIOLATION_RULE_ID FOREIGN KEY (VIOLATION_RULE_ID) REFERENCES Workflow_Rule(ID);
...
(
	...
	CONSTRAINT Point_FK_CONTROLLER_ID FOREIGN KEY (CONTROLLER_ID) REFERENCES Controllers (ID) ON DELETE CASCADE,
...
(
	...
	CONTROLLER_ID BIGINT,
	PATH          VARCHAR(1000),
	CONSTRAINT Misc_Point_FK_CONTROLLER_ID FOREIGN KEY (CONTROLLER_ID) REFERENCES Controllers (ID),
...
(
	...
	CONSTRAINT BACnet_IP_Point_FK_CONTROLLER_ID FOREIGN KEY (CONTROLLER_ID) REFERENCES Controllers (ID),
   ...
   CONSTRAINT Niagara_Point_FK_CONTROLLER_ID FOREIGN KEY (CONTROLLER_ID) REFERENCES Controllers (ID),
   ...
   CREATE TABLE IF NOT EXISTS OPC_XML_DA_Point (
   	...
   	CONSTRAINT OPC_XML_DA_Point_FK_CONTROLLER_ID FOREIGN KEY (CONTROLLER_ID) REFERENCES Controllers (ID),
   ...
   CONSTRAINT Modbus_Point_FK_CONTROLLER_ID FOREIGN KEY (CONTROLLER_ID) REFERENCES Controllers (ID),
   ...
   FUNCTION_CODE INT NOT NULL,
   MODBUS_DATA_TYPE INT NOT NULL,
   CONSTRAINT Modbus_Rtu_Point_META_UNIQUE UNIQUE (ORGID,CONTROLLER_ID,REGISTER_NUMBER),
   CONSTRAINT Modbus_Rtu_Point_FK_CONTROLLER_ID FOREIGN KEY (CONTROLLER_ID) REFERENCES Controllers (ID),
   ...
   CONSTRAINT OPC_UA_Point_FK_CONTROLLER_ID FOREIGN KEY (CONTROLLER_ID) REFERENCES Controllers (ID),
...
CREATE TABLE IF NOT EXISTS Workflow_Rule_Historical_Logger (
 ...
 CREATE TABLE IF NOT EXISTS Workflow_Rule_Logger (
    ...
    CALCULATION_START_TIME BIGINT,
    CALCULATION_END_TIME BIGINT,
    CONSTRAINT Workflow_Rule_Logger_FK_RULEID FOREIGN KEY (RULE_ID) REFERENCES Workflow_Rule(ID) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS Workflow_Rule_Resource_Logger (
    ...
    CALCULATION_END_TIME BIGINT,
  	...
  	CONSTRAINT Workflow_Rule_Resource_Logger_FK_RESOURCE_ID FOREIGN KEY (RESOURCE_ID) REFERENCES Resources(ID)
);
...
CREATE TABLE IF NOT EXISTS Pm_Exec_Sharing (
  ...
  CONSTRAINT PM_EXEC_SHARING_FK_GROUP_ID FOREIGN KEY (GROUP_ID) REFERENCES `Groups`(GROUPID)
);
...
CREATE TABLE Workflow_RCA_Mapping (
...
CREATE TABLE IF NOT EXISTS AlarmWorkflow_Rule (
	...
	CONSTRAINT ALARMWKF_FK_RULEID FOREIGN KEY (RULE_ID) REFERENCES Reading_Rule (ID)
);
...
CREATE TABLE IF NOT EXISTS SLA_Entity (
	...
	COMPARE_FIELDID BIGINT NOT NULL,
	...
	CONSTRAINT FK_SLAENTITY_COMPAREFIELDID FOREIGN KEY (COMPARE_FIELDID) REFERENCES Fields(FIELDID)
);

CREATE TABLE IF NOT EXISTS SLA_Workflow_Rule (
	ID BIGINT PRIMARY KEY,
	ORGIG BIGINT,
	BASE_FIELDID BIGINT,
	DUE_FIELDID BIGINT,
	COMPARE_FIELDID BIGINT,
	ADD_DURATION BIGINT,
	CONSTRAINT SLAWORKFLOWRULE_FK_BASEFIELDID FOREIGN KEY (BASE_FIELDID) REFERENCES Fields (FIELDID) ON DELETE CASCADE
	CONSTRAINT SLAWORKFLOWRULE_FK_DUE_FIELDID FOREIGN KEY (DUE_FIELDID) REFERENCES Fields (FIELDID) ON DELETE CASCADE
	CONSTRAINT SLAWORKFLOWRULE_FK_COMPAREFIELDID FOREIGN KEY (COMPARE_FIELDID) REFERENCES Fields (FIELDID) ON DELETE CASCADE
	CONSTRAINT SLAWORKFLOWRULE_FK_ID FOREIGN KEY (ID) REFERENCES Workflow_Rule (ID) ON DELETE CASCADE
);
...
CREATE TABLE IF NOT EXISTS SLA_Workflow_Escalation (
	...
	TYPE TINYINT,
	TIME_INTERVAL BIGINT,
	CONSTRAINT SLAWORKFLOWESCALATION_FK_SLARULEID FOREIGN KEY (SLA_RULE_ID) REFERENCES SLA_Workflow_Rule (ID) ON DELETE CASCADE
);
...
CREATE TABLE SLA (
  ...
  SLA_MODULE_ID BIGINT DEFAULT NULL,
  FORM_ID BIGINT DEFAULT NULL,
  CONSTRAINT SLA_FK_MODULEID FOREIGN KEY (MODULEID) REFERENCES Modules (MODULEID),
  CONSTRAINT SLA_FK_FORMID FOREIGN KEY (FORM_ID) REFERENCES Forms (ID) ON DELETE SET NULL,
  CONSTRAINT SLA_FK_SLAMODULEID FOREIGN KEY (SLA_MODULE_ID) REFERENCES Modules (MODULEID),
  CONSTRAINT SLA_FL_RULEID FOREIGN KEY (SLA_RULE_ID) REFERENCES SLA_Workflow_Rule (ID) ON DELETE CASCADE
);
...
CREATE TABLE IF NOT EXISTS Visitor (
      ...
      CONSTRAINT Visitor_FK_LAST_VISITED_HOST FOREIGN KEY (LAST_VISITED_HOST) REFERENCES Contacts(ID),
      CONSTRAINT Visitor_FK_LAST_VISITED_SPACE FOREIGN KEY (LAST_VISITED_SPACE) REFERENCES Resources(ID),
...
CREATE TABLE IF NOT EXISTS Visitor_Logging (
      ...
      CONSTRAINT Visitor_Logging_FK_VISITED_SPACE FOREIGN KEY (VISITED_SPACE) REFERENCES Resources(ID),
...
CREATE TABLE IF NOT EXISTS WorkPermit_Attachments (
	...
	CONSTRAINT WorkPermit_Attachments_FK_PARENT_VISITOR FOREIGN KEY (PARENT_WORK_PERMIT) REFERENCES WorkPermit (ID),
...
CREATE TABLE IF NOT EXISTS WorkPermit_Notes (
	...
	CONSTRAINT WorkPermit_Notes_FK_PARENT_ID FOREIGN KEY (PARENT_ID) REFERENCES WorkPermit (ID)
);
...
CREATE TABLE IF NOT EXISTS Devices_Feedback_Kiosk(
    ID BIGINT NOT NULL PRIMARY KEY,
    ORGID BIGINT NOT NULL,
    PRINTER_ID BIGINT DEFAULT NULL,
    KIOSK_FOR_SPACE BIGINT(20) DEFAULT NULL,
    CONSTRAINT DEVICES_FEEDBACK_KIOSK_ID FOREIGN KEY(ID) REFERENCES Devices(ID) ON DELETE CASCADE,
    CONSTRAINT DEVICES_FEEDBACK_KIOSK_PRINTER_ID FOREIGN KEY(PRINTER_ID) REFERENCES Printers(ID) ON DELETE SET NULL,
    CONSTRAINT DEVICE_FEEDBACK_KIOSK_FOR_SPACE_ID FOREIGN KEY(KIOSK_FOR_SPACE) REFERENCES BaseSpace(ID)
);

CREATE TABLE IF NOT EXISTS Device_Catalog_Mapping (
	ID BIGINT PRIMARY KEY AUTO_INCREMENT,
	ORGID BIGINT NOT NULL,
	DEVICE_ID BIGINT NOT NULL,
	SERVICE_CATALOG_ID BIGINT NOT NULL,
	CONSTRAINT DEVICECATALOG_DEVICEID FOREIGN KEY (DEVICE_ID) REFERENCES Devices_Feedback_Kiosk(ID) ON DELETE CASCADE,
	CONSTRAINT DEVICECATALOG_CATALOGID FOREIGN KEY (SERVICE_CATALOG_ID) REFERENCES Service_Catalog(ID) ON DELETE CASCADE
);
...
CREATE TABLE IF NOT EXISTS WebTab_Group(
	...
	CONSTRAINT WEBTAB_GROUP_FK_APPLICATION_ID FOREIGN KEY (APP_ID) REFERENCES Application(ID) ON DELETE CASCADE
);
...
CREATE TABLE IF NOT EXISTS WebTab(
	...
	CONSTRAINT WEBTAB_GROUPID FOREIGN KEY (GROUP_ID) REFERENCES WebTab_Group (ID)
);
...
CREATE TABLE IF NOT EXISTS CB_Session (
  ...
  START_TIME BIGINT NOT NULL,
  PRIMARY KEY (ID),
  CONSTRAINT CB_Session_Intent_id FOREIGN KEY (INTENT_ID) REFERENCES CB_Intent (ID) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
CREATE TABLE IF NOT EXISTS CB_Session_Conversation (
  ...
  INTENT_PARAM_ID BIGINT NOT NULL,
  ...
  PRIMARY KEY (ID),
  CONSTRAINT CB_Session_Conversation_INTENT_PARAM_ID FOREIGN KEY (INTENT_PARAM_ID) REFERENCES CB_Intent_Params (ID) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
CREATE TABLE IF NOT EXISTS CB_Session_Params (
  ...
  CONSTRAINT CB_Session_Params_intent_param_id FOREIGN KEY (INTENT_PARAM_ID) REFERENCES CB_Intent_Params (ID) ON DELETE NO ACTION ON UPDATE NO ACTION
);
