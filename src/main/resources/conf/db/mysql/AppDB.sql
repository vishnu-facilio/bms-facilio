...
CREATE TABLE IF NOT EXISTS SLA_Workflow_Rule (
	ID BIGINT PRIMARY KEY,
	ORGIG BIGINT,
	SLA_POLICY_RULE_ID BIGINT NOT NULL,
	BASE_FIELDID BIGINT,
	DUE_FIELDID BIGINT,
	COMPARE_FIELDID BIGINT,
	ADD_DURATION BIGINT,

	CONSTRAINT SLAWORKFLOWRULE_FK_POLICYRULEID FOREIGN KEY (SLA_POLICY_RULE_ID) REFERENCES SLA_Policy (ID) ON DELETE CASCADE,
