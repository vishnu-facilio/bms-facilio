...
CREATE TABLE IF NOT EXISTS AgentControl ( 
	...
	CONSTRAINT AGENT_CONTROL_FK_ID FOREIGN KEY (AGENT_ID) REFERENCES Agent(ID)
);
...
CREATE TABLE IF NOT EXISTS Base_Scoring (
    ...
    CONSTRAINT BASESCORING_FK_SCORINGRULEID FOREIGN KEY (SCORING_RULE_ID) REFERENCES Workflow_Rule (ID) ON DELETE CASCADE
);
...
CREATE TABLE IF NOT EXISTS Condition_Scoring (
    ...
    CONSTRAINT CONDITIONSCORING_FK_CRITERIAID FOREIGN KEY (CRITERIA_ID) REFERENCES Criteria(CRITERIAID)
);
...
CREATE TABLE IF NOT EXISTS Node_Scoring (
    ...
    MODULEID BIGINT,
    SITE_ID BIGINT,
    RECORD_MODULE_ID BIGINT NOT NULL,
    RECORD_ID BIGINT NOT NULL,
    SCORING_FIELD_ID BIGINT NOT NULL,
