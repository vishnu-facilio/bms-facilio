...
CREATE TABLE IF NOT EXISTS ORG_Users (
	...
	CONSTRAINT App_ORG_USERS_FK_PEOPLE_ID FOREIGN KEY (PEOPLE_ID) REFERENCES People(ID),
...
CREATE TABLE IF NOT EXISTS Tenant_Contacts (
      ...
      CONSTRAINT Tenant_Contacts_FK_VENDOR_ID FOREIGN KEY (TENANT_ID) REFERENCES Tenants (ID)
...
CREATE TABLE IF NOT EXISTS Employee (
      ...
      APP_ACCESS TINYINT,
      IS_LABOUR TINYINT,
      EMPLOYEE_PORTAL_ACCESS TINYINT,
      OCCUPANT_PORTAL_ACCESS TINYINT,
