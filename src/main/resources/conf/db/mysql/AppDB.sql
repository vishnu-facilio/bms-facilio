...
CREATE TABLE IF NOT EXISTS Form_Rule_Trigger_Field (
  ...
  PRIMARY KEY (ID),
  CONSTRAINT Form_Rule_Trigger_Field_field_id FOREIGN KEY (FIELD_ID) REFERENCES Form_Fields (ID),
...
CREATE TABLE IF NOT EXISTS CustomMailMessage (
  ...
  MAIL_SUBJECT TEXT ,
  CONTENT LONGTEXT,
  CONSTRAINT SUPPORT_MAIL_FK_ID FOREIGN KEY (SUPPORT_MAIL_ID) REFERENCES SupportEmails (ID)
) ;
...
CREATE TABLE IF NOT EXISTS Mail_Attachments (
	...
	CONSTRAINT MAIL_ATTACHEMENTS_FK_MESSAGE_ID FOREIGN KEY (MESSAGE_ID) REFERENCES CustomMailMessage (ID),
	CONSTRAINT MAIL_ATTACHEMENTS_FK_FILE_ID FOREIGN KEY (FILE_ID) REFERENCES FacilioFile (FILE_ID)
);
...
(
    ...
    STRING_CF19         VARCHAR(50),
    STRING_CF20         VARCHAR(50),
    STRING_CF21         VARCHAR(50),
    STRING_CF22         VARCHAR(50),
    STRING_CF23         VARCHAR(50),
    STRING_CF24         VARCHAR(50),
    STRING_CF25         VARCHAR(50),
    STRING_CF26         VARCHAR(50),
    STRING_CF27         VARCHAR(50),
    STRING_CF28         VARCHAR(50),
    STRING_CF29         VARCHAR(50),
    STRING_CF30         VARCHAR(50),
    NUMBER_CF1          BIGINT,
    NUMBER_CF2          BIGINT,
    NUMBER_CF3          BIGINT,
    NUMBER_CF4          BIGINT,
...
(
    ...
    CONSTRAINT WORK_PERMIT_CHECK_LIST_FK_WORK_PERMIT_ID FOREIGN KEY (WORK_PERMIT_ID) REFERENCES WorkPermit (ID) ON DELETE SET NULL
);
...
(
    ...
    CONSTRAINT WORKPERMIT_ACTIVITY_FK_PARENT_ID FOREIGN KEY (PARENT_ID) REFERENCES WorkPermit (ID),
...
CREATE TABLE Inbound_Connections(
     ...
     CONSTRAINT INBOUND_CONNECTIONS_FK_USER_ID FOREIGN KEY (CREATED_BY) REFERENCES Account_Users(USERID) ON DELETE SET NULL
 );
