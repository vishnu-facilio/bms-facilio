...
CREATE TABLE IF NOT EXISTS  Controller_Alarm (
	ID BIGINT PRIMARY KEY AUTO_INCREMENT,
	ORGID BIGINT NOT NULL,
	MODULEID BIGINT NOT NULL,
	SITE_ID BIGINT,
	AGENT_ID BIGINT,
	CONTROLLER_LIST VARCHAR(1000),
	CONSTRAINT CONTROLLER_ALARM_FK_ID FOREIGN KEY (ID) REFERENCES BaseAlarm(ID) ON DELETE CASCADE,
	CONSTRAINT CONTROLLER_ALARM_FK_MODULEID FOREIGN KEY (MODULEID) REFERENCES Modules (MODULEID),
	CONSTRAINT CONTROLLER_ALARM_FK_SITE_ID FOREIGN KEY (SITE_ID) REFERENCES Site (ID),
	CONSTRAINT CONTROLLER_ALARM_FK_AGENT_ID FOREIGN KEY (AGENT_ID) REFERENCES Agent(ID) ON DELETE SET NULL
);
CREATE TABLE IF NOT EXISTS  Controller_Event (
	...
	AGENT_ID BIGINT,
	CONTROLLER_LIST VARCHAR(1000),
	CONSTRAINT CONTROLLER_ALARM_EVENT_FK_ID FOREIGN KEY (ID) REFERENCES BaseEvent(ID) ON DELETE CASCADE,
	CONSTRAINT CONTROLLER_ALARM_EVENT_FK_MODULEID FOREIGN KEY (MODULEID) REFERENCES Modules (MODULEID),
	CONSTRAINT CONTROLLER_EVENT_FK_SITE_ID FOREIGN KEY (SITE_ID) REFERENCES Site (ID),
	CONSTRAINT CONTROLLER_Event_FK_AGENT_ID FOREIGN KEY (AGENT_ID) REFERENCES Agent(ID) ON DELETE SET NULL
);
CREATE TABLE IF NOT EXISTS  Controller_AlarmOccurrence(
	ID BIGINT PRIMARY KEY AUTO_INCREMENT,
	MODULEID BIGINT NOT NULL,
	ORGID BIGINT NOT NULL,
	SITE_ID BIGINT,
	AGENT_ID BIGINT,
	CONTROLLER_LIST VARCHAR(1000),
	CONSTRAINT CONTROLLER_ALARM_Occurrence_FK_ID FOREIGN KEY (ID) REFERENCES AlarmOccurrence(ID) ON DELETE CASCADE,
	CONSTRAINT CONTROLLER_Occurrence_FK_AGENT_ID FOREIGN KEY (AGENT_ID) REFERENCES Agent(ID) ON DELETE SET NULL
);
...
CREATE TABLE IF NOT EXISTS People (
	  ...
	  SYS_DELETED_TIME 	BIGINT,
   	  ...
   	  IS_ACTIVE			TINYINT,
   	  CONSTRAINT People_FK_MODULE_ID FOREIGN KEY (MODULEID) REFERENCES Modules (MODULEID),
      CONSTRAINT People_FK_SITE_ID FOREIGN KEY (SITE_ID) REFERENCES Site (ID),
      CONSTRAINT People_FK_LOCATED_SPACE FOREIGN KEY (LOCATED_SPACE) REFERENCES Resources (ID),
      CONSTRAINT People_FK_SYS_CREATED_BY FOREIGN KEY (SYS_CREATED_BY) REFERENCES ORG_Users(ORG_USERID),
      CONSTRAINT People_FK_SYS_MODIFIED_BY FOREIGN KEY (SYS_MODIFIED_BY) REFERENCES ORG_Users(ORG_USERID),
      CONSTRAINT People_FK_SYS_DELETED_BY FOREIGN KEY (SYS_DELETED_BY) REFERENCES ORG_Users(ORG_USERID),
      CONSTRAINT People_FK_FORM_ID FOREIGN KEY (FORM_ID) REFERENCES Forms(ID) ON DELETE SET NULL
...
CREATE TABLE Operation_Alarm_Occurrence (
  ID BIGINT PRIMARY KEY,
  ORGID BIGINT NOT NULL,
  MODULEID BIGINT NOT NULL,
  SITE_ID BIGINT,
