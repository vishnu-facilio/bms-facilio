...
CREATE TABLE Bim_Integration_Logs (
  ...
  CONSTRAINT BIM_DEFAULT_VALUES_FK_MODULE_ID FOREIGN KEY (MODULE_ID) REFERENCES Modules (ID) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT BIM_DEFAULT_VALUES_FK_FIELD_ID FOREIGN KEY (FIELD_ID) REFERENCES Fields (ID) ON DELETE RESTRICT ON UPDATE RESTRICT
);
