...
alter table ORG_Users add column LOCATED_SPACE BIGINT;
alter table ORG_Users ADD CONSTRAINT ORG_USER_LOCATED_SPACE_FK FOREIGN KEY (LOCATED_SPACE) REFERENCES Resources(ID);