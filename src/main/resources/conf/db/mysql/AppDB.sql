...
CREATE TABLE IF NOT EXISTS View_Filters (
    ...
    VIEWID BIGINT 	  NOT NULL,
    CRITERIA_ID BIGINT,
	CONSTRAINT VIEW_FILTERS_VIEWID_FK FOREIGN KEY (VIEWID) REFERENCES Views(ID) ON DELETE CASCADE,
	CONSTRAINT VIEW_FILTERS_FK_CRITERIA_ID FOREIGN KEY (CRITERIA_ID) REFERENCES Criteria(CRITERIAID)
