...
CREATE TABLE IF NOT EXISTS Facilio_Trigger(
	...
	FIELD_ID BIGINT,
	EVENT_TYPE INT,
	EXTRAINFO VARCHAR(5000),
	STATUS TiNYiNT,
	CONSTRAINT TRIGGER_MODULE_ID_FK FOREIGN KEY (MODULE_ID) REFERENCES Modules(MODULEID),
	CONSTRAINT TRIGGER_ASSET_CATEGORY_ID_FK FOREIGN KEY (ASSET_CATEGORY_ID) REFERENCES Asset_Categories(ID),
	CONSTRAINT TRIGGER_FIELD_ID_FK FOREIGN KEY (FIELD_ID) REFERENCES Fields(FIELDID),
	CONSTRAINT TRIGGER_CHILD_MODULE_ID_FK FOREIGN KEY (CHILD_MODULE_ID) REFERENCES Modules(MODULEID)
);
...
(
    ...
    MAX_MULTI_BOOKING_PER_SLOT BIGINT,
    ...
    SCORE_CF29              DOUBLE,
    SCORE_CF30              DOUBLE,
    CONSTRAINT Facility_FK_MANAGER FOREIGN KEY (MANAGER) REFERENCES ORG_Users (ORG_USERID),
...
(
    ...
    SYS_CREATED_BY    BIGINT,
    SYS_MODIFIED_BY   BIGINT,
    CONSTRAINT Facility_Availability_FK_SYS_CREATED_BY FOREIGN KEY (SYS_CREATED_BY) REFERENCES ORG_Users (ORG_USERID),
    CONSTRAINT Facility_Availability_FK_SYS_MODIFIED_BY FOREIGN KEY (SYS_MODIFIED_BY) REFERENCES ORG_Users (ORG_USERID),
    CONSTRAINT Facility_Availability_FK_SYS_DELETED_BY FOREIGN KEY (SYS_DELETED_BY) REFERENCES ORG_Users (ORG_USERID),
    CONSTRAINT Facility_Availability_MODULE_ID FOREIGN KEY (MODULEID) REFERENCES Modules (MODULEID),
    CONSTRAINT Facility_Availability_FK_AMENITY_ID FOREIGN KEY (AMENITY_ID) REFERENCES Amenities (ID) ON DELETE CASCADE,
    CONSTRAINT Facility_Availability_FK_FACILITY_ID FOREIGN KEY (FACILITY_ID) REFERENCES Facility (ID) ON DELETE CASCADE
);
...
CREATE TABLE IF NOT EXISTS FacilityBooking (
   ...
   CONSTRAINT FacilityBooking_FK_SYS_MODIFIED_BY FOREIGN KEY (SYS_DELETED_BY) REFERENCES ORG_Users(ORG_USERID),
   CONSTRAINT FacilityBooking_FK_RESERVED_FOR FOREIGN KEY (RESERVED_FOR) REFERENCES ORG_Users(ORG_USERID),
...
CREATE TABLE IF NOT EXISTS FacilityBooking_Internal_Attendees (
    ...
    CONSTRAINT FacilityBooking_Internal_Attendees_FK_SYS_DELETED_BY FOREIGN KEY (SYS_DELETED_BY) REFERENCES ORG_Users(ORG_USERID),
    CONSTRAINT FacilityBooking_Internal_Attendees_FK_ATTENDEE_USER FOREIGN KEY (ATTENDEE) REFERENCES ORG_Users(ORG_USERID),
...
CREATE TABLE IF NOT EXISTS FacilityBooking_External_Attendees (
      ...
      CONSTRAINT FacilityBooking_External_Attendees_FK_SYS_DELETED_BY FOREIGN KEY (SYS_DELETED_BY) REFERENCES ORG_Users(ORG_USERID),
...
CREATE TABLE IF NOT EXISTS Facility_Booking_Notes (
    ...
    CONSTRAINT Facility_Booking_Notes_FK_PARENT_ID FOREIGN KEY (PARENT) REFERENCES FacilityBooking (ID)
);
