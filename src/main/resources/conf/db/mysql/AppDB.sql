...
-- AHU Readings Tables ---
    ...
    CREATE TABLE IF NOT EXISTS AHU_Readings_Return_Air(
        ID BIGINT AUTO_INCREMENT PRIMARY KEY,
        ORGID BIGINT NOT NULL,
        MODULEID BIGINT NOT NULL,
        SOURCE_TYPE BIGINT,
        ...
        CONSTRAINT AHU_READINGS_RETURN_AIR_FK_MODULEID FOREIGN KEY (MODULEID) REFERENCES Modules(MODULEID),
        CONSTRAINT AHU_READINGS_RETURN_AIR_FK_PARENT_ID FOREIGN KEY (PARENT_ID) REFERENCES AHU(ID));

    CREATE INDEX AHU_READINGS_RETURN_AIR_PARENT_ID_INDEX on AHU_Readings_Return_Air (PARENT_ID);
    CREATE INDEX AHU_READINGS_RETURN_AIR_PARENT_ID_TTIME_INDEX ON AHU_Readings_Return_Air (ORGID, MODULEID, PARENT_ID, TTIME);
    CREATE INDEX AHU_READINGS_RETURN_AIR_TTIME_INDEX ON AHU_Readings_Return_Air (ORGID, MODULEID, TTIME);
...
CREATE TABLE IF NOT EXISTS Service_Catalog (
	ID BIGINT AUTO_INCREMENT PRIMARY KEY,
	ORGID BIGINT NOT NULL,
	IS_COMPLAINT_TYPE BOOLEAN DEFAULT FALSE,
    SITE_ID BIGINT,
	MODULEID BIGINT NOT NULL,
	NAME VARCHAR(50) NOT NULL,
	DESCRIPTION VARCHAR(255),
...
CREATE TABLE IF NOT EXISTS Energy_Star_Customer (
  ...
  CREATED_TIME BIGINT NOT NULL,
  CREATED_BY BIGINT NOT NULL,
  ENERGY_STAR_CUSTOMER_ID varchar(45) NOT NULL,
  USERNAME varchar(500) NOT NULL,
  PASSWORD varchar(500) NOT NULL,
  DATA_EXCHANGE_MODE int(11) NOT NULL,
  PRIMARY KEY (ID)
);
...
CREATE TABLE IF NOT EXISTS Energy_Star_Property (
  ...
  YEAR_BUILD varchar(45) NOT NULL,
  OCCUPANCY_PERCENTAGE varchar(45) NOT NULL,
  PRIMARY KEY (ID),
