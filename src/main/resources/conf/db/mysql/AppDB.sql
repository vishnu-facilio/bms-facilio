...
CREATE TABLE IF NOT EXISTS Vendors (
	...
	MODULE_STATE		BIGINT,
    STATE_FLOW_ID		BIGINT,
    CONSTRAINT VENDORS_FK_MODULE_STATE_ID FOREIGN KEY (MODULE_STATE) REFERENCES TicketStatus(MODULEID),
...
CREATE TABLE IF NOT EXISTS  Agent_VersionLog(
    ...
    CONSTRAINT AGENT_VERSION_LOG_FK_NEW_AGENT_ID FOREIGN KEY (AGENT_ID) REFERENCES Agent(ID)
);
...
CREATE TABLE IF NOT EXISTS Invite_Visitor_Rel (
      ...
      STATE_FLOW_ID 	BIGINT,
      QR_URL			VARCHAR(1000),
      CONSTRAINT Invite_Visitor_Rel_FK_MODULE_ID FOREIGN KEY (MODULE_STATE) REFERENCES TicketStatus (ID),
...
CREATE TABLE VisitorSettings (
  ...
  ORGID bigint(20) NOT NULL,
  VISITOR_FORM_ID bigint(20) DEFAULT NULL,
  ...
  CONSTRAINT VISITOR_SETTING_FK_VISITOR_FORM_ID FOREIGN KEY (VISITOR_FORM_ID) REFERENCES Forms (ID),
