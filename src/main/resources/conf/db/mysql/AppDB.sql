...
CREATE TABLE IF NOT EXISTS  Agent_Alarm (
	...
	CONSTRAINT AGENT_ALARM_FK_AGENT_ID FOREIGN KEY (AGENT_ID) REFERENCES Agent_Data(ID) ON DELETE SET NULL
);
CREATE TABLE IF NOT EXISTS  Agent_Event (
	...
	CONSTRAINT AGENT_ALARM_Event_FK_AGENT_ID FOREIGN KEY (AGENT_ID) REFERENCES Agent_Data(ID) ON DELETE SET NULL
);
CREATE TABLE IF NOT EXISTS  Agent_AlarmOccurrence(
	...
	CONSTRAINT AGENT_ALARM_Occurrence_FK_AGENT_ID FOREIGN KEY (AGENT_ID) REFERENCES Agent_Data(ID) ON DELETE SET NULL
);
