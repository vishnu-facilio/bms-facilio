...
CREATE TABLE IF NOT EXISTS Asset_Depreication_Rel (
	...
	CONSTRAINT ASSETDEPREREL_FK_DEPRECIATIONID FOREIGN KEY (DEPRECIATION_ID) REFERENCES AssetDepreciation(ID)
);
...
CREATE TABLE IF NOT EXISTS CustomModuleData (
	...
	STRING_CF14 VARCHAR(50),
	STRING_CF15 VARCHAR(50),
	STRING_CF16 VARCHAR(50),
	STRING_CF17 VARCHAR(50),
	STRING_CF18 VARCHAR(50),
	STRING_CF19 VARCHAR(50),
	STRING_CF20 VARCHAR(50),
	NUMBER_CF1 BIGINT,
	NUMBER_CF2 BIGINT,
	NUMBER_CF3 BIGINT,
	NUMBER_CF4 BIGINT,
...
CREATE TABLE IF NOT EXISTS Form_Rule_Action_Field (
  ...
  CRITERIA_ID BIGINT DEFAULT NULL,
  PRIMARY KEY (ID),
  CONSTRAINT Form_Rule_Action_Field_criteria_id FOREIGN KEY (CRITERIA_ID) REFERENCES Criteria (CRITERIAID) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT Form_Rule_Action_Field_form_field_id FOREIGN KEY (FORM_FIELD_ID) REFERENCES Form_Fields (ID) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
CREATE TABLE IF NOT EXISTS SupportEmails (
	...
	CONSTRAINT SUPPORT_EMAILS_FK_AUTO_ASSIGN_GROUP FOREIGN KEY (AUTO_ASSIGN_GROUP_ID) REFERENCES FacilioGroups(GROUPID),
...
CREATE TABLE IF NOT EXISTS RuleRollUpEvent (
	...
	CONSTRAINT RULEROLLUPEVENT_FK_SUB_RULE_ID FOREIGN KEY (SUB_RULE_ID) REFERENCES Reading_Rule(ID) ON DELETE SET NULL,
	CONSTRAINT RULEROLLUPEVENT_FK_READING_FIELD_ID FOREIGN KEY (READING_FIELD_ID) REFERENCES Fields (FIELDID) ON DELETE SET NULL
);
...
CREATE TABLE IF NOT EXISTS RuleRollUpOccurrence (
    ...
    CONSTRAINT RULEROLLUPOCCURRENCE_FK_SUB_RULE_ID FOREIGN KEY (SUB_RULE_ID) REFERENCES Reading_Rule(ID) ON DELETE SET NULL,
    CONSTRAINT RULEROLLUPOCCURRENCE_FK_READING_FIELD_ID FOREIGN KEY (READING_FIELD_ID) REFERENCES Fields (FIELDID) ON DELETE SET NULL,
    CONSTRAINT RULEROLLUPOCCURRENCE_FK_CATEGORYID FOREIGN KEY (CATEGORY_ID) REFERENCES ReadingAlarmCategory(ID)
);
...
CREATE TABLE IF NOT EXISTS RuleRollUpAlarm (
    ...
    CONSTRAINT RULEROLLUPALARM_FK_SUB_RULE_ID FOREIGN KEY (SUB_RULE_ID) REFERENCES Reading_Rule(ID) ON DELETE SET NULL,
    CONSTRAINT RULEROLLUPALARM_FK_READING_FIELD_ID FOREIGN KEY (READING_FIELD_ID) REFERENCES Fields (FIELDID) ON DELETE SET NULL,
    CONSTRAINT RULEROLLUPALARM_FK_CATEGORYID FOREIGN KEY (CATEGORY_ID) REFERENCES ReadingAlarmCategory(ID)
);
...
CREATE TABLE IF NOT EXISTS AssetRollUpAlarm (
	...
	CONSTRAINT ASSETROLLUPALARM_FK_RULE_ID FOREIGN KEY (RULE_ID) REFERENCES Reading_Rule(ID) ON DELETE SET NULL,
    CONSTRAINT ASSETROLLUPALARM_FK_SUB_RULE_ID FOREIGN KEY (SUB_RULE_ID) REFERENCES Reading_Rule(ID) ON DELETE SET NULL,
    CONSTRAINT ASSETROLLUPALARM_FK_READING_FIELD_ID FOREIGN KEY (READING_FIELD_ID) REFERENCES Fields (FIELDID) ON DELETE SET NULL,
    CONSTRAINT ASSETROLLUPALARM_FK_CATEGORYID FOREIGN KEY (CATEGORY_ID) REFERENCES ReadingAlarmCategory(ID)
);
...
CREATE TABLE IF NOT EXISTS AssetRollUpEvent (
	...
	CONSTRAINT ASSETROLLUPEVENT_FK_RULE_ID FOREIGN KEY (RULE_ID) REFERENCES Reading_Rule(ID) ON DELETE SET NULL,
	CONSTRAINT ASSETROLLUPEVENT_FK_SUB_RULE_ID FOREIGN KEY (SUB_RULE_ID) REFERENCES Reading_Rule(ID) ON DELETE SET NULL,
	CONSTRAINT ASSETROLLUPEVENT_FK_READING_FIELD_ID FOREIGN KEY (READING_FIELD_ID) REFERENCES Fields (FIELDID) ON DELETE SET NULL
);
...
CREATE TABLE IF NOT EXISTS AssetRollUpOccurrence (
	...
	CONSTRAINT ASSETROLLUPOCCURRENCE_FK_RULE_ID FOREIGN KEY (RULE_ID) REFERENCES Reading_Rule(ID) ON DELETE SET NULL,
    CONSTRAINT ASSETROLLUPOCCURRENCE_FK_SUB_RULE_ID FOREIGN KEY (SUB_RULE_ID) REFERENCES Reading_Rule(ID) ON DELETE SET NULL,
    CONSTRAINT ASSETROLLUPOCCURRENCE_FK_READING_FIELD_ID FOREIGN KEY (READING_FIELD_ID) REFERENCES Fields (FIELDID) ON DELETE SET NULL,
    CONSTRAINT ASSETROLLUPOCCURRENCE_FK_CATEGORYID FOREIGN KEY (CATEGORY_ID) REFERENCES ReadingAlarmCategory(ID)
);
...
CREATE TABLE IF NOT EXISTS Energy_Star_Meter (
  ...
  METER_DATA_MODULE_ID BIGINT DEFAULT NULL,
  METER_DATA_FIELD_ID BIGINT DEFAULT NULL,
  ENERGY_STAR_METER_ID varchar(45) DEFAULT NULL,
  FIRST_BILL_DATE varchar(45) DEFAULT NULL,
  META_JSON varchar(1000) NULL,
  PRIMARY KEY (ID),
  CONSTRAINT Energy_Star_Meter_fieldid FOREIGN KEY (METER_DATA_FIELD_ID) REFERENCES Fields (FIELDID) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT Energy_Star_Meter_meter_id FOREIGN KEY (METER_ID) REFERENCES Assets (ID) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT Energy_Star_Meter_moduleid FOREIGN KEY (METER_DATA_MODULE_ID) REFERENCES Modules (MODULEID) ON DELETE NO ACTION ON UPDATE NO ACTION,
