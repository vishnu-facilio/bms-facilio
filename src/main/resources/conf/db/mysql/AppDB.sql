...
CREATE TABLE IF NOT EXISTS Custom_Controller (
	...
	CONSTRAINT Custom_Controller_FK_AGENT_ID FOREIGN KEY (AGENT_ID) REFERENCES Agent_Data(ID)
);
...
CREATE TABLE IF NOT EXISTS Rest_Controller (
	...
	CONSTRAINT Rest_Controller_FK_AGENT_ID FOREIGN KEY (AGENT_ID) REFERENCES Agent_Data(ID)
);
...
CREATE TABLE IF NOT EXISTS Visitor (
      ...
      CONSTRAINT Visitor_FK_LAST_VISITED_HOST FOREIGN KEY (LAST_VISITED_HOST) REFERENCES ORG_Users(ORG_USERID),
      CONSTRAINT Visitor_FK_LAST_VISITED_SPACE FOREIGN KEY (LAST_VISITED_SPACE) REFERENCES Resources(ID),
      CONSTRAINT VISITOR_UNQIUE UNIQUE(PHONE)
...
CREATE TABLE IF NOT EXISTS Visitor_Logging (
      ...
      CONSTRAINT Visitor_Logging_FK_EVENT_HOST FOREIGN KEY (HOST) REFERENCES ORG_Users(ORG_USERID),
