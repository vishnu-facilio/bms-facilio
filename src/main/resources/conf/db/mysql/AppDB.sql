...
(
    ...
    CONSTRAINT ChartOfAccountAttachments_FK_PARENT FOREIGN KEY (PARENT) REFERENCES ChartOfAccount (ID) ON DELETE CASCADE,
...
(
    ...
    CONSTRAINT ChartOfAccountNotes_FK_PARENT_ID FOREIGN KEY (PARENT_ID) REFERENCES ChartOfAccount (ID) ON DELETE CASCADE
);
