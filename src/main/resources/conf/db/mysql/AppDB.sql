...
(
    ...
    CONSTRAINT Facility_FK_MODULE_ID FOREIGN KEY (MODULE_ID) REFERENCES Modules (MODULEID)
...
(
    ...
    LOOKUP_CF4        BIGINT,
    LOOKUP_CF5        BIGINT,
    CONSTRAINT Amenities_FK_MODULE_ID FOREIGN KEY (MODULE_ID) REFERENCES Modules (MODULEID),
