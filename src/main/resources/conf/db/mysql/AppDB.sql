...
CREATE TABLE IF NOT EXISTS Tenants (
    ...
    CONSTRAINT TENANTS_FK_BUILDING_ID FOREIGN KEY (BUILDING_ID) REFERENCES Building (ID)
...
CREATE TABLE IF NOT EXISTS SupportEmails (
	...
	CONSTRAINT SUPPORT_EMAILS_FK_WORKFLOW_RULE_ID FOREIGN KEY (WORKFLOW_RULE_ID) REFERENCES Workflow_Rule (ID) ON DELETE SET NULL
);
...
CREATE TABLE IF NOT EXISTS NewAndInformationSharing
(
    ID           BIGINT AUTO_INCREMENT PRIMARY KEY,
    ORGID        BIGINT NOT NULL,
    MODULEID     BIGINT NOT NULL,
    ...
    CONSTRAINT NEW_AND_INFORMATION_SHARING_FK_ANNOUNCEMENT_ID FOREIGN KEY (NEWS_ID) REFERENCES NewsAndInformation (ID) ON DELETE CASCADE
);
