...
CREATE TABLE IF NOT EXISTS Devices (
  ...
  PRIMARY KEY (ID),  
  CONSTRAINT DEVICE_KF_ASSOCIATED_RESOURCE FOREIGN KEY (ASSOCIATED_RESOURCE) REFERENCES Resources (ID),
  CONSTRAINT DEVICE_FK_ASSET_ID FOREIGN KEY (ID) REFERENCES Assets (ID) ON DELETE CASCADE,
  CONSTRAINT DEVICE_FK_MODULE_ID FOREIGN KEY (MODULEID) REFERENCES Modules (MODULEID),
  CONSTRAINT DEVICE_FK_SITE_ID FOREIGN KEY (SITE_ID) REFERENCES Site (ID)
);
