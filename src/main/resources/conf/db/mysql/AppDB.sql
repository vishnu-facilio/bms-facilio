...
(
    ...
    TTIME_HOUR INT NOT NULL,
    PARENT_ID BIGINT NOT NULL,
    LOAD_AVERAGE BIGINT NOT NULL,
    TOTAL_LOADED_CLASS_COUNT BIGINT NOT NULL,
    FREE_HEAP_MEMORY BIGINT NOT NULL,
    FREE_NON_HEAP_MEMORY BIGINT NOT NULL,
    LIVE_THREAD_COUNT BIGINT NOT NULL,
    FREE_DISK_SPACE BIGINT NOT NULL,
    MONITOR_DEAD_LOCKED_THREADS BIGINT NOT NULL,
    PEAK_THREAD_COUNT BIGINT NOT NULL,
    DEAD_LOCKED_THREADS BIGINT NOT NULL,
    ...
    CONSTRAINT System_Controller_Readings_FK_PARENT_ID FOREIGN KEY (PARENT_ID) REFERENCES Chiller(ID)
);
