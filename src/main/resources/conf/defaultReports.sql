...
INSERT INTO Report (ORGID,MODULEID,REPORT_FOLDER_ID,REPORT_ENTITY_ID,NAME,DESCRIPTION,CHART_TYPE,X_AXIS,X_AGGREGATE_FUNCTION,X_AXIS_LABEL,Y1_AXIS,Y1_AGGREGATE_FUNCTION,Y1_AXIS_LABEL,Y1_AXIS_UNIT) VALUES (${orgId},${energyDataModuleId},@REPORT_FOLDER_ID,@REPORT_ENTITY_ID,'Cost by Buildings','Cost by Buildings',2,@EM_PURPOSE_SPACE_REPORT_FIELD_ID,22,'Opperational Space',@ED_TOTAL_CONS_DELTA_REPORT_FIELD_ID,3,'Cost','cost');
SET @REPORT_ID := (SELECT LAST_INSERT_ID());
...
INSERT INTO Report (ORGID,MODULEID,REPORT_FOLDER_ID,REPORT_ENTITY_ID,NAME,DESCRIPTION,CHART_TYPE,X_AXIS,X_AGGREGATE_FUNCTION,X_AXIS_LABEL,Y1_AXIS,Y1_AGGREGATE_FUNCTION,Y1_AXIS_LABEL,Y1_AXIS_UNIT) VALUES (${orgId},${energyDataModuleId},@REPORT_FOLDER_ID,@REPORT_ENTITY_ID,'EUI Ranking','EUI Ranking',9,@EM_PURPOSE_SPACE_REPORT_FIELD_ID,22,'Opperational Space',@ED_TOTAL_CONS_DELTA_REPORT_FIELD_ID,3,'Ranking','eui');
SET @REPORT_ID := (SELECT LAST_INSERT_ID());
