...
INSERT INTO Report_Formula_Field (ORGID,MODULEID,NAME,DATA_TYPE,FORMULA) VALUES (${orgId},${workOrderModuleId},'Resolution Time by mins',1,'(ACTUAL_WORK_END-ACTUAL_WORK_START)/1000/60');
...
INSERT INTO Report_Formula_Field (ORGID,MODULEID,NAME,DATA_TYPE,FORMULA) VALUES (${orgId},${workOrderModuleId},'Resolution Time by hour',1,'(ACTUAL_WORK_END-ACTUAL_WORK_START)/1000/60/60');
...
INSERT INTO Report_Formula_Field (ORGID,MODULEID,NAME,DATA_TYPE,FORMULA) VALUES (${orgId},${alarmModuleId},'Response time by Min',1,'(ACKNOWLEDGED_TIME - CREATED_TIME)/1000/60');
...
INSERT INTO Report_Formula_Field (ORGID,MODULEID,NAME,DATA_TYPE,FORMULA) VALUES (${orgId},${alarmModuleId},'Resolution time by Min',1,'(CLEARED_TIME - CREATED_TIME)/1000/60');
...
INSERT INTO Report (ORGID,MODULEID,REPORT_FOLDER_ID,REPORT_ENTITY_ID,NAME,DESCRIPTION,CHART_TYPE,X_AXIS,X_AGGREGATE_FUNCTION,X_AXIS_LABEL,Y1_AXIS,Y1_AGGREGATE_FUNCTION,Y1_AXIS_LABEL,GROUP_BY,GROUP_BY_LABEL) VALUES  (${orgId},${alarmModuleId},@REPORT_FOLDER_ID,@REPORT_ENTITY_ID,'Avg Response Time by Building','Avg Response Time by Building',5,@FA_RESOURCE_REPORT_FIELD_ID,22,'Buildings',@FA_AVG_RESPONSE_TIME_FF_REPORT_FIELD_ID,2,'No of Alarms',@FA_CATEGORY_REPORT_FIELD_ID,'Category');
SET @REPORT_ID := (SELECT LAST_INSERT_ID());
...
INSERT INTO Report (ORGID,MODULEID,REPORT_FOLDER_ID,REPORT_ENTITY_ID,NAME,DESCRIPTION,CHART_TYPE,X_AXIS,X_AXIS_LABEL,Y1_AXIS,Y1_AGGREGATE_FUNCTION,Y1_AXIS_LABEL) VALUES (${orgId},${alarmModuleId},@REPORT_FOLDER_ID,@REPORT_ENTITY_ID,'Average Response Time By Technicians','Average Response Time By Technicians',9,@FA_ACKNOWLEDGED_BY_REPORT_FIELD_ID,'Acknowledged By',@FA_AVG_RESPONSE_TIME_FF_REPORT_FIELD_ID,2,'mins');
SET @REPORT_ID := (SELECT LAST_INSERT_ID());
