...
INSERT INTO Report_DateFilter (REPORT_ID,FIELD_ID,OPERATOR) VALUES (@REPORT_ID,${alarm_createdTime},28);
...
INSERT INTO Report (ORGID,MODULEID,REPORT_FOLDER_ID,REPORT_ENTITY_ID,NAME,DESCRIPTION,CHART_TYPE,X_AXIS,X_AGGREGATE_FUNCTION,X_AXIS_LABEL,Y1_AXIS_LABEL,GROUP_BY,GROUP_BY_LABEL) VALUES (${orgId},${alarmModuleId},@REPORT_FOLDER_ID,@REPORT_ENTITY_ID,'Alarms by Building with Severity','Alarms by Building with Severity',1,@FA_RESOURCE_REPORT_FIELD_ID,22,'Buildings','No of Alarms',@FA_SEVERITY_REPORT_FIELD_ID,'Severity');
SET @REPORT_ID := (SELECT LAST_INSERT_ID());
...
INSERT INTO Report (ORGID,MODULEID,REPORT_FOLDER_ID,REPORT_ENTITY_ID,NAME,DESCRIPTION,CHART_TYPE,X_AXIS,X_AGGREGATE_FUNCTION,X_AXIS_LABEL,Y1_AXIS,Y1_AGGREGATE_FUNCTION,Y1_AXIS_LABEL,GROUP_BY,GROUP_BY_LABEL) VALUES  (${orgId},${alarmModuleId},@REPORT_FOLDER_ID,@REPORT_ENTITY_ID,'Avg Response Time by Building','Avg Response Time by Building',1,@FA_RESOURCE_REPORT_FIELD_ID,22,'Buildings',@FA_AVG_RESPONSE_TIME_FF_REPORT_FIELD_ID,2,'No of Alarms',@FA_CATEGORY_REPORT_FIELD_ID,'Category');
SET @REPORT_ID := (SELECT LAST_INSERT_ID());
