...
CREATE TABLE Unmodeled_Instance (
  ...
  CONSTRAINT Unmodeled_Instance_FK_CONTROLLER_ID FOREIGN KEY (CONTROLLER_ID) REFERENCES Controller (ID) ON DELETE NO ACTION
);
...
CREATE TABLE Inventory_Attachments (
	...
	CONSTRAINT INVENTORY_ATTACHEMENTS_FK_FILE_ID FOREIGN KEY (FILE_ID) REFERENCES File (FILE_ID)
);
...
CREATE TABLE Inventory_Photos (
	...
	CONSTRAINT INVENTORY_PHOTOS_FK_PHOTO_ID FOREIGN KEY (PHOTO_ID) REFERENCES File (FILE_ID)
);
