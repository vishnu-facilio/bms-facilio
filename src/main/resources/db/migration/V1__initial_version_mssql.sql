...
CREATE TABLE Resources (
	...
	CONSTRAINT RESOURCES_FK_PHOTO_ID FOREIGN KEY (PHOTO_ID) REFERENCES Files (FILE_ID),
...
CREATE TABLE ResizedFile (
  ...
  CONSTRAINT RESIZEDFILE_FK_ID FOREIGN KEY (FILE_ID) REFERENCES Files(FILE_ID) ON DELETE CASCADE
);
...
CREATE TABLE BaseSpace_Photos (
	...
	CONSTRAINT BASESPACE_PHOTOS_FK_PHOTO_ID FOREIGN KEY (PHOTO_ID) REFERENCES Files (FILE_ID)
);
...
CREATE TABLE BaseSpace_Attachments (
	...
	CONSTRAINT BASESPACE_ATTACHEMENTS_FK_FILE_ID FOREIGN KEY (FILE_ID) REFERENCES Files (FILE_ID)
);
...
CREATE TABLE Asset_Photos (
	...
	CONSTRAINT ASSET_PHOTOS_FK_PHOTO_ID FOREIGN KEY (PHOTO_ID) REFERENCES Files (FILE_ID)
);
...
CREATE TABLE Asset_Attachments (
	...
	CONSTRAINT ASSET_ATTACHEMENTS_FK_FILE_ID FOREIGN KEY (FILE_ID) REFERENCES Files (FILE_ID)
);
...
CREATE TABLE Ticket_Attachments (
	...
	CONSTRAINT TICKET_ATTACHEMENTS_FK_FILE_ID FOREIGN KEY (FILE_ID) REFERENCES Files (FILE_ID)
);
...
CREATE TABLE Task_Attachments (
	...
	CONSTRAINT TASK_ATTACHMENTS_FK_FILE_ID FOREIGN KEY (FILE_ID) REFERENCES Files (FILE_ID)
);
...
CREATE TABLE Attachments (
	...
	CONSTRAINT ATTACHEMENTS_FK_FILE_ID FOREIGN KEY (FILE_ID) REFERENCES Files (FILE_ID)
);
...
CREATE TABLE ImportProcess (
	...
	CONSTRAINT IMPORT_ORGFILE_FK_ORGID FOREIGN KEY (FILEID) REFERENCES Files(FILE_ID)
);
...
CREATE TABLE EMail_Templates (
	...
	CONSTRAINT EMAIL_TEMPLATES_BODY_FK FOREIGN KEY (BODY_ID) REFERENCES Files(FILE_ID)
);
...
CREATE TABLE Excel_Templates (
	...
	CONSTRAINT EXCEL_FILE_ID_FK FOREIGN KEY (EXCEL_FILE_ID) REFERENCES Files(FILE_ID) ON DELETE CASCADE
);
...
CREATE TABLE PortalInfo (
	...
	CONSTRAINT PORTALINFO_PUBLICKEY_FILEID FOREIGN KEY (PUBLICKEY) REFERENCES Files (FILE_ID),
...
CREATE TABLE Unmodeled_Data (
 ...
 CREATE TABLE Historical_VM_Calculation  (
  ID BIGINT identity(1,1) PRIMARY KEY,
  ORGID BIGINT NOT NULL,
...
CREATE TABLE Scheduled_Rule_Jobs (
	ID BIGINT identity(1,1) PRIMARY KEY,
	ORGID BIGINT NOT NULL,
	SITE_ID BIGINT,
	RULE_ID BIGINT NOT NULL,
...
CREATE TABLE PM_Jobs(
	...
	CONSTRAINT PM_JOBS_FK_PM_TRIGGER_ID FOREIGN KEY (PM_TRIGGER_ID) REFERENCES PM_Triggers(ID) ON DELETE NO ACTION,
...
CREATE TABLE PM_Resource_Planner (
  ...
  CONSTRAINT PM_Triggers_Resource_TRIGGER_ID FOREIGN KEY (TRIGGER_ID) REFERENCES PM_Triggers (ID) ON DELETE NO ACTION ON UPDATE NO ACTION
);
...
CREATE TABLE Tenants (
	...
	CONSTRAINT TENANTS_FK_LOGO_ID FOREIGN KEY (LOGO_ID) REFERENCES Files (FILE_ID),
