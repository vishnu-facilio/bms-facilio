...
CREATE TABLE IF NOT EXISTS Unmodeled_Data (
 ...
 CREATE TABLE IF NOT EXISTS Instance_To_Energy_Data_Mapping (
   ...
   FIELD_ID BIGINT(20),
   CONSTRAINT INSTANCE_TO_ENERGY_DATA_MAPPING_FK_INSTANCEID FOREIGN KEY (INSTANCE_ID) REFERENCES Unmodeled_Instance(ID),
   ...
   CONSTRAINT UNIQUE_INSTANCEID UNIQUE(INSTANCE_ID)
 );
