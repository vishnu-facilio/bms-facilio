...
CREATE TABLE IF NOT EXIST Report1_BaseLine_Rel (
  ...
  CONSTRAINT REPORT1_BASELINE_REL_REPORT_ID_FK FOREIGN KEY (REPORT_ID) REFERENCES Report1 (ID)
);
...
CREATE TABLE IF NOT EXIST Report1_Benchmark_Rel (
  ...
  CONSTRAINT REPORT1_BENCHMARK_REL_REPORT_ID_FK FOREIGN KEY (REPORT_ID) REFERENCES Report1 (ID)
);
