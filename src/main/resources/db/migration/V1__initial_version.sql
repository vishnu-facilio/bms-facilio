...
CREATE TABLE IF NOT EXISTS Alarms (
	...
	CONSTRAINT ALARMS_FK_WO_ID FOREIGN KEY (WO_ID) REFERENCES WorkOrders (ID)
);
...
CREATE TABLE IF NOT EXISTS PM_Resource_Planner_Reminder (
  ...
  CONSTRAINT PM_Resource_Planner_Remainder_fk_id FOREIGN KEY (PM_RESOURCE_PLANNER_ID) REFERENCES PM_Resource_Planner (ID) ON DELETE NO ACTION ON UPDATE NO ACTION,
