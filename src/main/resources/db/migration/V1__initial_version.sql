...
CREATE TABLE IF NOT EXISTS Conditions (
	...
	CONSTRAINT CONDITIONS_CRITERIAID_FK FOREIGN KEY (PARENT_CRITERIA_ID) REFERENCES Criteria(CRITERIAID),
	CONSTRAINT CONDITIONS_CRITERIAID_FK FOREIGN KEY (CRITERIA_VAL_ID) REFERENCES Criteria(CRITERIAID),
