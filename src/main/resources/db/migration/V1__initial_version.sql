...
ALTER TABLE Resources ADD CONSTRAINT RESOURCES_FK_SITE_ID FOREIGN KEY (SITE_ID) REFERENCES Site (ID);
...
CREATE TABLE IF NOT EXISTS Report1 (
  ...
  DATA_POINT_JSON VARCHAR(5000) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS Report_Fields (
  ...
  CONSTRAINT REPORT_FIELDS_REPORT_ID1 FOREIGN KEY (REPORT_ID) REFERENCES Report1 (ID),
...
CREATE TABLE IF NOT EXISTS Tenants_Utility_Mapping (
	...
	SHOW_IN_PORTAL TINYINT NOT NULL,
