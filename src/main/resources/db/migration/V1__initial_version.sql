...
CREATE TABLE IF NOT EXISTS WorkOrderRequest_EMail (
	...
	REQUEST_ID BIGINT,
	CONSTRAINT WORK_ORDER_REQUESTS_EMAIL_FK_REQUEST_ID FOREIGN KEY (REQUEST_ID) REFERENCES WorkOrderRequests(ID)
);
...
CREATE INDEX PM_READINGS_PARENT_ID_INDEX on PM_Readings (PARENT_PM_ID);
