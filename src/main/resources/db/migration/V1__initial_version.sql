...
CREATE TABLE IF NOT EXISTS Widget_Static (
  ...
  CONSTRAINT WIDGET_STATIC_WORKFLOW_ID FOREIGN KEY (WORKFLOW_ID) REFERENCES Workflow (ID),
  CONSTRAINT WIDGET_STATIC_BASESPACE_ID FOREIGN KEY (BASE_SPACE_ID) REFERENCES BaseSpace (ID),
