...
CREATE TABLE IF NOT EXISTS Campus (
	...
	DATETIME_CF4 BIGINT,
	DATETIME_CF5 BIGINT,
	CONSTRAINT CAMPUS_FK_CAMPUS_ID FOREIGN KEY (ID) REFERENCES Area(AREA_ID),
...
CREATE TABLE IF NOT EXISTS Building (
	...
	DATETIME_CF4 BIGINT,
	DATETIME_CF5 BIGINT,
	CONSTRAINT BUILDING_FK_BUILDING_ID FOREIGN KEY (ID) REFERENCES Area(AREA_ID),
...
CREATE TABLE IF NOT EXISTS Floor (
	...
	DATETIME_CF4 BIGINT,
	DATETIME_CF5 BIGINT,
	CONSTRAINT FLOOR_FK_FLOOR_ID FOREIGN KEY (ID) REFERENCES Area(AREA_ID),
...
CREATE TABLE IF NOT EXISTS Space (
	...
	DATETIME_CF4 BIGINT,
	DATETIME_CF5 BIGINT,
	CONSTRAINT SPACE_FK_SPACE_ID FOREIGN KEY (ID) REFERENCES Area(AREA_ID),
...
CREATE TABLE IF NOT EXISTS Zone_Space (
	...
	CONSTRAINT ZONE_SPACE_FK_AREA_ID FOREIGN KEY (AREA_ID) REFERENCES Area(AREA_ID)
);
...
CREATE TABLE IF NOT EXISTS Ticket_Note (
	...
	TICKET_ID BIGINT,
	NOTE_ID BIGINT,
	CONSTRAINT TICKET_NOTE_FK_TICKET_ID FOREIGN KEY (TICKET_ID) REFERENCES Tickets(ID),
	CONSTRAINT TICKET_NOTE_FK_NOTE_ID FOREIGN KEY (NOTE_ID) REFERENCES Notes(NOTEID)
);
...
CREATE TABLE IF NOT EXISTS Ticket_Attachment (
	...
	TICKETID BIGINT,
	FILE_ID BIGINT,
	CONSTRAINT TICKET_ATTACHMENT_FK_TID FOREIGN KEY (TICKETID) REFERENCES Tickets(ID),
