...
CREATE TABLE IF NOT EXISTS Assignment_Templates (
	...
	CONSTRAINT ASSIGNMENT_TEMPLATES_USERID_FK FOREIGN KEY (USERID) REFERENCES Users(USERID),
	CONSTRAINT ASSIGNMENT_TEMPLATES_GROUPID_FK FOREIGN KEY (GROUPID) REFERENCES Groups(GROUPID)
);
...
CREATE TABLE IF NOT EXISTS Reading_Rule (
	...
	LAST_VALUE BIGINT,
	CONSTRAINT READING_RULE_ID_FK FOREIGN KEY (ID) REFERENCES Workflow_Rule(ID)
);
...
CREATE TABLE IF NOT EXISTS PM_Triggers(
	...
	CONSTRAINT PM_TRIGGERS_FK_PM_ID FOREIGN KEY (PM_ID) REFERENCES Preventive_Maintenance(ID),
	CONSTRAINT PM_TRIGGERS_FK_READING_RULE_ID FOREIGN KEY (READING_RULE_ID) REFERENCES Reading_Rule(ID),
...
CREATE TABLE IF NOT EXISTS Report_Criteria (
  ...
  CONSTRAINT REPORT_COMPARISION_CONDITIONS_REPORT_ID FOREIGN KEY (REPORT_ID) REFERENCES Report (ID) 
);
...
CREATE TABLE IF NOT EXISTS Widget_List_View (
  ...
  CONSTRAINT WIDGET_LIST_VIEW_ID FOREIGN KEY (VIEW_ID) REFERENCES Views (ID),
...
CREATE TABLE IF NOT EXISTS Unmodeled_Data (
 ...
 CREATE TABLE IF NOT EXISTS Instance_To_Asset_Mapping (
   ...
   CONSTRAINT INSTANCE_TO_ASSET_MAPPING_FK_FIELDID FOREIGN KEY (FIELD_ID) REFERENCES Fields(FIELDID),
   CONSTRAINT INSTANCE_TO_ASSET_MAPPING_FK_ASSETID FOREIGN KEY (ASSET_ID) REFERENCES Assets(ID)
 );
