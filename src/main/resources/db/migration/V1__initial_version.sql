...
CREATE TABLE IF NOT EXISTS Resources (
	...
	CONSTRAINT RESOURCES_FK_CONTROLLER_ID FOREIGN KEY (CONTROLLER_ID) REFERENCES Controller (ID)
);
...
CREATE INDEX SHIFT_READINGS_TIME_INDEX on Shift_Readings (TTIME);
CREATE INDEX SHIFT_READINGS_DATE_INDEX on Shift_Readings (TTIME_DATE);
...
CREATE INDEX PSYCHROMETRIC_READING_TIME_INDEX on Psychrometric_Reading (TTIME);
CREATE INDEX PSYCHROMETRIC_READING_DATE_INDEX on Psychrometric_Reading (TTIME_DATE);
...
-- Create indexes for CDD_Reading table
CREATE INDEX WDD_READING_TIME_INDEX on WDD_Reading (TTIME);
CREATE INDEX WDD_READING_DATE_INDEX on WDD_Reading (TTIME_DATE);
...
CREATE TABLE IF NOT EXISTS Site (
	...
	CONSTRAINT SITE_FK_MAINTAINED_BY FOREIGN KEY (MAINTAINED_BY) REFERENCES ORG_Users (ORG_USERID),
...
CREATE INDEX CHILLER_PRIMARY_PUMP_READINGS_TIME_INDEX on Chiller_Primary_Pump_Readings (TTIME);
CREATE INDEX CHILLER_PRIMARY_PUMP_READINGS_DATE_INDEX on Chiller_Primary_Pump_Readings (TTIME_DATE);
...
CREATE INDEX CHILLER_SECONDARY_PUMP_READINGS_TIME_INDEX on Chiller_Secondary_Pump_Readings (TTIME);
CREATE INDEX CHILLER_SECONDARY_PUMP_READINGS_DATE_INDEX on Chiller_Secondary_Pump_Readings (TTIME_DATE);
...
CREATE INDEX CHILLER_CONDENSER_PUMP_READINGS_TIME_INDEX on Chiller_Condenser_Pump_Readings (TTIME);
CREATE INDEX CHILLER_CONDENSER_PUMP_READINGS_DATE_INDEX on Chiller_Condenser_Pump_Readings (TTIME_DATE);
...
CREATE INDEX COOLING_TOWER_READINGS_TIME_INDEX on Cooling_Tower_Readings (TTIME);
CREATE INDEX COOLING_TOWER_READINGS_DATE_INDEX on Cooling_Tower_Readings (TTIME_DATE);
...
CREATE INDEX FCU_READINGS_TIME_INDEX on FCU_Readings (TTIME);
CREATE INDEX FCU_READINGS_DATE_INDEX on FCU_Readings (TTIME_DATE);
...
CREATE INDEX HEAT_PUMP_READINGS_TIME_INDEX on Heat_Pump_Readings (TTIME);
CREATE INDEX HEAT_PUMP_READINGS_DATE_INDEX on Heat_Pump_Readings (TTIME_DATE);
...
CREATE TABLE IF NOT EXISTS Formula_Field_Resource_Jobs (
	...
	CONSTRAINT FORMULA_FIELD_RESOURCE_JOBS_UNIQUE UNIQUE (FORMULA_FIELD_ID, RESOURCE_ID)
);
...
CREATE TABLE IF NOT EXISTS User_Workhour_Readings (
	...
	CONSTRAINT USER_WORKHOUR_READINGS_FK_WO_ID FOREIGN KEY (WO_ID) REFERENCES WorkOrders(ID) ON DELETE CASCADE,
	CONSTRAINT USER_WORKHOUR_READINGS_FK_SOURCE_ACTIVITY_WO_ID FOREIGN KEY (SOURCE_ACTIVITY_WO_ID) REFERENCES WorkOrders(ID) ON DELETE SET NULL
);

-- Create indexes for User_Workhour_Readings table
CREATE INDEX USER_WORKHOUR_READINGS_TIME_INDEX on User_Workhour_Readings (TTIME);
CREATE INDEX USER_WORKHOUR_READINGS_DATE_INDEX on User_Workhour_Readings (TTIME_DATE);
...
CREATE TABLE IF NOT EXISTS  PM_Readings (
	...
	CONSTRAINT PM_READINGS_FK_PARENT_ID FOREIGN KEY (PARENT_ID) REFERENCES Preventive_Maintenance(ID)
);

-- Create indexes for PM_Readings table
CREATE INDEX PM_READINGS_TIME_INDEX on PM_Readings (TTIME);
CREATE INDEX PM_READINGS_DATE_INDEX on PM_Readings (TTIME_DATE);
...
CREATE TABLE IF NOT EXIST Report1_Folder (
  ID BIGINT NOT NULL AUTO_INCREMENT PRIMARY KEY,
  ORGID BIGINT DEFAULT NULL,
...
CREATE TABLE IF NOT EXIST Report1 (
  ID BIGINT NOT NULL AUTO_INCREMENT PRIMARY KEY,
  ORGID BIGINT NOT NULL,
  SITE_ID BIGINT DEFAULT NULL,
  REPORT_FOLDER_ID BIGINT DEFAULT NULL,
  ...
  WORKFLOW_ID BIGINT DEFAULT NULL,
  CHART_STATE VARCHAR(5000) DEFAULT NULL,
  TABULAR_STATE VARCHAR(5000) DEFAULT NULL,
  CONSTRAINT REPORT1_ORGID_FK FOREIGN KEY (ORGID) REFERENCES Organizations (ORGID),
  CONSTRAINT REPORT1_SITE_ID_FK FOREIGN KEY (SITE_ID) REFERENCES Site (ID),
  CONSTRAINT REPORT1_WF_ID_FK FOREIGN KEY (WORKFLOW_ID) REFERENCES Workflow (ID) 
);


CREATE TABLE IF NOT EXIST Report_Data_Point (
  ID BIGINT NOT NULL AUTO_INCREMENT PRIMARY KEY,
  ORGID BIGINT NOT NULL,
  SITE_ID BIGINT DEFAULT NULL,
  REPORT_ID BIGINT DEFAULT NULL,
  ...
  X_AXIS_FIELD BIGINT DEFAULT NULL,
  X_AXIS VARCHAR(200) DEFAULT NULL,
  X_AXIS_AGGREGATE_FUNCTION int(11) DEFAULT NULL,
  X_AXIS_LABEL VARCHAR(200) DEFAULT NULL,
  X_AXIS_UNIT int(11) DEFAULT NULL,
  Y_AXIS_FIELD BIGINT DEFAULT NULL,
  Y_AXIS VARCHAR(45) DEFAULT NULL,
  Y_AXIS_AGGREGATE_FUNCTION int(11) DEFAULT NULL,
  Y_AXIS_LABEL VARCHAR(200) DEFAULT NULL,
  Y_AXIS_UNIT int(11) DEFAULT NULL,
  FETCH_LIMIT int(11) DEFAULT NULL,
  ORDER_BY VARCHAR(200) DEFAULT NULL,
  ORDER_BY_FUNCTION int(11) DEFAULT NULL,
  CRITERIA_ID BIGINT DEFAULT NULL,
  TRANSFORM_CRITERIA_ID BIGINT DEFAULT NULL,
  TRANSFORM_WORKFLOW_ID BIGINT DEFAULT NULL,
  CONSTRAINT REPORT_DATA_POINT_ORGID_FK FOREIGN KEY (ORGID) REFERENCES Organizations (ORGID),
  CONSTRAINT REPORT_DATA_POINT_SITE_ID_FK FOREIGN KEY (SITE_ID) REFERENCES Site (ID),
  CONSTRAINT REPORT_DATA_POINT_CRITERIA_ID_FK FOREIGN KEY (CRITERIA_ID) REFERENCES Criteria (CRITERIAID),
  CONSTRAINT REPORT_DATA_POINT_TRANSFORM_CRITERIA_ID_FK FOREIGN KEY (TRANSFORM_CRITERIA_ID) REFERENCES Criteria (CRITERIAID),
  CONSTRAINT REPORT_DATA_POINT_X_AXIS_FIELD_FK FOREIGN KEY (X_AXIS_FIELD) REFERENCES Fields (FIELDID),
  CONSTRAINT REPORT_DATA_POINT_FIELD_Y_AXIS_FIELD_FK FOREIGN KEY (Y_AXIS_FIELD) REFERENCES Fields (FIELDID),
  CONSTRAINT REPORT_DATA_POINT_MODULE_ID_FK FOREIGN KEY (MODULE_ID) REFERENCES Modules (MODULEID),
  CONSTRAINT REPORT_DATA_POINT_REPORT_ID_FK FOREIGN KEY (REPORT_ID) REFERENCES Report1 (ID),
  CONSTRAINT REPORT_DATA_POINT_TRANSFORM_WORKFLOW_ID_FK FOREIGN KEY (TRANSFORM_WORKFLOW_ID) REFERENCES Workflow (ID) 
);


CREATE TABLE IF NOT EXIST Report_X_Criteria (
  ID BIGINT NOT NULL AUTO_INCREMENT PRIMARY KEY,
  ORGID BIGINT NOT NULL,
  SITE_ID BIGINT DEFAULT NULL,
  REPORT_ID BIGINT DEFAULT NULL,
  ...
  X_FIELD_ID BIGINT DEFAULT NULL,
  X_FIELD_NAME VARCHAR(100) DEFAULT NULL,
  CRITERIA_ID BIGINT DEFAULT NULL,
  WORKFLOW_ID BIGINT DEFAULT NULL,
  CONSTRAINT REPORT_X_CRITERIA_ORGID_FK FOREIGN KEY (ORGID) REFERENCES Organizations (ORGID),
  CONSTRAINT REPORT_X_CRITERIA_SITE_ID_FK FOREIGN KEY (SITE_ID) REFERENCES Site (ID),
  CONSTRAINT REPORT_X_CRITERIA_CRITERIA_ID_FK FOREIGN KEY (CRITERIA_ID) REFERENCES Criteria (CRITERIAID),
  CONSTRAINT REPORT_X_CRITERIA_FIELD_ID_FK FOREIGN KEY (X_FIELD_ID) REFERENCES Fields (FIELDID),
  CONSTRAINT REPORT_X_CRITERIA_MODULE_ID_FK FOREIGN KEY (MODULE_ID) REFERENCES Modules (MODULEID),
  CONSTRAINT REPORT_X_CRITERIA_REPORT_ID_FK FOREIGN KEY (REPORT_ID) REFERENCES Report1 (ID),
  CONSTRAINT REPORT_X_CRITERIA_WORKFLOW_ID_FK FOREIGN KEY (WORKFLOW_ID) REFERENCES Workflow (ID) 
);

CREATE TABLE IF NOT EXIST Report1_BaseLine_Rel (
  ID BIGINT NOT NULL AUTO_INCREMENT PRIMARY KEY,
  ORGID BIGINT NOT NULL,
  SITE_ID BIGINT DEFAULT NULL,
  BASE_LINE_ID BIGINT NOT NULL,
  REPORT_DATA_POINT_ID BIGINT DEFAULT NULL,
  ADJUST_TYPE TINYINT DEFAULT NULL,
  CONSTRAINT REPORT1_BASELINE_REL_ORGID_FK FOREIGN KEY (ORGID) REFERENCES Organizations (ORGID),
  CONSTRAINT REPORT1_BASELINE_REL_SITE_ID_FK FOREIGN KEY (SITE_ID) REFERENCES Site (ID),
  CONSTRAINT REPORT1_BASELINE_REL_BASE_LINE_ID_FK FOREIGN KEY (BASE_LINE_ID) REFERENCES BaseLines (ID),
  CONSTRAINT REPORT1_BASELINE_REL_REPORT_DATA_POINT_ID_FK FOREIGN KEY (REPORT_DATA_POINT_ID) REFERENCES Report_Data_Point (ID) 
);


CREATE TABLE IF NOT EXIST Report1_Benchmark_Rel (
  ID BIGINT NOT NULL AUTO_INCREMENT PRIMARY KEY,
  ORGID BIGINT NOT NULL,
  SITE_ID BIGINT DEFAULT NULL,
  BENCHMARK_ID BIGINT NOT NULL,
  REPORT_DATA_POINT_ID BIGINT DEFAULT NULL,
  CONSTRAINT REPORT1_BENCHMARK_REL_ORGID_FK FOREIGN KEY (ORGID) REFERENCES Organizations (ORGID),
  CONSTRAINT REPORT1_BENCHMARK_REL_SITE_ID_FK FOREIGN KEY (SITE_ID) REFERENCES Site (ID),
  CONSTRAINT REPORT1_BENCHMARK_REL_BASE_LINE_ID_FK FOREIGN KEY (BENCHMARK_ID) REFERENCES BaseLines (ID),
  CONSTRAINT REPORT1_BENCHMARK_REL_REPORT_DATA_POINT_ID_FK FOREIGN KEY (REPORT_DATA_POINT_ID) REFERENCES Report_Data_Point (ID)
);
...
CREATE INDEX COST_READINGS_TIME_INDEX on Cost_Readings (TTIME);
CREATE INDEX COST_READINGS_DATE_INDEX on Cost_Readings (TTIME_DATE);
