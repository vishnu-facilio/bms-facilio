...
CREATE TABLE IF NOT EXIST Report1_Folder (
  ...
  PRIMARY KEY (ID),
  CONSTRAINT report1_folder_module_id FOREIGN KEY (MODULEID) REFERENCES Modules (MODULEID),
  CONSTRAINT report1_folder_orgid FOREIGN KEY (ORGID) REFERENCES Organizations (ORGID) 
);
...
CREATE TABLE IF NOT EXIST Report1 (
  ...
  WORKFLOW_ID BIGINT DEFAULT NULL,
  PRIMARY KEY (ID),
  CONSTRAINT REPORT_ORGID1 FOREIGN KEY (ORGID) REFERENCES Organizations (ORGID),
  CONSTRAINT REPORT_SITE_ID FOREIGN KEY (SITE_ID) REFERENCES Site (ID),
  CONSTRAINT REPORT_WF_ID FOREIGN KEY (WORKFLOW_ID) REFERENCES Workflow (ID) 
);
...
CREATE TABLE IF NOT EXIST Report_Data_Point (
  ...
  PRIMARY KEY (ID),
  CONSTRAINT REPORT_DATA_CRITERIA_1 FOREIGN KEY (CRITERIA_ID) REFERENCES Criteria (CRITERIAID),
  CONSTRAINT REPORT_DATA_CRITERIA_2 FOREIGN KEY (TRANSFORM_CRITERIA_ID) REFERENCES Criteria (CRITERIAID),
  CONSTRAINT REPORT_DATA_POINT_FIELD_ID1 FOREIGN KEY (X_AXIS_FIELD) REFERENCES Fields (FIELDID),
  CONSTRAINT REPORT_DATA_POINT_FIELD_ID2 FOREIGN KEY (Y_AXIS_FIELD) REFERENCES Fields (FIELDID),
  CONSTRAINT REPORT_DATA_POINT_MODULE_ID FOREIGN KEY (MODULE_ID) REFERENCES Modules (MODULEID),
  CONSTRAINT REPORT_DATA_POINT_REPORT_ID FOREIGN KEY (REPORT_ID) REFERENCES Report1 (ID),
  CONSTRAINT REPORT_DATA_WORKFLOW FOREIGN KEY (TRANSFORM_WORKFLOW_ID) REFERENCES Workflow (ID) 
);
...
CREATE TABLE IF NOT EXIST Report_X_Criteria (
  ...
  WORKFLOW_ID BIGINT DEFAULT NULL,
  PRIMARY KEY (ID),
  CONSTRAINT Report_X_Criteria_CRITERIA_ID FOREIGN KEY (CRITERIA_ID) REFERENCES Criteria (CRITERIAID),
  CONSTRAINT Report_X_Criteria_FIELD_ID FOREIGN KEY (X_FIELD_ID) REFERENCES Fields (FIELDID),
  CONSTRAINT Report_X_Criteria_MODULE_ID FOREIGN KEY (MODULE_ID) REFERENCES Modules (MODULEID),
  CONSTRAINT Report_X_Criteria_REPORT_ID FOREIGN KEY (REPORT_ID) REFERENCES Report1 (ID),
  CONSTRAINT Report_X_Criteria_WORKFLOW_ID FOREIGN KEY (WORKFLOW_ID) REFERENCES Workflow (ID) 
);


CREATE TABLE IF NOT EXIST Report_Meta (
  ID BIGINT NOT NULL AUTO_INCREMENT,
  REPORT_ID BIGINT DEFAULT NULL,
  CHART_META VARCHAR(5000) DEFAULT NULL,
  TABULAR_META VARCHAR(5000) DEFAULT NULL,
  PRIMARY KEY (ID),
  CONSTRAINT Report_Meta_report_id FOREIGN KEY (REPORT_ID) REFERENCES Report1 (ID) 
);
...
CREATE TABLE IF NOT EXIST Report1_BaseLine_Rel (
  ...
  ADJUST_TYPE tinyint(4) DEFAULT NULL,
  PRIMARY KEY (BASE_LINE_ID),
  CONSTRAINT Report1_BaseLine_Rel_baseline_id FOREIGN KEY (BASE_LINE_ID) REFERENCES BaseLines (ID),
  CONSTRAINT Report1_BaseLine_Rel_report_DP_ID FOREIGN KEY (REPORT_DATA_POINT_ID) REFERENCES Report_Data_Point (ID) 
);
