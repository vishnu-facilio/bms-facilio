...
CREATE TABLE IF NOT EXISTS ViewColumns (
	ID BIGINT AUTO_INCREMENT PRIMARY KEY,
	VIEWID BIGINT NOT NULL,
	FIELDID BIGINT NOT NULL,
	CONSTRAINT VIEW_FIELDS_VIEWID_FK FOREIGN KEY (VIEWID) REFERENCES Views(VIEWID),
	CONSTRAINT VIEWS_FIELDS_UNIQUE UNIQUE(VIEWID, FIELDID)
);
