...
CREATE TABLE IF NOT EXISTS Campus (
	...
	CONSTRAINT CAMPUS_FK_PHOTO_ID FOREIGN KEY (PHOTO_ID) REFERENCES File (FILE_ID),
...
CREATE TABLE IF NOT EXISTS Building (
	...
	CONSTRAINT BUILDING_FK_PHOTO_ID FOREIGN KEY (PHOTO_ID) REFERENCES File (FILE_ID)
);
...
CREATE TABLE IF NOT EXISTS Floor (
	...
	CONSTRAINT FLOOR_FK_PHOTO_ID FOREIGN KEY (PHOTO_ID) REFERENCES File (FILE_ID)
);
...
CREATE TABLE IF NOT EXISTS Space (
	...
	CONSTRAINT SPACE_FK_PHOTO_ID FOREIGN KEY (PHOTO_ID) REFERENCES File (FILE_ID)
);
...
CREATE TABLE IF NOT EXISTS WorkOrders (
	...
	CONSTRAINT WORK_ORDERS_FK_ID FOREIGN KEY (ID) REFERENCES Tickets(ID),
...
CREATE TABLE IF NOT EXISTS WorkOrderRequests (
	...
	CONSTRAINT WORK_ORDER_REQUESTS_FK_ID FOREIGN KEY (ID) REFERENCES Tickets(ID),
...
CREATE TABLE IF NOT EXISTS Tasks (
	...
	CONSTRAINT TASKS_FK_ID FOREIGN KEY (ID) REFERENCES Tickets(ID)
);
...
CREATE TABLE IF NOT EXISTS Alarms (
	...
	CONSTRAINT ALARMS_FK_ID FOREIGN KEY (ID) REFERENCES Tickets(ID),
...
CREATE TABLE IF NOT EXISTS Event (
	...
	CONSTRAINT EVENT_FK_MODULEID FOREIGN KEY (MODULEID) REFERENCES Modules(MODULEID),
...
CREATE TABLE IF NOT EXISTS Workorder_Template (
  	...
  	CONSTRAINT WORKORDER_TEMPLATE_ID_FK FOREIGN KEY (ID) REFERENCES Templates(ID) ON DELETE CASCADE
);

CREATE TABLE IF NOT EXISTS Preventive_Maintenance (
  	PREVENTIVE_MAINTENANCE_ID BIGINT AUTO_INCREMENT PRIMARY KEY,
  	ORGID BIGINT NOT NULL,
  	TITLE VARCHAR(100),
  	PM_TYPE TINYINT,
  	STATUS BOOLEAN,
...
CREATE TABLE IF NOT EXISTS Workflow_Rule (
	...
	CONSTRAINT WORKFLOW_RULE_EVENT_ID_FK FOREIGN KEY (EVENT_ID) REFERENCES Workflow_Event(ID),
...
CREATE TABLE IF NOT EXISTS Ticket_Activity (
	TICKET_ACTIVITY_ID BIGINT AUTO_INCREMENT PRIMARY KEY,
	TICKET_ID BIGINT NOT NULL,
	MODIFIED_TIME BIGINT NOT NULL,
	MODIFIED_BY BIGINT NOT NULL,
	ACTIVITY_TYPE INT NOT NULL,
	INFO VARCHAR(5000),
	CONSTRAINT Ticket_Activity_FK_TICKET_ID FOREIGN KEY (TICKET_ID) REFERENCES Tickets(ID),
