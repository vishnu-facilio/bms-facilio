...
CREATE TABLE IF NOT EXISTS Ticket_Task (
	...
	TICKET_ID BIGINT,
	TASK_ID BIGINT,
	CONSTRAINT TICKET_TASK_FK_TICKET_ID FOREIGN KEY (TICKET_ID) REFERENCES Tickets(TICKETID),
	CONSTRAINT TICKET_TASK_FK_TASK_ID FOREIGN KEY (TASK_ID) REFERENCES Tasks(TASKID)
);
...
CREATE TABLE IF NOT EXISTS Ticket_Note (
	...
	TICKET_ID BIGINT,
	NOTE_ID BIGINT,
	CONSTRAINT TICKET_NOTE_FK_TICKET_ID FOREIGN KEY (TICKET_ID) REFERENCES Tickets(TICKETID),
...
CREATE TABLE IF NOT EXISTS Task_Note (
	...
	TASK_ID BIGINT,
	NOTE_ID BIGINT,
	CONSTRAINT TASKS_NOTES_FK_TASK_ID FOREIGN KEY (TASK_ID) REFERENCES Tasks(TASKID),
	CONSTRAINT TASKS_NOTES_FK_NOTE_ID FOREIGN KEY (NOTE_ID) REFERENCES Notes(NOTEID)
);
