...
CREATE TABLE IF NOT EXISTS Dashboard_vs_Widget (
  ...
  CONSTRAINT dashboard_vs_widget_widget_id FOREIGN KEY (WIDGET_ID) REFERENCES Widget (WIDGET_ID)
);
...
CREATE TABLE IF NOT EXISTS Widget_Period (
  ...
  CONSTRAINT WIDGET_PERIOD_WIDGET_ID FOREIGN KEY (WIDGET_ID) REFERENCES widget (WIDGET_ID)
);
