...
CREATE TABLE IF NOT EXISTS Push_Notification_Templates (
	...
	TO_UID BIGINT,
	MSG VARCHAR(250) NOT NULL,
	CONSTRAINT PUSH_NOTIFICATION_TEMPLATE_FK_TO_ID FOREIGN KEY (TO_UID) REFERENCES ORG_Users(ORG_USERID),
...
CREATE TABLE IF NOT EXISTS Web_Notification_Templates (
	...
	TO_UID BIGINT,
	MSG VARCHAR(250) NOT NULL,
	CONSTRAINT WEB_NOTIFICATION_TEMPLATE_FK_TO_ID FOREIGN KEY (TO_UID) REFERENCES ORG_Users(ORG_USERID),
