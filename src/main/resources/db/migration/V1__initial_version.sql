...
SELECT TOTAL_ENERGY_CONSUMPTION INTO PREV_ENERGY_CONSUMPTION FROM Energy_Data WHERE DEVICE_ID = NEW.DEVICE_ID ORDER BY ADDED_TIME DESC LIMIT 1;
...
CREATE TABLE IF NOT EXISTS Workflow_Rule (
	WORKFLOW_RULE_ID BIGINT AUTO_INCREMENT PRIMARY KEY,
	ORGID BIGINT NOT NULL,
	NAME VARCHAR(100),
	DESCRIPTION VARCHAR(1000),
	...
	CONSTRAINT WORKFLOW_RULE_EVENT_ID_FK FOREIGN KEY (EVENT_ID) REFERENCES Event(EVENT_ID),
...
CREATE TABLE IF NOT EXISTS Workflow_Rule_Action (
	...
	CONSTRAINT WORKFLOW_ACTION_RULE_WORKFLOW_ID_FK FOREIGN KEY (WORKFLOW_RULE_ID) REFERENCES Workflow_Rule(WORKFLOW_RULE_ID),
	CONSTRAINT WORKFLOW_ACTION_RULE_ACTION_ID_FK FOREIGN KEY (ACTION_ID) REFERENCES Action(ACTION_ID)
