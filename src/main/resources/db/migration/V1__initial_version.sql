...
CREATE TABLE IF NOT EXISTS Tenants_Utility_Mapping (
 ...
 CREATE TABLE IF NOT EXISTS Rate_Card_Services {
	...
	CONSTRAINT RATE_CARD_SERVICES_FK_RATE_CARD_ID FOREIGN KEY (RATE_CARD_ID) REFERENCES Rate_Card (ID),
	CONSTRAINT RATE_CARD_SERVICES_FK_UTILITY_ID FOREIGN KEY (UTILITY_ID) REFERENCES Tenants_Utility (ID),
