...
CREATE TABLE IF NOT EXISTS Controller (
	...
	CONSTRAINT CONTROLLER_UNIQUE_MAC_ADDR UNIQUE(MAC_ADDR)
);
...
CREATE TABLE IF NOT EXISTS Controller_Activity (
	...
	CONSTRAINT Controller_Activity_FK_CONTROLLER_ID FOREIGN KEY (CONTROLLER_ID) REFERENCES Controller(ID)
);
...
CREATE TABLE IF NOT EXISTS Controller_Activity_Records ( -- Having separate table because Controller_Activity will be queried frequently
	...
	CONSTRAINT CONTROLLER_ACTIVITY_RECORDS_FK_ID FOREIGN KEY (ID) REFERENCES Controller_Activity(ID),
