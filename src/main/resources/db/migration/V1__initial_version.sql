...
CREATE TABLE PM_Remainders (
	ID BIGINT AUTO_INCREMENT PRIMARY KEY,
	ORGID BIGINT NOT NULL,
	PM_ID BIGINT NOT NULL,
	REMAINDER_TYPE TINYINT NOT NULL,
	DURATION BIGINT NOT NULL,
	ACTION_ID BIGINT NOT NULL,
	CONSTRAINT PM_REMAINDER_FK_ORGID FOREIGN KEY (ORGID) REFERENCES Organizations(ORGID),
	CONSTRAINT PM_REMAINDER_FK_PM_ID FOREIGN KEY (PM_ID) REFERENCES Preventive_Maintenance(ID),
	CONSTRAINT PM_REMAINDER_FK_ACTION_ID FOREIGN KEY (ACTION_ID) REFERENCES Action(ID)
);
