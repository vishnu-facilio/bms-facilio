...
CREATE TABLE IF NOT EXISTS  Approver_Actions_Rel (
	...
	CONSTRAINT APPROVER_ACTIONS_REL_FK_APPROVER_ID FOREIGN KEY (APPROVER_ID) REFERENCES Approvers(ID),
	CONSTRAINT APPROVER_ACTIONS_REL_FK_ACTION_ID FOREIGN KEY (ACTION_ID) REFERENCES Action(ID)
);
