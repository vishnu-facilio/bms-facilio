...
CREATE TABLE IF NOT EXISTS BaseSpace (
	...
	BUILDING_ID BIGINT,
	FLOOR_ID BIGINT,
	CONSTRAINT BASE_SPACE_FK_ID FOREIGN KEY (ID) REFERENCES Resources(ID),
...
CREATE TABLE IF NOT EXISTS BaseSpace_Readings (
	...
	CONSTRAINT BASESPACE_READINGS_FK_SPACE_ID FOREIGN KEY (SPACE_ID) REFERENCES BaseSpace(ID),
	CONSTRAINT BASESPACE_READINGS_FK_READING_ID FOREIGN KEY (READING_ID) REFERENCES Modules(MODULEID)
);
...
CREATE TABLE IF NOT EXISTS Assets (
	...
	LOCAL_ID INT,
	CONSTRAINT ASSET_FK_ID FOREIGN KEY (ID) REFERENCES Resources(ID),
...
CREATE TABLE IF NOT EXISTS Chiller (
	...
	ORGID BIGINT NOT NULL,
	MODULEID BIGINT NOT NULL,
	CONSTRAINT CHILLER_FK_ID FOREIGN KEY (ID) REFERENCES Assets(ID),
...
CREATE TABLE IF NOT EXISTS AHU (
	...
	ORGID BIGINT NOT NULL,
	MODULEID BIGINT NOT NULL,
	CONSTRAINT AHU_FK_ID FOREIGN KEY (ID) REFERENCES Assets(ID),
...
CREATE TABLE IF NOT EXISTS Task_Section (
	...
	CONSTRAINT TASK_SECTION_FK_PARENT_TICKET_ID FOREIGN KEY (PARENT_TICKET_ID) REFERENCES Tickets(ID)
);
...
CREATE TABLE IF NOT EXISTS EnergyPerformanceIndicator (
	...
	CONSTRAINT ENERGY_PERFORMANCE_INDICATOR_EXPRESSION_ID FOREIGN KEY (EXPRESSION_ID) REFERENCES Expression (ID),
...
CREATE TABLE IF NOT EXISTS Template_placeholder (
	...
	CONSTRAINT TEMPLATE_PLACEHOLDER_TEMPLATE_ID_FK FOREIGN KEY (TEMPLATE_ID) REFERENCES Templates(ID)
);
...
CREATE TABLE IF NOT EXISTS Workflow_Rule (
	...
	CONSTRAINT WORKFLOW_RULE_EXPRESSION_ID_FK FOREIGN KEY (EXPRESSION_ID) REFERENCES Expression(ID)
);
...
CREATE TABLE IF NOT EXISTS Preventive_Maintenance (
	...
	CONSTRAINT PREVENTIVE_MAINTENANCE_FK_RESOURCE_ID FOREIGN KEY (RESOURCE_ID) REFERENCES Resources(ID),
	CONSTRAINT PREVENTIVE_MAINTENANCE_FK_TYPE_ID FOREIGN KEY (TYPE_ID) REFERENCES TicketType(ID),
	CONSTRAINT PREVENTIVE_MAINTENANCE_FK_ASSIGNMENT_GROUP FOREIGN KEY (ASSIGNMENT_GROUP_ID) REFERENCES Groups(GROUPID),
	CONSTRAINT PREVENTIVE_MAINTENANCE_FK_ASSIGNED_TO_ID FOREIGN KEY (ASSIGNED_TO_ID) REFERENCES ORG_Users(ORG_USERID)
);
...
CREATE TABLE IF NOT EXISTS PM_To_WO (
	...
	CONSTRAINT PM_TO_WO_FK_PM_ID FOREIGN KEY (PM_ID) REFERENCES Preventive_Maintenance(ID) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS Alarm_vs_Energy_Data (
  ...
  CRITERIA_ID BIGINT DEFAULT NULL,
  CONSTRAINT ALARM_VS_ENERGY_DATA_ALARM_ID FOREIGN KEY (ALARM_ID) REFERENCES Alarms (ID),
...
CREATE TABLE IF NOT EXISTS PM_Jobs(
	...
	CONSTRAINT PM_TRIGGERS_FK_TEMPLATE_ID FOREIGN KEY (TEMPLATE_ID) REFERENCES JSON_Template(ID)
);
