...
CREATE TABLE IF NOT EXISTS User_Workhour_Readings (
	...
	CONSTRAINT USER_WORKHOUR_READINGS_FK_WO_ID FOREIGN KEY (WO_ID) REFERENCES WorkOrders(ID)
);
...
CREATE TABLE IF NOT EXISTS Shift_User_Rel (
	...
	CONSTRAINT SHIFT_USER_REL_USERID_FK FOREIGN KEY (USERID) REFERENCES Users (USERID) ON DELETE CASCADE,
