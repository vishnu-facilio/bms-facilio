...
CREATE TABLE IF NOT EXISTS Campus_Notes (
	CAMPUS_NOTE_ID BIGINT AUTO_INCREMENT PRIMARY KEY,
	CAMPUS_ID BIGINT,
	NOTEID BIGINT,
	CONSTRAINT CAMPUS_NOTES_FK_CAMPUS_ID FOREIGN KEY (CAMPUS_ID) REFERENCES Campus(CAMPUS_ID),
	CONSTRAINT CAMPUS_NOTES_FK_NOTE_ID FOREIGN KEY (NOTEID) REFERENCES Notes(NOTEID)
);
...
CREATE TABLE IF NOT EXISTS Building (
	...
	MAX_OCCUPANCY INT,
	PERCENT_OCCUPIED DOUBLE,
	UTILIZATION_MIN DOUBLE,
	UTILIZATION_MAX DOUBLE,
	STRING_CF1 VARCHAR(50),
	STRING_CF2 VARCHAR(50),
	STRING_CF3 VARCHAR(50),
	STRING_CF4 VARCHAR(50),
	...
	CONSTRAINT BUILDING_FK_BUILDING_ID FOREIGN KEY (BUILDING_ID) REFERENCES Assets(ASSETID),
