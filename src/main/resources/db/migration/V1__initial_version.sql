...
CREATE TABLE IF NOT EXISTS FormulaFields (
	FIELDID BIGINT PRIMARY KEY,
	ORGID BIGINT NOT NULL,
	WORKFLOW_ID BIGINT NOT NULL,
	INTERVAL INT,
	RESULT_DATA_TYPE TINYINT NOT NULL,
	FORMULA_FIELD_TYPE TINYINT NOT NULL,
	CONSTRAINT FORMULA_FIELDS_FK_ORGID FOREIGN KEY (ORGID) REFERENCES Organizations(ORGID),
	CONSTRAINT FORMULA_FIELDS_FK_FIELDID FOREIGN KEY (FIELDID) REFERENCES Fields(FIELDID) ON DELETE CASCADE,
	CONSTRAINT FORMULA_FIELDS_FK_WORKFLOW_ID FOREIGN KEY (WORKFLOW_ID) REFERENCES Workflow(ID) 
);
