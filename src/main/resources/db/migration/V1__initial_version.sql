...
CREATE TABLE IF NOT EXISTS Controller (
	...
	CONSTRAINT CONTROLLER_FK_BUILDING_ID FOREIGN KEY (BUILDING_ID) REFERENCES Building(ID)
);
...
CREATE TABLE IF NOT EXISTS Workflow_Field_Change_Fields (
	...
	CONSTRAINT WORKFLOW_FIELD_CHANGE_FIELDS_RULE_ID_FK FOREIGN KEY (RULE_ID) REFERENCES Workflow_Rule (ID),
...
CREATE TABLE IF NOT EXISTS Report1 (
  ...
  WORKFLOW_ID BIGINT DEFAULT NULL,
  CHART_STATE_JSON VARCHAR(5000) DEFAULT NULL,
  TABULAR_STATE_JSON VARCHAR(5000) DEFAULT NULL,
  COMMON_STATE_JSON VARCHAR(5000) DEFAULT NULL,
  DATE_OPERATOR INT DEFAULT NULL,
  DATE_VALUE VARCHAR(45) DEFAULT NULL,
  DATE_RANGE_JSON VARCHAR(100) DEFAULT NULL,
  DATA_POINT_JSON VARCHAR(10000) DEFAULT NULL,
  X_CRITERIA_JSON VARCHAR(5000) DEFAULT NULL,
  BASELINE_JSON VARCHAR(5000) DEFAULT NULL,
  BENCHMARK_JSON VARCHAR(5000) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS Tenant_Users (
    ...
    ORG_USERID BIGINT(20) NOT NULL,
 	CONSTRAINT TENANT_USERS_FK_ORGID FOREIGN KEY (ORGID) REFERENCES Organizations (ORGID),
  	CONSTRAINT TENANT_USERS_FK_ORG_USERID FOREIGN KEY (ORG_USERID) REFERENCES ORG_Users (ORG_USERID),
	CONSTRAINT TENANT_USERS_FK_TENANTID FOREIGN KEY (TENANTID) REFERENCES Tenants (ID)
);
