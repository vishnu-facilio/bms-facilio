...
CREATE TABLE IF NOT EXISTS Workflow (
	...
	CRITERIAID BIGINT NOT NULL,
	STATUS INT,
	CONSTRAINT WORKFLOW_ORGID_FK FOREIGN KEY (ORGID) REFERENCES Organizations(ORGID),
	CONSTRAINT WORKFLOW_MODULEID_FK FOREIGN KEY (MODULEID) REFERENCES Modules(MODULEID),
	CONSTRAINT WORKFLOW_CRITERIAID_FK FOREIGN KEY (CRITERIAID) REFERENCES Criteria(CRITERIAID)
);