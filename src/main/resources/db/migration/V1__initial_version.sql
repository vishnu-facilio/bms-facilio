...
CREATE TABLE IF NOT EXISTS Additonal_Costs (
	ID BIGINT AUTO_INCREMENT PRIMARY KEY,
	ORGID BIGINT NOT NULL,
	SITE_ID BIGINT,
	COST_ID BIGINT NOT NULL,
...
CREATE TABLE IF NOT EXISTS Cost_Readings (
	...
	CONSTRAINT COST_READINGS_FK_PARENT_ID FOREIGN KEY (PARENT_ID) REFERENCES Preventive_Maintenance(ID)
);
