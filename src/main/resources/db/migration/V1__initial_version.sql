...
CREATE TABLE IF NOT EXISTS Controller_Activity (
	...
	CONSTRAINT CONTROLLER_ACTIVITY_UNIQUE_ORGID_MAC_ADDR UNIQUE(ORGID, CONTROLLER_MAC_ADDR)
);
...
CREATE TABLE IF NOT EXISTS Controller_Actvity_Watcher (
	ID BIGINT AUTO_INCREMENT PRIMARY KEY,
	ORGID BIGINT NOT NULL,
	CREATED_TIME BIGINT NOT NULL,
	RECORD_TIME BIGINT NOT NULL,
	...
	CONSTRAINT CONTROLLER_ACTVITY_WATCHER_FK_ID FOREIGN KEY (ID) REFERENCES Controller_Activity(ID) ON DELETE CASCADE,
	CONSTRAINT CONTROLLER_ACTVITY_WATCHER_FK_ORGID FOREIGN KEY (ORGID) REFERENCES Organizations(ORGID)
);
