...
CREATE TABLE IF NOT EXISTS ORG_Users (
	ORG_USERID BIGINT PRIMARY KEY AUTO_INCREMENT,
	USERID BIGINT,
	ORGID BIGINT NOT NULL,
	INVITEDTIME BIGINT,
	LICENSE INT,
...
CREATE TABLE IF NOT EXISTS EnumFieldValues (
	...
	CONSTRAINT ENUM_FIELD_SEQUENCE_NUMBER_UNIQUE UNIQUE (ORGID,FIELDID,SEQUENCE_NUMBER),
...
CREATE TABLE IF NOT EXISTS SystemEnumFields (
    ...
    CONSTRAINT SYSTEM_ENUM_FIELDS_FK_ORGID FOREIGN KEY (ORGID) REFERENCES Organizations(ORGID),
...
CREATE TABLE IF NOT EXISTS Workflow_User_Function (
  ...
  CONSTRAINT Workflow_User_Function_orgid FOREIGN KEY (ORGID) REFERENCES Organizations (ORGID) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
CREATE TABLE IF NOT EXISTS Controllers (
	...
	LAST_MODIFIED_TIME BIGINT NOT NULL,
	LAST_DATA_RECEIVED_TIME BIGINT,
	CONSTRAINT CONTROLLERS_FK_ID FOREIGN KEY (ID) REFERENCES Assets(ID) ON DELETE CASCADE,
	CONSTRAINT CONTROLLERS_FK_ORGID FOREIGN KEY (ORGID) REFERENCES Organizations(ORGID),
	...
	CONSTRAINT CONTROLLERS_FK_AGENT_ID FOREIGN KEY (AGENT_ID) REFERENCES Agent_Data(ID)
);
...
CREATE TABLE IF NOT EXISTS Misc_Controller (
	...
	CONSTRAINT Misc_Controller_FK_ORGID FOREIGN KEY (ORGID) REFERENCES Organizations(ORGID),
	...
	CONSTRAINT Misc_Controller_FK_AGENT_ID FOREIGN KEY (AGENT_ID) REFERENCES Agent_Data(ID)
);
...
CREATE TABLE IF NOT EXISTS BACnet_IP_Controller (
	...
	CONSTRAINT BACnet_IP_Controller_FK_ORGID FOREIGN KEY (ORGID) REFERENCES Organizations(ORGID),
	...
	CONSTRAINT BACnet_IP_Controller_FK_AGENT_ID FOREIGN KEY (AGENT_ID) REFERENCES Agent_Data(ID),
	CONSTRAINT BACnet_IP_Controller_META_UNIQUE UNIQUE (ORGID,MODULEID,AGENT_ID,IP_ADDRESS,INSTANCE_NUMBER,NETWORK_NUMBER)
);
...
CREATE TABLE IF NOT EXISTS Niagara_Controller (
	...
	CONSTRAINT Niagara_Controller_FK_ORGID FOREIGN KEY (ORGID) REFERENCES Organizations(ORGID),
	...
	CONSTRAINT Niagara_Controller_FK_AGENT_ID FOREIGN KEY (AGENT_ID) REFERENCES Agent_Data(ID),
...
CREATE TABLE IF NOT EXISTS LonWorks_Controller (
	...
	CONSTRAINT LonWorks_Controller_FK_ORGID FOREIGN KEY (ORGID) REFERENCES Organizations(ORGID),
	...
	CONSTRAINT LonWorks_Controller_FK_AGENT_ID FOREIGN KEY (AGENT_ID) REFERENCES Agent_Data(ID),
	CONSTRAINT LonWorks_Controller_META_UNIQUE UNIQUE (ORGID,MODULEID,AGENT_ID,NEURON_ID)
);

CREATE TABLE IF NOT EXISTS Modbus_Controller (
	ID BIGINT PRIMARY KEY,
	ORGID BIGINT NOT NULL,
	SITE_ID BIGINT,
	MODULEID BIGINT NOT NULL,
	AGENT_ID BIGINT,
	SLAVE_ID INT,
	COM_PORT VARCHAR(100),
	CONSTRAINT Modbus_Controller_FK_ID FOREIGN KEY (ID) REFERENCES Controllers (ID) ON DELETE CASCADE,
	CONSTRAINT Modbus_Controller_FK_ORGID FOREIGN KEY (ORGID) REFERENCES Organizations(ORGID),
	...
	CONSTRAINT Modbus_Controller_FK_AGENT_ID FOREIGN KEY (AGENT_ID) REFERENCES Agent_Data(ID),
	CONSTRAINT Modbus_Controller_META_UNIQUE UNIQUE (ORGID,MODULEID,AGENT_ID,SLAVE_ID,COM_PORT)
);
...
CREATE TABLE IF NOT EXISTS OpcXMLDA_Controller (
	...
	CONSTRAINT OpcXMLDA_Controller_FK_ORGID FOREIGN KEY (ORGID) REFERENCES Organizations(ORGID),
	...
	CONSTRAINT OpcXMLDA_Controller_FK_AGENT_ID FOREIGN KEY (AGENT_ID) REFERENCES Agent_Data(ID),
...
CREATE TABLE IF NOT EXISTS OpcUA_Controller (
	...
	CONSTRAINT OpcUA_Controller_FK_ORGID FOREIGN KEY (ORGID) REFERENCES Organizations(ORGID),
	...
	CONSTRAINT OpcUA_Controller_FK_AGENT_ID FOREIGN KEY (AGENT_ID) REFERENCES Agent_Data(ID),
...
CREATE TABLE IF NOT EXISTS Assets (
	...
	CONSTRAINT ASSET_FK_PO_ID FOREIGN KEY (PO_ID) REFERENCES Purchase_Orders (ID)
...
CREATE TABLE Relationship (
  ...
  CONSTRAINT RELATIONSHIP_ORGID_FK FOREIGN KEY (ORGID) REFERENCES Organizations (ORGID) ON DELETE CASCADE);
...
CREATE TABLE Related_Assets (
  ...
  CONSTRAINT RELATED_ASSETES_ORGID_FK FOREIGN KEY (ORGID) REFERENCES Organizations (ORGID) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS Asset_Breakdown (
       ...
       CONSTRAINT ASSET_BREAKDOWN_FK_ORGID FOREIGN KEY (ORGID) REFERENCES Organizations(ORGID),
...
CREATE TABLE IF NOT EXISTS Asset_BD_SourceDetails (
       ...
       CONSTRAINT ASSET_BD_SOURCEDETAILS_FK_ORGID FOREIGN KEY (ORGID) REFERENCES Organizations(ORGID),
...
CREATE TABLE IF NOT EXISTS Controller_Asset (
	...
	CONSTRAINT CONTROLLER_CATEGORY_FK_ORGID FOREIGN KEY (ORGID) REFERENCES Organizations(ORGID),
...
CREATE TABLE IF NOT EXISTS Tasks (
	...
	CONSTRAINT TASKS_UNIQUE_ID UNIQUE(PARENT_TICKET_ID, UNIQUE_ID,IS_PRE_REQUEST),
...
CREATE TABLE IF NOT EXISTS Controller_Readings (
	...
	ENUM_CF4 INTEGER,
	ENUM_CF5 INTEGER,
	CONSTRAINT CONTROLLER_READINGS_FK_ORGID FOREIGN KEY (ORGID) REFERENCES Organizations(ORGID),
...
CREATE TABLE CMD_Notes (
  ...
  CONSTRAINT CMD_NOTES_FK_ORGID FOREIGN KEY (ORGID) REFERENCES Organizations (ORGID),
  CONSTRAINT CMD_NOTES_FK_PARENT_ID FOREIGN KEY (PARENT_ID) REFERENCES Tickets (ID) ON DELETE CASCADE
);

CREATE TABLE CMD_Attachments (
  ID bigint PRIMARY KEY AUTO_INCREMENT,
  ORGID bigint NOT NULL,
  MODULEID bigint NOT NULL,
  PARENT_TICKET bigint NOT NULL,
  ...
  CONSTRAINT CMD_ATTACHEMENTS_FK_ORGID FOREIGN KEY (ORGID) REFERENCES Organizations (ORGID),
  CONSTRAINT CMD_ATTACHEMENTS_FK_PARENT_TICKET FOREIGN KEY (PARENT_TICKET) REFERENCES CustomModuleData (ID)
);
...
CREATE TABLE IF NOT EXISTS Form_Rule (
  ...
  CONSTRAINT Form_Rules_fieldid FOREIGN KEY (FORM_FIELD_ID) REFERENCES Form_Fields (ID) ON DELETE CASCADE ON UPDATE NO ACTION,
  CONSTRAINT Form_Rules_form_id FOREIGN KEY (FORM_ID) REFERENCES Forms (ID) ON DELETE CASCADE ON UPDATE NO ACTION,
  CONSTRAINT Form_Rules_orgid FOREIGN KEY (ORGID) REFERENCES Organizations (ORGID) ON DELETE NO ACTION ON UPDATE NO ACTION
);
...
CREATE TABLE IF NOT EXISTS Form_Rule_Action (
  ...
  CONSTRAINT Form_Rule_Action_criteria_id FOREIGN KEY (CRITERIA_ID) REFERENCES Criteria (CRITERIAID) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ...
  CONSTRAINT Form_Rule_Action_fieldid FOREIGN KEY (FORM_FIELD_ID) REFERENCES Form_Fields (ID) ON DELETE CASCADE ON UPDATE NO ACTION,
  CONSTRAINT Form_Rule_Action_orgid FOREIGN KEY (ORGID) REFERENCES Organizations (ORGID) ON DELETE NO ACTION ON UPDATE NO ACTION
);
...
CREATE TABLE IF NOT EXISTS KPI_Category (
  ...
  ORGID BIGINT NOT NULL,
  NAME VARCHAR(100) NOT NULL,
  CONSTRAINT KPI_Category FOREIGN KEY (ORGID) REFERENCES Organizations (ORGID) ON DELETE NO ACTION ON UPDATE NO ACTION
);
...
CREATE TABLE IF NOT EXISTS Job_Plan (
	...
	ORGID BIGINT NOT NULL,
	NAME VARCHAR(100) NOT NULL,
	CONSTRAINT JOB_PLAN_ORGID_FK FOREIGN KEY (ORGID) REFERENCES Organizations(ORGID)
);
...
CREATE TABLE IF NOT EXISTS Prerequisite_Approvers_Template (
  ...
  CONSTRAINT APPROVERS_TEMPLATE_FK_ORGID FOREIGN KEY (ORGID) REFERENCES Organizations (ORGID),
  ...
  CONSTRAINT APPROVERS_TEMPLATE_FK_GROUP_ID FOREIGN KEY (GROUP_ID)  REFERENCES Groups (GROUPID));
...
ALTER TABLE Tasks ADD CONSTRAINT TASKS_FK_ACTION_ID FOREIGN KEY (ACTION_ID) REFERENCES Action(ID);
...
CREATE TABLE IF NOT EXISTS Prerequisite_Photos (
	...
	TTIME BIGINT NOT NULL,
	PHOTO_ID BIGINT NOT NULL,
	CONSTRAINT PREREQUISITE_PHOTOS_FK_ORGID FOREIGN KEY (ORGID) REFERENCES Organizations(ORGID),
...
CREATE TABLE IF NOT EXISTS Prerequisite_Approvers (
	...
	SHARING_TYPE TINYINT NOT NULL,
	FIELD_ID BIGINT,
	CONSTRAINT PREREQ_APPROVERS_FK_ORGID FOREIGN KEY (ORGID) REFERENCES Organizations(ORGID),
	...
	CONSTRAINT PREREQ_APPROVERS_FK_GROUP_ID FOREIGN KEY (GROUP_ID) REFERENCES Groups(GROUPID)
);
...
CREATE TABLE IF NOT EXISTS BaseAlarm (
	...
	CONSTRAINT BASEALARM_FK_ORGID FOREIGN KEY (ORGID) REFERENCES Organizations (ORGID),
...
CREATE TABLE IF NOT EXISTS AlarmOccurrence (
	...
	CONSTRAINT ALARMOCCURANCE_FK_ORGID FOREIGN KEY (ORGID) REFERENCES Organizations (ORGID),
	...
	CONSTRAINT ALARMOCCURANCE_FK_ALARMID FOREIGN KEY (ALARM_ID) REFERENCES BaseAlarm (ID),
	...
	CONSTRAINT ALARMOCCURANCE_FK_WOID FOREIGN KEY (WOID) REFERENCES WorkOrders (ID)
);
...
CREATE TABLE IF NOT EXISTS BaseEvent (
	...
	CONSTRAINT BASEEVENT_FK_ORGID FOREIGN KEY (ORGID) REFERENCES Organizations (ORGID),
	...
	CONSTRAINT BASEEVENT_FK_ALARMID FOREIGN KEY (ALARM_OCCURRENCE_ID) REFERENCES AlarmOccurrence (ID)
);
...
CREATE TABLE IF NOT EXISTS Dashboard_Tab (
  ...
  CONSTRAINT Dashboard_Tab_ORGID FOREIGN KEY (ORGID) REFERENCES Organizations (ORGID) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
CREATE TABLE IF NOT EXISTS Points (
 ...
 CREATE TABLE IF NOT EXISTS Point (
   ...
   MAPPED_TIME BIGINT,
   UNIT INT,
   CONSTRAINT Point_FK_ORGID FOREIGN KEY (ORGID) REFERENCES Organizations(ORGID),
   ...
   CONSTRAINT Point_FK_CONTROLLER_ID FOREIGN KEY (CONTROLLER_ID) REFERENCES Controller (ID) ON DELETE CASCADE,
 ...
 CREATE TABLE IF NOT EXISTS Misc_Point (
   ...
   ORGID BIGINT NOT NULL,
   CONTROLLER_ID BIGINT,
   CONSTRAINT Misc_Point_FK_ORGID FOREIGN KEY (ORGID) REFERENCES Organizations(ORGID),
   CONSTRAINT Misc_Point_FK_CONTROLLER_ID FOREIGN KEY (CONTROLLER_ID) REFERENCES Controller (ID),
 ...
 CREATE TABLE IF NOT EXISTS BACnet_IP_Point (
   ...
   CONSTRAINT BACnet_IP_Point_META_UNIQUE UNIQUE (ORGID,CONTROLLER_ID,INSTANCE_NUMBER,INSTANCE_TYPE),
   CONSTRAINT BACnet_IP_Point_FK_ORGID FOREIGN KEY (ORGID) REFERENCES Organizations(ORGID),
   CONSTRAINT BACnet_IP_Point_FK_CONTROLLER_ID FOREIGN KEY (CONTROLLER_ID) REFERENCES Controller (ID),
   ...
   CONSTRAINT Niagara_Point_META_UNIQUE UNIQUE (ORGID,CONTROLLER_ID,PATH(500)),
   CONSTRAINT Niagara_Point_FK_ORGID FOREIGN KEY (ORGID) REFERENCES Organizations(ORGID),
   CONSTRAINT Niagara_Point_FK_CONTROLLER_ID FOREIGN KEY (CONTROLLER_ID) REFERENCES Controller (ID),
   ...
   CREATE TABLE IF NOT EXISTS OPC_XML_DA_Point (
   	...
   	CONTROLLER_ID BIGINT,
   	PATH VARCHAR(1000) NOT NULL,
   	CONSTRAINT OPC_XML_DA__Point_META_UNIQUE UNIQUE (ORGID,CONTROLLER_ID,PATH(500)),
   	CONSTRAINT OPC_XML_DA_Point_FK_ORGID FOREIGN KEY (ORGID) REFERENCES Organizations(ORGID),
   	CONSTRAINT OPC_XML_DA_Point_FK_CONTROLLER_ID FOREIGN KEY (CONTROLLER_ID) REFERENCES Controller (ID),
   ...
   CONSTRAINT Modbus_Point_META_UNIQUE UNIQUE (ORGID,CONTROLLER_ID,REGISTER_NUMBER),
   CONSTRAINT Modbus_Point_FK_ORGID FOREIGN KEY (ORGID) REFERENCES Organizations(ORGID),
   CONSTRAINT Modbus_Point_FK_CONTROLLER_ID FOREIGN KEY (CONTROLLER_ID) REFERENCES Controller (ID),
   ...
   CONSTRAINT OPC_UA__Point_META_UNIQUE UNIQUE (ORGID,CONTROLLER_ID,NAME_SPACE,IDENTIFIER(500)),
   CONSTRAINT OPC_UA_Point_FK_ORGID FOREIGN KEY (ORGID) REFERENCES Organizations(ORGID),
   CONSTRAINT OPC_UA_Point_FK_CONTROLLER_ID FOREIGN KEY (CONTROLLER_ID) REFERENCES Controller (ID),
...
CREATE TABLE IF NOT EXISTS ReadingAlarm (
	...
	CONSTRAINT READINGALARM_FK_ORGID FOREIGN KEY (ORGID) REFERENCES Organizations (ORGID),
...
CREATE TABLE IF NOT EXISTS ReadingEvent (
	...
	CONSTRAINT READINGEVENT_FK_ORGID FOREIGN KEY (ORGID) REFERENCES Organizations (ORGID),
...
CREATE TABLE IF NOT EXISTS ML_Anomaly_Event(
	...
	CONSTRAINT ML_ANOMALY_EVENT_FK_ORGID FOREIGN KEY (ORGID) REFERENCES Organizations (ORGID),
...
CREATE TABLE IF NOT EXISTS ML_Anomaly_Alarm(
	...
	CONSTRAINT ML_ANOMALY_ALARM_FK_ORGID FOREIGN KEY (ORGID) REFERENCES Organizations (ORGID),
...
CREATE TABLE IF NOT EXISTS RCA_Event(
	...
	CONSTRAINT RCA_EVENT_FK_ORGID FOREIGN KEY(ORGID) REFERENCES Organizations (ORGID),
	CONSTRAINT RCA_EVENT_FK_ML_ID FOREIGN KEY (ML_ID) REFERENCES ML(ID),
	CONSTRAINT RCA_EVENT_FK_PARENT_ID FOREIGN KEY (PARENT_ID) REFERENCES BaseEvent(ID) ON DELETE CASCADE
);
...
CREATE TABLE IF NOT EXISTS RCA_Alarm(
	...
	CONSTRAINT RCA_ALARM_FK_ORGID FOREIGN KEY(ORGID) REFERENCES Organizations (ORGID),
...
CREATE TABLE ReadingRCAEvent (
  ...
  CONSTRAINT READINGRCA_EVENT_FK_PARENT_ID FOREIGN KEY (PARENT_ID) REFERENCES BaseEvent (ID) ON DELETE CASCADE
);

CREATE TABLE ReadingRCAAlarm (
  ID BIGINT NOT NULL PRIMARY KEY,
  ORGID BIGINT NOT NULL,
  PARENT_ID BIGINT NOT NULL,
  RULE_ID BIGINT NOT NULL,
  ...
  CONSTRAINT READINGRCA_ALARM_FK_PARENT_ID FOREIGN KEY (PARENT_ID) REFERENCES BaseAlarm (ID) ON DELETE CASCADE
);
...
CREATE TABLE Reset_Counter_Meta (
  ...
  CONSTRAINT RESET_COUNTER_META_FK_ORGID FOREIGN KEY (ORGID) REFERENCES Organizations (ORGID) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS Gate_Pass_Notes (
	...
	CONSTRAINT GATE_PASS_NOTES_NO_FK_ORGID FOREIGN KEY (ORGID) REFERENCES Organizations(ORGID),
...
CREATE TABLE IF NOT EXISTS Gate_Pass_Attachments (
	...
	CONSTRAINT GATE_PASS_ATTACHMENTS_FK_ORGID FOREIGN KEY (ORGID) REFERENCES Organizations(ORGID),
...
CREATE TABLE IF NOT EXISTS Inventory_Requests (
	...
	PARENT_ID BIGINT,
	STOREROOM BIGINT,
	CONSTRAINT INVENTORY_REQUESTS_FK_ORGID FOREIGN KEY (ORGID) REFERENCES Organizations (ORGID),
...
CREATE TABLE IF NOT EXISTS Inventory_Request_Attachments (
	...
	FILE_ID BIGINT NOT NULL,
	ATTACHMENT_TYPE TINYINT,
	CONSTRAINT Inventory_Request_ATTACHEMENTS_FK_ORGID FOREIGN KEY (ORGID) REFERENCES Organizations(ORGID),
...
CREATE TABLE IF NOT EXISTS Inventory_Request_Notes (
	...
	TITLE VARCHAR(50),
	BODY VARCHAR(1000) NOT NULL,
	CONSTRAINT Inventory_Request_NOTES_FK_ORGID FOREIGN KEY (ORGID) REFERENCES Organizations(ORGID),
...
CREATE TABLE IF NOT EXISTS InventoryRequestLineItems (
	...
	CONSTRAINT INVENTORYREQUESTLINEITEMS_FK_ORGID FOREIGN KEY (ORGID) REFERENCES Organizations (ORGID),
...
CREATE TABLE IF NOT EXISTS Shipment (
    ...
    SYS_DELETED_BY BIGINT,
	FORM_ID BIGINT,
	CONSTRAINT SHIPMENT_FK_ORGID FOREIGN KEY (ORGID) REFERENCES Organizations(ORGID),
...
CREATE TABLE IF NOT EXISTS Shipment_line_item (
	...
	CONSTRAINT SHIPMENT_LINE_ITEM_FK_ORGID FOREIGN KEY (ORGID) REFERENCES Organizations(ORGID),
...
CREATE TABLE IF NOT EXISTS Shipment_Notes (
	...
	CONSTRAINT SHIPMENT_NOTES_NO_FK_ORGID FOREIGN KEY (ORGID) REFERENCES Organizations(ORGID),
...
CREATE TABLE IF NOT EXISTS Shipment_Attachments (
	...
	CONSTRAINT SHIPMENT_ATTACHMENTS_FK_ORGID FOREIGN KEY (ORGID) REFERENCES Organizations(ORGID),
...
CREATE TABLE IF NOT EXISTS Tool_vendors (
	...
	CONSTRAINT TOOL_VENDORS_FK_ORGID FOREIGN KEY (ORGID) REFERENCES Organizations(ORGID),
...
CREATE TABLE IF NOT EXISTS Service (
	...
	CONSTRAINT SERVICE_FK_ORGID FOREIGN KEY (ORGID) REFERENCES Organizations (ORGID),
...
CREATE TABLE IF NOT EXISTS Connection_Params (
  ...
  CONSTRAINT Connection_Params_ORGID FOREIGN KEY (CONNECTION_ID) REFERENCES Organizations (ORGID) ON DELETE NO ACTION ON UPDATE NO ACTION
);
...
CREATE TABLE IF NOT EXISTS Shipped_Asset_Rel (
	...
	SHIPMENT_ID BIGINT,
	CONSTRAINT Shipped_Asset_Rel_ORGID_FK FOREIGN KEY (ORGID) REFERENCES Organizations(ORGID),
...
CREATE TABLE IF NOT EXISTS Attendance (
	...
	CONSTRAINT ATTENDANCE_FK_ORGID FOREIGN KEY (ORGID) REFERENCES Organizations(ORGID),
...
CREATE TABLE IF NOT EXISTS Attendance_Transactions (
	...
	CONSTRAINT ATTENDANCE_TRANSACTION_FK_ORGID FOREIGN KEY (ORGID) REFERENCES Organizations(ORGID),
...
CREATE TABLE IF NOT EXISTS Graphics_Folder (
	...
	NAME VARCHAR(100),
	DESCRIPTION VARCHAR(500),
	CONSTRAINT GRAPHICS_FOLDER_FK_ORGID FOREIGN KEY (ORGID) REFERENCES Organizations (ORGID)
);
...
CREATE TABLE IF NOT EXISTS Graphics (
	...
	CONSTRAINT GRAPHICS_FK_ORGID FOREIGN KEY (ORGID) REFERENCES Organizations (ORGID),
...
CREATE TABLE IF NOT EXISTS Widget_Graphics (
  ...
  CONSTRAINT WIDGET_GRAPHICS_ORGID FOREIGN KEY (ORGID) REFERENCES Organizations (ORGID),
...
CREATE TABLE IF NOT EXISTS MV_Project (
  ...
  CONSTRAINT MV_Project_orgid FOREIGN KEY (ORGID) REFERENCES Organizations (ORGID) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
CREATE TABLE IF NOT EXISTS MV_Baseline (
  ...
  CONSTRAINT MV_Baseline_ORGID FOREIGN KEY (ORGID) REFERENCES Organizations (ORGID) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
CREATE TABLE IF NOT EXISTS MV_Adjustment (
  ...
  CONSTRAINT MV_Adjustment_ORGID FOREIGN KEY (ORGID) REFERENCES Organizations (ORGID) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
CREATE TABLE IF NOT EXISTS Shift_Rotation (
	...
	CONSTRAINT SHIFT_ROTATION_FK_ORGID FOREIGN KEY (ORGID) REFERENCES Organizations(ORGID),
...
CREATE TABLE IF NOT EXISTS Shift_Rotation_Details (
	...
	CONSTRAINT SHIFT_ROTATION_DETAILS_FK_ORGID FOREIGN KEY (ORGID) REFERENCES Organizations(ORGID),
...
CREATE TABLE IF NOT EXISTS Shift_Rotation_Applicable_For (
	...
	CONSTRAINT SHIFTROTATION_USER_REL_ORGID_FK FOREIGN KEY (ORGID) REFERENCES Organizations(ORGID) ,
...
CREATE TABLE IF NOT EXISTS Store_Notification_config (
	...
	CONSTRAINT Store_Notification_config_ORGID_FK FOREIGN KEY (ORGID) REFERENCES Organizations(ORGID) ,
  ...
  CREATE TABLE IF NOT EXISTS Break_Transaction (
    	...
    	CONSTRAINT BREAK_TRANSACTION_FK_ORGID FOREIGN KEY (ORGID) REFERENCES Organizations(ORGID),
...
CREATE TABLE IF NOT EXISTS Warranty_Contracts (
	...
	CONSTRAINT WARRANTY_CONTRACTS_FK_ORGID FOREIGN KEY (ORGID) REFERENCES Organizations (ORGID),
...
CREATE TABLE IF NOT EXISTS Contracts_Associated_Assets (
	...
	TOTAL_COST DOUBLE,
	PO_ID BIGINT,
	CONSTRAINT Contracts_Associated_Assets_FK_ORGID FOREIGN KEY (ORGID) REFERENCES Organizations (ORGID),
...
CREATE TABLE IF NOT EXISTS WarrantyContractLineItems (
	...
	DURATION DOUBLE,
	TIME_UNIT TINYINT,
	CONSTRAINT WarrantyContractLineItems_FK_ORGID FOREIGN KEY (ORGID) REFERENCES Organizations (ORGID),
...
CREATE TABLE IF NOT EXISTS Workorder_service (
	...
	VENDOR BIGINT,
	SERVICE BIGINT,
	CONSTRAINT WORKORDER_SERVICE_FK_ORGID FOREIGN KEY (ORGID) REFERENCES Organizations(ORGID),
...
CREATE TABLE IF NOT EXISTS Service_vendors (
	...
	CONSTRAINT SERVICE_VENDORS_FK_ORGID FOREIGN KEY (ORGID) REFERENCES Organizations(ORGID),
...
CREATE TABLE IF NOT EXISTS Rental_Lease_Contracts (
	...
	CONSTRAINT RENTAL_LEASE_CONTRACTS_FK_ORGID FOREIGN KEY (ORGID) REFERENCES Organizations (ORGID),
...
CREATE TABLE IF NOT EXISTS RentalLeaseContractLineItems (
	...
	QUANTITY_RECEIVED DOUBLE,
	LEASE_END_VALUE DOUBLE,
	CONSTRAINT RentalLeaseContractLineItems_FK_ORGID FOREIGN KEY (ORGID) REFERENCES Organizations (ORGID),
...
CREATE TABLE IF NOT EXISTS Terms_And_Conditions (
	...
	CONSTRAINT TERMS_AND_CONDITIONS_FK_ORGID FOREIGN KEY (ORGID) REFERENCES Organizations (ORGID),
...
CREATE TABLE IF NOT EXISTS Terms_And_Conditions_Attachments (
	...
	FILE_ID BIGINT NOT NULL,
	ATTACHMENT_TYPE TINYINT,
	CONSTRAINT Terms_And_Conditions_ATTACHEMENTS_FK_ORGID FOREIGN KEY (ORGID) REFERENCES Organizations(ORGID),
...
CREATE TABLE IF NOT EXISTS Terms_And_Conditions_Notes (
	...
	TITLE VARCHAR(50),
	BODY VARCHAR(1000) NOT NULL,
	CONSTRAINT Terms_And_Conditions_NOTES_FK_ORGID FOREIGN KEY (ORGID) REFERENCES Organizations(ORGID),
...
CREATE TABLE IF NOT EXISTS Contracts_Associated_Terms (
	...
	CONSTRAINT Contracts_Associated_Terms_FK_ORGID FOREIGN KEY (ORGID) REFERENCES Organizations (ORGID),
...
CREATE TABLE IF NOT EXISTS Digest_Configuration (
	...
	DASHBOARD_ID BIGINT,
	IS_ACTIVE BOOLEAN,
	CONSTRAINT Digest_Configuration_FK_ORGID FOREIGN KEY (ORGID) REFERENCES Organizations (ORGID),
...
CREATE TABLE IF NOT EXISTS Digest_Configuration_Users (
	...
	USER_ID BIGINT,
	CONSTRAINT Digest_Configuration_Users_FK_ORGID FOREIGN KEY (ORGID) REFERENCES Organizations (ORGID),
...
CREATE TABLE IF NOT EXISTS Preferences (
	...
	IS_ACTIVE BOOLEAN,
	CONSTRAINT Preferences_FK_ORGID FOREIGN KEY (ORGID) REFERENCES Organizations (ORGID),
...
CREATE TABLE IF NOT EXISTS Preference_Rules (
	...
	PREFERENCE_NAME VARCHAR(500),
	RULE_ID BIGINT,
	CONSTRAINT Preference_Rules_FK_ORGID FOREIGN KEY (ORGID) REFERENCES Organizations (ORGID),
...
CREATE TABLE IF NOT EXISTS Account_UserSessions (
	SESSIONID BIGINT AUTO_INCREMENT PRIMARY KEY,
	USERID BIGINT,
	SESSION_TYPE INT,
	TOKEN VARCHAR(1000),
	...
	SESSION_INFO VARCHAR(5000),
	USER_TYPE VARCHAR(100),
	CONSTRAINT Account_USERSESSIONS_FK_USERID FOREIGN KEY (USERID) REFERENCES Account_Users(USERID) ON DELETE CASCADE
);

CREATE TABLE IF NOT EXISTS Account_`faciliousers` (
`id` int( 11 ) NOT NULL AUTO_INCREMENT ,
`username` varchar( 200 ) NOT NULL ,
`email` varchar( 200 ) NOT NULL ,
...
UNIQUE KEY `username` ( `username` ) ,
UNIQUE KEY `email` ( `email` ),
CONSTRAINT Acccount_faciliousers_FK_USERID FOREIGN KEY (USERID) REFERENCES Account_Users(USERID) ON UPDATE CASCADE
...
CREATE TABLE IF NOT EXISTS Reading_Tools (
	...
	CONSTRAINT Reading_Tools_FK_ORGID FOREIGN KEY (ORGID) REFERENCES Organizations (ORGID)
);
