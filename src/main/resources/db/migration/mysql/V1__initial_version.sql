...
CREATE TABLE IF NOT EXISTS Points (
 ...
 CREATE TABLE IF NOT EXISTS BACnet_IP_Point (
   ...
   CONSTRAINT Niagara_Point_META_UNIQUE UNIQUE (ORGID,CONTROLLER_ID,PATH),
   ...
   CREATE TABLE IF NOT EXISTS OPC_XML_DA_Point (
   	...
   	CONTROLLER_ID BIGINT,
   	PATH VARCHAR(1000) NOT NULL,
   	CONSTRAINT OPC_XML_DA__Point_META_UNIQUE UNIQUE (ORGID,CONTROLLER_ID,PATH),
   ...
   CONSTRAINT OPC_UA__Point_META_UNIQUE UNIQUE (ORGID,CONTROLLER_ID,NAME_SPACE,IDENTIFIER),
