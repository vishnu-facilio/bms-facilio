...
CREATE TABLE IF NOT EXISTS AutoCommission_Readings (
	ID BIGINT AUTO_INCREMENT PRIMARY KEY,
	ORGID BIGINT NOT NULL,
	MODULEID BIGINT NOT NULL,
	ACTUAL_TTIME BIGINT NOT NULL,
	...
	ENUM_CF4 INTEGER,
	ENUM_CF5 INTEGER,
	CONSTRAINT AUTOCOMMISSION_READINGS_FK_ORGID FOREIGN KEY (ORGID) REFERENCES Organizations(ORGID),
	CONSTRAINT AUTOCOMMISSION_READINGS_FK_MODULEID FOREIGN KEY (MODULEID) REFERENCES Modules(MODULEID)

)
-- Create Index for AutoCommission Table
CREATE INDEX AUTOCOMMISSION_READINGS_PARENT_ID_INDEX on AutoCommission_Readings (PARENT_ID);
CREATE INDEX AUTOCOMMISSION_READINGS_PARENT_ID_TTIME_INDEX ON AutoCommission_Readings (ORGID, MODULEID, PARENT_ID, TTIME);
CREATE INDEX AUTOCOMMISSION_READINGS_TTIME_INDEX ON AutoCommission_Readings (ORGID, MODULEID, TTIME);
...
CREATE TABLE IF NOT EXISTS Graphics (
	...
	CONSTRAINT GRAPHICS_FK_PARENT_GRAPHICS_FOLDER_ID FOREIGN KEY (GRAPHICS_PARENT_FOLDER_ID) REFERENCES Graphics_Folder(ID),
