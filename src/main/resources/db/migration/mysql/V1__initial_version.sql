...
CREATE TABLE IF NOT EXISTS Notification_Configurations (
    ...
    ACTION_ID BIGINT,
    FORM_ID BIGINT,
    CONSTRAINT Notification_Configurations_FORM_ID FOREIGN KEY (FORM_ID) REFERENCES Forms(ID) ON DELETE SET NULL
	CONSTRAINT Notification_Configurations_FK_ORGID FOREIGN KEY (ORGID) REFERENCES Organizations (ORGID),
	CONSTRAINT Notification_Configurations_FK_MODULE FOREIGN KEY (MODULEID) REFERENCES Modules (MODULEID),
	CONSTRAINT Notification_Configurations_FK_ACTION_ID FOREIGN KEY (ACTION_ID) REFERENCES Action (ID),
	CONSTRAINT Notification_Configurations_FK_MODULE_ID FOREIGN KEY (CONFIG_MODULE_NAME) REFERENCES Modules (NAME) ON DELETE CASCADE
);
...
CREATE TABLE IF NOT EXISTS Notification_Users (
	...
	CONSTRAINT Notification_Users_FK_MODULE FOREIGN KEY (MODULEID) REFERENCES Modules (MODULEID),
