...
CREATE TABLE IF NOT EXISTS InventoryRequestLineItems (
	...
	CONSTRAINT INVENTORYREQUESTLINEITEMS_FK_ITEM FOREIGN KEY (ITEM) REFERENCES Item (ID),
	CONSTRAINT INVENTORYREQUESTLINEITEMS_FK_PARENT_ID FOREIGN KEY (PARENT_ID) REFERENCES Tickets(ID),
	CONSTRAINT INVENTORYREQUESTLINEITEMS_FK_TOOL FOREIGN KEY (TOOL) REFERENCES Tool (ID)
);
...
CREATE TABLE IF NOT EXISTS Workorder_items (
	...
	CONSTRAINT WORKORDER_ITEMS_FK_REQUESTED_LINEITEM FOREIGN KEY (REQUESTED_LINEITEM) REFERENCES InventoryRequestLineItems(ID),
...
CREATE TABLE IF NOT EXISTS Workorder_tools (
	...
	COST DOUBLE,
	REQUESTED_LINEITEM BIGINT,
	CONSTRAINT WORKORDER_TOOLS_FK_REQUESTED_LINEITEM FOREIGN KEY (REQUESTED_LINEITEM) REFERENCES InventoryRequestLineItems(ID),
