...
CREATE TABLE IF NOT EXISTS ML (
	...
	MIN_SAMPLING_PERIOD BIGINT(20),
	MAX_SAMPLING_PERIOD BIGINT(20),
...
CREATE TABLE IF NOT EXISTS ML_Variables (
 ...
 CREATE TABLE IF NOT EXISTS ML_Model_Variables (
  ...
  CREATE TABLE IF NOT EXISTS ML_Assets (
  	ID BIGINT PRIMARY KEY AUTO_INCREMENT,
	ORGID BIGINT NOT NULL,
	ML_ID BIGINT NOT NULL,
	ASSETID BIGINT NOT NULL,
	
	CONSTRAINT MLASSETS_FK_ORGID FOREIGN KEY (ORGID) REFERENCES Organizations (ORGID),
	CONSTRAINT MLASSETS_FK_ML_ID FOREIGN KEY (ML_ID) REFERENCES ML(ID),
	CONSTRAINT MLASSETS_FK_ASSETID FOREIGN KEY (ASSETIS) REFERENCES Assets(ID)
  );
 ...
 CREATE TABLE IF NOT EXISTS ML_Asset_Variables (
	...
	CONSTRAINT MLASSETVARIABLES_FK_ASSETIS FOREIGN KEY (ASSETIS) REFERENCES Assets(ID)
  );
