...
CREATE TABLE IF NOT EXISTS StateFlow (
	...
	CONSTRAINT STATEFLOW_FK_ID FOREIGN KEY (ID) REFERENCES Workflow_Rule (ID),
...
CREATE TABLE IF NOT EXISTS StateFlowTransition (
	...
	CONSTRAINT STATEFLOWTRANS_FK_ID FOREIGN KEY (ID) REFERENCES Workflow_Rule (ID)
);
...
CREATE TABLE IF NOT EXISTS ML (
	...
	CONSTRAINT ML_FK_JOBID FOREIGN KEY ( JOBID) REFERENCES Jobs (JOBID),
...
CREATE TABLE IF NOT EXISTS ML_Variables (
	...
	CONSTRAINT MLVARIABLES_FK_PARENTID FOREIGN KEY(PARENTID) REFERENCES Resources(ID)
);
 ...
 CREATE TABLE IF NOT EXISTS ML_Asset_Variables (
	...
	CONSTRAINT MLASSETVARIABLES_FK_ASSETIS FOREIGN KEY (PARENTID) REFERENCES Resources(ID)
  );
