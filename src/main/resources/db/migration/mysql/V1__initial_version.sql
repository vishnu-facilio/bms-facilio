...
CREATE TABLE IF NOT EXISTS Organizations (
	...
	STREET VARCHAR(255),
  	...
  	LOGGER_LEVEL INT,
  	UNIQUE(FACILIODOMAINNAME,DELETED_TIME)
);
...
CREATE TABLE IF NOT EXISTS Formula_Readings	(
	...
	CONSTRAINT Formula_Readings_ORGID FOREIGN KEY (ORGID) REFERENCES Organizations(ORGID)
);
...
CREATE TABLE IF NOT EXISTS Control_Groups (
  ...
  CONSTRAINT Control_Groups_orgid FOREIGN KEY (ORGID) REFERENCES Organizations (ORGID) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
CREATE TABLE IF NOT EXISTS BaseEvent (
	...
	CONSTRAINT BASEEVENT_FK_ALAID FOREIGN KEY (ALARM_ID) REFERENCES BaseAlarm (ID),
...
CREATE TABLE IF NOT EXISTS Control_Group_Spaces (
  ...
  CONSTRAINT Control_Group_Spaces_orgid FOREIGN KEY (ORGID) REFERENCES Organizations (ORGID) ON DELETE NO ACTION ON UPDATE NO ACTION
);
...
CREATE TABLE IF NOT EXISTS Control_Group_Include_Exclude_Resource (
  ...
  CONSTRAINT Control_Group_Include_Exclude_Resource_orgid FOREIGN KEY (ORGID) REFERENCES Organizations (ORGID) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
CREATE TABLE IF NOT EXISTS Control_Action_Command (
  ...
  CONSTRAINT Control_Action_Command_orgid FOREIGN KEY (ORGID) REFERENCES Organizations (ORGID) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
alter table Assets add column IS_MOVE_APPROVAL_NEEDED TINYINT;

alter table Assets add column CURRENT_SPACE_ID BIGINT;
alter table Assets ADD CONSTRAINT Assets_FK_CURRENT_SPACE FOREIGN KEY (CURRENT_SPACE_ID) REFERENCES Resources(ID);
