...
CREATE TABLE IF NOT EXISTS Workflow_Template (
  ...
  CONSTRAINT Workflow_Template_id FOREIGN KEY (ID) REFERENCES Templates (ID) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
CREATE TABLE IF NOT EXISTS Reading_Alarm_Rule (
  ...
  CONSTRAINT Reading_Alarm_Rule_id FOREIGN KEY (ID) REFERENCES Workflow_Rule (ID) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ...
  CONSTRAINT Reading_Alarm_Rule_reading_rule_group_id FOREIGN KEY (READING_RULE_GROUP_ID) REFERENCES Reading_Rule (RULE_GROUP_ID) ON DELETE NO ACTION ON UPDATE NO ACTION
);
...
CREATE TABLE IF NOT EXISTS ML_Alarm_Occurrences (
	...
	CONSTRAINT ML_ALARM_OCCURRENCES_FK_PARENT_ALARM FOREIGN KEY (PARENT_ALARM) REFERENCES ML_Alarms (ID),
