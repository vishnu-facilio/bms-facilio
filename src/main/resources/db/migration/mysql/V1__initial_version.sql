...
CREATE TABLE IF NOT EXISTS User_Mobile_Setting (
	...
	CREATED_TIME BIGINT,
	CONSTRAINT UNIQUE_INSTANCE_ORGID FOREIGN KEY (ORGID) REFERENCES Organizations(ORGID),
...
CREATE TABLE IF NOT EXISTS Permission (
	...
	CONSTRAINT PERMISSION_FK_ROLEID FOREIGN KEY (ORGID) REFERENCES Organizations(ORGID),
...
CREATE TABLE IF NOT EXISTS MeasurementType (
   ...
   ORGID BIGINT NOT NULL,
   TYPENAME VARCHAR(50),
   CONSTRAINT MEASUREMENT_TYPE_ORGID_FK FOREIGN KEY (ORGID) REFERENCES Organizations(ORGID)
);
...
CREATE TABLE IF NOT EXISTS MeasurementUnit(
   ...
   CONSTRAINT MEASUREMENT_UNIT_FK_ORGID FOREIGN KEY (ORGID) REFERENCES Organizations(ORGID),
...
CREATE TABLE IF NOT EXISTS MeasurementConversion (
   ...
   DIVIDEND FLOAT,
   TOUNITOFFSET FLOAT,
   CONSTRAINT MEASUREMENT_CONVERSION_FK_ORGID FOREIGN KEY (ORGID) REFERENCES Organizations(ORGID),
...
CREATE TABLE IF NOT EXISTS `GroupMembers` (
	...
	CONSTRAINT GROUP_MEMBERS_FK_GORGID FOREIGN KEY (GROUPID) REFERENCES `Groups`(GROUPID) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS Zone_Space (
	...
	CONSTRAINT ZONE_SPACE_FK_ZONE_ORGID FOREIGN KEY (ORGID) REFERENCES Zone(ORGID), 
...
CREATE TABLE IF NOT EXISTS Asset_Category_Readings (
	...
	READING_MODULE_ID BIGINT,
	PRIMARY KEY (PARENT_CATEGORY_ID, READING_MODULE_ID),
	CONSTRAINT ASSET_CATEGORY_READINGS_ORGID_FK FOREIGN KEY  (ORGID) REFERENCES Asset_Categories(ORGID),
...
CREATE TABLE IF NOT EXISTS TicketStateFlow (
	...
	CONSTRAINT TICKET_STATEFLOW_FK_ORGID FOREIGN KEY (ORGID) REFERENCES TicketStatus(ORGID),
...
CREATE TABLE IF NOT EXISTS WorkOrderRequest_EMail (
	...
	REQUEST_ID BIGINT,
	CONSTRAINT WORK_ORDER_REQUESTS_EMAIL_FK_REQUEST_ORGID FOREIGN KEY (ORGID) REFERENCES Organizations(ORGID),
...
CREATE TABLE IF NOT EXISTS Task_Input_Options (
	...
	CONSTRAINT TASK_INPUT_OPTIONS_FK_TASK_ORGID FOREIGN KEY (ORGID) REFERENCES Tasks(ORGID),
...
CREATE TABLE IF NOT EXISTS UserLocationCoverage (
  ...
  ORG_USERID BIGINT,
  LOCATION_ID BIGINT,
  CONSTRAINT USERLOCATIONS_ORGID_FK FOREIGN KEY (ORGID) REFERENCES ORG_Users(ORGID),
...
CREATE TABLE IF NOT EXISTS UserSkills (
  ...
  ORG_USERID BIGINT,
  SKILL_ID BIGINT,
  CONSTRAINT USERSKILLS_ORGID_FK FOREIGN KEY (ORGID) REFERENCES ORG_Users(ORGID),
...
CREATE TABLE IF NOT EXISTS Conditions (
	...
	CONSTRAINT CONDITIONS_PARENT_ORGID_FK FOREIGN KEY (ORGID) REFERENCES Criteria(ORGID),
...
CREATE TABLE IF NOT EXISTS EMail_Templates (
	...
	CONSTRAINT EMAIL_TEMPLATES_ORGID_FK FOREIGN KEY (ORGID) REFERENCES Templates(ORGID),
...
CREATE TABLE IF NOT EXISTS SMS_Templates (
	...
	CONSTRAINT SMS_TEMPLATES_ORGID_FK FOREIGN KEY (ORGID) REFERENCES Templates(ORGID),
...
CREATE TABLE IF NOT EXISTS Assignment_Templates (
	...
	USERID BIGINT,
	GROUPID BIGINT,
	CONSTRAINT ASSIGNMENT_TEMPLATES_ORGID_FK FOREIGN KEY (ORGID) REFERENCES Templates(ORGID),
...
CREATE TABLE IF NOT EXISTS SLA_Templates (
	...
	CONSTRAINT SLA_TEMPLATES_ORGID_FK FOREIGN KEY (ORGID) REFERENCES Templates(ORGID),
...
CREATE TABLE IF NOT EXISTS Push_Notification_Templates (
	...
	TITLE VARCHAR(250),
	URL VARCHAR(250),
	CONSTRAINT PUSH_NOTIFICATION_TEMPLATE_ORGID_FK FOREIGN KEY (ORGID) REFERENCES Templates(ORGID),
...
CREATE TABLE IF NOT EXISTS Web_Notification_Templates (
	...
	TITLE VARCHAR(250),
	URL VARCHAR(250),
	CONSTRAINT WEB_NOTIFICATION_TEMPLATE_ORGID_FK FOREIGN KEY  (ORGID) REFERENCES Templates(ORGID),
...
CREATE TABLE IF NOT EXISTS JSON_Template (
  	...
  	CONSTRAINT JSON_TEMPLATE_ORGID_FK FOREIGN KEY (ORGID)  REFERENCES Templates(ORGID),
...
CREATE TABLE IF NOT EXISTS Task_Section_Template (
	...
	CONSTRAINT TASK_SECTION_TEMPLATE_FK_ORGID FOREIGN KEY (ORGID) REFERENCES Templates(ORGID),
...
CREATE TABLE IF NOT EXISTS Task_Template (
	...
	ASSIGNMENT_TYPE INT DEFAULT NULL,
  	ASSET_CATEGORY_ID BIGINT DEFAULT NULL,
  	SPACE_CATEGORY_ID BIGINT DEFAULT NULL,
  	CONSTRAINT TASK_TEMPLATE_FK_ORGID FOREIGN KEY (ORGID) REFERENCES Templates(ORGID), 
...
CREATE TABLE IF NOT EXISTS Excel_Templates (
	...
	CONSTRAINT EXCEL_TEMPLATES_ORGID_FK FOREIGN KEY (ORGID)REFERENCES Templates(ORGID), 
...
CREATE TABLE IF NOT EXISTS TenantZones (
	...
	CONSTRAINT TENANT_TENANTZONE_ORGID_FK FOREIGN KEY (ORGID) REFERENCES Tenant(ORGID),
...
CREATE TABLE IF NOT EXISTS TenantMeters (
	...
	CONSTRAINT TENANT_TENANTMETER_ORGID_FK FOREIGN KEY (ORGID) REFERENCES Tenant(ORGID),
...
CREATE TABLE IF NOT EXISTS Report_DateFilter (
  ...
  CONSTRAINT REPORT_DATEFILTER_REPORT_ORGID FOREIGN KEY (ORGID) REFERENCES Report (ORGID) ,
...
CREATE TABLE IF NOT EXISTS Report_EnergyMeter (
  ...
  CONSTRAINT REPORT_ENERGYMETER_REPORT_ORGID FOREIGN KEY (ORGID) REFERENCES Report (ORGID) ,
...
CREATE TABLE IF NOT EXISTS Report_Criteria (
  ...
  CONSTRAINT REPORT_COMPARISION_CONDITIONS_CRITERIA_ORGID (ORGID) REFERENCES  Report (ORGID) ,
...
CREATE TABLE IF NOT EXISTS Report_Threshold (
  ...
  CONSTRAINT REPORT_THRESHOLD_REPORT_ORGID FOREIGN KEY (ORGID) REFERENCES  Report (ORGID) ,
...
CREATE TABLE IF NOT EXISTS Report_User_Filter (
  ...
  WHERE_CLAUSE VARCHAR(1000) DEFAULT NULL,
   CONSTRAINT REPORT_USER_FILTER_REPORT_FIELD_ORGID FOREIGN KEY (ORGID) REFERENCES  Report (ORGID) ,
...
CREATE TABLE IF NOT EXISTS Space_Filtered_Dashboard_Settings (
  ...
  CONSTRAINT Space_Filtered_Dashboard_Settings_Dashboard_ORGid FOREIGN KEY (ORGID) REFERENCES Dashboard (ORGID),
...
CREATE TABLE IF NOT EXISTS Widget_Chart (
  ...
  CONSTRAINT WIDGET_CHART_REPORT_ORGID FOREIGN KEY (ORGID) REFERENCES Widget (ORGID),
...
CREATE TABLE IF NOT EXISTS Widget_List_View (
  ...
  VIEW_NAME VARCHAR(100) DEFAULT NULL,
   CONSTRAINT WIDGET_LIST_WIDGET_ORGID FOREIGN KEY (ORGID) REFERENCES Widget (ORGID),
...
CREATE TABLE IF NOT EXISTS Widget_Static (
  ...
  CONSTRAINT WIDGET_STATIC_WIDGET_ORGID FOREIGN KEY (ORGID) REFERENCES Widget (ORGID),
...
CREATE TABLE IF NOT EXISTS Widget_Vs_Workflow (
  ...
  CONSTRAINT WIDGET_WF_BASE_ORGID FOREIGN KEY (ORGID) REFERENCES Widget (ORGID),
...
CREATE TABLE IF NOT EXISTS Widget_Web (
  ...
  CONSTRAINT WIDGET_WEB_WIDGET_ORGID FOREIGN KEY (ORGID) REFERENCES Widget (ORGID),
...
CREATE TABLE IF NOT EXISTS Unmodeled_Instance (
  ...
  INSTANCE_DESCRIPTION VARCHAR(250) NOT NULL,
  INSTANCE_TYPE INT,
...
CREATE TABLE IF NOT EXISTS Unmodeled_Data (
  ...
  TTIME BIGINT(20), 
  VALUE VARCHAR(1000), 
  CONSTRAINT UNMODELED_DATA_FK_ORGID FOREIGN KEY (ORGID) REFERENCES Organizations(ORGID),
...
CREATE TABLE IF NOT EXISTS View_Column (
	...
	CONSTRAINT VIEW_COLUMN_ORGID_FK FOREIGN KEY (ORGID) REFERENCES Views(ORGID),
...
CREATE TABLE IF NOT EXISTS Task_Section_Template_Triggers (
	...
	CONSTRAINT Task_Section_Template_Triggers_FK_SECTION_ORGID (ORGID) REFERENCES Organizations(ORGID),
...
CREATE TABLE IF NOT EXISTS PM_Jobs(
	...
	RESOURCE_ID BIGINT DEFAULT NULL,
	CONSTRAINT PM_JOBS_FK_PM_ORGID FOREIGN KEY (ORGID) (ORGID) REFERENCES Organizations(ORGID),
...
CREATE TABLE IF NOT EXISTS Shift_User_Rel (
	...
	CONSTRAINT SHIFT_USER_REL_ORGID_FK FOREIGN KEY (ORGID) REFERENCES ORG_Users (ORGID) ,
