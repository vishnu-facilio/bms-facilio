...
CREATE TABLE IF NOT EXISTS Asset_Breakdown (
       ...
       CONSTRAINT ASSET_BREAKDOWN_FK_PARENT_ID FOREIGN KEY (PARENT_ID) REFERENCES Assets(ID)
);

ALTER TABLE  Assets
ADD CONSTRAINT ASSET_FK_LAST_DOWNTIME_ID FOREIGN KEY (LAST_DOWNTIME_ID) REFERENCES  Asset_Breakdown (ID);
