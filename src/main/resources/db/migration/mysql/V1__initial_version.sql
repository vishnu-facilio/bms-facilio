...
CREATE TABLE IF NOT EXISTS Graphics (
	...
	CANVAS VARCHAR(15000),
	CONSTRAINT GRAPHICS_FK_ORGID FOREIGN KEY (ORGID) REFERENCES Organizations (ORGID),
	CONSTRAINT GRAPHICS_FK_MODULEID FOREIGN KEY (MODULEID) REFERENCES Modules(MODULEID),
	CONSTRAINT GRAPHICS_FK_FORM_ID FOREIGN KEY (FORM_ID) REFERENCES Forms(ID) ON DELETE SET NULL,
