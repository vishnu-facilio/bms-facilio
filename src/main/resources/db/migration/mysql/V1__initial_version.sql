...
CREATE TABLE IF NOT EXISTS Item_Transactions (
	...
	CONSTRAINT ITEM_TRANSACTIONS_FK_WO_ID FOREIGN KEY (WO_ID) REFERENCES Tickets(ID)
);
...
CREATE TABLE IF NOT EXISTS Tool_transactions (
	...
	CONSTRAINT TOOL_TRANSACTIONS_FK_WO_ID FOREIGN KEY (WO_ID) REFERENCES Tickets(ID)
);
