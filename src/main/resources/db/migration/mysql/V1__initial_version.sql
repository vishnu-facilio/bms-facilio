...
CREATE TABLE IF NOT EXISTS Workflow (
  ...
  WORKFLOW_STRING VARCHAR(10000) DEFAULT NULL,
  UI_MODE TINYINT,
  TYPE TINYINT,
...
CREATE TABLE IF NOT EXISTS Workflow_Rule (
	...
	CREATED_TIME BIGINT,
	MODIFIED_TIME BIGINT,
	IS_CONSOLIDATED_ACTION TINYINT,
...
CREATE TABLE IF NOT EXISTS WorkOrders (
	...
	SYS_CREATED_TIME BIGINT,
	JOB_STATUS TINYINT,
	PRE_REQUEST_STATUS TINYINT DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS Receivables (
	...
	CONSTRAINT RECEIVABLE_FK_FORM_ID FOREIGN KEY (FORM_ID) REFERENCES Forms (ID),
...
CREATE TABLE IF NOT EXISTS Receipts (
	...
	CONSTRAINT RECEIPTS_FK_FORM_ID FOREIGN KEY (FORM_ID) REFERENCES Forms (ID),
...
CREATE TABLE IF NOT EXISTS PM_Planner_Settings (
  ID BIGINT(20) NOT NULL AUTO_INCREMENT,
  ORGID BIGINT(20) NOT NULL,
  SETTINGS_JSON VARCHAR(1000) DEFAULT NULL,
  PRIMARY KEY (ID),
...
CREATE TABLE IF NOT EXISTS MV_Adjustment (
  ...
  CONSTRAINT MV_Adjustment_formula_field_id FOREIGN KEY (FORMULA_FIELD_ID) REFERENCES Formula_Field (ID) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
CREATE TABLE IF NOT EXISTS Service_Contracts (
	...
	LOCAL_ID BIGINT(20),
	SITE_ID BIGINT,
	CONSTRAINT SERVICE_CONTRACTS_FK_ORGID FOREIGN KEY (ORGID) REFERENCES Organizations (ORGID),
	CONSTRAINT SERVICE_CONTRACTS_FK_ID FOREIGN KEY (ID) REFERENCES Contracts(ID) ON DELETE CASCADE,
	CONSTRAINT SERVICE_CONTRACTS_FK_SITE_ID FOREIGN KEY (SITE_ID) REFERENCES Resources(ID),
	CONSTRAINT SERVICE_CONTRACTS_FK_MODULE_ID FOREIGN KEY (MODULEID) REFERENCES Modules (MODULEID) ON DELETE CASCADE
);

CREATE TABLE IF NOT EXISTS ServiceContractLineItems (
	ID BIGINT PRIMARY KEY AUTO_INCREMENT,
	ORGID BIGINT NOT NULL,
	MODULEID BIGINT NOT NULL,
	SERVICE_CONTRACT BIGINT NOT NULL,
	SERVICE BIGINT,
	UNIT_PRICE DOUBLE,
	QUANTITY DOUBLE,
	COST DOUBLE,
	CONSTRAINT ServiceContractLineItems_FK_ORGID FOREIGN KEY (ORGID) REFERENCES Organizations (ORGID),
	CONSTRAINT ServiceContractLineItems_FK_MODULE FOREIGN KEY (MODULEID) REFERENCES Modules (MODULEID),
	CONSTRAINT ServiceContractLineItems_FK_SERVICE_CONTRACT FOREIGN KEY (SERVICE_CONTRACT) REFERENCES Service_Contracts (ID) ON DELETE CASCADE,
	CONSTRAINT ServiceContractLineItems_FK_SERVICE FOREIGN KEY (SERVICE) REFERENCES Service (ID)
);
...
CREATE TABLE IF NOT EXISTS Notification_Configurations (
	...
	ORGID BIGINT NOT NULL,
	PARENT_ID BIGINT,
    CONFIG_MODULE_NAME VARCHAR(255),
    ACTION_ID BIGINT,
    FREQUENCY_TYPE TINYINT,
    SCHEDULE_MODE TINYINT,
    SCHEDULE_INFO VARCHAR(5000),
    CRITERIA_ID BIGINT,
    CONSTRAINT Notification_Configurations_FK_ORGID FOREIGN KEY (ORGID) REFERENCES Organizations (ORGID),
	CONSTRAINT Notification_Configurations_FK_ACTION_ID FOREIGN KEY (ACTION_ID) REFERENCES Action (ID),
	CONSTRAINT Notification_Configurations_FK_CRITERIAID FOREIGN KEY (CRITERIA_ID) REFERENCES Criteria (CRITERIAID)
...
CREATE TABLE IF NOT EXISTS Notification_Users (
	...
	CONSTRAINT Notification_Users_FK_ORGID FOREIGN KEY (ORGID) REFERENCES Organizations (ORGID),
	CONSTRAINT Notification_Users_FK_CONFIG_ID FOREIGN KEY (CONFIGURATION_ID) REFERENCES Notification_Configurations (ID) ON DELETE CASCADE,
	CONSTRAINT Notification_Users_FK_TO_USER_ID FOREIGN KEY (TO_USER) REFERENCES ORG_Users(ORG_USERID) ON DELETE CASCADE

);


CREATE TABLE IF NOT EXISTS Contracts_Payment_Schedule (
	ID BIGINT PRIMARY KEY AUTO_INCREMENT,
	ORGID BIGINT NOT NULL,
	MODULEID BIGINT NOT NULL,
	CONTRACTS_ID BIGINT,
    FREQUENCY_TYPE TINYINT,
    SCHEDULE_MONTH TINYINT,
    SCHEDULE_DAY BIGINT,
    SCHEDULE_TIME BIGINT,
    PAYMENT_INTERVAL BIGINT,
    CONSTRAINT Contracts_Payment_Schedule_FK_ORGID FOREIGN KEY (ORGID) REFERENCES Organizations (ORGID),
	CONSTRAINT Contracts_Payment_Schedule_FK_MODULE FOREIGN KEY (MODULEID) REFERENCES Modules (MODULEID),
	CONSTRAINT Contracts_Payment_Schedule_FK_CONTRACTS_ID FOREIGN KEY (CONTRACTS_ID) REFERENCES Contracts (ID) ON DELETE CASCADE
