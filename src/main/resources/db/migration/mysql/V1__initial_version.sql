...
CREATE TABLE IF NOT EXISTS Item_Transactions (
	...
	CONSTRAINT ITEM_TRANSACTIONS_FK_SHIPMENT_ID FOREIGN KEY (SHIPMENT_ID) REFERENCES Shipments (ID)
...
CREATE TABLE IF NOT EXISTS Tool_transactions (
	...
	CONSTRAINT TOOL_TRANSACTIONS_FK_SHIPMENT_ID FOREIGN KEY (SHIPMENT_ID) REFERENCES Shipments (ID)
