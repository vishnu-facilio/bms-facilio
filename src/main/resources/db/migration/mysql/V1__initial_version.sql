...
CREATE TABLE IF NOT EXISTS MV_Adjustment_vs_Baseline (
  ID BIGINT AUTO_INCREMENT PRIMARY KEY,
  ORGID BIGINT NOT NULL,
  PROJECT_ID BIGINT NOT NULL,
  ADJUSTMENT_ID BIGINT NOT NULL,
  BASELINE_ID BIGINT NOT NULL,
  CONSTRAINT MV_Adjustment_vs_Baseline_ajustment_id FOREIGN KEY (ADJUSTMENT_ID) REFERENCES MV_Adjustment (ID) ON DELETE CASCADE ON UPDATE NO ACTION,
  CONSTRAINT MV_Adjustment_vs_Baseline_baseline_id FOREIGN KEY (BASELINE_ID) REFERENCES MV_Baseline (ID) ON DELETE CASCADE ON UPDATE NO ACTION,
  CONSTRAINT MV_Adjustment_vs_Baseline_orgid FOREIGN KEY (ORGID) REFERENCES Organizations (ORGID) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT MV_Adjustment_vs_Baseline_project_id FOREIGN KEY (PROJECT_ID) REFERENCES MV_Project (ID) ON DELETE CASCADE ON UPDATE NO ACTION
);
