...
CREATE TABLE IF NOT EXISTS Workflow (
  ...
  CONSTRAINT WORKFLOW_NAMESPACE_ID_FK FOREIGN KEY (NAMESPACE_ID) REFERENCES Workflow_Namespace (ID)
);
...
CREATE TABLE IF NOT EXISTS Break_Transaction (
	...
	ATTENDANCE_ID BIGINT,
	BREAK_ID BIGINT,
	ATTENDANCE_TRANSACTION_ID BIGINT,
	TRANSACTION_TYPE TINYINT,
	TIME_TAKEN BIGINT,
	START_TIME BIGINT,
	STOP_TIME BIGINT,
	...
	CONSTRAINT BREAK_TRANSACTION_FK_ATTENDANCE_TRANSACTION_ID FOREIGN KEY (ATTENDANCE_TRANSACTION_ID) REFERENCES Attendance_Transactions (ID)
);