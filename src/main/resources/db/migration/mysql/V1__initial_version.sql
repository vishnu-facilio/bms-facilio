...
CREATE TABLE IF NOT EXISTS Workflow_Log (
  ...
  VARIABLE_MAP VARCHAR(1000) NULL,
...
CREATE TABLE IF NOT EXISTS Points (
   ...
   CONSTRAINT Points_FK_ASSETID FOREIGN KEY (ASSET_ID) REFERENCES Assets(ID) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS Purchase_Orders (
	...
	CONSTRAINT PURCHASE_ORDERS_FK_SYS_CREATED_BY_ID FOREIGN KEY (SYS_CREATED_BY) REFERENCES ORG_Users(USERID),
	CONSTRAINT PURCHASE_ORDERS_FK_SYS_MODIFIED_BY_ID FOREIGN KEY (SYS_MODIFIED_BY) REFERENCES ORG_Users(USERID),
...
CREATE TABLE IF NOT EXISTS Purchase_Requests (
	...
	CONSTRAINT PURCHASE_REQUESTS_FK_SYS_CREATED_BY_ID FOREIGN KEY (SYS_CREATED_BY) REFERENCES ORG_Users(USERID),
	CONSTRAINT PURCHASE_REQUESTS_FK_SYS_MODIFIED_BY_ID FOREIGN KEY (SYS_MODIFIED_BY) REFERENCES ORG_Users(USERID),
...
CREATE TABLE IF NOT EXISTS Receivables (
	...
	CONSTRAINT RECEIVABLE_FK_SYS_CREATED_BY_ID FOREIGN KEY (SYS_CREATED_BY) REFERENCES ORG_Users(USERID),
	CONSTRAINT RECEIVABLE_FK_SYS_MODIFIED_BY_ID FOREIGN KEY (SYS_MODIFIED_BY) REFERENCES ORG_Users(USERID),
...
CREATE TABLE IF NOT EXISTS Receipts (
	...
	CONSTRAINT RECEIPTS_FK_SYS_CREATED_BY_ID FOREIGN KEY (SYS_CREATED_BY) REFERENCES ORG_Users(USERID),
	CONSTRAINT RECEIPTS_FK_SYS_MODIFIED_BY_ID FOREIGN KEY (SYS_MODIFIED_BY) REFERENCES ORG_Users(USERID),
