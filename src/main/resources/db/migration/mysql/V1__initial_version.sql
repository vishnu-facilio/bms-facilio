...
CREATE TABLE IF NOT EXISTS MV_Baseline (
  ...
  NAME VARCHAR(100) NOT NULL,
  FORMULA_FIELD_ID BIGINT NOT NULL,
  FORMULA_FIELD_WITH_ADJUSTMENT BIGINT NOT NULL,
  START_TIME BIGINT DEFAULT NULL,
  END_TIME BIGINT DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS Shift_Rotation_User_Rel (
	ID BIGINT AUTO_INCREMENT PRIMARY KEY,
	ORGID BIGINT NOT NULL,
	ORG_USERID BIGINT NOT NULL,
	SHIFT_ROTATION_ID BIGINT NOT NULL,
	...
	CONSTRAINT SHIFTROTATION_USER_REL_USERID_FK FOREIGN KEY (ORG_USERID) REFERENCES ORG_Users (ORG_USERID) ON DELETE CASCADE,
