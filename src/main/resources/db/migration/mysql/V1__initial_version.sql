...
CREATE TABLE IF NOT EXISTS Page (
  ID BIGINT AUTO_INCREMENT PRIMARY KEY,
  ORGID BIGINT NOT NULL,
  CONSTRAINT PAGE_ORG_ID FOREIGN KEY (ORGID) REFERENCES Organizations (ORGID)
);

CREATE TABLE IF NOT EXISTS Page_Column (
  ID BIGINT AUTO_INCREMENT PRIMARY KEY,
  ORGID BIGINT NOT NULL,
  PAGE BIGINT NOT NULL,
  FIXED BOOLEAN DEFAULT FALSE,
  WIDTH INT,
  CONSTRAINT PAGE_COLUMN_ORG_ID_FK FOREIGN KEY (ORGID) REFERENCES Organizations (ORGID),
  CONSTRAINT PAGE_COLUMN_PAGE_FK FOREIGN KEY (PAGE) REFERENCES Page (ID) ON DELETE CASCADE
);
...
CREATE TABLE IF NOT EXISTS Section (
  ...
  CONSTRAINT SECTION_ORG_ID_FK FOREIGN KEY (ORGID) REFERENCES Organizations (ORGID),
  CONSTRAINT SECTION_PAGE_FK FOREIGN KEY (PAGE) REFERENCES Page (ID) ON DELETE CASCADE,
  CONSTRAINT SECTION_COLUMN_FK FOREIGN KEY (COLUMN_ID) REFERENCES Page_Column (ID)
);
...
CREATE TABLE IF NOT EXISTS Page_Widget (
  ...
  LAYOUT_PARAMS TEXT,
  WIDGET_PARAMS TEXT,
  CONSTRAINT PAGE_WIDGET_ORG_ID_FK FOREIGN KEY (ORGID) REFERENCES Organizations (ORGID),
  CONSTRAINT PAGE_WIDGET_SECTION_ID_FK FOREIGN KEY (SECTION_ID) REFERENCES Organizations (ORGID)
);
...
CREATE TABLE IF NOT EXISTS Resource_Page (
  ...
  ASSET_CATEGORY_ID BIGINT,
  PAGE BIGINT NOT NULL,
  CONSTRAINT RESOURCE_PAGE_ORG_ID_FK FOREIGN KEY (ORGID) REFERENCES Organizations (ORGID),
  CONSTRAINT RESOURCE_PAGE_FK FOREIGN KEY (PAGE) REFERENCES Page (ID) ON DELETE CASCADE,
  CONSTRAINT RESOURCE_PAGE_RESOURCE_ID_FK FOREIGN KEY (RESOURCE_ID) REFERENCES Resources (ID) ON DELETE CASCADE,
  CONSTRAINT RESOURCE_PAGE_ASSET_CATEGORY_ID_FK FOREIGN KEY (ASSET_CATEGORY_ID) REFERENCES Asset_Categories(ID) ON DELETE CASCADE
);
...
CREATE TABLE IF NOT EXISTS Item_Types (
	...
	CONSTRAINT ITEM_TYPES_FK_CATEGORY FOREIGN KEY (CATEGORY) REFERENCES Item_Types_category(ID),
...
CREATE TABLE IF NOT EXISTS Tool_types(
	...
	CONSTRAINT TOOLS_FK_CATEGORY FOREIGN KEY (CATEGORY) REFERENCES Tool_types_category(ID)
);
