...
CREATE TABLE IF NOT EXISTS Inventry (
	...
	CONSTRAINT INVENTRY_FK_FK_SITE_ID FOREIGN KEY (SITE_ID) REFERENCES Site(ID)
);
...
CREATE TABLE IF NOT EXISTS Workorder_items (
	...
	CONSTRAINT WORKORDER_ITEMS_FK_ID FOREIGN KEY (ID) REFERENCES Inventory_transactions(ID) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS Item_vendors (
	...
	CONSTRAINT ITEM_VENDORS_FK_ITEM_ID FOREIGN KEY (ITEM_ID) REFERENCES Items(ID),
