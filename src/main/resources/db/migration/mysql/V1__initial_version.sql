...
CREATE TABLE IF NOT EXISTS Item_Transactions (
	...
	CONSTRAINT ITEM_TRANSACTIONS_FK_PURCHASED_ITEM_ID FOREIGN KEY (PURCHASED_ITEM_ID) REFERENCES Purchased_Item(ID),
	CONSTRAINT ITEM_TRANSACTIONS_FK_ITEM_ID FOREIGN KEY (ITEM_ID) REFERENCES Item(ID)
);
