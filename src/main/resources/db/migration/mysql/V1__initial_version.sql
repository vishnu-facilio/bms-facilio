...
CREATE TABLE IF NOT EXISTS State (
	...
	CONSTRAINT STAGE_FK_ORG FOREIGN KEY (ORGID) REFERENCES Organizations (ORGID),
	CONSTRAINT STAGE_FK_SITE_ID FOREIGN KEY (SITE_ID) REFERENCES Resources (ID),
	CONSTRAINT STAGE_FK_MODULEID FOREIGN KEY (MODULDID) REFERENCES Modules (MODULEID)
);
...
CREATE TABLE IF NOT EXISTS StateFlow (
	...
	CONSTRAINT STATEFLOW_FK_MODULEID FOREIGN KEY (MODULDID) REFERENCES Modules (MODULEID),
...
CREATE TABLE IF NOT EXISTS StateFlowTransistion (
	...
	CONSTRAINT STATEFLOWTRANS_FK_FROMSTATE FOREIGN KEY (FROM_STATE_ID) REFERENCES State (ID),
	CONSTRAINT STATEFLOWTRANS_FK_TOSTATE FOREIGN KEY (TO_STATE_ID) REFERENCES State (ID),
