...
CREATE TABLE IF NOT EXISTS ML_Anomaly_Event(
	...
	CONSTRAINT ML_ANOMALY_EVENT_FK_ENERGY_DATA_FIELDID FOREIGN KEY (ENERGY_DATA_FIELID) REFERENCES Fields(FIELDID) ON DELETE SET NULL,
...
CREATE TABLE IF NOT EXISTS ML_Anomaly_Alarm(
	...
	CONSTRAINT ML_ANOMALY_ALARM_FK_ENERGY_DATA_FIELDID FOREIGN KEY (ENERGY_DATA_FIELID) REFERENCES Fields(FIELDID) ON DELETE SET NULL,
