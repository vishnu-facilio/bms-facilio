...
CREATE TABLE IF NOT EXISTS Record_Rules (
	...
	MODULE_ID BIGINT NOT NULL,
	SCHEDULE_MODE TINYINT,
	CONSTRAINT Record_Rules_FK_ORG FOREIGN KEY (ORGID) REFERENCES Organizations (ORGID),
	CONSTRAINT Record_Rules_FK_ID FOREIGN KEY (ID) REFERENCES Workflow_Rule (ID) ON DELETE CASCADE,
	CONSTRAINT Record_Rules_FK_SITEID FOREIGN KEY (SITE_ID) REFERENCES Resources (ID),
	CONSTRAINT Record_Rules_FK_MODULE FOREIGN KEY (MODULEID) REFERENCES Modules (MODULEID)
