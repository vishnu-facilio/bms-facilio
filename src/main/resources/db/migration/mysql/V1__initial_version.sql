...
CREATE TABLE IF NOT EXISTS Report_Criteria (
  ...
  CONSTRAINT REPORT_COMPARISION_CONDITIONS_CRITERIA_ORGID FOREIGN KEY (ORGID) REFERENCES  Report (ORGID) ,
...
CREATE TABLE IF NOT EXISTS Workorder_Parts (
	...
	CONSTRAINT WORKORDER_INVENTORY_FK_ORGID FOREIGN KEY (ORGID) REFERENCES Organizations(ORGID),
	CONSTRAINT WORKORDER_INVENTORY_FK_MODULEID FOREIGN KEY (MODULEID) REFERENCES Modules(MODULEID),
	CONSTRAINT WORKORDER_INVENTORY_FK_PARENT_ID FOREIGN KEY (PARENT_ID) REFERENCES Tickets(ID),
	CONSTRAINT WORKORDER_INVENTORY_FK_INVENTORY_ID FOREIGN KEY (PARTS_ID) REFERENCES Inventory(ID)
);
...
CREATE TABLE IF NOT EXISTS Item_Attachments (
	...
	CONSTRAINT ITEM_ATTACHEMENTS_FK_PARENT_ASSET FOREIGN KEY (PARENT_ASSET) REFERENCES Items (ID) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS Stocked_tools_status (
	ID BIGINT AUTO_INCREMENT PRIMARY KEY,
	ORGID BIGINT NOT NULL,
	MODULEID BIGINT NOT NULL,
	NAME VARCHAR(50) NOT NULL,
...
CREATE TABLE IF NOT EXISTS Stocked_tools (
	ID BIGINT PRIMARY KEY AUTO_INCREMENT,
	ORGID BIGINT NOT NULL,
	MODULEID BIGINT NOT NULL,
	TOOLS_ID BIGINT,
...
CREATE TABLE IF NOT EXISTS Tools_Notes (
	ID BIGINT AUTO_INCREMENT PRIMARY KEY,
	ORGID BIGINT,
	MODULEID BIGINT NOT NULL,
	CREATED_BY BIGINT,
...
CREATE TABLE IF NOT EXISTS Tools_Attachments (
	ID BIGINT AUTO_INCREMENT PRIMARY KEY,
	ORGID BIGINT NOT NULL,
	MODULEID BIGINT NOT NULL,
	PARENT_ASSET BIGINT NOT NULL,
...
CREATE TABLE IF NOT EXISTS Stocked_tools_transactions (
	ID BIGINT AUTO_INCREMENT PRIMARY KEY,
	ORGID BIGINT NOT NULL,
	MODULEID BIGINT NOT NULL,
	STOCKED_TOOL BIGINT,
	ISSUE_QUANTITY DOUBLE,
...
CREATE TABLE IF NOT EXISTS Stocked_Tools_Return_Tracking (
	ID BIGINT AUTO_INCREMENT PRIMARY KEY,
	ORGID BIGINT NOT NULL,
	MODULEID BIGINT NOT NULL,
...
CREATE TABLE IF NOT EXISTS Workorder_tools (
	...
	CONSTRAINT WORKORDER_ITEMS_FK_ID FOREIGN KEY (ID) REFERENCES Stocked_tools_transactions(ID) ON DELETE CASCADE,
	CONSTRAINT WORKORDER_ITEMS_FK_ORGID FOREIGN KEY (ORGID) REFERENCES Organizations(ORGID),
	CONSTRAINT WORKORDER_ITEMS_FK_MODULEID FOREIGN KEY (MODULEID) REFERENCES Modules(MODULEID),
	CONSTRAINT WORKORDER_ITEMS_FK_PARENT_ID FOREIGN KEY (PARENT_ID) REFERENCES Tickets(ID)
);
