...
export default {
  ...
  methods: {
    drop(data, index) {
      ...
      this.selectedMarker.geoLocation = locationStr
      this.markers[this.selectedMarkerIndex] = this.selectedMarker
      if (
        this.selectedMarkersList.findIndex(
          rt => rt.id === this.selectedMarker.id
        ) > -1
      ) {
        ...
        this.selectedMarkersList.push(this.selectedMarker)
      }
      this.$emit('location', this.selectedMarkersList)
    },
