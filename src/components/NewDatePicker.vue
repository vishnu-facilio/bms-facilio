...
export default {
  ...
  computed: {
    ...
    isCurrentDateRange: function() {
      ...
      if (
        currentmillis < this.result.value[1] &&
  ...
  methods: {
    ...
    quickChoose(period) {
      ...
      let operation = dateoperators.getOperationFromLabel(period)
      this.customCaseSection = dateoperators.returnOperator(
