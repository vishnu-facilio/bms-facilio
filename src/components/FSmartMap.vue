        ...
        <template>
          <div class="smartmap-info-window">
            <div class="am-header row p15 border-bottom2 pT10 pB10 f12 pB0">
              <div class="col-6 text-left bold uppercase">
                {{ data.module }} DETAIL
              </div>
            ...
            <div class="am-info-row row p15">
              ...
              <div class="am-info-label  col-8 pL10">
                ...
                <div
                  class="am-label am-subject text-left"
                  v-if="markerValueMap[data.markerValue.type]"
                >
                  {{ markerValueMap[data.markerValue.type]
                  }}<span class="pL5">{{ currentMarker.markerValue }}</span>
                </div>
              ...
              <div class="col-12">
                <div class="mT10">
                  <el-button
                    size="mini"
                    class="plain"
                    @click="jumpToModule(data.module, currentMarker)"
                    >View all</el-button
                  >
                </div>
              </div>
...
export default {
  props: ['mapheight', 'markers', 'categoryId', 'category', 'data'],
  mixins: [FMAPMixin, JumpToHelper],
  data() {
    return {
      markerValueMap: {
        noOfWorkorders: 'No of Workorders',
