<template>
  <div class="fc-attachments new-attachments">
    <iframe
    ...
    <div v-else>
      ...
      <form v-if="!diasbleAttachment" enctype="multipart/form-data" novalidate>
        <div class="dropbox">
          <input
            type="file"
            multiple
...
.fc-attachments.new-attachments {
  padding: 0 0 20px 0;
}
