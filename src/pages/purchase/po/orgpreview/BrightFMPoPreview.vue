    ...
    >
      <div class="pdf-padding-container">
        <div v-if="$org.logoUrl" class="fc-quotation-logo">
          <img :src="$prependBaseUrl($org.logoUrl)" style="width: 80px;" />
        </div>
                  ...
                  <div class="flex-middle justify-content-space width100">
                    ...
                    <div class="">
                      ...
                      <div class="mT10 text-right label-txt-black">
                        PO DATE: {{ details.orderedTime | formatDate(true) }}
                      </div>
                      <div
                      ...
                      <div
                        class="mT10 text-right label-txt-black"
                        v-if="$getProperty(details, 'moduleState.displayName')"
                      >
                        STATE:
                ...
                <td colspan="100%">
                  ...
                  >
                    <div class="pT40 fc-quotation-signature">
                      <div v-if="details.signature_3Id > 0">
                        <img
                          :src="
                            $helpers.getImagePreviewUrl(details.signature_3Id)
                          "
...
export default {
  ...
  computed: {
    ...
    currentModuleState() {
      let { details } = this
      let currentStateId = this.$getProperty(details, 'moduleState.id')
      let currentState = this.getTicketStatus(currentStateId, 'purchaseorder')
