              ...
              <el-row>
                <el-col :span="24">
                  <div
                    ...
                    :title="getPurchaseOrderName(record)"
                    v-tippy="{
                      placement: 'top',
                  ...
                  <div class="flex-middle justify-content-space width100 pT10">
                    <div class="fc-id pR10">
                      #{{ getPurchaseOrderLocalId(record) }}
                    </div>
          ...
          >
            ...
            <template #[slotList[1].criteria]="{ record }">
              ...
              >
                <router-link
                  :to="redirectToOverview(record.id)"
                  class="fw5 label-txt-black ellipsis main-field-column"
                >
                  {{ getPurchaseOrderName(record) }}
                </router-link>
              </div>
