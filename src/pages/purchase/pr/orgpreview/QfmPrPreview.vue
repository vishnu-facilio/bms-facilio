    ...
    >
      ...
      <div>
        <div class="fc-black-13 text-left pT20">
          <span class="fwBold pR10">{{ $t('common.products.subject') }}</span>
      ...
      <div
        ...
        style="width: 51.4%;"
        v-if="!$validation.isEmpty($getProperty(details, 'notes'))"
      >
        <div class="fc-black-13 fwBold text-left">
          {{ $t('common.products._notes') }}
        </div>
        <div class="fc-black-13 pT10 text-left line-height20 pR20">
          {{ $getProperty(details, 'notes') }}
        </div>
      </div>
      <!-- terms and condition -->
      <div
