  ...
  computed: {
    ...
    userList() {
      ...
      return this.users.filter(user =>
        canHandleSite(user, +this.model.woData.woModel.site.id)
      )
    },
  },
  methods: {
