              ...
              <div class="review-wrap-block">
                <el-row class="pB15">
                  <el-col :span="12">
                    ...
                    <div class="label-txt-black">{{ siteName }}</div>
                  </el-col>
                  <el-col
                    ...
                    >
                      <el-col :span="4">
                        <el-tooltip
                          ...
                          placement="bottom"
                        >
                          <div class="fc-grey-text14 pT5 pB5">
                            {{
...
export default {
    ...
    save() {
      ...
      for (let x in this.model.triggerData.triggers) {
        ...
        if (trigger.type === 1) {
          ...
          if (!trigger.frequency || trigger.frequency < 0) {
            trigger.frequency = 0
          }
  ...
  computed: {
    ...
    siteName() {
      ...
      let { woData = {} } = model
      let { woModel = null } = woData

      if (!isEmpty(woModel)) {
        let site = this.siteOptions.find(i => woModel.site.id === i.value)
        if (site) {
          return site.label
        }
      }
