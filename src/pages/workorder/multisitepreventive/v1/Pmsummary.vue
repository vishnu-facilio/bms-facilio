  ...
  <div class="pm-summary">
                ...
                <div class="pm-summary-card-container mT20">
                  ...
                  <div class="pm-summarycard-split-con">
                    <div class="summary-card">
                      ...
                      <div
                        v-else-if="
                          pm.pmCreationType === 3 && pm.assignmentType === 4
                        "
                      >
                        <p class="fc-black-11 fwBold text-uppercase">
                      ...
                      <div
                        v-else-if="
                          pm.pmCreationType === 3 && pm.assignmentType === 7
                        "
                      >
                        <p class="fc-black-11 fwBold text-uppercase">
                          {{ $t('maintenance.pm_list.associated_buildings') }}
                        </p>
                        <div class="summary-data-block pT0">
                          <div class="date-block">
                            <div
                            ...
                            >
                              ...
                              <div
                                v-else-if="pm.pmIncludeExcludeCount > 0"
                                class="label-txt-black fw3"
                                style="font-size: 40px;"
                              >
                                {{ pm.pmIncludeExcludeCount }}
                              </div>
                              <div v-else>
                                <div class="label-txt-black mT0">
                                  {{
                                    $t(
                                      'maintenance.pm_list.no_associated_buildings'
                                    )
                                  }}
                                </div>
                              </div>
                      ...
                      <div
                        v-else-if="
                          pm.pmCreationType === 3 && pm.assignmentType === 3
                        "
                      >
                        <p class="fc-black-11 fwBold text-uppercase">
                      ...
                      <div
                        v-else-if="
                          pm.pmCreationType === 3 && pm.assignmentType === 1
                        "
                      >
                        <p class="fc-black-11 fwBold text-uppercase">
                          {{ $t('maintenance.pm_list.associated_spaces') }}
                      ...
                      <div
                        v-else-if="
                          pm.pmCreationType === 3 && pm.assignmentType === 8
                        "
                      >
                        <p class="fc-black-11 fwBold text-uppercase">
                          {{ $t('maintenance.pm_list.associated_sites') }}
                        </p>
                        <div class="summary-data-block pT0">
                          <div class="date-block">
                            <div
                            ...
                            >
                              ...
                              <div v-else>
                                <div class="label-txt-black mT0">
                                  {{
                                    $t(
                                      'maintenance.pm_list.no_associated_sites'
                                    )
                                  }}
                                </div>
                              </div>
                            ...
                            <div v-else>
                              <div class="label-txt-black mT0">
                                {{
                                  $t('maintenance.pm_list.no_associated_sites')
                                }}
                              </div>
                            </div>
                          </div>
          ...
          >
            <div class="fc-scrollbar-wrap pT10">
              ...
              <div class="p30 white-bg-block pm-summary-right-bg">
                ...
                <div v-if="pm.pmCreationType === 3 && pm.assignmentType === 1">
                  <el-row class="wo__details__res pB20">
                    <el-col :span="11">
                ...
                <div v-if="pm.pmCreationType === 3 && pm.assignmentType === 3">
                  <el-row class="wo__details__res pB20">
                    <el-col :span="11">
                      <div class="fc-blue-label line-height18">
                ...
                <div v-if="pm.pmCreationType === 3 && pm.assignmentType === 4">
                  <el-row class="wo__details__res pB20">
                    <el-col :span="11">
                      <div class="fc-blue-label line-height18">
                ...
                <el-row class="wo__details__res pB20">
                  ...
                  <el-col :span="13">
                    ...
                    >
                      {{
                        workorder.category && workorder.category.id > 0
                ...
                >
                  ...
                  <el-col :span="13">
                    <div class style="cursor: pointer;">
                      <span v-if="cf.field.dataTypeEnum === 'LOOKUP'">
                        {{
                          workorder.data &&
                          workorder.data[cf.field.name] &&
                          workorder.data[cf.field.name].primaryValue
                            ? workorder.data[cf.field.name].primaryValue
                            : '---'
                        }}
                      </span>
                      <span v-else-if="cf.field.dataTypeEnum === 'ENUM'">
                        {{
                          workorder.data && workorder.data[cf.field.name]
                            ? cf.field.enumMap[
                                workorder.data[cf.field.name] + ''
                              ]
                            : '---'
                      ...
                      <span v-else-if="cf.field.dataTypeEnum === 'BOOLEAN'">
                        {{
                          workorder.data && cf.field.name in workorder.data
                            ? workorder.data[cf.field.name]
                              ? $t('maintenance.pm_list.true')
                              : $t('maintenance.pm_list.false')
                            : '---'
                        }}
                      </span>
                      <span v-else-if="isFieldDisplayTypeDuration(cf)">
                        {{ getFormattedDuration(workorder.data, cf) || '---' }}
                      </span>
                      <span v-else>
                        {{
                          workorder.data && workorder.data[cf.field.name]
              ...
              <div class="p20 white-bg-block mT20">
                ...
                <div class="notifications-container">
                  ...
                  <template
                    v-else-if="
                      pm.pmCreationType === 3 && reminders && reminders.length
                    "
                  >
                    <el-row
    ...
    >
      ...
      <div class="modal-dialog-footer">
        ...
        <el-button
          type="primary"
          :loading="disableExecuteNowButton"
...
import PmHistory from 'pages/workorder/multisitepreventive/v1/PmHistory'
...
export default {
  ...
  computed: {
    ...
    customFields() {
      let customFields = []
      for (const formField of this.pmFormData.fields) {
        if (formField && formField.field && !formField.field.default) {
    ...
    pmDescription() {
      return this.$getProperty(this, 'workorder.description', '---')
    },
  },
  methods: {
    async loadFormData() {
    ...
    async loadSite() {
      let { pm } = this
      let { siteIds = [] } = pm || {}
      if (isEmpty(siteIds)) return
      let defaultIds = [siteIds]
      let params = {
    ...
    goToEdit() {
      ...
      if (isWebTabsEnabled()) {
        ...
        if (name) {
          return { name, params: { id: id, pmCreationType: pmCreationType } }
        }
      } else {
        if (['SINGLE', 'MULTIPLE'].includes(pmCreationType)) {
          return `/app/wo/planned/new?edit=${id}`
        } else if (pmCreationType === 'MULTI_SITE') {
          return `/app/wo/multiplanned/new?edit=${id}`
        }
      }
    },
    getMultiResources() {
    ...
    getSiteName(pm) {
      ...
      if (!isEmpty(sites) && !isEmpty(siteIds)) {
        siteLabel = ''
        siteIds.forEach((siteId, index) => {
          let seperator =
            siteIds.length > 0 && index !== siteIds.length - 1 ? ',' : ''
          let site = sites.find(site => site.value === siteId) || {}
          let siteName = this.$getProperty(site, 'label', '---')

          siteLabel += `${siteName}${seperator}`
        })
      }
      return siteLabel
    },
    ...
    executeMultiPM() {
      if (this.disableExecuteNowButton) {
        return
      }
      let data = {}
      ...
      this.disableExecuteNowButton = true
      this.$http
        ...
        .then(response => {
          ...
          this.disableExecuteNowButton = false
    ...
    getFormattedDuration(workorderData, fieldObj) {
      let fieldName = this.$getProperty(fieldObj, 'field.name', '---')
      let { $helpers } = this
      let { getFormattedDuration } = $helpers || {}
      return workorderData && workorderData[fieldName]
        ? getFormattedDuration(workorderData[fieldName], 'seconds')
        : '---'
    },
    isFieldDisplayTypeDuration(customField) {
      let displayType = this.$getProperty(customField, 'field.displayType', '')
