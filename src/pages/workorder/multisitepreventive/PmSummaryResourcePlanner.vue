        ...
        <div class="flex-middle width100 justify-content-space mT30 mL30 PL20">
          ...
          <div class="fc-black-small-txt-12">
            <div class="flex-middle" style="height: 28px;">
              ...
              ></div>
              <!-- <el-input placeholder="search" style="margin-right: 32px;" v-model="searchQuery" type="search" class="fc-input-full-border2 text-input-icon-align input-padding width220px" prefix-icon="el-icon-search"></el-input> -->
              <f-search
            ...
            <thead>
              <tr class="pm-trigger-head-tr">
                <th class="pT10 pB10" style="padding-left: 25px !important;">
                  <div
                    v-if="pm.pmCreationType === 2 && pm.assignmentType === 4"
                  >
                    ASSETS
                  </div>
                  <div
                    v-if="pm.pmCreationType === 2 && pm.assignmentType === 3"
                  >
                    SPACES
                  </div>
                  <div
                    v-if="pm.pmCreationType === 2 && pm.assignmentType === 1"
                  >
                    SPACES
                  </div>
                </th>
                ...
                <th class="pT10 pB10 text-left">ASSIGN TO</th>
                <th></th>
              </tr>
            </thead>
            <tbody>
...
export default {
  ...
  watch: {
    page() {
      console.log('modelmodel', this.model)
