<template>
  <div class="p30">
    <div class="header">
      ...
      {{ (cardMeta && cardMeta.name) || 'Reading Card Layout 5' }}
...
<script>
import Config from '../type4/Config'
    ...
    previewData() {
      return !isEmpty(this.result)
        ...
        : {
            title: null,
            values: [
              { value: '--', name: 'Asset 1', unit: 'kWh' },
              { value: '--', name: 'Asset 2', unit: 'kWh' },
              { value: '--', name: 'Asset 3', unit: 'kWh' },
            ],
            period: null,
            unit: null,
          }
