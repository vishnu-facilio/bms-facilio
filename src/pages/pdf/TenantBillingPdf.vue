<template>
  <div class="height100vh">
    <div
      ...
      :class="{
        'header-sidebar-hide': $route.path === 'pdf/tenantbilling',
      }"
    >
              ...
              <el-row class="pT10">
                <el-col :span="14">
                  <div
                    ...
                    v-if="tenatData.tenanttobebilled.name"
                  >
                    {{ tenatData.tenanttobebilled.name }}
                  </div>
                  <div
                    class="fc-black-14 text-left"
                    v-if="tenatData.tenanttobebilled.primaryContactEmail"
                  >
                    {{ tenatData.tenanttobebilled.primaryContactEmail }}
                  </div>
                  <div
                    class="fc-black-14 text-left"
                    v-if="tenatData.tenanttobebilled.primaryContactPhone"
                  >
                    {{ tenatData.tenanttobebilled.primaryContactPhone }}
                  </div>
                </el-col>
                <el-col :span="10">
                  <el-row v-if="tenatData.billablemonth">
                    <el-col :span="12">
                    ...
                    <el-col :span="12">
                      <div class="fc-black-12 text-left pL15">
                        {{ tenatData.billablemonth }}
                      </div>
                    </el-col>
                  </el-row>

                  <el-row v-if="tenatData.date_1" class="pT10">
                    <el-col :span="12">
                      <div class="fc-black-12 text-left fwBold text-uppercase">
                        Bill Period
                      </div>
                  ...
                  <el-row class="pT10" v-if="tenatData.date_3">
                    <el-col :span="12">
                      <div class="fc-black-12 text-left fwBold text-uppercase">
                        Bill Due Date
                      </div>
                    ...
                    <el-col :span="12">
                      <div class="fc-black-12 text-left pL15">
                        {{
                          tenatData.date_3
                            ? getDate(tenatData.date_3, 'DD MMM YYYY')
                            : '---'
                        }}
                      </div>
                    </el-col>
              ...
              <table>
                ...
                <tbody>
                  <tr v-for="(lineItem, index) in lineItems" :key="index">
                    <td>
                      <div class="fwBold">
                        {{ getLineFieldData(lineItem, 'singleline_1') }}
                      </div>
      ...
      this.$http
        ...
        .then(response => {
          if (
            ...
            response.data.result.moduleData.data.tenanttobebilled
          ) {
            this.detail = response.data.result.moduleData
            this.tenatData = response.data.result.moduleData.data
          }
          this.getFields()
        })
    },
    ...
    getLineFieldData(item, fieldName) {
      if (fieldName && item && item.data) {
        ...
        if (fieldName === 'name') {
          ...
          return lineItem.decimal_2 ? lineItem.decimal_2 : '---'
