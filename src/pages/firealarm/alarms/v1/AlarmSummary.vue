    ...
    <div class="alarm-summary-body clearboth">
        ...
        <div class="alaram-summary-body-scroll">
          <div class="alarm-summary-inner">
            ...
            <div v-if="alarm.possibleCauses || alarm.recommendation > 0">
              <div class="fc-white-bg-container mT10">
                <div v-if="alarm.possibleCauses">
                  ...
                  <div class="label-txt-black mT10 line-height20 space-preline">
      ...
      <div class="alarm-summary-body-right clearboth">
        <div class="alaram-summary-body-scroll mL30 mR20">
          <div v-if="alarm.createdTime" class="mT20">
          ...
          <div v-if="resource" class="asset-con">
            <div class="mT20">
              ...
              >
                {{
                  resource
                    ? getAssetCategoryById(resource.category.id).name
...
import { QItem, QItemMain, QIcon, QPopover, QList, QModal } from 'quasar'
...
export default {
  ...
  methods: {
    ...
    getDatePickerObject() {
      ...
      return newDateHelper.getDatePickerObject(62, '' + modifiedTime)
    },
    ...
    loadAssetDetails() {
      if (this.alarm.asset && this.alarm.asset.id) {
        let self = this
        let url = '/asset/summary/' + this.alarm.asset.id
        self.$http.get(url).then(function(response) {
    ...
    loadRelatedAlarms(entityId) {
      ...
      self.$http
        ...
        .catch(() => {
          this.relatedAlarmsLoading = false
        })
    },
...
.alarm-summary-chart .fc-newchart-container svg {
  height: 300px;
}
