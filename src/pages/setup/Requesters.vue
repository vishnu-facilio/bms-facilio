        ...
        <div class="col-lg-12 col-md-12 mT60">
          <table class="setting-list-view-table" width="100%">
            ...
            <tbody
              v-else-if="
                !userlist ||
                  userlist.filter(user => user.inviteAcceptStatus === true)
                    .length == 0
              "
            >
              <tr>
                <td colspan="100%" class="text-center">
                  {{ $t('setup.users_management.no_portal_users') }}
                </td>
              </tr>
            </tbody>
            <tbody v-else>
              <tr
                ...
                :key="index"
                v-if="user.inviteAcceptStatus === true"
              >
                <td>
                ...
                <td style="width: 10%;">
                  ...
                  >
                    <i
                      ...
                      data-arrow="true"
                      :title="$t('setup.users_management.delete_requester')"
                      v-tippy
...
export default {
  ...
  methods: {
    deleteUser(user) {
      ...
      self.$dialog
        .confirm({
          title: self.$t('setup.users_management.delete_user_msg'),
          message:
