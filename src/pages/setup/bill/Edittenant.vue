    ...
    <el-form>
      ...
      <div class="tenant-body">
              ...
              <span class="input-upload tenant-upload">
                ...
                <span class="upload-icon-block">
                  ...
                  <img
                    ...
                    class="upload-img2"
                  />
                  <div class="upload-txt">Upload/Change Logo</div>
                </span>
          ...
          <el-col :span="18">
            <el-col :span="11">
              <el-form-item prop="name">
                <p class="grey-text2">Tenant Name</p>
                <el-input
                  :autofocus="true"
                  v-model="model.name"
            ...
            <el-col :span="24">
              <el-form-item prop="description">
                <p class="grey-text2">Description</p>
                <el-input
                  :min-rows="1"
        ...
        <el-row class="mT30" v-if="sites.length !== 1">
          <el-col :span="8">
            ...
            <el-col :span="20" class="mL15 utility-det-block">
              ...
              <p class="utility-list-D">Site associated with the tenant</p>
            </el-col>
          </el-col>
          ...
          <el-col :span="8">
            ...
            <el-col :span="20" class="mL15 utility-det-block">
              ...
              <p class="utility-list-D">
                Spaces associated with the tenant zone
              </p>
            </el-col>
          </el-col>
        ...
        <div class="mT30">
          ...
          <p class="grey-text2 line-height10">Name and contact details</p>
        </div>
        ...
        <el-row class="mT30">
          <el-col :span="8">
            ...
            <el-col :span="20" class="mL15 utility-det-block">
              ...
              <p class="utility-list-D">
                Energy meters associated with the tenant
              </p>
            </el-col>
          </el-col>
        ...
        <el-row class="mT30">
          <el-col :span="8">
            ...
            <el-col :span="20" class="mL15 utility-det-block">
              ...
              <p class="utility-list-D">
                Water services associated with the tenant
              </p>
            </el-col>
          </el-col>
          <el-col :span="14" class="mL20">
        ...
        <el-row class="mT30">
          <el-col :span="8">
            ...
            <el-col :span="20" class="mL15 utility-det-block">
              ...
              <p class="utility-list-D">
                Natural Gas services associated with the tenant
              </p>
            </el-col>
          </el-col>
          <el-col :span="14" class="mL20">
        ...
        <el-row class="mT30">
          <el-col :span="8">
            ...
            <el-col :span="20" class="mL15 utility-det-block">
              ...
              <p class="utility-list-D">BTUs associated with the tenant</p>
            </el-col>
          </el-col>
          <el-col :span="14" class="mL20">
            <el-select
...
export default {
  ...
  mounted() {
    ...
    if (this.tenant) {
      ...
      this.zone.id = this.tenant.zone.id
      this.zone.name = this.tenant.zone.name
      this.zone.siteId = this.tenant.zone.siteId
      this.zone.area = this.tenant.zone.area
      this.logoImageUrl = this.tenant.logoUrl
      this.loadChildren()
      this.loadSpaces(this.model.siteId)
  ...
  methods: {
    loadEnergyMeters() {
      ...
      this.$util
        ...
        .then(response => {
          self.energyMeters = response.assets
        })
    },
    loadChildren() {
      let self = this
      self.childrenLoading = true
      let url = '/zone/children?zoneId=' + this.zone.id
      self.$http.get(url).then(function(response) {
        self.childrenLoading = false
        self.children = response.data.children ? response.data.children : []
        self.children.forEach(child => {
          self.spacesAssociated.push(child.id)
        })
        self.loadEnergyMeters()
      })
    },
    loadChildSpaces() {
      this.$util
        .loadSpace(
          [2, 3, 4],
          null,
          [{ key: 'siteId', value: this.model.siteId }],
          null
        )
        .then(data => {
    ...
    requester() {
      ...
      if (this.user && this.user.name && this.user.email) {
        ...
        if (data) {
          this.model.contactInfo = data
        }
        this.model.contactInfo.name = this.user.name
        this.model.contactInfo.email = this.user.email
    ...
    loadSpaces(siteId) {
      let self = this
      this.$util
        .loadSpace([2, 3, 4], null, [{ key: 'siteId', value: siteId }], null)
        .then(data => {
          self.spaces = data.basespaces
        })
    },
    save() {
      let self = this
