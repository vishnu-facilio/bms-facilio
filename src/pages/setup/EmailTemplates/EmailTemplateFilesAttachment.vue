<template>
  ...
  >
    <div
      class="setup-dialog-lay new-body-modal mT0 pB100 height100 min-height300"
    >
      <el-form>
        <div v-if="showfileAttachment">
          <el-row>
        ...
        <div v-if="showUrlFiledAttachment">
          <el-row>
            <el-col :span="24" class="el-select-block">
              <div class="email-attachment">
        ...
        <div v-if="showFileUpload">
          <el-row v-if="!$validation.isEmpty(fileFieldsList)">
            <el-col :span="24" class="el-select-block">
              <div class="email-attachment">
