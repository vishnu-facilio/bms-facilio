            ...
            <div class="flex-middle pT15">
              ...
              <div class="visibility-visible-actions">
                ...
                <div class="flex-middle">
                  <a
                    :href="
                      `https://${application.appDomain.domain}/${application.linkName}`
                    "
                    target="_blank"
...
export default {
  ...
  methods: {
    ...
    saveUser(user, emailVerificationNeeded) {
      ...
      let params = { appId, emailVerificationNeeded, user: pick(user, props) }
