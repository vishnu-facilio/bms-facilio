    ...
    <div v-else class="container pB50">
      ...
      <div class="header-section border-bottom1px">
        <div class="d-flex flex-col">
          ...
          <div class="neighbourgood-category-chip width-fit mT10">
            <div v-if="record && record.category" class="chip-text">
              {{ categoryName }}
            </div>
          </div>
        </div>
...
export default {
  ...
  computed: {
    ...
    editRouteName() {
      return 'edit-neighbourhood'
    },
    categoryName() {
      return this.$getProperty(
        this.fieldsMap,
        `category.enumMap.${this.record.category}`,
        '---'
      )
    },
  },
