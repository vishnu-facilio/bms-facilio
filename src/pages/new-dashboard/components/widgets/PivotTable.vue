...
import skeletonLoader from 'src/pages/energy/pivot/Components/skeletonLoader.vue'
...
export default {
    ...
    pivotTable() {
      ...
      this.$nextTick().then(() => {
        ...
        if (this.printMode) {
          ...
          clonedItem.h = Math.ceil((tableElement.scrollHeight + 100) / 15)
  ...
  methods: {
    ...
    setDatePicker() {
      if (!isEmpty(this.dateOperator) && this.showTimelineFilter) {
