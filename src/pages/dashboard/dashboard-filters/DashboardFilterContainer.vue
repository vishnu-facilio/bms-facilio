...
export default {
  ...
  created() {
    console.log('db filter container , comp created ', this.dashboardFilterObj)

    this.dashboardUserFilters = this.$getProperty(
      this,
  ...
  methods: {
    ...
    saveContainer() {
      let availableFilter = this.editStateUserFilters
        ? this.editStateUserFilters.find(
