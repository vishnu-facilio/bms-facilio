<template>
  <div class="height100 energy-saving-card">
    ...
    <div class="dragabale-card  saving-card">
      ...
      <div class="sv-month">{{ $t('panel.card.this_month') }}</div>
      <div class="sv-date">
...
export default {
  ...
  methods: {
    ...
    prepareData(data) {
      ...
      data.percentage = data.savedPercentage || 0
      data.savedConsumption = data.savedConsumption || 0
      data.baselineConsumption = data.baselineConsumption || 0
      data.baselineCost = data.baselineCost || 0
      data.savedCost = data.savedCost || 0
