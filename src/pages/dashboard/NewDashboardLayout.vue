      ...
      <template v-else>
        ...
        >
          ...
          <div class="d-flex flex-shrink-0 self-center  mL-auto height-auto">
            <portal-target
              v-if="!isAltayerNonPrivilagedUser"
            ...
            <div class="flex-middle  fc-new-dashboard-full-more mR20 mT2">
              ...
              >
                ...
                >
                  ...
                  >
                    <span>{{ 'Clone' }}</span></el-dropdown-item
                  >
                  <el-dropdown-item
                    class="mobiledashboard"
        ...
        <!-- dashboard folder choose end -->
        <new-dashboard ref="newDashboard"></new-dashboard>
        <dashboard-manager
          :module="getCurrentModule()"
          :visibility.sync="showDashboardManager"
        ></dashboard-manager>
        <router-view
          :sites="{ data: sites, linkName: linkName }"
          :buildings="buildings"
          @mobiledashboard="mobiledashboardstatus"
          @dashboardobj="getdashboardObj"
...
import dashboardLayoutHelper from './helpers/newDashboardlayoutHelper'
...
export default {
  ...
  destroyed() {
    ...
    API.cancel({ uniqueKey: 'get-dashboard-list' })
  },
  methods: {
