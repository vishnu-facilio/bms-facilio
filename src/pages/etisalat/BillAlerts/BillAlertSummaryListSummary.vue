                ...
                >
                  <el-row>
                    <el-col :span="24">
                      ...
                      <div
                        class="label bold break-word whitespace-normal"
                      ...
                      >
                        <div class="d-flex">
                          <div class="fc-black-12 letter-spacing-normal">
                            <span>{{
                              row.data.lookup_1 ? row.data.lookup_1.name : ''
                            }}</span>
                          </div>
                        </div>
                        <div class="fc-grey2-text12 letter-spacing-normal">
