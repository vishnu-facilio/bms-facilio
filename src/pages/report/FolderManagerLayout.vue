<template>
  <div class="views-manager-container" :style="activeTabName == 'ScheduleViews' ? '' : 'margin-bottom:37px;'">
    ...
    <div>
      <div class="manager-tabs-container" v-if="activeTabName == 'folderViews'" style="padding: 10px;">
      ...
      <div v-if="activeTabName == 'ScheduleViews'" style="padding:10px;">
          <ReportScheduledList
          :Name="name"
          :list="list"
          :moduleName="$attrs.moduleName"
    ...
    <!-- <el-tabs class="manager-tabs-container" v-model="activeTabName">
      <el-tab-pane label="Folder Views" name="folderViews">
        <ReportFolderListView
          ref="folderList"
          :moduleName="$attrs.moduleName"
          :tabId="$attrs.tabId"
    ...
    <!-- <CreateFolderDialogBox
      v-if="addFolderDialog"
      :visibility.sync="addFolderDialog"
...
<script>
import ReportFolderListView from './ReportFolderListView'
import ReportScheduledList from './ReportScheduledList.vue'
