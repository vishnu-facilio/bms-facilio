<template>
  <div
    ...
    :class="
      ...
      reportConfig.options.settings &&
      reportConfig.options.settings.chart !== false
        ? 'f-tabular-report-new pT30'
        : 'f-tabular-report-new'
    "
    :style="{
      position: 'relative',
            ...
            <tbody class="scroll-y">
              ...
              >
                <td
                  ...
                  style="text-align: center;text-align: center;min-width: 49px;max-width: 49px;color: #000000 !important;font-size: 12px;font-weight: 500;letter-spacing: 1px;text-transform: uppercase;"
                ...
                <template v-for="(header, index) in table.columns">
                  <td
                    :key="index"
                    :style="
                      !isPrinting
