<template>
  <div
    class="reports-summary new-reports-summary workorder-report-page"
  ...
  >
    ...
    >
      ...
      >
        ...
        <div class="module-report-options">
          <f-report-options
    ...
    <div
      class="fc-report-author-sec"
      :class="[$helpers.isPortalUser() ? 'fc-report-pdf-height' : '']"
    ...
    >
      <module-new-report
        ...
        :class="[
          showOnlyImage ? 'fc-report-image-chart' : '',
          $helpers.isPortalUser() ? 'fc-report-pdf-portal' : '',
        ]"
      ></module-new-report>
    </div>
...
@media print {
  ...
  .fc-report-author-sec.fc-report-pdf-height {
  ...
  .fc-report-pdf-chart.fc-report-pdf-portal {
    zoom: 80%;
  }
