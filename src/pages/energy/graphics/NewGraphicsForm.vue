      ...
      >
        ...
        <div v-else style="padding: 20px 40px;">
          ...
          <el-row class="mB20" :gutter="20">
            ...
            <el-col :span="12">
              <p class="fc-input-label-txt">Folder</p>
              <el-select
  ...
  methods: {
    ...
    saveGraphicsActions() {
      if (!this.graphicsData.parentFolderId) {
        this.$message.error(
          'Please Choose the folder or enter new folder name.'
        )
      } else {
