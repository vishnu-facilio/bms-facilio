<template>
  <div class="newanalytics-generater mobile-alarmsummary-chart" v-if="!loading">
    <f-new-analytic-report
      id="mobile-summary-chart"
...
export default {
  ...
  methods: {
    loadQueryData() {
      ...
      if (querryData.analyticsConfig) {
        this.analyticsConfig = JSON.parse(querryData.analyticsConfig)
      }
    },
  },
}
