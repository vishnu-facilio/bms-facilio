  ...
  <div>
        ...
        <div class="col-7">
          ...
          <div class="analytics-page-header-filters">
            <div class="data-points-container">
              ...
              <div class="data-point">
                <div
                  @click="openEditDataPoint('Y-Axis', yAxisDataPoint, 'meter')"
                  :title="$t('common._common.y_axis')"
                  v-tippy
                >
                  {{
                    yAxisDataPoint.name
    ...
    <div ref="chartSection" class="self-center fchart-section scrollable">
      <div v-if="!analyticsConfig.dataPoints.length" class="text-center">
        <div class="p15">
          {{ $t('common._common.please_select_an_xaxis_yaxis') }}
        </div>
      </div>
      <f-analytic-report
...
export default {
  ...
  title() {
    return this.$t('common.header.regression_analysis')
  },
  data() {
    return {
      analyticsConfig: {
        name: this.$t('common.header.regression_analysis'),
        period: 12,
        regression: true,
